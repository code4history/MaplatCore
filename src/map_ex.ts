...
export class MaplatMap extends Map {
    ...
    constructor(optOptions: any) {
        ...
        const movestart = () => {
            if (!(self as any).__AvoidFirstMoveStart)
                self.dispatchEvent("movestart");
    ...
    setFillEnvelope(xys: any, stroke: any, fill: any, layer: any) {
        ...
        if (stroke != null || fill != null) {
            const option = {};
            if (stroke != null)
                (option as any).stroke = new Stroke(stroke);
            if (fill != null)
                (option as any).fill = new Fill(fill);
    ...
    handleGPS(launch: any, avoidEventForOff: any) {
        ...
        if (launch) {
            ...
            if (!avoidEventForOff)
                ...
                this.dispatchEvent(new MapEvent("gps_result", map, { error: "gps_off" }));
        }
    }
}
