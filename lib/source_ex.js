...
const checkMapTypeIsWMTS = (maptype) => (maptype || '').match(/^(?:base|overlay|google(?:_(?:roadmap|satellite|hybrid|terrain))?|mapbox)$/);
...
const checkIsBaseMap = (source) => (source instanceof NowMap && !(source instanceof TmsMap)) || source instanceof GoogleMap;
const checkIsMapbox = (source) => source instanceof MapboxMap;
const checkIsWMTSMap = (source) => source instanceof NowMap || source instanceof GoogleMap;
export default {
    mapSourceFactory,
    registerMapToSW,
    checkIsBaseMap,
