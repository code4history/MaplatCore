...
declare const HistMap_base: ((abstract new (...args: any[]) => {
    ...
    insideCheckSysCoord(sysCoord: import("ol/coordinate").Coordinate): boolean;
    modulateXyInside(xy: any): number[];
    modulateSysCoordInside(histCoords: any): import("ol/coordinate").Coordinate;
    ...
    defZoom(screenSize?: import("ol/size").Size | undefined): number;
