...
export declare class MaplatApp extends EventTarget {
    ...
    appData: any;
    appLang: string;
    backMap: MaplatMap | undefined;
    mercSrc: NowMap | undefined;
    mercBuffer: any;
    timer: any;
    ...
    currentPosition: any;
    startFrom: string;
    from: NowMap | HistMap | undefined;
    lines: any;
    mapDivDocument: any;
    mapObject: any;
    mapboxMap: any;
    pois: any;
    poiTemplate: string | boolean;
    poiStyle: string | boolean;
    iconTemplate: string | boolean;
    transparency_: any;
    logger: Logger;
    _backMapMoving: boolean;
    ...
    setInitialMap(cache: any): Promise<void>;
    setMapClick(): void;
    ...
    changeMap(mapID: any, restore: any): Promise<void>;
