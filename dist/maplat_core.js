...
const Vt = 11102230246251565e-32, ot = 134217729, Ro = (3 + 8 * Vt) * Vt;
...
const So = (3 + 16 * Vt) * Vt, Po = (2 + 12 * Vt) * Vt, xo = (9 + 64 * Vt) * Vt * Vt, Ve = _A(4), Xr = _A(8), Zr = _A(12), Fr = _A(16), ht = _A(4);
function Do(A, t, e, n, i, r, s) {
  ...
  let H = To(4, Ve), At = Po * s;
  if (H >= At || -H >= At || (C = A - X, g = A - (X + C) + (C - i), C = e - Z, a = e - (Z + C) + (C - i), C = t - N, o = t - (N + C) + (C - r), C = n - F, I = n - (F + C) + (C - r), g === 0 && o === 0 && a === 0 && I === 0) || (At = xo * s + Ro * Math.abs(H), H += X * I + F * g - (N * a + Z * o), H >= At || -H >= At)) return H;
...
const Kt = 11102230246251565e-32, at = 134217729, na = (3 + 8 * Kt) * Kt;
...
const ra = (3 + 16 * Kt) * Kt, sa = (2 + 12 * Kt) * Kt, ga = (9 + 64 * Kt) * Kt * Kt, Ke = JA(4), Kr = JA(8), _r = JA(12), Jr = JA(16), ut = JA(4);
function oa(A, t, e, n, i, r, s) {
  ...
  let H = ia(4, Ke), At = sa * s;
  if (H >= At || -H >= At || (C = A - X, g = A - (X + C) + (C - i), C = e - Z, a = e - (Z + C) + (C - i), C = t - N, o = t - (N + C) + (C - r), C = n - F, I = n - (F + C) + (C - r), g === 0 && o === 0 && a === 0 && I === 0) || (At = ga * s + na * Math.abs(H), H += X * I + F * g - (N * a + Z * o), H >= At || -H >= At)) return H;
...
function Rg(A, t) {
  let e;
  return e = t(Na(A)), e || (e = t(Ga(A)), e) || (e = t(Fa(A)), e) || (e = t(Za(A)), e) ? e : !1;
}
function Na(A) {
  return [A[0], A[1]];
}
...
const qA = 6378137, iA = Math.PI * qA, qa = [-iA, -iA, iA, iA], $a = [-180, -85, 180, 85], kn = qA * Math.log(Math.tan(Math.PI / 2));
class _e extends HA {
  /**
...
const Qn = 0.9996, Tt = 669438e-8, ni = Tt * Tt, ii = ni * Tt, Se = Tt / (1 - Tt), os = Math.sqrt(1 - Tt), lA = (1 - os) / (1 + os), Pg = lA * lA, dr = Pg * lA, mr = dr * lA, xg = mr * lA, Dg = 1 - Tt / 4 - 3 * ni / 64 - 5 * ii / 256, sI = 3 * Tt / 8 + 3 * ni / 32 + 45 * ii / 1024, gI = 15 * ni / 256 + 45 * ii / 1024, oI = 35 * ii / 3072, aI = 3 / 2 * lA - 27 / 32 * dr + 269 / 512 * xg, II = 21 / 16 * Pg - 55 / 32 * mr, CI = 151 / 96 * dr - 417 / 128 * xg, cI = 1097 / 512 * mr, Yn = 6378137;
function lI(A, t, e) {
  const n = A - 5e5, s = (e.north ? t : t - 1e7) / Qn / (Yn * Dg), g = s + aI * Math.sin(2 * s) + II * Math.sin(4 * s) + CI * Math.sin(6 * s) + cI * Math.sin(8 * s), o = Math.sin(g), a = o * o, I = Math.cos(g), C = o / I, c = C * C, u = c * c, p = 1 - Tt * a, f = Math.sqrt(1 - Tt * a), d = Yn / f, m = (1 - Tt) / p, E = Se * I ** 2, R = E * E, v = n / (d * Qn), S = v * v, P = S * v, D = P * v, L = D * v, X = L * v, Z = g - C / m * (S / 2 - D / 24 * (5 + 3 * c + 10 * E - 4 * R - 9 * Se)) + X / 720 * (61 + 90 * c + 298 * E + 45 * u - 252 * Se - 3 * R);
...
function fI(A, t, e) {
  ...
  const n = oA(t), i = Math.sin(n), r = Math.cos(n), s = i / r, g = s * s, o = g * g, a = oA(A), I = Bg(e.number), C = oA(I), c = Yn / Math.sqrt(1 - Tt * i ** 2), u = Se * r ** 2, p = r * tr(a - C, -Math.PI, Math.PI), f = p * p, d = f * p, m = d * p, E = m * p, R = E * p, v = Yn * (Dg * n - sI * Math.sin(2 * n) + gI * Math.sin(4 * n) - oI * Math.sin(6 * n)), S = Qn * c * (p + d / 6 * (1 - g + u) + E / 120 * (5 - 18 * g + o + 72 * u - 58 * Se)) + 5e5;
...
function oe(A, t) {
  return Ar && !Hn(A, [0, 0]) && A[0] >= -180 && A[0] <= 180 && A[1] >= -90 && A[1] <= 90 && (Ar = !1, Va(
...
function Zg(A, t, e, n, i, r, s) {
  ...
  for (; a.length > 0; ) {
    ...
    for (let E = c + n; E < C; E += n) {
      const R = A[E], v = A[E + 1], S = Ka(R, v, p, f, d, m);
      S > u && (I = E, u = S);
    }
...
class ir extends ug(wo) {
  constructor(t = {}) {
    const e = Object.assign({}, t), { mapType: n, layerTypes: i } = $I(t.maptype, t.layers);
...
class Es extends uA {
   ...
   */
  constructor(t) {
    super(), this.on, this.once, this.un, t = Object.assign({}, t), this.hints_ = [0, 0], this.animations_ = [], this.updateAnimationKey_, this.projection_ = pr(t.projection, "EPSG:3857"), this.viewportSize_ = [100, 100], this.targetCenter_ = null, this.targetResolution_, this.targetRotation_, this.nextCenter_ = null, this.nextResolution_, this.nextRotation_, this.cancelAnchor_ = void 0, t.projection && bI(), t.center && (t.center = oe(t.center, this.projection_)), t.extent && (t.extent = Nn(t.extent, this.projection_)), this.applyOptions_(t);
  }
  /**
  ...
  calculateExtentInternal(t) {
    ...
    return ce(i !== void 0, "The view rotation is not defined"), ja(e, n, i, t);
  }
  /**
