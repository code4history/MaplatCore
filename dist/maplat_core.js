import { transform as Bt, toLonLat as jn, Projection as Ur, addProjection as En, addCoordinateTransforms as ZA, getTransform as an, identityTransform as cn } from "ol/proj";
import { View as hg, Map as Wr, Feature as Qr } from "ol";
import { Vector as MA, Group as Vr, Tile as ln } from "ol/layer";
import { XYZ as ug, Google as Hr, Vector as EA } from "ol/source";
import { Style as Lt, Icon as Se, Stroke as Rn, Fill as Pn } from "ol/style";
class Vt {
  /**
...
class Kr {
  constructor(t = Je.INFO) {
    this.level = t, this.make();
  }
  level;
  make() {
    const t = Object.keys(Je).filter(
      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
      // @ts-expect-error
      (e) => !Yr.includes(e)
    );
    for (const e of t) {
      const A = Je[e], i = e.toLowerCase();
...
var He = { exports: {} }, qr = He.exports, bi;
function _r() {
  return bi || (bi = 1, (function(n, t) {
    (function(e, A) {
      A(t);
    })(qr, (function(e) {
      function A(h, l, u = {}) {
      ...
      function i(h, l, u = {}) {
        ...
        if (!s(h[0]) || !s(h[1])) throw new Error("coordinates must contain numbers");
        return A({ type: "Point", coordinates: h }, l, u);
      }
      function g(h, l, u = {}) {
        for (const m of h) {
        ...
        return A({ type: "Polygon", coordinates: h }, l, u);
      }
      function r(h, l = {}) {
        const u = { type: "FeatureCollection" };
        return l.id && (u.id = l.id), l.bbox && (u.bbox = l.bbox), u.features = h, u;
      }
      function s(h) {
      ...
      function p(h, l, u, m, v) {
        let b, R, B, x, G = l[0], Z = m[0], E = 0, D = 0;
        Z > G == Z > -G ? (b = G, G = l[++E]) : (b = Z, Z = m[++D]);
        let L = 0;
        if (E < h && D < u) for (Z > G == Z > -G ? (R = G + b, B = b - (R - G), G = l[++E]) : (R = Z + b, B = b - (R - Z), Z = m[++D]), b = R, B !== 0 && (v[L++] = B); E < h && D < u; ) Z > G == Z > -G ? (R = b + G, x = R - b, B = b - (R - x) + (G - x), G = l[++E]) : (R = b + Z, x = R - b, B = b - (R - x) + (Z - x), Z = m[++D]), b = R, B !== 0 && (v[L++] = B);
        for (; E < h; ) R = b + G, x = R - b, B = b - (R - x) + (G - x), G = l[++E], b = R, B !== 0 && (v[L++] = B);
        for (; D < u; ) R = b + Z, x = R - b, B = b - (R - x) + (Z - x), Z = m[++D], b = R, B !== 0 && (v[L++] = B);
      ...
      function st(h, l, u, m, v, b, R) {
        let B, x, G, Z, E, D, L, U, O, k, P, F, Y, K, et, W, tt, ct;
        const xt = h - v, St = u - v, Dt = l - b, Et = m - b;
        K = xt * Et, D = c * xt, L = D - (D - xt), U = xt - L, D = c * Et, O = D - (D - Et), k = Et - O, et = U * k - (K - L * O - U * O - L * k), W = Dt * St, D = c * Dt, L = D - (D - Dt), U = Dt - L, D = c * St, O = D - (D - St), k = St - O, tt = U * k - (W - L * O - U * O - L * k), P = et - tt, E = et - P, j[0] = et - (P + E) + (E - tt), F = K + P, E = F - K, Y = K - (F - E) + (P - E), P = Y - W, E = Y - P, j[1] = Y - (P + E) + (E - W), ct = F + P, E = ct - F, j[2] = F - (ct - E) + (P - E), j[3] = ct;
        let Ft = y(4, j), Kt = X * R;
        if (Ft >= Kt || -Ft >= Kt || (E = h - xt, B = h - (xt + E) + (E - v), E = u - St, G = u - (St + E) + (E - v), E = l - Dt, x = l - (Dt + E) + (E - b), E = m - Et, Z = m - (Et + E) + (E - b), B === 0 && x === 0 && G === 0 && Z === 0) || (Kt = z * R + d * Math.abs(Ft), Ft += xt * Z + Et * B - (Dt * G + St * x), Ft >= Kt || -Ft >= Kt)) return Ft;
        K = B * Et, D = c * B, L = D - (D - B), U = B - L, D = c * Et, O = D - (D - Et), k = Et - O, et = U * k - (K - L * O - U * O - L * k), W = x * St, D = c * x, L = D - (D - x), U = x - L, D = c * St, O = D - (D - St), k = St - O, tt = U * k - (W - L * O - U * O - L * k), P = et - tt, E = et - P, H[0] = et - (P + E) + (E - tt), F = K + P, E = F - K, Y = K - (F - E) + (P - E), P = Y - W, E = Y - P, H[1] = Y - (P + E) + (E - W), ct = F + P, E = ct - F, H[2] = F - (ct - E) + (P - E), H[3] = ct;
        const rn = p(4, j, 4, H, Q);
        K = xt * Z, D = c * xt, L = D - (D - xt), U = xt - L, D = c * Z, O = D - (D - Z), k = Z - O, et = U * k - (K - L * O - U * O - L * k), W = Dt * G, D = c * Dt, L = D - (D - Dt), U = Dt - L, D = c * G, O = D - (D - G), k = G - O, tt = U * k - (W - L * O - U * O - L * k), P = et - tt, E = et - P, H[0] = et - (P + E) + (E - tt), F = K + P, E = F - K, Y = K - (F - E) + (P - E), P = Y - W, E = Y - P, H[1] = Y - (P + E) + (E - W), ct = F + P, E = ct - F, H[2] = F - (ct - E) + (P - E), H[3] = ct;
        const sn = p(rn, Q, 4, H, q);
        K = B * Z, D = c * B, L = D - (D - B), U = B - L, D = c * Z, O = D - (D - Z), k = Z - O, et = U * k - (K - L * O - U * O - L * k), W = x * G, D = c * x, L = D - (D - x), U = x - L, D = c * G, O = D - (D - G), k = G - O, tt = U * k - (W - L * O - U * O - L * k), P = et - tt, E = et - P, H[0] = et - (P + E) + (E - tt), F = K + P, E = F - K, Y = K - (F - E) + (P - E), P = Y - W, E = Y - P, H[1] = Y - (P + E) + (E - W), ct = F + P, E = ct - F, H[2] = F - (ct - E) + (P - E), H[3] = ct;
        const yA = p(sn, q, 4, H, nt);
        return nt[yA - 1];
      }
      function ot(h, l, u, m, v, b) {
        const R = (l - b) * (u - v), B = (h - v) * (m - b), x = R - B, G = Math.abs(R + B);
        return Math.abs(x) >= T * G ? x : -st(h, l, u, m, v, b, G);
      }
      function gt(h, l) {
        var u, m, v = 0, b, R, B, x, G, Z, E, D = h[0], L = h[1], U = l.length;
        for (u = 0; u < U; u++) {
          m = 0;
          var O = l[u], k = O.length - 1;
          if (Z = O[0], Z[0] !== O[k][0] && Z[1] !== O[k][1]) throw new Error("First and last coordinates in a ring must be the same");
          for (R = Z[0] - D, B = Z[1] - L, m; m < k; m++) {
            if (E = O[m + 1], x = E[0] - D, G = E[1] - L, B === 0 && G === 0) {
              if (x <= 0 && R >= 0 || R <= 0 && x >= 0) return 0;
            } else if (G >= 0 && B <= 0 || G <= 0 && B >= 0) {
              if (b = ot(R, x, B, G, 0, 0), b === 0) return 0;
              (b > 0 && G > 0 && B <= 0 || b < 0 && G <= 0 && B > 0) && v++;
            }
            Z = E, B = G, R = x;
          }
        }
      ...
      function it(h, l, u = {}) {
        ...
        for (var G = 0; G < B.length; ++G) {
          const Z = gt(m, B[G]);
          if (Z === 0) return !u.ignoreBoundary;
          Z && (x = !0);
        }
        return x;
      }
      ...
      function Ht(h, l, u) {
        const m = l.geometry.coordinates[0][0], v = l.geometry.coordinates[0][1], b = l.geometry.coordinates[0][2], R = h.geometry.coordinates, B = l.properties.a.geom, x = l.properties.b.geom, G = l.properties.c.geom, Z = [v[0] - m[0], v[1] - m[1]], E = [b[0] - m[0], b[1] - m[1]], D = [R[0] - m[0], R[1] - m[1]], L = [x[0] - B[0], x[1] - B[1]], U = [G[0] - B[0], G[1] - B[1]];
        let O = (E[1] * D[0] - E[0] * D[1]) / (Z[0] * E[1] - Z[1] * E[0]), k = (Z[0] * D[1] - Z[1] * D[0]) / (Z[0] * E[1] - Z[1] * E[0]);
        if (u) {
          const P = u[l.properties.a.index], F = u[l.properties.b.index], Y = u[l.properties.c.index];
          let K;
          if (O < 0 || k < 0 || 1 - O - k < 0) {
            const et = O / (O + k), W = k / (O + k);
            K = O / F / (et / F + W / Y), k = k / Y / (et / F + W / Y);
          } else K = O / F / (O / F + k / Y + (1 - O - k) / P), k = k / Y / (O / F + k / Y + (1 - O - k) / P);
          O = K;
        }
        return [O * L[0] + k * U[0] + B[0], O * L[1] + k * U[1] + B[1]];
      }
      function N(h, l, u, m) {
        ...
        const x = l[1][B];
        return Ht(h, x.features[0], m);
      }
      function pt(h, l, u, m, v, b, R, B) {
        let x;
        if (R && (x = Pt(h, r([R]))), !x) if (u) {
          const G = h.geometry.coordinates, Z = u.gridNum, E = u.xOrigin, D = u.yOrigin, L = u.xUnit, U = u.yUnit, O = u.gridCache, k = It(G[0], E, L, Z), P = It(G[1], D, U, Z), F = O[k] ? O[k][P] ? O[k][P] : [] : [], Y = r(F.map((K) => l.features[K]));
          x = Pt(h, Y);
        } else x = Pt(h, l);
        return B && B(x), x ? Ht(h, x, b) : N(h, m, v, b);
      }
      function It(h, l, u, m) {
      ...
      function Yt(h, l) {
        ...
        for (let b = 0; b < l.length; b++) {
          const R = (b + 1) % l.length, B = zt(h - l[R]), x = Math.min(Math.abs(u), Math.abs(B));
          u * B <= 0 && x < m && (m = x, v = b), u = B;
        }
        return v;
      }
      function zt(h, l = !1) {
        const u = 2 * Math.PI, m = h - Math.floor(h / u) * u;
        return l ? m : m > Math.PI ? m - u : m;
      }
      function aA(h) {
        const l = h.features;
        for (let u = 0; u < l.length; u++) {
          const m = l[u];
          `${m.properties.a.index}`.substring(0, 1) === "b" && `${m.properties.b.index}`.substring(0, 1) === "b" ? l[u] = { geometry: { type: "Polygon", coordinates: [[m.geometry.coordinates[0][2], m.geometry.coordinates[0][0], m.geometry.coordinates[0][1], m.geometry.coordinates[0][2]]] }, properties: { a: { geom: m.properties.c.geom, index: m.properties.c.index }, b: { geom: m.properties.a.geom, index: m.properties.a.index }, c: { geom: m.properties.b.geom, index: m.properties.b.index } }, type: "Feature" } : `${m.properties.c.index}`.substring(0, 1) === "b" && `${m.properties.a.index}`.substring(0, 1) === "b" && (l[u] = { geometry: { type: "Polygon", coordinates: [[m.geometry.coordinates[0][1], m.geometry.coordinates[0][2], m.geometry.coordinates[0][0], m.geometry.coordinates[0][1]]] }, properties: { a: { geom: m.properties.b.geom, index: m.properties.b.index }, b: { geom: m.properties.c.geom, index: m.properties.c.index }, c: { geom: m.properties.a.geom, index: m.properties.a.index } }, type: "Feature" });
        }
        return h;
      }
      function tn(h) {
      ...
      function Oe(h, l, u, m, v, b = !1, R) {
        const B = h.map((x) => {
          (!R || R < 2.00703) && (x = cA(x));
          const G = isFinite(x) ? l[x] : x === "c" ? m : (function() {
            const Z = x.match(/^b(\d+)$/);
            if (Z) return v[parseInt(Z[1])];
            const E = x.match(/^e(\d+)$/);
            if (E) return u[parseInt(E[1])];
            throw new Error("Bad index value for indexesToTri");
          })();
          return b ? [[G[1], G[0]], x] : [[G[0], G[1]], x];
        });
        return en(B);
      }
      function cA(h) {
      ...
      function le(h) {
        return { points: h.points, pointsWeightBuffer: $(h), strictStatus: gn(h), verticesParams: hA(h), centroid: Ze(h), edges: lA(h.edges || []), edgeNodes: h.edgeNodes || [], tins: fA(h), kinks: Ae(h.kinks_points), yaxisMode: h.yaxisMode ?? "invert", strictMode: h.strictMode ?? "auto", vertexMode: h.vertexMode, bounds: h.bounds, boundsPolygon: h.boundsPolygon, wh: h.wh, xy: h.xy ?? [0, 0] };
      }
      function nn(h) {
        const l = dA(h), u = l.tins;
        return { compiled: l, tins: u, points: Le(u), strictStatus: l.strict_status, pointsWeightBuffer: l.weight_buffer, verticesParams: l.vertices_params, centroid: l.centroid, kinks: l.kinks };
      }
      function $(h) {
        return !h.version || h.version < Xe ? ["forw", "bakw"].reduce((l, u) => {
      ...
      function hA(h) {
        ...
        return l.forw[1] = uA(h, !1), l.bakw[1] = uA(h, !0), l;
      }
      function uA(h, l) {
        const u = h.vertices_points.length;
        return Array.from({ length: u }, (m, v) => {
          const b = (v + 1) % u, R = Oe(["c", `b${v}`, `b${b}`], h.points, h.edgeNodes || [], h.centroid_point, h.vertices_points, l, Xe);
          return r([R]);
        });
      }
      function Ze(h) {
      ...
      function fA(h) {
        ...
        return { forw: r(h.tins_points[0].map((u) => Oe(u, h.points, h.edgeNodes || [], h.centroid_point, h.vertices_points, !1, h.version))), bakw: r(h.tins_points[l].map((u) => Oe(u, h.points, h.edgeNodes || [], h.centroid_point, h.vertices_points, !0, h.version))) };
      }
      function Ae(h) {
      ...
      function Le(h) {
        ...
        for (let m = 0; m < u.length; m++) {
          const v = u[m];
          ["a", "b", "c"].forEach((b, R) => {
            const B = v.geometry.coordinates[0][R], x = v.properties[b].geom, G = v.properties[b].index;
            typeof G == "number" && (l[G] = [B, x]);
          });
        }
        return l;
      }
      ...
      class ft {
        ...
        setCompiled(l) {
          ...
          this.applyLegacyState(nn(l));
        }
        applyModernState(l) {
          this.points = l.points, this.pointsWeightBuffer = l.pointsWeightBuffer, this.strict_status = l.strictStatus, this.vertices_params = l.verticesParams, this.centroid = l.centroid, this.edges = l.edges, this.edgeNodes = l.edgeNodes || [], this.tins = l.tins, this.addIndexedTin(), this.kinks = l.kinks, this.yaxisMode = l.yaxisMode ?? ft.YAXIS_INVERT, this.vertexMode = l.vertexMode ?? ft.VERTEX_PLAIN, this.strictMode = l.strictMode ?? ft.MODE_AUTO, l.bounds ? (this.bounds = l.bounds, this.boundsPolygon = l.boundsPolygon, this.xy = l.xy, this.wh = l.wh) : (this.bounds = void 0, this.boundsPolygon = void 0, this.xy = l.xy ?? [0, 0], l.wh && (this.wh = l.wh));
        }
        applyLegacyState(l) {
        ...
        addIndexedTin() {
          const l = this.tins, u = l.forw, m = l.bakw, v = Math.ceil(Math.sqrt(u.features.length));
          if (v < 3) {
          ...
          const B = u.features.map((O) => {
            let k = [];
            return I(O)[0].map((P) => {
              b.length === 0 ? b = [Array.from(P), Array.from(P)] : (P[0] < b[0][0] && (b[0][0] = P[0]), P[0] > b[1][0] && (b[1][0] = P[0]), P[1] < b[0][1] && (b[0][1] = P[1]), P[1] > b[1][1] && (b[1][1] = P[1])), k.length === 0 ? k = [Array.from(P), Array.from(P)] : (P[0] < k[0][0] && (k[0][0] = P[0]), P[0] > k[1][0] && (k[1][0] = P[0]), P[1] < k[0][1] && (k[0][1] = P[1]), P[1] > k[1][1] && (k[1][1] = P[1]));
            }), k;
          }), x = (b[1][0] - b[0][0]) / v, G = (b[1][1] - b[0][1]) / v, Z = B.reduce((O, k, P) => {
            const F = It(k[0][0], b[0][0], x, v), Y = It(k[1][0], b[0][0], x, v), K = It(k[0][1], b[0][1], G, v), et = It(k[1][1], b[0][1], G, v);
            for (let W = F; W <= Y; W++) {
              O[W] || (O[W] = []);
              for (let tt = K; tt <= et; tt++) O[W][tt] || (O[W][tt] = []), O[W][tt].push(P);
            }
            return O;
          }, []), E = m.features.map((O) => {
            let k = [];
            return I(O)[0].map((P) => {
              R.length === 0 ? R = [Array.from(P), Array.from(P)] : (P[0] < R[0][0] && (R[0][0] = P[0]), P[0] > R[1][0] && (R[1][0] = P[0]), P[1] < R[0][1] && (R[0][1] = P[1]), P[1] > R[1][1] && (R[1][1] = P[1])), k.length === 0 ? k = [Array.from(P), Array.from(P)] : (P[0] < k[0][0] && (k[0][0] = P[0]), P[0] > k[1][0] && (k[1][0] = P[0]), P[1] < k[0][1] && (k[0][1] = P[1]), P[1] > k[1][1] && (k[1][1] = P[1]));
            }), k;
          }), D = (R[1][0] - R[0][0]) / v, L = (R[1][1] - R[0][1]) / v, U = E.reduce((O, k, P) => {
            const F = It(k[0][0], R[0][0], D, v), Y = It(k[1][0], R[0][0], D, v), K = It(k[0][1], R[0][1], L, v), et = It(k[1][1], R[0][1], L, v);
            for (let W = F; W <= Y; W++) {
              O[W] || (O[W] = []);
              for (let tt = K; tt <= et; tt++) O[W][tt] || (O[W][tt] = []), O[W][tt].push(P);
            }
          ...
          this.indexedTins = { forw: { gridNum: v, xOrigin: b[0][0], yOrigin: b[0][1], xUnit: x, yUnit: G, gridCache: Z }, bakw: { gridNum: v, xOrigin: R[0][0], yOrigin: R[0][1], xUnit: D, yUnit: L, gridCache: U } };
        }
        transform(l, u, m) {
          if (!this.tins) throw new Error("setCompiled() must be called before transform()");
          if (u && this.strict_status == ft.STATUS_ERROR) throw new Error('Backward transform is not allowed if strict_status == "strict_error"');
          this.yaxisMode == ft.YAXIS_FOLLOW && u && (l = [l[0], -1 * l[1]]);
          const v = i(l);
          if (this.bounds && !u && !m && !it(v, this.boundsPolygon)) return !1;
          const b = u ? this.tins.bakw : this.tins.forw, R = u ? this.indexedTins.bakw : this.indexedTins.forw, B = u ? this.vertices_params.bakw : this.vertices_params.forw, x = u ? this.centroid.bakw : this.centroid.forw, G = u ? this.pointsWeightBuffer.bakw : this.pointsWeightBuffer.forw;
          let Z, E;
          ...
          let D = pt(v, b, R, B, x, G, Z, E);
          if (this.bounds && u && !m) {
            const L = i(D);
            if (!it(L, this.boundsPolygon)) return !1;
          } else this.yaxisMode == ft.YAXIS_FOLLOW && !u && (D = [D[0], -1 * D[1]]);
          return D;
        }
      }
      const Mt = 20037508342789244e-9, je = [[0, 0], [0, 1], [1, 0], [0, -1], [-1, 0]];
      function Ne(h, l) {
      ...
      function ze(h, l, u, m) {
        const v = Ne(m, l);
        return pA(je, u).map((b) => [b[0] * v + h[0], b[1] * v + h[1]]);
      }
      function Fe(h, l) {
        ...
        for (let D = 0; D < 4; D++) {
          ...
          b += O;
          const k = L[0] * U[1] - L[1] * U[0], P = Math.acos((L[0] * U[0] + L[1] * U[1]) / O), F = k > 0 ? -1 * P : P;
          R += Math.cos(F), B += Math.sin(F);
        }
        const x = b / 4, G = Math.atan2(B, R), Z = Math.floor(Math.min(l[0], l[1]) / 4), E = Math.log(Z * Mt / 128 / x) / Math.log(2);
        return { center: u, zoom: E, rotation: G };
      }
      function he(h, l) {
      ...
      class ne {
        ...
        setMapData(l) {
          const u = new ft();
          if (u.setCompiled(l.compiled), this.mainTin = u, l.maxZoom !== void 0) this._maxxy = Math.pow(2, l.maxZoom) * Ue;
          else if (l.compiled.wh) {
            const m = Math.max(l.compiled.wh[0], l.compiled.wh[1]), v = Math.ceil(Math.log2(m / Ue));
            this._maxxy = Math.pow(2, v) * Ue;
          }
          if (this.subTins = [], l.sub_maps) for (const m of l.sub_maps) {
            ...
            const R = [...b, b[0]], B = R.map((x) => {
              const G = v.transform(x, !1);
              if (!G) throw new Error("Failed to transform sub-map bounds to mercator");
              return G;
            });
            this.subTins.push({ tin: v, priority: m.priority, importance: m.importance, xyBounds: g([R]), mercBounds: g([B]) });
          }
        }
        xy2Merc(l) {
          const u = this.xy2MercWithLayer(l);
          return u ? u[1] : !1;
        }
        merc2Xy(l) {
          const u = this.merc2XyWithLayer(l), m = u[0] || u[1];
          return m ? m[1] : !1;
        }
        xy2MercWithLayer(l) {
          this._assertMapData();
        ...
        merc2XyWithLayer(l) {
          return this._assertMapData(), this._getAllTinsWithIndex().map(({ index: u, tin: m, isMain: v }) => {
            ...
            const R = m[0], B = m[1], x = m[2];
            if (!x) return u;
            for (let G = 0; G < v; G++) {
              const Z = b[G][1], E = Z === 0;
              if (b[G][2] && (E || it(i(x), this.subTins[Z - 1].xyBounds))) if (u.length) {
                const D = !u[0], L = D ? u[1][2] : u[0][2], U = R.importance ?? 0, O = L.importance ?? 0;
                return D ? U < O ? u : [void 0, [B, x, R]] : [...u.filter((k) => k !== void 0), [B, x, R]].sort((k, P) => (k[2].importance ?? 0) < (P[2].importance ?? 0) ? 1 : -1).slice(0, 2);
              } else return [[B, x, R]];
            }
            return !u.length || !u[0] ? [[B, x, R]] : (u.push([B, x, R]), u.sort((G, Z) => {
              const E = G[2].importance ?? 0, D = Z[2].importance ?? 0;
              return E < D ? 1 : -1;
            }).filter((G, Z) => Z < 2));
          }, []).map((u) => {
            if (u) return [u[0], u[1]];
        ...
        mercs2SysCoords(l) {
          ...
          return u.map((v, b) => {
            ...
            const R = v[0], B = v[1];
            return b !== 0 && !m ? [this.xy2SysCoordInternal(B)] : l.map((x, G) => G === 0 ? B : this._transformByIndex(x, R, !0)).map((x) => this.xy2SysCoordInternal(x));
          });
        }
        viewpoint2Mercs(l, u) {
          this._assertMapData(), this._assertMaxxy();
          const m = ze(l.center, l.zoom, l.rotation, u).map((B) => ue(B, this._maxxy)), v = this.xy2MercWithLayer(m[0]);
          if (!v) throw new Error("viewpoint2Mercs: center point is out of bounds");
          const b = v[0], R = v[1];
          return m.map((B, x) => {
            if (x === 0) return R;
            const G = this._transformByIndex(B, b, !1);
            if (G === !1) throw new Error(`viewpoint2Mercs: point ${x} is out of bounds`);
            return G;
          });
        }
        mercs2Viewpoint(l, u) {
          ...
          const b = v[0], R = v[1], B = l.map((x, G) => {
            if (G === 0) return R;
            const Z = this._transformByIndex(x, b, !0);
            if (Z === !1) throw new Error(`mercs2Viewpoint: point ${G} is out of bounds`);
            return Z;
          }).map((x) => he(x, this._maxxy));
          return Fe(B, u);
        }
        ...
        _getTinsSortedByPriority() {
          return this._getAllTinsWithIndex().sort((l, u) => {
            const m = l.tin.priority ?? 0, v = u.tin.priority ?? 0;
            return m < v ? 1 : -1;
          });
        }
        _getAllTinsWithIndex() {
          const l = [{ index: 0, tin: this.mainTin, isMain: !0 }];
          return this.subTins.forEach((u, m) => {
            u.tin.priority = u.priority, u.tin.importance = u.importance, l.push({ index: m + 1, tin: u.tin, isMain: !1 });
          }), l;
        }
        _transformByIndex(l, u, m) {
          if (u === 0) return this.mainTin.transform(l, m);
          const v = this.subTins[u - 1];
      ...
      e.MERC_CROSSMATRIX = je, e.MERC_MAX = Mt, e.MapTransform = ne, e.Transform = ft, e.counterTri = tn, e.format_version = mA, e.mercViewpoint2Mercs = ze, e.mercs2MercViewpoint = Fe, e.normalizeEdges = lA, e.rotateMatrix = pA, e.rotateVerticesTriangle = aA, e.sysCoord2Xy = ue, e.transformArr = pt, e.xy2SysCoord = he, e.zoom2Radius = Ne, Object.defineProperty(e, Symbol.toStringTag, { value: "Module" });
    }));
  })(He, He.exports)), He.exports;
}
var At = _r();
const fg = "data:image/png;base64,", re = 256, $r = `<canvas width="${re}" height="${re}" src="${fg}"></canvas>`;
async function RA(n) {
  if (typeof n == "string") {
...
const dg = ["hide", "title", "icon", "selectedIcon"], ts = [
  "lnglat",
  "lng",
  "lat",
  "longitude",
...
function Sn(n) {
  if (!xn(n) || n.type === "FeatureCollection") return !1;
  const t = n.layer, e = typeof t == "string", A = xn(t) && t.type === "FeatureCollection";
  return !(!e && !A || ts.some((i) => n[i] !== void 0));
}
function es(n) {
  return Sn(n) && dg.some((t) => n[t] !== void 0);
}
function Mi(n) {
  const t = {};
...
function Ei(n, t) {
  ...
  t.hide === !0 && (n.hide = !0);
  const e = t.title;
  (typeof e == "string" ? e !== "" : xn(e) && Object.keys(e).length > 0) && (n.name = e);
  for (const A of ["icon", "selectedIcon"]) {
    const i = t[A];
    typeof i == "string" && i !== "" && (n[A] = i);
  }
  return n;
}
async function mg(n, t) {
  if (n = await RA(n), Array.isArray(n))
    if (n = await Promise.all(
      n.map(async (e) => await RA(e))
    ), n.length > 0 && (n[0].type === "FeatureCollection" || Sn(n[0]))) {
      const e = await Promise.all(
        n.map(async (A, i) => {
          let g, r;
          Sn(A) ? (g = await RA(A.layer), r = Mi(A)) : (g = A, r = null);
    ...
    const e = await RA(n.layer), A = e.id || e.properties && e.properties.id || "main", i = _t(e, A, t);
    n = { [A]: Ei(i, Mi(n)) };
  } else
    Object.keys(n).map((e) => {
      n[e] = _t(n[e], e, t);
    });
  return n.main || (n.main = _t([], "main", t)), Object.keys(n).map((e) => {
    Nn(n, e, t);
  }), n;
}
function _t(n, t, e) {
  if (Array.isArray(n))
    ...
    n.name && (A.name = n.name), A.pois = n.features.map((i) => _e(i)), n = A;
  }
  if (typeof n.id > "u")
    n.id = t;
...
function _e(n) {
  ...
  return n.lnglat || (n.lnglat = [n.lng || n.longitude, n.lat || n.latitude]), delete n.lng, delete n.lat, delete n.longitude, delete n.latitude, n;
}
function Nn(n, t, e) {
  if (!n[t]) return;
  const A = n[t], i = A.pois;
  A.__nextId || (A.__nextId = 0), i.map((g) => {
      ...
      for (var X = 0; X < s; X++) {
        ...
        if (r = c ? I.geometries[X] : I, r !== null) {
          ...
          switch (C = Q === "Polygon" || Q === "MultiPolygon" ? 1 : 0, Q) {
            ...
            case "MultiPolygon":
              for (A = 0; A < o.length; A++) {
                for (j = 0, i = 0; i < o[A].length; i++) {
                  for (g = 0; g < o[A][i].length - C; g++) {
                    if (t(
                      o[A][i][g],
                      a,
                      T,
            ...
            case "GeometryCollection":
              for (A = 0; A < r.geometries.length; A++)
                if (wg(r.geometries[A], t) === !1)
                  return !1;
              break;
            default:
...
const Qt = 11102230246251565e-32, dt = 134217729, gs = (3 + 8 * Qt) * Qt;
function hn(n, t, e, A, i) {
  let g, r, s, o, I = t[0], C = A[0], a = 0, c = 0;
  C > I == C > -I ? (g = I, I = t[++a]) : (g = C, C = A[++c]);
  let d = 0;
  if (a < n && c < e)
    for (C > I == C > -I ? (r = I + g, s = g - (r - I), I = t[++a]) : (r = C + g, s = g - (r - C), C = A[++c]), g = r, s !== 0 && (i[d++] = s); a < n && c < e; )
      C > I == C > -I ? (r = g + I, o = r - g, s = g - (r - o) + (I - o), I = t[++a]) : (r = g + C, o = r - g, s = g - (r - o) + (C - o), C = A[++c]), g = r, s !== 0 && (i[d++] = s);
  for (; a < n; )
    r = g + I, o = r - g, s = g - (r - o) + (I - o), I = t[++a], g = r, s !== 0 && (i[d++] = s);
  for (; c < e; )
    r = g + C, o = r - g, s = g - (r - o) + (C - o), C = A[++c], g = r, s !== 0 && (i[d++] = s);
  return (g !== 0 || d === 0) && (i[d++] = g), d;
}
function rs(n, t) {
  let e = t[0];
  for (let A = 1; A < n; A++) e += t[A];
  return e;
}
function sA(n) {
  return new Float64Array(n);
}
const ss = (3 + 16 * Qt) * Qt, os = (2 + 12 * Qt) * Qt, Is = (9 + 64 * Qt) * Qt * Qt, de = sA(4), xi = sA(8), Si = sA(12), Di = sA(16), wt = sA(4);
function Cs(n, t, e, A, i, g, r) {
  ...
  let mt = rs(4, de), Pt = os * r;
  if (mt >= Pt || -mt >= Pt || (a = n - st, s = n - (st + a) + (a - i), a = e - ot, I = e - (ot + a) + (a - i), a = t - gt, o = t - (gt + a) + (a - g), a = A - it, C = A - (it + a) + (a - g), s === 0 && o === 0 && I === 0 && C === 0) || (Pt = Is * r + gs * Math.abs(mt), mt += st * C + it * s - (gt * I + ot * o), mt >= Pt || -mt >= Pt)) return mt;
  ...
  const pt = hn(N, Si, 4, wt, Di);
  return Di[pt - 1];
}
function as(n, t, e, A, i, g) {
  const r = (t - g) * (e - i), s = (n - i) * (A - g), o = r - s, I = Math.abs(r + s);
  return Math.abs(o) >= ss * I ? o : -Cs(n, t, e, A, i, g, I);
}
function cs(n, t) {
...
function ls(n, t, e = {}) {
  ...
  const A = ns(n), i = is(t), g = i.type, r = t.bbox;
  let s = i.coordinates;
  if (r && hs(A, r) === !1)
    return !1;
  g === "Polygon" && (s = [s]);
...
class vg {
  ...
  _up(t) {
    const { data: e, compare: A } = this, i = e[t];
    for (; t > 0; ) {
      const g = t - 1 >> 1, r = e[g];
      if (A(i, r) >= 0) break;
      e[t] = r, t = g;
  ...
  _down(t) {
    const { data: e, compare: A } = this, i = this.length >> 1, g = e[t];
    for (; t < i; ) {
      let r = (t << 1) + 1, s = e[r];
      const o = r + 1;
      if (o < this.length && A(e[o], s) < 0 && (r = o, s = e[o]), A(s, g) >= 0) break;
      e[t] = s, t = r;
    }
    e[t] = g;
  }
...
class Bi {
  constructor(t, e, A, i) {
    this.p = {
      x: t[0],
      y: t[1]
    }, this.featureId = e, this.ringId = A, this.eventId = i, this.otherEvent = null, this.isLeftEndpoint = null;
  }
  isSamePoint(t) {
...
function Ti(n, t) {
  ...
  let A = e.coordinates;
  (e.type === "Polygon" || e.type === "MultiLineString") && (A = [A]), e.type === "LineString" && (A = [[A]]);
  for (let i = 0; i < A.length; i++)
    for (let g = 0; g < A[i].length; g++) {
      let r = A[i][g][0], s = null;
      xA = xA + 1;
      for (let o = 0; o < A[i][g].length - 1; o++) {
        s = A[i][g][o + 1];
        const I = new Bi(r, PA, xA, SA), C = new Bi(s, PA, xA, SA + 1);
        I.otherEvent = C, C.otherEvent = I, bg(I, C) > 0 ? (C.isLeftEndpoint = !0, I.isLeftEndpoint = !1) : (I.isLeftEndpoint = !0, C.isLeftEndpoint = !1), t.push(I), t.push(C), r = s, SA = SA + 1;
      }
    }
  PA = PA + 1;
}
...
function ps(n, t) {
  ...
  const e = n.leftSweepEvent.p.x, A = n.leftSweepEvent.p.y, i = n.rightSweepEvent.p.x, g = n.rightSweepEvent.p.y, r = t.leftSweepEvent.p.x, s = t.leftSweepEvent.p.y, o = t.rightSweepEvent.p.x, I = t.rightSweepEvent.p.y, C = (I - s) * (i - e) - (o - r) * (g - A), a = (o - r) * (A - s) - (I - s) * (e - r), c = (i - e) * (A - s) - (g - A) * (e - r);
  if (C === 0)
    return !1;
  const d = a / C, p = c / C;
  if (d >= 0 && d <= 1 && p >= 0 && p <= 1) {
...
function ys(n, t) {
  ...
  for (; n.length; ) {
    ...
    if (i.isLeftEndpoint) {
      ...
      A.push(g);
    } else i.isLeftEndpoint === !1 && A.pop();
  }
  return e;
}
function ws(n, t) {
  const e = new vg([], bg);
  return ds(n, e), ys(e, t);
}
var vs = ws;
function bs(n, t, e = {}) {
  const { removeDuplicates: A = !0, ignoreSelfIntersections: i = !0 } = e;
  let g = [];
  n.type === "FeatureCollection" ? g = g.concat(n.features) : n.type === "Feature" ? g.push(n) : (n.type === "LineString" || n.type === "Polygon" || n.type === "MultiLineString" || n.type === "MultiPolygon") && g.push($e(n)), t.type === "FeatureCollection" ? g = g.concat(t.features) : t.type === "Feature" ? g.push(t) : (t.type === "LineString" || t.type === "Polygon" || t.type === "MultiLineString" || t.type === "MultiPolygon") && g.push($e(t));
  const r = vs(
    Ri(g),
    i
  );
...
function Mg(n) {
  class t extends n {
    ...
    initialize(A) {
      if (A = jt(A), this.mapID = A.mapID, this.homePosition = A.homePosition, this.mercZoom = A.mercZoom, this.label = A.label, this.maxZoom = A.maxZoom, this.minZoom = A.minZoom, this.poiTemplate = A.poiTemplate, this.poiStyle = A.poiStyle, this.iconTemplate = A.iconTemplate, this.icon = A.icon, this.selectedIcon = A.selectedIcon, this.mercatorXShift = A.mercatorXShift, this.mercatorYShift = A.mercatorYShift, this.weiwudi = A.weiwudi, A.envelopeLngLats) {
        const s = A.envelopeLngLats.map(
          (o) => Bt(o, "EPSG:4326", "EPSG:3857")
        );
        s.push(s[0]), this.envelope = yg([s]), this.centroid = Ms(this.envelope).geometry?.coordinates;
      }
      ...
      const i = A.thumbnail ? new Promise((r) => {
        this.thumbnail = A.thumbnail, r(void 0);
      }) : new Promise((r) => {
        this.thumbnail = `./tmbs/${A.mapID}.jpg`, fetch(this.thumbnail).then((s) => {
          s.ok || (this.thumbnail = `./tmbs/${A.mapID}_menu.jpg`), r(void 0);
        }).catch((s) => {
          this.thumbnail = `./tmbs/${A.mapID}_menu.jpg`, r(void 0);
        });
      }).catch((r) => {
        this.thumbnail = `./tmbs/${A.mapID || A.sourceID}_menu.jpg`;
      }), g = this.resolvePois(A.pois);
      this.initialWait = Promise.all([g, i]), Ps(this);
    }
    static isBasemap() {
    ...
    async fetchAllTileCacheAsync(A) {
      if (this.weiwudi)
        try {
          const i = (r) => {
            A(r.type, r.detail);
          }, g = (r) => {
            this.weiwudi.removeEventListener("proceed", i), this.weiwudi.removeEventListener("finish", g), this.weiwudi.removeEventListener("stop", g), this.weiwudi.removeEventListener("canceled", g), i(r);
          };
          this.weiwudi.addEventListener("proceed", i), this.weiwudi.addEventListener("finish", g), this.weiwudi.addEventListener("stop", g), this.weiwudi.addEventListener("canceled", g), await this.weiwudi.fetchAll();
        } catch {
        }
    }
    ...
    setViewpointRadian(A) {
      let i, g;
      const r = A.mercZoom, s = A.zoom, o = A.direction, I = A.rotation, a = this.getMap()?.getView();
      A.latitude !== void 0 && A.longitude !== void 0 && (i = Bt(
        [A.longitude, A.latitude],
        "EPSG:4326",
        "EPSG:3857"
      )), A.x !== void 0 && A.y != null && (g = [A.x, A.y]), this.viewpoint2MercsAsync().then((c) => this.mercs2MercViewpoint(c)).then((c) => {
        const d = this.mercViewpoint2Mercs([
          i || c[0],
          r || c[1] || 17,
          o ?? I ?? c[2]
        ]);
        this.mercs2ViewpointAsync(d).then((p) => {
          i != null ? a?.setCenter(p[0]) : g != null && a?.setCenter(g), r != null ? a?.setZoom(p[1]) : s != null && a?.setZoom(s), o != null ? a?.setRotation(p[2]) : I != null && a?.setRotation(I);
        });
      });
    }
    setViewpoint(A) {
    ...
    setGPSMarkerAsync(A, i = !1) {
      const g = this.getMap(), r = g?.getView();
      if (!A)
        return new Promise((o, I) => {
          g?.setGPSPosition(null), o(!0);
        });
      const s = this.mercsFromGPSValue(A.lnglat, A.acc);
    ...
    setGPSMarker(A, i = !1) {
      this.setGPSMarkerAsync(A, i).then(() => {
      });
    }
    mercsFromGPSValue(A, i) {
      const g = Bt(A, "EPSG:4326", "EPSG:3857"), r = A[1] * Math.PI / 180, s = i / Math.cos(r);
      return At.MERC_CROSSMATRIX.map((o) => [
        o[0] * s + g[0],
        o[1] * s + g[1]
      ]);
    }
    ...
    rotateMatrix(A, i) {
      return i === void 0 && (i = this.getMap().getView().getRotation()), At.rotateMatrix(A, i);
    }
    async resolvePois(A) {
      this.pois = await mg(A || [], {
    ...
    getPoi(A) {
      ...
      return Object.keys(this.pois).map((g) => {
        this.pois[g].pois.map((r, s) => {
          r.id === A && (i = this.pois[g].pois[s]);
        });
      }), i;
    }
    addPoi(A, i) {
      if (i || (i = "main"), this.pois[i])
        return A = _e(A), this.pois[i].pois.push(A), Nn(this.pois, i, {
          name: this.officialTitle || this.title,
          namespace: this.mapID
        }), A.namespaceID;
    }
    removePoi(A) {
      Object.keys(this.pois).map((i) => {
        this.pois[i].pois.map((g, r) => {
          g.id === A && delete this.pois[i].pois[r];
        });
      });
    }
    clearPoi(A) {
      A || (A = "main"), A === "all" ? Object.keys(this.pois).map((i) => {
        this.pois[i].pois = [];
    ...
    addPoiLayer(A, i) {
      A !== "main" && (this.pois[A] || (this.pois[A] = _t(i || [], A, {
        name: this.officialTitle || this.title,
        namespace: this.mapID
      })));
    }
    removePoiLayer(A) {
      A !== "main" && this.pois[A] && delete this.pois[A];
    }
    merc2SysCoordAsync_ignoreBackground(A) {
      return this.merc2XyAsync_ignoreBackground(A).then(
        (i) => i ? this.xy2SysCoord(i) : void 0
      );
    }
    merc2SysCoordAsync(A) {
      return this.merc2XyAsync(A).then(
        (i) => i && this.xy2SysCoord(i)
      );
    }
    sysCoord2MercAsync(A) {
      const i = this.sysCoord2Xy(A);
      return this.xy2MercAsync(i);
    }
    // size(画面サイズ)とズームから、地図面座標上での半径を得る。zoom無指定の場合は自動取得
    zoom2Radius(A, i) {
      return i === void 0 && (i = this.getMap().getView().getDecimalZoom()), At.zoom2Radius(A, i);
    }
    // 画面サイズと地図ズームから、地図面座標上での5座標を取得する。zoom, rotate無指定の場合は自動取得
    viewpoint2SysCoords(A, i) {
      return this.mercViewpoint2Mercs(A, i);
    }
    mercViewpoint2Mercs(A, i) {
      let g = A ? A[0] : void 0;
      const r = A ? A[1] : void 0, s = A ? A[2] : void 0;
      g === void 0 && (g = this.getMap().getView().getCenter()), i === void 0 && (i = this.getMap().getSize());
      const o = r ?? this.getMap().getView().getDecimalZoom(), I = s ?? this.getMap().getView().getRotation();
      return [At.mercViewpoint2Mercs(
        g,
        o,
        I,
        i
    ...
    sysCoords2Viewpoint(A) {
      return this.mercs2MercViewpoint(A);
    }
    // メルカトル5地点情報からメルカトル地図でのサイズ情報（中心座標、サイズ、回転）を得る
    mercs2MercViewpoint(A) {
      let i = A[1];
      i || (i = this.getMap().getSize());
      const g = At.mercs2MercViewpoint(
        A[0],
        i
      );
    ...
    sysCoords2Xys(A) {
      return [
        A[0].map((i) => this.sysCoord2Xy(i)),
        A[1]
      ];
    }
    xys2SysCoords(A) {
      return [A[0].map((i) => this.xy2SysCoord(i)), A[1]];
    }
    mercs2XysAsync(A) {
      return Promise.all(A[0].map((i) => this.merc2XyAsync(i))).then(
        (i) => [i, A[1]]
      );
    }
    xys2MercsAsync(A) {
      return Promise.all(A[0].map((i) => this.xy2MercAsync(i))).then(
        (i) => [i, A[1]]
      );
    }
    static async createAsync(A) {
      return new this(A);
    }
  }
  return t;
...
function Eg(n) {
  class t extends Mg(n) {
    static isBasemap_ = !0;
    static isWmts_ = !0;
    insideCheckXy(A) {
      return this.envelope ? ls(A, this.envelope) : !0;
    }
    insideCheckSysCoord(A) {
      return this.insideCheckXy(A);
    }
    modulateXyInside(A) {
      if (!this.centroid) return A;
      const i = As([A, this.centroid]), g = bs(this.envelope, i);
      return g.features.length > 0 && g.features[0].geometry ? g.features[0].geometry.coordinates : A;
    }
    modulateSysCoordInside(A) {
      return this.modulateXyInside(A);
    }
    // unifyTerm対応
    ...
    merc2XyAsync_ignoreBackground(A) {
      return this.merc2XyAsync(A);
    }
    xy2MercAsync(A) {
      return Promise.resolve(A);
    }
    ...
    viewpoint2MercsAsync(A, i) {
      const g = this.viewpoint2SysCoords(A, i), r = this.sysCoords2Xys(g);
      return this.xys2MercsAsync(r);
    }
    mercs2ViewpointAsync(A) {
      return this.mercs2XysAsync(A).then((i) => {
        const g = this.xys2SysCoords(i);
        return this.sysCoords2Viewpoint(g);
      });
    }
    mercs2SysCoordsAsync_multiLayer(A) {
      return Promise.all(
        A[0].map((i) => this.merc2SysCoordAsync(i))
      ).then((i) => [[i, A[1]]]);
    }
    defZoom() {
...
function Es(n) {
  class t extends Mg(n) {
    ...
    _maxxy = 0;
    insideCheckXy(A) {
      return !(A[0] < 0 || A[0] > this.width || A[1] < 0 || A[1] > this.height);
    }
    insideCheckSysCoord(A) {
      return this.insideCheckXy(this.sysCoord2Xy(A));
    }
    modulateXyInside(A) {
      const i = A[0] / (this.width / 2) - 1, g = A[1] / (this.height / 2) - 1, r = Math.max(Math.abs(i), Math.abs(g));
      return [
        (i / r + 1) * this.width / 2,
        (g / r + 1) * this.height / 2
      ];
    ...
    modulateSysCoordInside(A) {
      const i = this.sysCoord2Xy(A), g = this.modulateXyInside(i);
      return this.xy2SysCoord(g);
    }
    // unifyTerm対応
    // https://github.com/code4history/MaplatCore/issues/19
    xy2SysCoord(A) {
      const i = A[0] * (2 * At.MERC_MAX) / this._maxxy - At.MERC_MAX, g = -1 * (A[1] * (2 * At.MERC_MAX) / this._maxxy - At.MERC_MAX);
      return [i, g];
    }
    sysCoord2Xy(A) {
      const i = (A[0] + At.MERC_MAX) * this._maxxy / (2 * At.MERC_MAX), g = (-A[1] + At.MERC_MAX) * this._maxxy / (2 * At.MERC_MAX);
      return [i, g];
    }
    defZoom(A) {
      const i = A[0], g = A[1], r = Math.log2((i - 10) / this.width), s = Math.log2((g - 10) / this.height), o = this.maxZoom;
      let I;
...
function Rg(n) {
  return n = jt(n), n.imageExtension || (n.imageExtension = "jpg"), n.mapID && !n.url && !n.urls && (n.url = n.tms ? `tiles/${n.mapID}/{z}/{x}/{-y}.${n.imageExtension}` : `tiles/${n.mapID}/{z}/{x}/{y}.${n.imageExtension}`), n;
}
function Ps(n) {
  const t = n;
    ...
    (function() {
      ...
      return function(i, g) {
        ...
        let s = i.tileCoord[1], o = i.tileCoord[2], I = Math.round(
          (t.mercatorXShift || 0) * 128 * Math.pow(2, r) / At.MERC_MAX
        ), C = Math.round(
          (t.mercatorYShift || 0) * -128 * Math.pow(2, r) / At.MERC_MAX
        );
        for (; I < 0 || I >= 256; )
...
function We(n) {
  ...
  for (let g = 0; g < i.childNodes.length; g++) {
    ...
    if (r.nodeName && r.nodeName.toLowerCase() === "script") {
      ...
      r.type && (s.type = r.type), r.src ? s.src = r.src : s.text = r.text, A[g] = s;
    } else
      A[g] = r;
  }
  return A;
...
function jt(n) {
  ...
  return Object.keys(t).reduce((e, A) => {
    if (e[A] !== void 0)
      throw new Error(`Invalid Maplat option key: ${A}. Use "${t[A]}" instead.`);
    return e;
  }, n);
}
class Pg {
...
function xs(n, t, e) {
  let A, i;
  e = e || xg;
  let g = 0, r = n.length, s = !1;
  for (; g < r; )
    A = g + (r - g >> 1), i = +e(n[A], t), i < 0 ? g = A + 1 : (r = A, s = !i);
  return s ? g : ~g;
}
function xg(n, t) {
  return n > t ? 1 : n < t ? -1 : 0;
...
function Bs(n) {
  ...
  return function() {
    ...
    return (!e || this !== A || !Ss(i, e)) && (A = this, e = i, t = n.apply(this, arguments)), t;
  };
}
function Bg(n) {
  for (const t in n)
...
class Tg extends Pg {
  ...
  addEventListener(t, e) {
    if (!t || !e)
      return;
    const A = this.listeners_ || (this.listeners_ = {}), i = A[t] || (A[t] = []);
   ...
   */
  dispatchEvent(t) {
    const e = typeof t == "string", A = e ? t : t.type, i = this.listeners_ && this.listeners_[A];
    if (!i)
      return;
    const g = e ? new Vt(t) : (
      /** @type {Event} */
   ...
   */
  disposeInternal() {
    this.listeners_ && Bg(this.listeners_);
  }
  /**
  ...
  removeEventListener(t, e) {
    ...
    if (!A)
      return;
    const i = A.indexOf(e);
    i !== -1 && (this.pendingRemovals_ && t in this.pendingRemovals_ ? (A[i] = Dn, ++this.pendingRemovals_[t]) : (A.splice(i, 1), A.length === 0 && delete this.listeners_[t]));
  }
}
hg.prototype.getDecimalZoom = function() {
  const n = this.getResolution(), t = (
    // NOTE: `resolution` maybe `undefined`
    // NOTE: `offset` maybe `NaN`
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-ignore
    Math.log(this.maxResolution_ / n) / Math.log(2)
  );
...
function zn(n, t, e) {
  let A, i;
  return t < n[0] ? A = n[0] - t : n[2] < t ? A = t - n[2] : A = 0, e < n[1] ? i = n[1] - e : n[3] < e ? i = e - n[3] : i = 0, A * A + i * i;
}
function ks(n, t, e) {
  return n[0] <= t && t <= n[2] && n[1] <= e && e <= n[3];
}
function Gi(n, t) {
  const e = n[0], A = n[1], i = n[2], g = n[3], r = t[0], s = t[1];
  let o = ht.UNKNOWN;
  return r < e ? o = o | ht.LEFT : r > i && (o = o | ht.RIGHT), s < A ? o = o | ht.BELOW : s > g && (o = o | ht.ABOVE), o === ht.UNKNOWN && (o = ht.INTERSECTING), o;
}
function kg() {
  return [1 / 0, 1 / 0, -1 / 0, -1 / 0];
}
function KA(n, t, e, A, i) {
  return i ? (i[0] = n, i[1] = t, i[2] = e, i[3] = A, i) : [n, t, e, A];
}
function Gg(n) {
  return KA(1 / 0, 1 / 0, -1 / 0, -1 / 0, n);
}
function Gs(n, t) {
  const e = n[0], A = n[1];
  return KA(e, A, e, A, t);
}
function Os(n, t, e, A, i) {
  const g = Gg(i);
  return Og(g, n, t, e, A);
}
function Og(n, t, e, A, i) {
  for (; e < A; e += i)
    Xs(n, t[e], t[e + 1]);
  return n;
}
...
function Xg(n, t) {
  let e;
  return e = t(Zs(n)), e || (e = t(Ls(n)), e) || (e = t(Fs(n)), e) || (e = t(zs(n)), e) ? e : !1;
}
function Zs(n) {
  return [n[0], n[1]];
}
...
function js(n, t, e, A, i) {
  const [g, r, s, o, I, C, a, c] = Ns(
    n,
    t,
    e,
    A
...
function Ns(n, t, e, A) {
  const i = t * A[0] / 2, g = t * A[1] / 2, r = Math.cos(e), s = Math.sin(e), o = i * r, I = i * s, C = g * r, a = g * s, c = n[0], d = n[1];
  return [
    c - o + a,
    d - I - C,
    c - o - a,
...
let Qs = 0;
function Vs(n) {
  return n.ol_uid || (n.ol_uid = String(++Qs));
}
const Hs = {
  /**
...
function Me(n, t, e, A, i) {
  if (i) {
    const r = e;
    e = function(s) {
      return n.removeEventListener(t, e), r.call(A ?? this, s);
    };
  } else A && A !== n && (e = e.bind(A));
  const g = {
    target: n,
    type: t,
    listener: e
...
function qe(n) {
  n && n.target && (n.target.removeEventListener(n.type, n.listener), Bg(n));
}
class JA extends Tg {
  constructor() {
   ...
   */
  changed() {
    ++this.revision_, this.dispatchEvent(ee.CHANGE);
  }
  /**
...
class Te extends JA {
   ...
   */
  constructor(t) {
    super(), this.on, this.once, this.un, Vs(this), this.values_ = null, t !== void 0 && this.setProperties(t);
  }
  /**
   * Gets a value.
  ...
  notify(t, e) {
    let A;
    A = `change:${t}`, this.hasListener(A) && this.dispatchEvent(new Xi(A, t, e)), A = Hs.PROPERTYCHANGE, this.hasListener(A) && this.dispatchEvent(new Xi(A, t, e));
  }
  /**
   * @param {string} key Key name.
   * @param {import("./events.js").Listener} listener Listener.
  ...
  unset(t, e) {
    if (this.values_ && t in this.values_) {
      ...
      delete this.values_[t], Ts(this.values_) && (this.values_ = null), e || this.notify(t, A);
    }
  }
}
function Ks(...n) {
...
function Js(n, t, e, A, i, g) {
  const r = i - e, s = g - A;
  if (r !== 0 || s !== 0) {
    const o = ((n - e) * r + (t - A) * s) / (r * r + s * s);
    o > 1 ? (e = i, A = g) : o > 0 && (e += r * o, A += s * o);
  }
  return Ee(n, t, e, A);
}
function Ee(n, t, e, A) {
...
class AA {
   ...
   */
  getMetersPerUnit() {
    return this.metersPerUnit_ || Lg[this.units_];
  }
  /**
...
const oA = 6378137, be = Math.PI * oA, $s = [-be, -be, be, be], to = [-180, -85, 180, 85], BA = oA * Math.log(Math.tan(Math.PI / 2));
class me extends AA {
  /**
...
function eo(n, t, e, A) {
  ...
  for (let g = 0; g < i; g += A) {
    t[g] = be * n[g] / 180;
    let r = oA * Math.log(Math.tan(Math.PI * (+n[g + 1] + 90) / 360));
    r > BA ? r = BA : r < -BA && (r = -BA), t[g + 1] = r;
  }
  return t;
}
function Ao(n, t, e, A) {
  ...
  e = e > 1 ? e : 2, A = A ?? e, t === void 0 && (e > 2 ? t = n.slice() : t = new Array(i));
  for (let g = 0; g < i; g += A)
    t[g] = 180 * n[g] / be, t[g + 1] = 360 * Math.atan(Math.exp(n[g + 1] / oA)) / Math.PI - 90;
  return t;
}
const no = 6378137, ji = [-180, -90, 180, 90], io = Math.PI * no / 180;
class ie extends AA {
  /**
   * @param {string} code Code.
...
let kn = {};
function go(n) {
  return kn[n] || kn[n.replace(/urn:(x-)?ogc:def:crs:EPSG:(.*:)?(\w+)$/, "EPSG:$3")] || null;
}
function ro(n, t) {
  kn[n] = t;
}
...
function nA(n, t, e) {
  ...
  A in Pe || (Pe[A] = {}), Pe[A][i] = e;
}
function un(n, t) {
  return n in Pe && t in Pe[n] ? Pe[n][t] : null;
}
const NA = 0.9996, Gt = 669438e-8, qA = Gt * Gt, _A = qA * Gt, oe = Gt / (1 - Gt), zi = Math.sqrt(1 - Gt), De = (1 - zi) / (1 + zi), jg = De * De, Vn = jg * De, Hn = Vn * De, Ng = Hn * De, zg = 1 - Gt / 4 - 3 * qA / 64 - 5 * _A / 256, so = 3 * Gt / 8 + 3 * qA / 32 + 45 * _A / 1024, oo = 15 * qA / 256 + 45 * _A / 1024, Io = 35 * _A / 3072, Co = 3 / 2 * De - 27 / 32 * Vn + 269 / 512 * Ng, ao = 21 / 16 * jg - 55 / 32 * Hn, co = 151 / 96 * Vn - 417 / 128 * Ng, lo = 1097 / 512 * Hn, zA = 6378137;
function ho(n, t, e) {
  const A = n - 5e5, r = (e.north ? t : t - 1e7) / NA / (zA * zg), s = r + Co * Math.sin(2 * r) + ao * Math.sin(4 * r) + co * Math.sin(6 * r) + lo * Math.sin(8 * r), o = Math.sin(s), I = o * o, C = Math.cos(s), a = o / C, c = a * a, d = c * c, p = 1 - Gt * I, y = Math.sqrt(1 - Gt * I), M = zA / y, T = (1 - Gt) / p, X = oe * C ** 2, z = X * X, j = A / (M * NA), Q = j * j, q = Q * j, nt = q * j, H = nt * j, st = H * j, ot = s - a / T * (Q / 2 - nt / 24 * (5 + 3 * c + 10 * X - 4 * z - 9 * oe)) + st / 720 * (61 + 90 * c + 298 * X + 45 * d - 252 * oe - 3 * z);
...
const Fi = -80, Ui = 84, uo = -180, fo = 180;
function mo(n, t, e) {
  n = Tn(n, uo, fo), t < Fi ? t = Fi : t > Ui && (t = Ui);
  const A = Re(t), i = Math.sin(A), g = Math.cos(A), r = i / g, s = r * r, o = s * s, I = Re(n), C = Fg(e.number), a = Re(C), c = zA / Math.sqrt(1 - Gt * i ** 2), d = oe * g ** 2, p = g * Tn(I - a, -Math.PI, Math.PI), y = p * p, M = y * p, T = M * p, X = T * p, z = X * p, j = zA * (zg * A - so * Math.sin(2 * A) + oo * Math.sin(4 * A) - Io * Math.sin(6 * A)), Q = NA * c * (p + M / 6 * (1 - s + d) + X / 120 * (5 - 18 * s + o + 72 * d - 58 * oe)) + 5e5;
  let q = NA * (j + c * r * (y / 2 + T / 24 * (5 - s + 9 * d + 4 * d ** 2) + z / 720 * (61 - 58 * s + o + 600 * d - 330 * oe)));
...
function Ug(n) {
  ...
  if (!t)
    return null;
  let e = 0, A = !1;
  return t > 32700 && t < 32761 ? e = t - 32700 : t > 32600 && t < 32661 && (A = !0, e = t - 32600), e ? { number: e, north: A } : null;
}
function Wi(n, t) {
  return function(e, A, i, g) {
    const r = e.length;
    i = i > 1 ? i : 2, g = g ?? i, A || (i > 2 ? A = e.slice() : A = new Array(r));
    for (let s = 0; s < r; s += g) {
      const o = e[s], I = e[s + 1], C = n(o, I, t);
      A[s] = C[0], A[s + 1] = C[1];
    }
    return A;
  };
...
function yo(n) {
  return Ug(n) ? new AA({ code: n, units: "m" }) : null;
}
function wo(n) {
  const t = Ug(n.getCode());
  return t ? {
    forward: Wi(mo, t),
    inverse: Wi(ho, t)
  } : null;
...
function Po(n, t) {
  ...
  return i && (On(n), On(t), nA(n, t, i)), i;
}
function fn(n, t) {
  return function(e, A, i, g) {
    return A = n(e, A, i, g), t(A, A, i, g);
  };
}
function Vi(n, t) {
  const e = iA(n), A = iA(t);
...
function Jt(n, t) {
  return Gn && !jA(n, [0, 0]) && n[0] >= -180 && n[0] <= 180 && n[1] >= -90 && n[1] <= 90 && (Gn = !1, Ks(
...
function Qg(n, t, e, A, i, g, r) {
  r = r || [];
  const s = Math.cos(i), o = Math.sin(i), I = g[0], C = g[1];
  let a = 0;
  for (let c = t; c < e; c += A) {
    const d = n[c] - I, p = n[c + 1] - C;
    r[a++] = I + d * s - p * o, r[a++] = C + d * o + p * s;
    for (let y = c + 2; y < c + A; ++y)
      r[a++] = n[y];
  }
  return r && r.length != a && (r.length = a), r;
}
function ko(n, t, e, A, i, g, r, s) {
  s = s || [];
  const o = r[0], I = r[1];
  let C = 0;
  for (let a = t; a < e; a += A) {
    const c = n[a] - o, d = n[a + 1] - I;
    s[C++] = o + i * c, s[C++] = I + g * d;
    for (let p = a + 2; p < a + A; ++p)
      s[C++] = n[p];
  }
  return s && s.length != C && (s.length = C), s;
}
function Go(n, t, e, A, i, g, r) {
  r = r || [];
  let s = 0;
  for (let o = t; o < e; o += A) {
    r[s++] = n[o] + i, r[s++] = n[o + 1] + g;
    for (let I = o + 2; I < o + A; ++I)
      r[s++] = n[I];
  }
  return r && r.length != s && (r.length = s), r;
}
const Yi = Do(), Oo = [NaN, NaN];
class Xo extends Te {
  constructor() {
    super(), this.extent_ = kg(), this.extentRevision_ = -1, this.simplifiedGeometryMaxMinSquaredTolerance = 0, this.simplifiedGeometryRevision = 0, this.simplifyTransformedInternal = Bs(
      (t, e, A) => {
        if (!A)
          return this.getSimplifiedGeometry(e);
        const i = this.clone();
        return i.applyTransform(A), i.getSimplifiedGeometry(e);
      }
    );
  }
  /**
   ...
   */
  containsXY(t, e) {
    return this.closestPointXY(t, e, Oo, Number.MIN_VALUE) === 0;
  }
  /**
  ...
  getExtent(t) {
    if (this.extentRevision_ != this.getRevision()) {
      ...
      (isNaN(e[0]) || isNaN(e[1])) && Gg(e), this.extentRevision_ = this.getRevision();
    }
    return Us(this.extent_, t);
  }
  /**
   ...
   */
  transform(t, e) {
    const A = iA(t), i = A.getUnits() == "tile-pixels" ? function(g, r, s) {
      const o = A.getExtent(), I = A.getWorldExtent(), C = eA(I) / eA(o);
      Bo(
        Yi,
        I[0],
        I[3],
...
class IA extends Xo {
  ...
  setFlatCoordinates(t, e) {
    this.stride = Ki(t), this.layout = t, this.flatCoordinates = e;
  }
  /**
   * @abstract
   ...
   */
  scale(t, e, A) {
    e === void 0 && (e = t), A || (A = LA(this.getExtent()));
...
class Jn extends IA {
   ...
   */
  constructor(t, e, A) {
    super(), A !== void 0 && e === void 0 ? this.setFlatCoordinates(A, t) : (e = e || 0, this.setCenterAndRadius(t, e, A));
  }
  /**
   * Make a complete copy of the geometry.
   * @return {!Circle} Clone.
  ...
  closestPointXY(t, e, A, i) {
    ...
    if (o < i) {
      if (o === 0)
        ...
        A[0] = g[0] + I * r, A[1] = g[1] + I * s;
        for (let C = 2; C < this.stride; ++C)
          A[C] = g[C];
      }
      return A.length = this.stride, o;
    }
    return i;
  }
  /**
   ...
   */
  containsXY(t, e) {
    const A = this.flatCoordinates, i = t - A[0], g = e - A[1];
   ...
   */
  computeExtent(t) {
    const e = this.flatCoordinates, A = e[this.stride] - e[0];
    return KA(
      e[0] - A,
      e[1] - A,
      e[0] + A,
  ...
  intersectsExtent(t) {
    ...
    if (Un(t, e)) {
      ...
      return t[0] <= A[0] && t[2] >= A[0] || t[1] <= A[1] && t[3] >= A[1] ? !0 : Xg(t, this.intersectsCoordinate.bind(this));
    }
    return !1;
  }
  /**
   ...
   */
  setCenter(t) {
    const e = this.stride, A = this.flatCoordinates[e] - this.flatCoordinates[0], i = t.slice();
    i[e] = i[0] + A;
    for (let g = 1; g < e; ++g)
      i[e + g] = t[g];
   ...
   * @api
   */
  setCenterAndRadius(t, e, A) {
    this.setLayout(A, t, 0), this.flatCoordinates || (this.flatCoordinates = []);
    const i = this.flatCoordinates;
    let g = Vg(i, 0, t, this.stride);
    i[g++] = i[0] + e;
   ...
   */
  rotate(t, e) {
    const A = this.getCenter(), i = this.getStride();
    this.setCenter(
      Qg(A, 0, A.length, i, t, e, A)
    ), this.changed();
  }
}
function Hg(n, t, e, A) {
  let i = 0;
  const g = n[e - A], r = n[e - A + 1];
  let s = 0, o = 0;
  for (; t < e; t += A) {
    const I = n[t] - g, C = n[t + 1] - r;
    i += o * I - s * C, s = I, o = C;
  }
  return i / 2;
}
...
function qn(n, t, e, A, i) {
  let g = n[t], r = n[t + 1];
  for (t += A; t < e; t += A) {
    const s = n[t], o = n[t + 1], I = Ee(g, r, s, o);
    I > i && (i = I), g = s, r = o;
  }
  return i;
}
...
function _n(n, t, e, A, i, g, r, s, o, I, C) {
  if (t == e)
    return I;
  let a, c;
  if (i === 0) {
...
function zo(n, t, e, A, i, g, r, s, o, I, C) {
  C = C || [NaN, NaN];
...
function Yg(n, t, e, A, i, g, r) {
  ...
  for (; I.length > 0; ) {
    ...
    for (let X = c + A; X < a; X += A) {
      const z = n[X], j = n[X + 1], Q = Js(z, j, p, y, M, T);
      Q > d && (C = X, d = Q);
    }
...
class gA extends IA {
   ...
   */
  clone() {
    return new gA(this.flatCoordinates.slice(), this.layout);
  }
  /**
   * @param {number} x X.
   * @param {number} y Y.
   ...
   */
  closestPointXY(t, e, A, i) {
    return i < zn(this.getExtent(), t, e) ? i : (this.maxDeltaRevision_ != this.getRevision() && (this.maxDelta_ = Math.sqrt(
      qn(
        this.flatCoordinates,
        0,
        this.flatCoordinates.length,
    ...
    ), this.maxDeltaRevision_ = this.getRevision()), _n(
      this.flatCoordinates,
      0,
      this.flatCoordinates.length,
      this.stride,
   ...
   */
  setCoordinates(t, e) {
    this.setLayout(e, t, 1), this.flatCoordinates || (this.flatCoordinates = []), this.flatCoordinates.length = Kn(
      this.flatCoordinates,
      0,
      t,
      this.stride
...
function Qo(n, t, e, A, i, g, r) {
  ...
  if (I === 1)
    ...
    const p = i * c, y = xs(d, p);
    y < 0 ? (o = (p - d[-y - 2]) / (d[-y - 1] - d[-y - 2]), s = t + (-y - 2) * A) : s = t + y * A;
  }
  r = r > 1 ? r : 2, g = g || new Array(r);
  for (let C = 0; C < r; ++C)
    g[C] = s === void 0 ? NaN : o === void 0 ? n[s + C] : Wn(n[s + C], n[s + A + C], o);
  return g;
}
function Vo(n, t, e, A, i, g) {
  if (e == t)
    return null;
  let r;
  if (i < n[t + A - 1])
    return g ? (r = n.slice(t, t + A), r[A - 1] = i, r) : null;
  if (n[e - 1] < i)
    return g ? (r = n.slice(e - A, e), r[A - 1] = i, r) : null;
  if (i == n[t + A - 1])
    return n.slice(t, t + A);
  let s = t / A, o = e / A;
  for (; s < o; ) {
    const c = s + o >> 1;
    i < n[(c + 1) * A - 1] ? o = c : s = c + 1;
  }
  const I = n[s * A - 1];
  if (i == I)
    return n.slice((s - 1) * A, (s - 1) * A + A);
  const C = n[(s + 1) * A - 1], a = (i - I) / (C - I);
  r = [];
  for (let c = 0; c < A - 1; ++c)
    r.push(
      Wn(
...
function ti(n, t, e, A, i, g) {
  return g = g ?? Og(kg(), n, t, e, A), Un(i, g) ? g[0] >= i[0] && g[2] <= i[2] || g[1] >= i[1] && g[3] <= i[3] ? !0 : Jg(
    n,
    t,
    e,
    A,
...
function Yo(n, t, e, A, i) {
  return !!(ti(n, t, e, A, i) || Ie(
    n,
    t,
    e,
    A,
...
function Jo(n, t, e, A) {
  let i = n[t], g = n[t + 1], r = 0;
  for (let s = t + A; s < e; s += A) {
    const o = n[s], I = n[s + 1];
...
class FA extends IA {
   ...
   */
  appendCoordinate(t) {
    Dg(this.flatCoordinates, t), this.changed();
  }
  /**
   * Make a complete copy of the geometry.
  ...
  getCoordinateAtM(t, e) {
    return this.layout != "XYM" && this.layout != "XYZM" ? null : (e = e !== void 0 ? e : !1, Vo(
      this.flatCoordinates,
      0,
      this.flatCoordinates.length,
      this.stride,
...
class rA extends IA {
   ...
   */
  clone() {
    const t = new rA(this.flatCoordinates.slice(), this.layout);
    return t.applyProperties(this), t;
  }
  /**
   * @param {number} x X.
   ...
   */
  closestPointXY(t, e, A, i) {
    const g = this.flatCoordinates, r = Ee(
      t,
      e,
      g[0],
      g[1]
   ...
   */
  intersectsExtent(t) {
    return ks(t, this.flatCoordinates[0], this.flatCoordinates[1]);
  }
  /**
   * @param {!Array<*>} coordinates Coordinates.
   * @param {import("./Geometry.js").GeometryLayout} [layout] Layout.
...
function qo(n, t, e, A, i, g, r) {
  ...
  let M = NaN, T = -1 / 0;
  for (y.sort(xg), C = y[0], s = 1, o = y.length; s < o; ++s) {
    a = y[s];
    const X = Math.abs(a - C);
    X > T && (I = (C + a) / 2, Kg(n, t, e, A, I, p) && (M = I, T = X)), C = a;
  }
...
function qi(n, t, e, A, i) {
  ...
  for (let g = 0, r = e.length; g < r; ++g) {
    ...
    (g === 0 ? i && o || !i && !o : i && !o || !i && o) && _o(n, t, s, A), t = s;
  }
  return t;
}
class Ce extends IA {
   ...
   */
  constructor(t, e, A) {
    super(), this.ends_ = [], this.flatInteriorPointRevision_ = -1, this.flatInteriorPoint_ = null, this.maxDelta_ = -1, this.maxDeltaRevision_ = -1, this.orientedRevision_ = -1, this.orientedFlatCoordinates_ = null, e !== void 0 && A ? (this.setFlatCoordinates(
      e,
      /** @type {Array<number>} */
      t
    ), this.ends_ = A) : this.setCoordinates(
   ...
   */
  appendLinearRing(t) {
    this.flatCoordinates ? Dg(this.flatCoordinates, t.getFlatCoordinates()) : this.flatCoordinates = t.getFlatCoordinates().slice(), this.ends_.push(this.flatCoordinates.length), this.changed();
  }
  /**
   * Make a complete copy of the geometry.
  ...
  getCoordinates(t) {
    let e;
    return t !== void 0 ? (e = this.getOrientedFlatCoordinates().slice(), qi(e, 0, this.ends_, this.stride, t)) : e = this.flatCoordinates, Fo(e, 0, this.ends_, this.stride);
  }
  /**
  ...
  getFlatInteriorPoint() {
    if (this.flatInteriorPointRevision_ != this.getRevision()) {
      const t = LA(this.getExtent());
      this.flatInteriorPoint_ = qo(
        this.getOrientedFlatCoordinates(),
        0,
        this.ends_,
        this.stride,
   ...
   */
  getInteriorPoint() {
    return new rA(this.getFlatInteriorPoint(), "XYM");
  }
  /**
   ...
   */
  getLinearRing(t) {
    return t < 0 || this.ends_.length <= t ? null : new gA(
      this.flatCoordinates.slice(
  ...
  getOrientedFlatCoordinates() {
    if (this.orientedRevision_ != this.getRevision()) {
      ...
      $o(t, 0, this.ends_, this.stride) ? this.orientedFlatCoordinates_ = t : (this.orientedFlatCoordinates_ = t.slice(), this.orientedFlatCoordinates_.length = qi(
  ...
  setCoordinates(t, e) {
    ...
    this.flatCoordinates.length = A.length === 0 ? 0 : A[A.length - 1], this.changed();
  }
}
function _i(n) {
  if (Zg(n))
    throw new Error("Cannot create polygon from empty extent");
  const t = n[0], e = n[1], A = n[2], i = n[3], g = [
    t,
    e,
    t,
    i,
...
class Be extends Eg(ug) {
  constructor(t = {}) {
    const e = Rg(t);
    if (super(e), t.mapID && (this.mapID = t.mapID), t.mapID === "morioka_ndl_affine") {
      const A = this.getTileUrlFunction();
      this.setTileUrlFunction((i, g, r) => A(i, g, r));
    }
    this.initialize(t);
  }
}
...
class Xn extends Eg(Hr) {
  constructor(t = {}) {
    const e = Object.assign({}, t);
    e.mapType = t.maptype.match(/^google_(.+)$/) ? RegExp.$1 : "roadmap", e.layerTypes = (t.layers || []).map((A) => `layer${A.charAt(0).toUpperCase()}${A.slice(1).toLowerCase()}`), super(e), t.mapID && (this.mapID = t.mapID), this.initialize(t);
  }
}
const qt = {
  ANIMATING: 0,
...
function ei(n, t, e, A) {
  const i = Fn(t) / e[0], g = eA(t) / e[1];
  return A ? Math.min(n, Math.max(i, g)) : Math.min(n, Math.min(i, g));
}
function Ai(n, t, e) {
  let A = Math.min(n, t);
  const i = 50;
  return A *= Math.log(1 + i * Math.max(0, n / t - 1)) / i + 1, e && (A = Math.max(A, e), A /= Math.log(1 + i * Math.max(0, e / n - 1)) / i + 1), Xt(A, e / 2, t * 2);
}
function iI(n, t, e, A) {
  ...
  (function(i, g, r, s) {
    if (i !== void 0) {
      const o = n[0], I = n[n.length - 1], C = e ? ei(
        o,
        e,
        r,
        A
      ...
      const a = Math.min(C, i), c = Math.floor(Sg(n, a, g));
      return n[c] > C && c < n.length - 1 ? n[c + 1] : n[c];
    }
  });
}
function gI(n, t, e, A, i, g) {
  return A = A !== void 0 ? A : !0, e = e !== void 0 ? e : 0, /**
   * @param {number|undefined} resolution Resolution.
   * @param {number} direction Direction.
   * @param {import("./size.js").Size} size Viewport size.
   * @param {boolean} [isMoving] True if an interaction or animation is in progress.
...
function sI(n) {
  ...
  return (
     ...
     */
    (function(e, A) {
      return A || e === void 0 ? e : Math.abs(e) <= t ? 0 : e;
    })
  );
}
const oI = 256, dn = 0;
class Ag extends Te {
   ...
   */
  constructor(t) {
    super(), this.on, this.once, this.un, t = Object.assign({}, t), this.hints_ = [0, 0], this.animations_ = [], this.updateAnimationKey_, this.projection_ = Yn(t.projection, "EPSG:3857"), this.viewportSize_ = [100, 100], this.targetCenter_ = null, this.targetResolution_, this.targetRotation_, this.nextCenter_ = null, this.nextResolution_, this.nextRotation_, this.cancelAnchor_ = void 0, t.projection && Mo(), t.center && (t.center = Jt(t.center, this.projection_)), t.extent && (t.extent = TA(t.extent, this.projection_)), this.applyOptions_(t);
  }
  /**
  ...
  applyOptions_(t) {
    ...
    const i = II(t), g = A.constraint, r = aI(t);
    this.constraints_ = {
      center: i,
      resolution: g,
      rotation: r
  ...
  set padding(t) {
    ...
    if (A) {
      ...
      this.setCenterInternal([A[0] + r, A[1] - s]);
    }
  }
  /**
  ...
  animate(t) {
    ...
    for (let A = 0; A < e.length; ++A) {
      let i = arguments[A];
      i.center && (i = Object.assign({}, i), i.center = Jt(
        i.center,
        this.getProjection()
      )), i.anchor && (i = Object.assign({}, i), i.anchor = Jt(
        i.anchor,
        this.getProjection()
      )), e[A] = i;
    }
   ...
   */
  animateInternal(t) {
    let e = arguments.length, A;
    e > 1 && typeof arguments[e - 1] == "function" && (A = arguments[e - 1], --e);
    let i = 0;
    ...
    for (; i < e; ++i) {
      ...
      if (C.center && (a.sourceCenter = r, a.targetCenter = C.center.slice(), r = a.targetCenter), C.zoom !== void 0 ? (a.sourceResolution = s, a.targetResolution = this.getResolutionForZoom(C.zoom), s = a.targetResolution) : C.resolution && (a.sourceResolution = s, a.targetResolution = C.resolution, s = a.targetResolution), C.rotation !== void 0) {
        a.sourceRotation = o;
        const c = Bn(C.rotation - o + Math.PI, 2 * Math.PI) - Math.PI;
        a.targetRotation = o + c, o = a.targetRotation;
      }
      cI(a) ? a.complete = !0 : g += a.duration, I.push(a);
    }
    this.animations_.push(I), this.setHint(qt.ANIMATING, 1), this.updateAnimations_();
  }
  /**
  ...
  cancelAnimations() {
    ...
    let t;
    for (let e = 0, A = this.animations_.length; e < A; ++e) {
    ...
    for (let A = this.animations_.length - 1; A >= 0; --A) {
      ...
      for (let r = 0, s = i.length; r < s; ++r) {
        ...
        if (o.sourceRotation !== void 0 && o.targetRotation !== void 0) {
          const c = a === 1 ? Bn(o.targetRotation + Math.PI, 2 * Math.PI) - Math.PI : o.sourceRotation + a * (o.targetRotation - o.sourceRotation);
          if (o.anchor) {
      ...
      if (g) {
        this.animations_[A] = null, this.setHint(qt.ANIMATING, -1), this.nextCenter_ = null, this.nextResolution_ = NaN, this.nextRotation_ = NaN;
  ...
  calculateCenterRotate(t, e) {
    ...
    return i !== void 0 && (A = [i[0] - e[0], i[1] - e[1]], Qn(A, t - this.getRotation()), qs(A, e)), A;
  }
  /**
  ...
  getViewportSize_(t) {
    ...
    if (t) {
      const A = e[0], i = e[1];
      return [
        Math.abs(A * Math.cos(t)) + Math.abs(i * Math.sin(t)),
        Math.abs(A * Math.sin(t)) + Math.abs(i * Math.cos(t))
      ];
    }
    return e;
  }
  ...
  calculateExtent(t) {
    ...
    return xo(e, this.getProjection());
  }
  /**
  ...
  calculateExtentInternal(t) {
    ...
    $t(e, "The view center is not defined");
    const A = (
      /** @type {!number} */
      this.getResolution()
    );
    $t(A !== void 0, "The view resolution is not defined");
    const i = (
      /** @type {!number} */
      this.getRotation()
    );
    return $t(i !== void 0, "The view rotation is not defined"), js(e, A, i, t);
  }
  /**
  ...
  getResolutionForValueFunction(t) {
    t = t || 2;
    const e = this.getConstrainedResolution(this.maxResolution_), A = this.minResolution_, i = Math.log(e / A) / Math.log(t);
    return (
      /**
  ...
  getValueForResolutionFunction(t) {
    const e = Math.log(t || 2), A = this.getConstrainedResolution(this.maxResolution_), i = this.minResolution_, g = Math.log(A / i) / e;
    return (
      /**
   ...
   */
  getState() {
    const t = this.getProjection(), e = this.getResolution(), A = this.getRotation();
    let i = (
      /** @type {import("./coordinate.js").Coordinate} */
      this.getCenterInternal()
    );
  ...
  getZoomForResolution(t) {
    ...
    if (this.resolutions_) {
      const g = Sg(this.resolutions_, t, 1);
    ...
    return e + Math.log(A / t) / Math.log(i);
  }
  /**
  ...
  getResolutionForZoom(t) {
    if (this.resolutions_?.length) {
      ...
      ), A = this.resolutions_[e] / this.resolutions_[e + 1];
      return this.resolutions_[e] / Math.pow(A, Xt(t - e, 0, 1));
    }
  ...
  fit(t, e) {
    ...
    if ($t(
      ...
      const i = TA(t, this.getProjection());
      A = _i(i);
      ...
      A = _i(i), A.rotate(this.getRotation(), LA(i));
    } else
      A = t;
    this.fitInternal(A, e);
  }
  /**
  ...
  rotatedExtentForGeometry(t) {
    const e = this.getRotation(), A = Math.cos(e), i = Math.sin(-e), g = t.getFlatCoordinates(), r = t.getStride();
    let s = 1 / 0, o = 1 / 0, I = -1 / 0, C = -1 / 0;
    for (let a = 0, c = g.length; a < c; a += r) {
      const d = g[a] * A - g[a + 1] * i, p = g[a] * i + g[a + 1] * A;
  ...
  fitInternal(t, e) {
    ...
    const I = this.getRotation(), C = Math.sin(I), a = Math.cos(I), c = LA(s);
    c[0] += (i[1] - i[3]) / 2 * o, c[1] += (i[0] - i[2]) / 2 * o;
    const d = c[0] * a - c[1] * C, p = c[1] * a + c[0] * C, y = this.getConstrainedCenter([d, p], o), M = e.callback ? e.callback : Dn;
    e.duration !== void 0 ? this.animateInternal(
      ...
      M
    ) : (this.targetResolution_ = o, this.targetCenter_ = y, this.applyTargetState_(!1, !0), kA(M, !0));
  }
  /**
   ...
   */
  calculateCenterShift(t, e, A, i) {
    let g;
    const r = this.padding_;
    if (r && t) {
      const s = this.getViewportSizeMinusPadding_(-A), o = mn(
        t,
        i,
        [s[0] / 2 + r[3], s[1] / 2 + r[0]],
        e,
  ...
  adjustResolution(t, e) {
    e = e && Jt(e, this.getProjection()), this.adjustResolutionInternal(t, e);
  }
  /**
   * Multiply the view resolution by a ratio, optionally using an anchor. Any resolution
   * constraint will apply.
  ...
  adjustResolutionInternal(t, e) {
    const A = this.getAnimating() || this.getInteracting(), i = this.getViewportSize_(this.getRotation()), g = this.constraints_.resolution(
   ...
   */
  adjustRotation(t, e) {
    e && (e = Jt(e, this.getProjection())), this.adjustRotationInternal(t, e);
  }
  /**
   * @param {number} delta Relative value to add to the zoom rotation, in radians.
   * @param {import("./coordinate.js").Coordinate} [anchor] The rotation center.
  ...
  adjustRotationInternal(t, e) {
    const A = this.getAnimating() || this.getInteracting(), i = this.constraints_.rotation(
  ...
  applyTargetState_(t, e) {
    const A = this.getAnimating() || this.getInteracting() || e, i = this.constraints_.rotation(
    ...
    this.get(Ot.ROTATION) !== i && this.set(Ot.ROTATION, i), this.get(Ot.RESOLUTION) !== r && (this.set(Ot.RESOLUTION, r), this.set("zoom", this.getZoom(), !0)), (!s || !this.get(Ot.CENTER) || !jA(this.get(Ot.CENTER), s)) && this.set(Ot.CENTER, s), this.getAnimating() && !t && this.cancelAnimations(), this.cancelAnchor_ = void 0;
  }
  /**
  ...
  resolveConstraints(t, e, A) {
    ...
    A = A || (t === 0 ? this.cancelAnchor_ : void 0), this.cancelAnchor_ = void 0, (this.getResolution() !== s || this.getRotation() !== g || !this.getCenterInternal() || !jA(this.getCenterInternal(), o)) && (this.getAnimating() && this.cancelAnimations(), this.animateInternal({
      rotation: g,
      center: o,
      resolution: s,
      duration: t,
   ...
   * @api
   */
  endInteraction(t, e, A) {
    A = A && Jt(A, this.getProjection()), this.endInteractionInternal(t, e, A);
  }
  /**
   * Notify the View that an interaction has ended. The view state will be resolved
   * to a stable one if needed (depending on its constraints).
   ...
   * @param {import("./coordinate.js").Coordinate} [anchor] The origin of the transformation.
   */
  endInteractionInternal(t, e, A) {
    this.getInteracting() && (this.setHint(qt.INTERACTING, -1), this.resolveConstraints(t, e, A));
  }
  /**
  ...
  getConstrainedZoom(t, e) {
    const A = this.getResolutionForZoom(t);
    return this.getZoomForResolution(
      this.getConstrainedResolution(A, e)
    );
  }
  /**
  ...
  getConstrainedResolution(t, e) {
    e = e || 0;
    const A = this.getViewportSize_(this.getRotation());
    return this.constraints_.resolution(t, e, A);
  }
}
function kA(n, t) {
  setTimeout(function() {
...
function II(n) {
  if (n.extent !== void 0) {
    ...
    return $i(n.extent, n.constrainOnlyCenter, e);
  }
  const t = Yn(n.projection, "EPSG:3857");
  if (n.multiWorld !== !0 && t.isGlobal()) {
    const e = t.getExtent().slice();
    return e[0] = -1 / 0, e[2] = 1 / 0, $i(e, !1, !1);
  }
  return tI;
}
function CI(n) {
  let t, e, A, r = n.minZoom !== void 0 ? n.minZoom : dn, s = n.maxZoom !== void 0 ? n.maxZoom : 28;
  const o = n.zoomFactor !== void 0 ? n.zoomFactor : 2, I = n.multiWorld !== void 0 ? n.multiWorld : !1, C = n.smoothResolutionConstraint !== void 0 ? n.smoothResolutionConstraint : !0, a = n.showFullExtent !== void 0 ? n.showFullExtent : !1, c = Yn(n.projection, "EPSG:3857"), d = c.getExtent();
  let p = n.constrainOnlyCenter, y = n.extent;
  if (!I && !y && c.isGlobal() && (p = !1, y = d), n.resolutions !== void 0) {
    const M = n.resolutions;
    e = M[r], A = M[s] !== void 0 ? M[s] : M[M.length - 1], n.constrainResolution ? t = iI(
      M,
      C,
      !p && y,
      a
    ...
    const T = (d ? Math.max(Fn(d), eA(d)) : (
      // use an extent that can fit the whole world if need be
      360 * Lg.degrees / c.getMetersPerUnit()
    )) / oI / Math.pow(2, dn), X = T / Math.pow(2, 28 - dn);
    e = n.maxResolution, e !== void 0 ? r = 0 : e = T / Math.pow(o, r), A = n.minResolution, A === void 0 && (n.maxZoom !== void 0 ? n.maxResolution !== void 0 ? A = e / Math.pow(o, s) : A = T / Math.pow(o, s) : A = X), s = r + Math.floor(
      Math.log(e / A) / Math.log(o)
    ), A = e / Math.pow(o, s - r), n.constrainResolution ? t = gI(
      o,
      e,
      A,
      C,
...
function aI(n) {
  if (n.enableRotation !== void 0 ? n.enableRotation : !0) {
    ...
    return e === void 0 || e === !0 ? sI() : e === !1 ? eg : typeof e == "number" ? rI(e) : eg;
  }
  return ni;
}
function cI(n) {
  return !(n.sourceCenter && n.targetCenter && !jA(n.sourceCenter, n.targetCenter) || n.sourceResolution !== n.targetResolution || n.sourceRotation !== n.targetRotation);
}
function mn(n, t, e, A, i) {
  const g = Math.cos(-i);
  let r = Math.sin(-i), s = n[0] * g - n[1] * r, o = n[1] * g + n[0] * r;
  s += (t[0] / 2 - e[0]) * A, o += (e[1] - t[1] / 2) * A, r = -r;
...
class hI extends Te {
  ...
  constructor(t) {
    ...
    const e = Object.assign({}, t);
    typeof t.properties == "object" && (delete e.properties, Object.assign(e, t.properties)), e[_.OPACITY] = t.opacity !== void 0 ? t.opacity : 1, $t(
  ...
  getLayerState(t) {
    ...
    return e.opacity = Xt(Math.round(this.getOpacity() * 100) / 100, 0, 1), e.visible = this.getVisible(), e.extent = this.getExtent(), e.zIndex = A === void 0 && !e.managed ? 1 / 0 : A, e.maxResolution = this.getMaxResolution(), e.minResolution = Math.max(this.getMinResolution(), 0), e.minZoom = this.getMinZoom(), e.maxZoom = this.getMaxZoom(), this.state_ = e, e;
  }
  /**
   * @abstract
   ...
   */
  setOpacity(t) {
    $t(typeof t == "number", "Layer opacity must be a number"), this.set(_.OPACITY, t);
  }
  /**
...
class _g extends hI {
  ...
  handleSourcePropertyChange_() {
    this.sourceChangeKey_ && (qe(this.sourceChangeKey_), this.sourceChangeKey_ = null), this.sourceReady_ = !1;
    const t = this.getSource();
    t && (this.sourceChangeKey_ = Me(
      t,
      ee.CHANGE,
  ...
  isVisible(t) {
    ...
    !t && A && (t = A.getView()), t instanceof Ag ? e = {
      viewState: t.getState(),
      extent: t.calculateExtent()
    } : e = t, !e.layerStatesArray && A && (e.layerStatesArray = A.getLayerGroup().getLayerStatesArray());
    let i;
    ...
    return uI(i, e.viewState) && (!g || Un(g, e.extent));
  }
  /**
  ...
  getAttributions(t) {
    ...
    if (!e)
      return [];
    const A = t instanceof Ag ? t.getViewStateAndExtent() : t;
    let i = e(A);
  ...
  render(t, e) {
    ...
    return A.prepareFrame(t) ? (this.rendered = !0, A.renderFrame(t, e)) : null;
  }
  /**
   ...
   */
  setMap(t) {
    this.mapPrecomposeKey_ && (qe(this.mapPrecomposeKey_), this.mapPrecomposeKey_ = null), t || this.changed(), this.mapRenderKey_ && (qe(this.mapRenderKey_), this.mapRenderKey_ = null), t && (this.mapPrecomposeKey_ = Me(
      t,
      lI.PRECOMPOSE,
      this.handlePrecompose_,
      this
    ), this.mapRenderKey_ = Me(this, ee.CHANGE, t.render, t), this.changed());
  }
  /**
...
function uI(n, t) {
  ...
  if (e < n.minResolution || e >= n.maxResolution)
    return !1;
  const A = t.zoom;
  return A > n.minZoom && A <= n.maxZoom;
}
class fI extends _g {
  constructor(t) {
    const e = function(A) {
      ...
      g.setStyle(i.style);
      const r = g.getCanvas(), s = A.viewState, o = this.getVisible();
      r.style.display = o ? "block" : "none";
      const I = this.getOpacity();
      r.style.opacity = I;
      const C = s.rotation * -180 / Math.PI, a = jn(s.center), c = s.zoom - 1, d = g.getBearing(), p = g.getCenter().toArray(), y = g.getZoom();
...
class dI extends _g {
  constructor(t) {
    const e = function(A) {
      ...
      const d = jn(s.center), p = s.zoom - 1;
...
class te extends Wr {
  ...
  static spawnLayer(t, e, A) {
    return e instanceof UA || e instanceof WA || !(t instanceof ln) ? (e instanceof UA ? t = new fI({
      style: e.style,
      accessToken: e.accessToken,
      container: A,
      source: e
    }) : e instanceof WA ? t = new dI({
      style: e.style,
      container: A,
      source: e
    }) : (t = new ln({
      source: e
    }), te.applyWmtsZoomGate(t, e)), t.set("name", "base")) : (t.setSource(e), te.applyWmtsZoomGate(t, e)), t;
  }
  getLayer(t = "base") {
    const e = (A) => {
      const i = A.getArray().map((g) => {
  ...
  setFeature(t, e, A) {
    const i = this.getSource(A), g = new Qr(t);
    return e && g.setStyle(e), i.addFeature(g), g;
  }
  removeFeature(t, e) {
  ...
  setGPSPosition(t, e = void 0) {
    const A = e == "sub" ? yI : e == "hide" ? pI : mI;
    e != "sub" && this.resetFeature("gps"), t && (this.setFeature(
      {
        geometry: new rA(t.xy)
      },
      A,
      "gps"
    ), e || this.setFeature(
      {
        geometry: new Jn(t.xy, t.rad)
      },
      wI,
      "gps"
    ));
  ...
  setMarker(t, e, A, i) {
    return i || (i = "marker"), e.geometry = new rA(t), A ? typeof A == "string" ? A = new Lt({
      image: new Se({
        anchor: [0.5, 1],
        anchorXUnits: "fraction",
        anchorYUnits: "fraction",
      ...
      image: new Se(A)
    })) : A = vI, this.setFeature(e, A, i);
  }
  resetMarker(t) {
    t || (t = "marker"), this.resetFeature(t);
  }
  setLine(t, e, A) {
    return this.setVector(t, "Line", e ? { stroke: e } : null, A);
  }
  setVector(t, e = "Line", A, i) {
    i || (i = "feature");
    const g = {};
    A.stroke != null && (g.stroke = new Rn(A.stroke)), A.fill != null && (g.fill = new Pn(A.fill));
    const r = new Lt(g), s = e === "Line" ? new FA(t) : new Ce(t);
  ...
  setEnvelope(t, e, A) {
    return A || (A = "envelope"), this.setLine(t, e, A);
  }
  removeEnvelope(t, e) {
  ...
  setFillEnvelope(t, e, A, i) {
    i || (i = "envelope");
    let g;
    if (e != null || A != null) {
      const r = {};
      e != null && (r.stroke = new Rn(e)), A != null && (r.fill = new Pn(A)), g = new Lt(r);
    }
    return this.setFeature(
      {
        geometry: new Ce([t])
  ...
  exchangeSource(t = void 0) {
    const e = this.getLayers(), A = e.item(0), i = te.spawnLayer(A, t, this.getTarget());
  ...
  setLayer(t = void 0) {
    ...
    if (e.clear(), t) {
      ...
      te.applyWmtsZoomGate(A, t), e.push(A);
    }
  }
  setTransparency(t) {
    const e = (100 - t) / 100, A = this.getSource();
    A instanceof Be || A instanceof Xn ? (this.getLayers().item(0).setOpacity(1), this.getLayers().item(1).setOpacity(e)) : this.getLayers().item(0).setOpacity(e);
  }
  setGPSMarker(t, e) {
...
function bI(n, t, e) {
  const A = n.getCenterInternal();
  if (A) {
    const i = [A[0] + t[0], A[1] + t[1]];
    n.animateInternal({
      duration: e !== void 0 ? e : 250,
      easing: nI,
      center: n.getConstrainedCenter(i)
    });
  }
}
function gi(n, t, e, A) {
  ...
  if (i === void 0)
    return;
  const g = n.getConstrainedZoom(i + t), r = n.getResolutionForZoom(g);
...
class MI extends CA {
  ...
  handleEvent(t) {
    let e = !1;
    if (t.type == Ye.DBLCLICK) {
      const A = (
        /** @type {MouseEvent} */
        t.originalEvent
      ), i = t.map, g = t.coordinate, r = A.shiftKey ? -this.delta_ : this.delta_, s = i.getView();
      gi(s, r, g, this.duration_), A.preventDefault(), e = !0;
    }
    return !e;
  }
}
const ae = typeof navigator < "u" && typeof navigator.userAgent < "u" ? navigator.userAgent.toLowerCase() : "", EI = ae.includes("safari") && !ae.includes("chrom");
EI && (ae.includes("version/15.4") || /cpu (os|iphone os) 15_4 like mac os x/.test(ae));
const RI = ae.includes("webkit") && !ae.includes("edge"), Ar = ae.includes("macintosh");
...
function Zn(n) {
  ...
  return function(e) {
    let A = !0;
    for (let i = 0, g = t.length; i < g && (A = A && t[i](e), !!A); ++i)
      ;
    return A;
  };
}
const PI = function(n) {
  ...
  const t = n.map.getTargetElement(), e = t.getRootNode(), A = n.map.getOwnerDocument().activeElement;
  return e instanceof ShadowRoot ? e.host.contains(A) : t.contains(A);
}, nr = function(n) {
  const t = n.map.getTargetElement(), e = t.getRootNode();
  return (e instanceof ShadowRoot ? e.host : t).hasAttribute("tabindex") ? SI(n) : !0;
}, DI = Ds, ir = function(n) {
  const t = n.originalEvent;
  return "pointerId" in t && t.button == 0 && !(RI && Ar && t.ctrlKey);
}, gr = function(n) {
  const t = (
...
class kI extends Pg {
   ...
   */
  render_() {
    const t = this.startPixel_, e = this.endPixel_, A = "px", i = this.element_.style;
    i.left = Math.min(t[0], e[0]) + A, i.top = Math.min(t[1], e[1]) + A, i.width = Math.abs(e[0] - t[0]) + A, i.height = Math.abs(e[1] - t[1]) + A;
  }
  /**
   * @param {import("../Map.js").default|null} map Map.
   */
...
class GI extends ke {
   ...
   */
  constructor(t) {
    super(), this.on, this.once, this.un, t = t ?? {}, this.box_ = new kI(t.className || "ol-dragbox"), this.minArea_ = t.minArea ?? 64, t.onBoxEnd && (this.onBoxEnd = t.onBoxEnd), this.startPixel_ = null, this.condition_ = t.condition ?? ir, this.boxEndCondition_ = t.boxEndCondition ?? this.defaultBoxEndCondition;
  }
  /**
   ...
   */
  defaultBoxEndCondition(t, e, A) {
    const i = A[0] - e[0], g = A[1] - e[1];
  ...
  setActive(t) {
    t || (this.box_.setMap(null), this.startPixel_ && (this.dispatchEvent(
      new Qe(ye.BOXCANCEL, this.startPixel_, null)
...
class OI extends ke {
  ...
  constructor(t) {
    ...
    const e = t.condition ? t.condition : Zn(gr, TI);
    this.condition_ = t.onFocusOnly ? Zn(nr, e) : e, this.noKinetic_ = !1;
  }
  /**
   * Handle pointer drag events.
   * @param {import("../MapBrowserEvent.js").default} mapBrowserEvent Event.
  ...
  handleDragEvent(t) {
    ...
    const A = this.targetPointers, i = e.getEventPixel(ri(A));
    if (A.length == this.lastPointersCount_) {
      if (this.kinetic_ && this.kinetic_.update(i[0], i[1]), this.lastCentroid) {
        ...
        _s(g, s.getResolution()), Qn(g, s.getRotation()), s.adjustCenterInternal(g);
      }
  ...
  handleUpEvent(t) {
    ...
    if (this.targetPointers.length === 0) {
      if (!this.noKinetic_ && this.kinetic_ && this.kinetic_.end()) {
        const i = this.kinetic_.getDistance(), g = this.kinetic_.getAngle(), r = A.getCenterInternal(), s = e.getPixelFromCoordinateInternal(r), o = e.getCoordinateFromPixelInternal([
          s[0] - i * Math.cos(g),
          s[1] - i * Math.sin(g)
        ]);
        A.animateInternal({
          center: A.getConstrainedCenter(o),
          duration: 500,
          easing: $A
        });
      }
      return this.panning_ && (this.panning_ = !1, A.endInteraction()), !1;
    }
  ...
  handleDownEvent(t) {
    if (this.targetPointers.length > 0 && this.condition_(t)) {
      const A = t.map.getView();
      return this.lastCentroid = null, A.getAnimating() && A.cancelAnimations(), this.kinetic_ && this.kinetic_.begin(), this.noKinetic_ = this.targetPointers.length > 1, !0;
    }
    return !1;
  }
}
class XI extends ke {
  ...
  constructor(t) {
    t = t || {}, super({
      stopDown: YA
    }), this.condition_ = t.condition ? t.condition : xI, this.lastAngle_ = void 0, this.duration_ = t.duration !== void 0 ? t.duration : 250;
  }
  /**
   * Handle pointer drag events.
   * @param {import("../MapBrowserEvent.js").default} mapBrowserEvent Event.
   ...
   */
  handleDownEvent(t) {
    return xe(t) && ir(t) && this.condition_(t) ? (t.map.getView().beginInteraction(), this.lastAngle_ = void 0, !0) : !1;
  }
}
class ZI extends ke {
  /**
  ...
  constructor(t) {
    t = t || {}, super(
      ...
      t
    ), this.condition_ = t.condition ? t.condition : rr, this.lastAngle_ = void 0, this.lastMagnitude_ = void 0, this.lastScaleDelta_ = 0, this.duration_ = t.duration !== void 0 ? t.duration : 400;
  }
  /**
   * Handle pointer drag events.
   * @param {import("../MapBrowserEvent.js").default} mapBrowserEvent Event.
...
class LI extends GI {
  ...
  constructor(t) {
    t = t || {};
    const e = t.condition ? t.condition : rr;
    super({
      condition: e,
  ...
  onBoxEnd(t) {
    ...
    if (this.out_) {
      const g = A.rotatedExtentForGeometry(i), r = A.getResolutionForExtentInternal(g), s = A.getResolution() / r;
...
class jI extends Te {
  ...
  constructor(t, e) {
    if (super(), this.on, this.once, this.un, e = e || {}, this.unique_ = !!e.unique, this.array_ = t ?? [], this.unique_)
      for (let A = 1, i = this.array_.length; A < i; ++A)
   ...
   */
  updateLength_() {
    this.set(ig.LENGTH, this.array_.length);
  }
  /**
   * @private
   * @param {T} elem Element.
...
class NI extends CA {
  ...
  handleEvent(t) {
    let e = !1;
    if (t.type == ee.KEYDOWN) {
      const A = (
        /** @type {KeyboardEvent} */
        t.originalEvent
      ), i = A.key;
      if (this.condition_(t) && (i == ge.DOWN || i == ge.LEFT || i == ge.RIGHT || i == ge.UP)) {
        const r = t.map.getView(), s = r.getResolution() * this.pixelDelta_;
        let o = 0, I = 0;
        i == ge.DOWN ? I = -s : i == ge.LEFT ? o = -s : i == ge.RIGHT ? o = s : I = s;
        const C = [o, I];
        Qn(C, r.getRotation()), bI(r, C, this.duration_), A.preventDefault(), e = !0;
      }
    }
    return !e;
  }
...
class zI extends CA {
  ...
  handleEvent(t) {
    let e = !1;
    if (t.type == ee.KEYDOWN || t.type == ee.KEYPRESS) {
      const A = (
        /** @type {KeyboardEvent} */
        t.originalEvent
      ), i = A.key;
      if (this.condition_(t) && (i === "+" || i === "-")) {
        ...
        gi(s, r, void 0, this.duration_), A.preventDefault(), e = !0;
      }
    }
    return !e;
  }
...
class WI extends CA {
  ...
  constructor(t) {
    ...
    this.condition_ = t.onFocusOnly ? Zn(nr, e) : e, this.lastAnchor_ = null, this.startTime_ = void 0, this.timeoutId_, this.mode_ = void 0, this.trackpadEventGap_ = 400, this.trackpadTimeoutId_, this.deltaPerZoom_ = 300;
  }
  /**
   * @private
   */
   ...
   */
  handleEvent(t) {
    if (!this.condition_(t) || t.type !== ee.WHEEL)
      return !0;
    const A = t.map, i = (
      /** @type {WheelEvent} */
      t.originalEvent
  ...
  handleWheelZoom_(t) {
    ...
    (e.getConstrainResolution() || this.constrainResolution_) && (A = A ? A > 0 ? 1 : -1 : 0), gi(
      e,
      A,
      this.lastAnchor_ ? t.getCoordinateFromPixel(this.lastAnchor_) : null,
      this.duration_
...
class QI extends ke {
  ...
  constructor(t) {
    ...
    e.stopDown || (e.stopDown = YA), super(e), this.anchor_ = null, this.lastAngle_ = void 0, this.rotating_ = !1, this.rotationDelta_ = 0, this.threshold_ = t.threshold !== void 0 ? t.threshold : 0.3, this.duration_ = t.duration !== void 0 ? t.duration : 250;
  }
  /**
   * Handle pointer drag events.
   * @param {import("../MapBrowserEvent.js").default} mapBrowserEvent Event.
  ...
  handleDragEvent(t) {
    let e = 0;
    const A = this.targetPointers[0], i = this.targetPointers[1], g = Math.atan2(
      i.clientY - A.clientY,
      i.clientX - A.clientX
    );
    if (this.lastAngle_ !== void 0) {
    ...
    s.getConstraints().rotation !== ni && (this.anchor_ = r.getCoordinateFromPixelInternal(
      r.getEventPixel(ri(this.targetPointers))
...
class VI extends ke {
  ...
  constructor(t) {
    ...
    e.stopDown || (e.stopDown = YA), super(e), this.anchor_ = null, this.duration_ = t.duration !== void 0 ? t.duration : 400, this.lastDistance_ = void 0, this.lastScaleDelta_ = 1;
  }
  /**
   * Handle pointer drag events.
   * @param {import("../MapBrowserEvent.js").default} mapBrowserEvent Event.
  ...
  handleDragEvent(t) {
    let e = 1;
    const A = this.targetPointers[0], i = this.targetPointers[1], g = A.clientX - i.clientX, r = A.clientY - i.clientY, s = Math.sqrt(g * g + r * r);
    ...
    e != 1 && (this.lastScaleDelta_ = e), this.anchor_ = o.getCoordinateFromPixelInternal(
      o.getEventPixel(ri(this.targetPointers))
  ...
  handleUpEvent(t) {
    if (this.targetPointers.length < 2) {
      const A = t.map.getView(), i = this.lastScaleDelta_ > 1 ? 1 : -1;
      return A.endInteraction(this.duration_, i), !1;
    }
    return !0;
  }
  /**
...
class HI {
   ...
   */
  constructor(t, e, A) {
    this.decay_ = t, this.minVelocity_ = e, this.delay_ = A, this.points_ = [], this.angle_ = 0, this.initialVelocity_ = 0;
  }
  /**
   ...
   */
    ...
    if (this.points_[e + 2] < t)
      return !1;
    let A = e - 3;
    for (; A > 0 && this.points_[A + 2] > t; )
      A -= 3;
    const i = this.points_[e + 2] - this.points_[A + 2];
    if (i < 1e3 / 60)
      return !1;
    const g = this.points_[e] - this.points_[A], r = this.points_[e + 1] - this.points_[A + 1];
...
function gg(n) {
  n = n || {};
  const t = new jI(), e = new HI(-5e-3, 0.05, 100);
  return (n.altShiftDragRotate === void 0 || n.altShiftDragRotate) && t.push(new XI()), (n.doubleClickZoom === void 0 || n.doubleClickZoom) && t.push(
    new MI({
      delta: n.zoomDelta,
  ...
  ), (n.pinchRotate === void 0 || n.pinchRotate) && t.push(new QI()), (n.pinchZoom === void 0 || n.pinchZoom) && t.push(
    new VI({
      duration: n.zoomDuration
    })
  ), (n.keyboard === void 0 || n.keyboard) && (t.push(new NI()), t.push(
    new zI({
      delta: n.zoomDelta,
      duration: n.zoomDuration
    })
...
function YI(n) {
  return KI(n[0], n[1], n[2]);
}
function KI(n, t, e) {
  return (t << n) + e;
}
const JI = /\{z\}/g, qI = /\{x\}/g, _I = /\{y\}/g, $I = /\{-y\}/g;
function tC(n, t, e, A, i) {
  return n.replace(JI, t.toString()).replace(qI, e.toString()).replace(_I, A.toString()).replace($I, function() {
    throw new Error(
  ...
  return (
    ...
    (function(e, A, i) {
      if (!e)
        return;
      const g = e[0];
      return tC(n, g, e[1], e[2]);
    })
  );
}
function rg(n, t) {
  const e = n.length, A = new Array(e);
  for (let i = 0; i < e; ++i)
    A[i] = eC(n[i]);
  return AC(A);
}
function AC(n) {
  return n.length === 1 ? n[0] : (
    ...
    (function(t, e, A) {
      if (!t)
        return;
      const i = YI(t), g = Bn(i, n.length);
      return n[g](t, e, A);
    })
  );
}
for (let n = 0; n < 9; n++) {
  const t = `ZOOM:${n}`, e = 256 * Math.pow(2, n);
  (function(A, i) {
    const g = new Ur({
      code: A,
    ...
    En(g), ZA(
      ...
      g,
      (r) => {
        const s = (r[0] + At.MERC_MAX) * i / (2 * At.MERC_MAX), o = (-r[1] + At.MERC_MAX) * i / (2 * At.MERC_MAX);
        return [s, o];
      },
      (r) => {
        const s = r[0] * (2 * At.MERC_MAX) / i - At.MERC_MAX, o = -1 * (r[1] * (2 * At.MERC_MAX) / i - At.MERC_MAX);
        return [s, o];
      }
    );
  })(t, e);
}
class or extends Es(ug) {
  constructor(t = {}) {
    t = Rg(t), t.wrapX = !1;
    const e = Math.log2(t.width / re), A = Math.log2(t.height / re);
    t.maxZoom = Math.ceil(Math.max(e, A)), t.tileUrlFunction = t.tileUrlFunction || function(i) {
      const g = i[0], r = i[1], s = i[2];
      return (
        // @ts-ignore
        r * re * Math.pow(2, this.maxZoom - g) >= this.width || // @ts-ignore
        s * re * Math.pow(2, this.maxZoom - g) >= this.height || r < 0 || s < 0 ? fg : this._tileUrlFunction(i)
      );
    }, super(t), t.mapID && (this.mapID = t.mapID), t.urls ? this._tileUrlFunction = rg(t.urls) : t.url && (this._tileUrlFunction = rg(Array.isArray(t.url) ? t.url : [t.url])), this.width = t.width, this.height = t.height, this.maxZoom = t.maxZoom, this._maxxy = Math.pow(2, this.maxZoom) * re, this.initialize(t);
  }
}
class QA extends Be {
  static isBasemap_ = !1;
...
class Wt extends nC {
  static async registerSW(t, e) {
    if ("serviceWorker" in navigator)
      try {
        const A = await navigator.serviceWorker.register(t, e), i = A.installing, g = A.waiting;
  ...
  static async swCheck() {
    return we !== void 0 ? we : (pn === void 0 && (pn = new Promise((t, e) => {
  ...
  constructor(t, e) {
    ...
    this.mapID = t, e && Object.assign(this, e), this.url = `${Ut}cache/${t}/{z}/{x}/{y}`, this.listener = (A) => {
      A.data.mapID === t && this.dispatchEvent(new CustomEvent(A.data.type, { detail: A.data }));
  ...
  async stats() {
    let t;
    if (this.checkAspect(), t = await (await fetch(`${Ut}stats?mapID=${this.mapID}`)).text(), typeof t == "string" && t.match(/^Error: /))
      throw t;
    return JSON.parse(t);
  }
  async clean() {
    let t;
    if (this.checkAspect(), t = await (await fetch(`${Ut}clean?mapID=${this.mapID}`)).text(), t.match(/^Error: /))
      throw t;
  }
  async fetchAll() {
    let t;
    if (this.checkAspect(), t = await (await fetch(`${Ut}fetchAll?mapID=${this.mapID}`)).text(), t.match(/^Error: /))
      throw t;
  }
  async remove() {
  ...
  async cancel() {
    let t;
    if (this.checkAspect(), t = await (await fetch(`${Ut}cancel?mapID=${this.mapID}`)).text(), t.match(/^Error: /))
      throw t;
  }
}
function XA(n, t, e) {
  const A = typeof n == "string" ? n : n.getCode(), i = typeof t == "string" ? t : t.getCode();
  let g = an(n, t);
  if (g == cn && A != i) {
    const r = an(n, "EPSG:3857"), s = an("EPSG:3857", t);
    if (r == cn && A != "EPSG:3857")
      throw "Transform of Source projection is not defined.";
    if (s == cn && i != "EPSG:3857")
      throw "Transform of Distination projection is not defined.";
    g = function(I) {
      return Bt(Bt(I, n, "EPSG:3857"), "EPSG:3857", t);
    }, ZA(n, t, g, function(I) {
      return Bt(Bt(I, t, "EPSG:3857"), "EPSG:3857", n);
    });
  }
  if (e)
    return g(e);
...
async function gC(n) {
  ...
  if (iC.forEach((g) => {
    t[g] = n[g];
  }), (n.imageExtention || n.imageExtension) && (t.imageExtension = n.imageExtension || n.imageExtention), !n.compiled)
    throw new Error(
      "@maplat/transform requires pre-compiled data. Cannot create MapTransform from GCPs."
    );
  const e = { compiled: n.compiled };
  n.sub_maps?.length && (e.sub_maps = n.sub_maps.filter((g) => g.compiled).map((g) => ({
    compiled: g.compiled,
    priority: g.priority,
    importance: g.importance,
    bounds: g.bounds
  })));
  const A = new At.MapTransform();
  A.setMapData(e);
  const i = A.getLayerTransform(0);
  if (t.strictMode = i.strictMode, t.vertexMode = i.vertexMode, t.yaxisMode = i.yaxisMode, t.width = i.wh?.[0], t.height = i.wh?.[1], t.gcps = i.points, t.edges = i.edges, n.sub_maps) {
    const g = n.sub_maps.map((r, s) => {
      const o = {
        importance: r.importance,
        priority: r.priority
      };
      if (r.compiled) {
        const I = A.getLayerTransform(s + 1);
...
class VA extends or {
  ...
  static async createAsync(t) {
    const [e, A] = await gC(t);
    t = e;
    const i = new VA(t);
    i.mapTransform = A;
    const g = A.getLayerTransform(0), r = new AA({
      code: `Illst:${i.mapID}`,
    ...
    return En(r), ZA(
      ...
      (s) => g.transform(s, !1),
      (s) => g.transform(s, !0)
    ), XA("EPSG:4326", r), t.sub_maps && t.sub_maps.forEach((s, o) => {
  ...
  setupMapParameter(t) {
    const e = [this.width / 2, this.height / 2], A = this.mapTransform.xy2MercWithLayer(e);
    if (!A) return;
    const [i, g] = A, r = this.mapTransform.getLayerTransform(i), s = this.mapTransform.getLayerTransform(0);
    if (!r) return;
    const o = [
      [e[0] - 150, e[1]],
      [e[0] + 150, e[1]],
      ...
      [0, this.height]
    ], C = o.map((y) => r.transform(y, !1)), a = I.map(
      (y) => s.transform(y, !1)
    ), c = Math.sqrt(
    ...
    this.mercZoom || (this.mercZoom = Math.log(300 * (2 * At.MERC_MAX) / 256 / p) / Math.log(2) - 3), this.homePosition || (this.homePosition = jn(g)), this.envelope = yg([
      [
        a[0],
        a[1],
        a[2],
  ...
  mercs2SysCoordsAsync_multiLayer(t) {
    ...
    return Promise.resolve(
      e.map((A) => {
        if (A)
          return [A.map((i) => i), t[1]];
      })
    );
  }
  merc2XyAsync_base(t, e) {
    return this.merc2XyAsync_returnLayer(t).then((A) => e && !A[0] ? void 0 : (A[0] ? A[0] : A[1])[1]);
  }
  ...
  viewpoint2MercsAsync(t, e) {
    const A = t?.[0] ?? this.getMap().getView().getCenter(), i = t?.[1] ?? this.getMap().getView().getDecimalZoom(), g = t?.[2] ?? this.getMap().getView().getRotation();
    e || (e = this.getMap().getSize());
    const r = this.mapTransform.viewpoint2Mercs(
      { center: A, zoom: i, rotation: g },
      e
    );
    return Promise.resolve([r, e]);
  }
  mercs2ViewpointAsync(t) {
    const e = t[1] ?? this.getMap().getSize(), A = this.mapTransform.mercs2Viewpoint(
      t[0],
      e
    );
    return Promise.resolve([
...
if (bt.arrayBuffer)
  var sC = [
    ...
    "[object Float32Array]",
    "[object Float64Array]"
  ], oC = ArrayBuffer.isView || function(n) {
    return n && sC.indexOf(Object.prototype.toString.call(n)) > -1;
  };
function Ge(n) {
...
function at(n) {
  this.map = {}, n instanceof at ? n.forEach(function(t, e) {
    this.append(e, t);
...
function IC(n) {
  var t = new FileReader(), e = Ir(t);
  return t.readAsArrayBuffer(n), e;
}
function CC(n) {
  var t = new FileReader(), e = Ir(t), A = /charset=([A-Za-z0-9_-]+)/.exec(n.type), i = A ? A[1] : "utf-8";
  return t.readAsText(n, i), e;
}
function aC(n) {
...
function Cr() {
  return this.bodyUsed = !1, this._initBody = function(n) {
    ...
    if (this._bodyArrayBuffer)
      return Promise.resolve(aC(this._bodyArrayBuffer));
    if (this._bodyFormData)
...
function ce(n, t) {
  ...
  if (n instanceof ce) {
    ...
    this.url = String(n);
  if (this.credentials = t.credentials || this.credentials || "same-origin", (t.headers || !this.headers) && (this.headers = new at(t.headers)), this.method = lC(t.method || this.method || "GET"), this.mode = t.mode || this.mode || null, this.signal = t.signal || this.signal || (function() {
...
function hC(n) {
  ...
  return n.trim().split("&").forEach(function(e) {
    if (e) {
      var A = e.split("="), i = A.shift().replace(/\+/g, " "), g = A.join("=").replace(/\+/g, " ");
      t.append(decodeURIComponent(i), decodeURIComponent(g));
    }
  }), t;
}
function uC(n) {
  var t = new at(), e = n.replace(/\r?\n[\t ]+/g, " ");
  return e.split("\r").map(function(A) {
    return A.indexOf(`
`) === 0 ? A.substr(1, A.length) : A;
  }).forEach(function(A) {
    var i = A.split(":"), g = i.shift().trim();
    if (g) {
      var r = i.join(":").trim();
      try {
        t.append(g, r);
...
function Nt(n, t) {
  ...
  this.ok = this.status >= 200 && this.status < 300, this.statusText = t.statusText === void 0 ? "" : "" + t.statusText, this.headers = new at(t.headers), this.url = t.url || "", this._initBody(n);
}
Cr.call(Nt.prototype);
  ...
  return new Promise(function(e, A) {
    ...
    g.onload = function() {
      var I = {
        ...
        headers: uC(g.getAllResponseHeaders() || "")
      };
    ...
    if (g.open(i.method, s(i.url), !0), i.credentials === "include" ? g.withCredentials = !0 : i.credentials === "omit" && (g.withCredentials = !1), "responseType" in g && (bt.blob ? g.responseType = "blob" : bt.arrayBuffer && (g.responseType = "arraybuffer")), t && typeof t.headers == "object" && !(t.headers instanceof at || ut.Headers && t.headers instanceof ut.Headers)) {
      ...
      Object.getOwnPropertyNames(t.headers).forEach(function(I) {
        o.push(Ge(I)), g.setRequestHeader(I, si(t.headers[I]));
...
}, og = (n) => (n || "").match(/^(?:base|overlay|google(?:_(?:roadmap|satellite|hybrid|terrain))?|mapbox|maplibre|osm)$/);
async function mC(n, t) {
  if (typeof n == "string" && (n = dC[n]), n = jt(Object.assign(n, t)), n.label = n.label || n.year, og(n.maptype)) {
    const r = n.maptype === "base" ? Be : n.maptype === "overlay" ? QA : n.maptype === "mapbox" ? UA : n.maptype === "maplibre" ? WA : Xn;
    r.isBasemap() ? (n.homePosition = n.homePos, n.mercZoom = n.defZoom) : (n.homePosition || (n.homePosition = n.homePos), n.mercZoom || (n.mercZoom = n.defZoom)), delete n.homePos, delete n.defZoom, n.zoomRestriction && (n.maxZoom = n.maxZoom || n.mercMaxZoom, n.minZoom = n.minZoom || n.mercMinZoom), n.zoomRestriction = n.mercMaxZoom = n.mercMinZoom = void 0, n.translator && (n.url = n.translator(n.url)), n.imageExtension || (n.imageExtension = "jpg"), n.mapID && !n.url && !n.urls && (n.url = n.tms ? `tiles/${n.mapID}/{z}/{x}/{-y}.${n.imageExtension}` : `tiles/${n.mapID}/{z}/{x}/{y}.${n.imageExtension}`), n.weiwudi = await wn(n), n.weiwudi && (n.url = n.weiwudi.url, delete n.urls);
    const s = await r.createAsync(n);
    return await s.initialWait, s;
  } else if (n.noload)
    return n.mercMaxZoom = n.mercMinZoom = void 0, new VA(n);
  const e = n.settingFile || `maps/${n.mapID}.json`, A = await fetch(e);
  if (!A.ok)
    throw new Error("Fail to load map json");
  const i = await A.json();
  if (n = jt(Object.assign(i, n)), n.label = n.label || i.year, n.translator && (n.url = n.translator(n.url)), n.maptype || (n.maptype = "maplat"), og(n.maptype)) {
    const r = n.maptype === "base" ? Be : n.maptype === "overlay" ? QA : n.maptype === "mapbox" ? UA : n.maptype === "maplibre" ? WA : Xn;
    r.isBasemap() ? (n.homePosition = n.homePos, n.mercZoom = n.defZoom) : (n.homePosition || (n.homePosition = n.homePos), n.mercZoom || (n.mercZoom = n.defZoom)), delete n.homePos, delete n.defZoom, n.zoomRestriction && (n.maxZoom = n.maxZoom || n.mercMaxZoom, n.minZoom = n.minZoom || n.mercMinZoom), n.zoomRestriction = n.mercMaxZoom = n.mercMinZoom = void 0, n.imageExtension || (n.imageExtension = "jpg"), n.mapID && !n.url && !n.urls && (n.url = n.tms ? `tiles/${n.mapID}/{z}/{x}/{-y}.${n.imageExtension}` : `tiles/${n.mapID}/{z}/{x}/{y}.${n.imageExtension}`), n.weiwudi = await wn(n), n.weiwudi && (n.url = n.weiwudi.url, delete n.urls);
    const s = await r.createAsync(n);
    try {
      return await s.initialWait, s;
    } catch {
  ...
  if (delete n.homePos, delete n.defZoom, n.imageExtension || (n.imageExtension = "jpg"), n.mapID && !n.url && !n.urls && (n.url = `tiles/${n.mapID}/{z}/{x}/{y}.${n.imageExtension}`), !n.compiled || !n.compiled.wh)
    throw console.error(
      `[Maplat] Missing compiled.wh for mapID=${n.mapID}. Check map setting file: ${e}`
    ), new Error(`Map ${n.mapID} is missing compiled data.`);
  n.width = n.width || n.compiled.wh[0], n.height = n.height || n.compiled.wh[1], n.weiwudi = await wn(n), n.weiwudi && (n.url = n.weiwudi.url, delete n.urls);
  const g = await VA.createAsync(n);
...
function vn(n, t) {
  return n + (Math.random() - 0.5) * t;
}
function Ln(n, t) {
  if (n instanceof Array)
    return n.map((A) => Ln(A, t));
  const e = Math.pow(10, t);
  return Math.round(n * e) / e;
}
var Ke = { exports: {} }, bn, Ig;
function ur() {
  if (Ig) return bn;
  Ig = 1;
  var n = /<%=([\s\S]+?)%>/g;
...
function pC() {
  if (Cg) return Mn;
  Cg = 1;
  var n = ur(), t = "[object Null]", e = "[object Symbol]", A = "[object Undefined]", i = /[&<>"']/g, g = RegExp(i.source), r = /<%-([\s\S]+?)%>/g, s = /<%([\s\S]+?)%>/g, o = {
    "&": "&amp;",
    "<": "&lt;",
    ">": "&gt;",
    '"': "&quot;",
  ...
  function c(N, pt) {
    for (var It = -1, Yt = N == null ? 0 : N.length, zt = Array(Yt); ++It < Yt; )
      zt[It] = pt(N[It], It, N);
    return zt;
  }
  function d(N) {
  ...
  function nt(N) {
    return N == null ? N === void 0 ? A : t : z && z in Object(N) ? st(N) : ot(N);
  }
  function H(N) {
    if (typeof N == "string")
      return N;
  ...
  function st(N) {
    ...
    var zt = T.call(N);
    return Yt && (pt ? N[z] = It : delete N[z]), zt;
  }
  function ot(N) {
    return T.call(N);
  }
  ...
  function mt(N) {
    return typeof N == "symbol" || it(N) && nt(N) == e;
  }
  function Pt(N) {
    return N == null ? "" : H(N);
  }
  function Ht(N) {
    return N = Pt(N), N && g.test(N) ? N.replace(i, p) : N;
  }
  return Mn = q, Mn;
}
Ke.exports;
var ag;
function yC() {
  return ag || (ag = 1, (function(n, t) {
    var e = ur(), A = pC(), i = 800, g = 16, r = 9007199254740991, s = "[object Arguments]", o = "[object Array]", I = "[object AsyncFunction]", C = "[object Boolean]", a = "[object Date]", c = "[object DOMException]", d = "[object Error]", p = "[object Function]", y = "[object GeneratorFunction]", M = "[object Map]", T = "[object Number]", X = "[object Null]", z = "[object Object]", j = "[object Proxy]", Q = "[object RegExp]", q = "[object Set]", nt = "[object String]", H = "[object Symbol]", st = "[object Undefined]", ot = "[object WeakMap]", gt = "[object ArrayBuffer]", it = "[object DataView]", mt = "[object Float32Array]", Pt = "[object Float64Array]", Ht = "[object Int8Array]", N = "[object Int16Array]", pt = "[object Int32Array]", It = "[object Uint8Array]", Yt = "[object Uint8ClampedArray]", zt = "[object Uint16Array]", aA = "[object Uint32Array]", tn = /\b__p \+= '';/g, en = /\b(__p \+=) '' \+/g, Oe = /(__e\(.*?\)|\b__t\)) \+\n'';/g, cA = /[\\^$.*+?()[\]{}|]/g, lA = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, Xe = /^\[object .+?Constructor\]$/, An = /^(?:0|[1-9]\d*)$/, le = /($^)/, nn = /['\n\r\u2028\u2029\\]/g, $ = {};
    $[mt] = $[Pt] = $[Ht] = $[N] = $[pt] = $[It] = $[Yt] = $[zt] = $[aA] = !0, $[s] = $[o] = $[gt] = $[C] = $[it] = $[a] = $[d] = $[p] = $[M] = $[T] = $[z] = $[Q] = $[q] = $[nt] = $[ot] = !1;
    var gn = {
      "\\": "\\",
      "'": "'",
      "\n": "n",
      ...
      "\u2028": "u2028",
      "\u2029": "u2029"
    }, hA = typeof globalThis == "object" && globalThis && globalThis.Object === Object && globalThis, uA = typeof self == "object" && self && self.Object === Object && self, Ze = hA || uA || Function("return this")(), fA = t && !t.nodeType && t, Ae = fA && !0 && n && !n.nodeType && n, dA = Ae && Ae.exports === fA, Le = dA && hA.process, mA = (function() {
      try {
        var f = Ae && Ae.require && Ae.require("util").types;
        return f || Le && Le.binding && Le.binding("util");
      } catch {
      }
    })(), ft = mA && mA.isTypedArray;
    function Mt(f, w, S) {
      switch (S.length) {
        case 0:
          return f.call(w);
        case 1:
          return f.call(w, S[0]);
        case 2:
          return f.call(w, S[0], S[1]);
        case 3:
          return f.call(w, S[0], S[1], S[2]);
      }
      return f.apply(w, S);
    }
    function je(f, w) {
    ...
    var Ue = Function.prototype, ne = Object.prototype, h = Ze["__core-js_shared__"], l = Ue.toString, u = ne.hasOwnProperty, m = (function() {
      var f = /[^.]+$/.exec(h && h.keys && h.keys.IE_PROTO || "");
      return f ? "Symbol(src)_1." + f : "";
    })(), v = ne.toString, b = l.call(Object), R = RegExp(
      "^" + l.call(u).replace(cA, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
    ), B = dA ? Ze.Buffer : void 0, x = Ze.Symbol, G = ue(Object.getPrototypeOf, Object), Z = ne.propertyIsEnumerable, E = x ? x.toStringTag : void 0, D = (function() {
      try {
        var f = pr(Object, "defineProperty");
        return f({}, "", {}), f;
      } catch {
      }
    })(), L = B ? B.isBuffer : void 0, U = ue(Object.keys, Object), O = Math.max, k = Date.now, P = x ? x.prototype : void 0, F = P ? P.toString : void 0;
    function Y(f, w) {
      var S = ci(f), V = !S && xr(f), J = !S && !V && Sr(f), Ct = !S && !V && !J && Tr(f), Tt = S || V || J || Ct, rt = Tt ? Ne(f.length, String) : [], Zt = rt.length;
      for (var kt in f)
        (w || u.call(f, kt)) && !(Tt && // Safari 9 has enumerable `arguments.length` in strict mode.
        (kt == "length" || // Node.js 0.10 has enumerable non-index properties on buffers.
        J && (kt == "offset" || kt == "parent") || // PhantomJS 2 has enumerable non-index properties on typed arrays.
        Ct && (kt == "buffer" || kt == "byteLength" || kt == "byteOffset") || // Skip index properties.
        Ii(kt, Zt))) && rt.push(kt);
      return rt;
    }
    function K(f, w, S) {
      var V = f[w];
      (!(u.call(f, w) && on(V, S)) || S === void 0 && !(w in f)) && et(f, w, S);
    }
    function et(f, w, S) {
      w == "__proto__" && D ? D(f, w, {
        configurable: !0,
    ...
    function W(f) {
      return f == null ? f === void 0 ? st : X : E && E in Object(f) ? yr(f) : br(f);
    }
    function tt(f) {
      return fe(f) && W(f) == s;
    }
    ...
    function St(f) {
      ...
      for (var S in Object(f))
        u.call(f, S) && S != "constructor" && w.push(S);
      return w;
    }
    function Dt(f) {
      if (!wA(f))
      ...
      var w = ai(f), S = [];
      for (var V in f)
        V == "constructor" && (w || !u.call(f, V)) || S.push(V);
      return S;
    }
    function Et(f, w) {
      return Er(Mr(f, w, di), f + "");
    }
    var Ft = D ? function(f, w) {
      return D(f, "toString", {
        configurable: !0,
        enumerable: !1,
        value: Lr(w),
    ...
    function Kt(f) {
      ...
      if (Br(f))
        return F ? F.call(f) : "";
      var w = f + "";
      return w == "0" && 1 / f == -1 / 0 ? "-0" : w;
    }
    function rn(f, w, S, V) {
      var J = !S;
      S || (S = {});
      for (var Ct = -1, Tt = w.length; ++Ct < Tt; ) {
        var rt = w[Ct], Zt = V ? V(S[rt], f[rt], rt, S, f) : void 0;
        Zt === void 0 && (Zt = f[rt]), J ? et(S, rt, Zt) : K(S, rt, Zt);
      }
      return S;
    }
    function sn(f) {
      return Et(function(w, S) {
        var V = -1, J = S.length, Ct = J > 1 ? S[J - 1] : void 0, Tt = J > 2 ? S[2] : void 0;
        for (Ct = f.length > 3 && typeof Ct == "function" ? (J--, Ct) : void 0, Tt && Ci(S[0], S[1], Tt) && (Ct = J < 3 ? void 0 : Ct, J = 1), w = Object(w); ++V < J; ) {
          var rt = S[V];
          rt && f(w, rt, V, Ct);
        }
        return w;
    ...
    function yA(f, w, S, V) {
      return f === void 0 || on(f, ne[S]) && !u.call(V, S) ? w : f;
    }
    function pr(f, w) {
      var S = he(f, w);
    ...
    function yr(f) {
      ...
      var J = v.call(f);
      return V && (w ? f[E] = S : delete f[E]), J;
    }
    function Ii(f, w) {
      var S = typeof f;
      return w = w ?? r, !!w && (S == "number" || S != "symbol" && An.test(f)) && f > -1 && f % 1 == 0 && f < w;
    }
    function Ci(f, w, S) {
      if (!wA(S))
        return !1;
      var V = typeof w;
      return (V == "number" ? In(S) && Ii(w, S.length) : V == "string" && w in S) ? on(S[w], f) : !1;
    }
    function wr(f) {
      return !!m && m in f;
    }
    function ai(f) {
      var w = f && f.constructor, S = typeof w == "function" && w.prototype || ne;
      return f === S;
    }
    function vr(f) {
      var w = [];
    ...
    function Mr(f, w, S) {
      return w = O(w === void 0 ? f.length - 1 : w, 0), function() {
        for (var V = arguments, J = -1, Ct = O(V.length - w, 0), Tt = Array(Ct); ++J < Ct; )
          Tt[J] = V[w + J];
        J = -1;
    ...
    var xr = tt(/* @__PURE__ */ (function() {
      return arguments;
    })()) ? tt : function(f) {
      return fe(f) && u.call(f, "callee") && !Z.call(f, "callee");
    }, ci = Array.isArray;
    function In(f) {
      return f != null && ui(f.length) && !hi(f);
    }
    var Sr = L || jr;
    function li(f) {
      if (!fe(f))
        return !1;
      var w = W(f);
      return w == d || w == c || typeof f.message == "string" && typeof f.name == "string" && !Dr(f);
    }
    function hi(f) {
      if (!wA(f))
        return !1;
    ...
    function ui(f) {
      return typeof f == "number" && f > -1 && f % 1 == 0 && f <= r;
    }
    function wA(f) {
      var w = typeof f;
    ...
    var fi = sn(function(f, w, S, V) {
      rn(w, Or(w), f, V);
    });
    function Gr(f) {
      return In(f) ? Y(f) : St(f);
    }
    function Or(f) {
      return In(f) ? Y(f, !0) : Dt(f);
    }
    function Xr(f, w, S) {
      var V = A.imports._.templateSettings || A;
      S && Ci(f, w, S) && (w = void 0), f = kr(f), w = fi({}, w, V, yA);
      var J = fi({}, w.imports, V.imports, yA), Ct = Gr(J), Tt = ze(J, Ct), rt, Zt, kt = 0, mi = w.interpolate || le, Rt = "__p += '", Nr = RegExp(
        (w.escape || le).source + "|" + mi.source + "|" + (mi === e ? lA : le).source + "|" + (w.evaluate || le).source + "|$",
        "g"
      ), zr = u.call(w, "sourceURL") ? "//# sourceURL=" + (w.sourceURL + "").replace(/[\r\n]/g, " ") + `
` : "";
      f.replace(Nr, function(pi, yi, bA, Fr, wi, vi) {
        return bA || (bA = Fr), Rt += f.slice(kt, vi).replace(nn, Fe), yi && (rt = !0, Rt += `' +
__e(` + yi + `) +
'`), wi && (Zt = !0, Rt += `';
` + wi + `;
__p += '`), bA && (Rt += `' +
...
`;
      var Cn = u.call(w, "variable") && w.variable;
      Cn || (Rt = `with (obj) {
` + Rt + `
}
`), Rt = (Zt ? Rt.replace(tn, "") : Rt).replace(en, "$1").replace(Oe, "$1;"), Rt = "function(" + (Cn || "obj") + `) {
` + (Cn ? "" : `obj || (obj = {});
...
`) + Rt + `return __p
      ...
      var vA = Zr(function() {
        return Function(Ct, zr + "return " + Rt).apply(void 0, Tt);
      });
      if (vA.source = Rt, li(vA))
        throw vA;
      return vA;
    }
    var Zr = Et(function(f, w) {
      try {
        return Mt(f, void 0, w);
      } catch (S) {
        return li(S) ? S : new Error(S);
      }
    });
    function Lr(f) {
      return function() {
...
var wC = yC();
const fr = /* @__PURE__ */ Jr(wC);
function cg(n, ...t) {
  const e = jt(Object.assign({}, n));
  if (e.icon) return e;
  const A = t.reduce((i, g) => {
    if (i) return i;
    const r = g.iconTemplate;
    if (r)
      return JSON.parse(fr(r)(e));
    if (g.icon)
      return {
        icon: g.icon,
  ...
  return A && (e.icon = A.icon, e.selectedIcon = A.selectedIcon), e;
}
function lg(n, ...t) {
  return n = jt(n), n.html ? n : t.reduce((e, A) => {
    if (e) return e;
    const i = A.poiTemplate;
    if (i)
      return n.html = fr(i)(n), n.poiStyle = n.poiStyle || A.poiStyle, n;
  }, void 0) || n;
}
const lt = {
  ACCURACY: "accuracy",
...
class bC extends Vt {
  ...
  message;
  constructor(t) {
    super(vC.ERROR), this.code = t.code, this.message = t.message;
  }
}
class MC extends Te {
  task_id_;
  ...
  timerPositionChange_() {
    const t = {
      longitude: vn(this.home_position_[0], 0.05),
      latitude: vn(this.home_position_[1], 0.05),
      accuracy: vn(15, 10)
    };
  ...
  positionChange_(t) {
    ...
    this.set(lt.ACCURACY, e.accuracy), this.set(
      ...
      lt.HEADING,
      e.heading === null ? void 0 : Re(e.heading)
...
function ve(n, t) {
  console.warn(
    `MaplatCore: POI layer "${n}" not found (${t}). Pass namespaceID (e.g. "<mapID>#<layerId>" for map-derived layers), not the layer-local id.`
  );
}
class HA extends Tg {
  ...
  constructor(t) {
    ...
    e && t.mapboxToken && (e.accessToken = t.mapboxToken), t.googleApiKey && (this.googleApiKey = t.googleApiKey), this.mapDiv = t.div || "map_div", this.mapDivDocument = document.querySelector(`#${this.mapDiv}`), this.mapDivDocument.classList.add("maplat"), this.logger = new Kr(
      t.debug ? Je.ALL : Je.INFO
    ...
    [...We(`<img id="center_circle" class="prevent-default" alt=""
            ...
            margin-left:-10px;" src="${dr}">`)].reverse().forEach((s) => {
    ...
    this.mapDivDocument.querySelectorAll(".prevent-default").forEach((s) => {
      ...
      const s = await this.settingLoader(A);
  ...
  async runLifecyclePhase(t, e) {
    ...
    const A = this.buildLifecycleContext(t, e), i = RC[t], g = this.uiHooks?.[i];
    if (g)
      try {
        const r = await g(A);
        this.lifecycleHookResults[t] = r, A.uiHookResult = r, A.uiHookResults = { ...this.lifecycleHookResults };
      } catch (r) {
        throw this.logger?.debug?.(`lifecycle:error:${t}`), this.dispatchEvent(new yt("lifecycle:error", { phaseId: t, error: r })), r;
      }
    return this.dispatchEvent(
      new yt(`lifecycle:${t}`, A)
    ), A;
  }
  ...
  async sourcesLoader(t) {
    const e = this.appData.sources, A = [], i = {
      homePos: t.homePos,
      defZoom: t.defZoom,
  ...
  initGeolocation(t) {
    ...
    this.alwaysGpsOn ? (e.setTracking(!0), this.gpsEnabled_ = !0, this.initialGpsMove_ = !0) : (e.setTracking(!1), this.gpsEnabled_ = !1), e.on("change", () => {
      (async () => {
        const A = this.mapObject, i = A.getLayer("overlay").getLayers().item(0), g = A.getLayers().item(0), r = i ? i.getSource() : g.getSource(), s = e.getPosition(), o = e.getAccuracy();
        if (!s || !o) return;
        ...
        this.dispatchEvent(new Ve(C ? { lnglat: s, acc: o } : { error: a }));
      })();
    }), e.on("error", (A) => {
      const i = A.code;
      if (i === 3) return;
      ...
      (r ? r.getSource() : s.getSource()).setGPSMarker(), this.dispatchEvent(new PC(i === 1 ? "user_gps_deny" : i === 2 ? "gps_miss" : "gps_timeout")), this.dispatchEvent(new Ve({ error: "gps_off" }));
      ...
      (async () => {
        if (e.getTracking()) {
          ...
          this.dispatchEvent(new Ve(I ? { lnglat: s, acc: o } : { error: C }));
        }
      })();
    });
  }
  ...
  handleGPS(t, e = !1) {
    if (this.geolocation) {
      if (t)
        if (!this.alwaysGpsOn)
          this.firstGpsRequest_ = !0, this.geolocation.setTracking(!0), this.gpsEnabled_ = !0, this.dispatchEvent(new xC());
        else {
          const A = this.geolocation.getPosition(), i = this.geolocation.getAccuracy();
          if (A && i) {
            const g = this.mapObject, r = g.getLayer("overlay").getLayers().item(0), s = g.getLayers().item(0), o = r ? r.getSource() : s.getSource();
            (async () => await o.setGPSMarkerAsync({ lnglat: A, acc: i }, !1) || (o.setGPSMarker(), this.dispatchEvent(new Ve({ error: "gps_out" }))))();
          }
        }
      else if (!this.alwaysGpsOn) {
        this.geolocation.setTracking(!1), this.gpsEnabled_ = !1;
        const A = this.mapObject, i = A.getLayer("overlay").getLayers().item(0), g = A.getLayers().item(0);
        (i ? i.getSource() : g.getSource()).setGPSMarker(), e || this.dispatchEvent(new Ve({ error: "gps_off" }));
      }
    }
  }
  getGPSEnabled() {
  ...
  async prepareMap(t) {
    ...
    const e = this.appData.homePosition, A = this.appData.defaultZoom, i = this.appData.zoomRestriction, g = this.appData.minZoom, r = this.appData.maxZoom;
    ...
    this.mapDivDocument.insertBefore(C, this.mapDivDocument.firstChild), this.fakeGps = s, this.fakeRadius = o, this.homePosition = e, this.mapObject = new te({
      div: I,
      controls: this.appData.controls || [],
      interactions: this.noRotate ? gg({ altShiftDragRotate: !1, pinchRotate: !1 }) : gg().extend([
        new ZI({
          condition: PI
        })
      ]),
    ...
    let a = null;
    this.overlay && (a = `${this.mapDiv}_back`, C = We(
  ...
  async handlePois(t, e) {
    this.pois = t;
    const A = await this.sourcesLoader(e);
    return this.handleSources(A);
  }
  // Async initializer 9: Handle sources loading result
  async handleSources(t) {
    this.mercSrc = t.reduce((A, i) => {
      if (A) return A;
      if (i.isBasemap()) return i;
    }, null);
    const e = [];
    this.cacheHash = {}, t.forEach((A) => {
      ...
      e.push(A), this.cacheHash[A.mapID] = A;
    }), this.dispatchEvent(new yt("sourceLoaded", t)), await this.setInitialMap(e), this.setMapClick(), this.setPointerEvents(), this.setMapOnOff(), this.setMouseCursor(), this.setBackMapBehavior(), this.raiseChangeViewpoint(), await this.runLifecyclePhase("core-ready"), await this.runLifecyclePhase("ui-ready");
  }
  ...
  async setInitialMap(t) {
    ...
    this.from = t.reduce(
      (A, i) => A ? !(A instanceof or) && i.mapID != e ? i : A : i.mapID != e ? i : A,
      void 0
  ...
  setMapClick() {
    this.mapObject.on("click", (t) => {
      ...
      const e = [];
      if (t.target.forEachFeatureAtPixel(t.pixel, (A) => {
        this.logger.debug(t.pixel), A.get("datum") && e.push(A.get("datum"));
      }), e.length > 0)
        this.dispatchEvent(new yt("clickMarker", e[0])), this.dispatchEvent(new yt("clickMarkers", e));
      else {
        const A = t.coordinate;
        this.dispatchEvent(new yt("clickMapXy", A)), this.from.sysCoord2MercAsync(A).then((i) => {
          this.dispatchEvent(new yt("clickMapMerc", i));
          const g = Bt(i, "EPSG:3857", "EPSG:4326");
          this.dispatchEvent(
            new yt("clickMap", {
              longitude: g[0],
              latitude: g[1]
  ...
  setPointerEvents() {
    let t, e = !1, A = !1;
    const i = {}, g = (r) => {
      this.dispatchEvent(new yt("pointerMoveOnMapXy", r)), this.from.sysCoord2MercAsync(r).then((s) => {
        if (this.dispatchEvent(new yt("pointerMoveOnMapMerc", s)), t) {
          const o = t;
          t = !1, g(o);
        } else
          e = !1;
    ...
    this.mapObject.on("pointermove", (r) => {
      A || (e ? t = r.coordinate : (e = !0, g(r.coordinate)));
    }), this.mapObject.on("pointerdown", (r) => {
      r.originalEvent && r.originalEvent.pointerId != null && (i[r.originalEvent.pointerId] = !0), A = !0;
    }), this.mapObject.on("pointerdrag", (r) => {
      r.originalEvent && r.originalEvent.pointerId != null && (i[r.originalEvent.pointerId] = !0), A = !0;
    }), this.mapObject.on("pointerup", (r) => {
      r.originalEvent && r.originalEvent.pointerId != null ? (delete i[r.originalEvent.pointerId], Object.keys(i).length == 0 && (A = !1)) : r.originalEvent && r.originalEvent.touches ? r.originalEvent.touches.length == 0 && (A = !1) : A = !1;
    });
  }
  // Async initializer 13: Handle map UI on/off
  setMapOnOff() {
    let t;
    const e = () => this.mapDivDocument.querySelectorAll(".ol-control"), A = (g) => {
    ...
    this.mapObject.on("click", () => {
      ...
      !this.mapObject.tapUIVanish || r ? i(g) : (A(g), t = setTimeout(() => {
        t = void 0, i(e());
      }, this.mapObject.tapDuration));
    }), this.mapObject.on("pointerdrag", () => {
      t && (clearTimeout(t), t = void 0), A(e());
  ...
  setMouseCursor() {
    const t = (A) => {
      const i = A.target.getEventPixel(A.originalEvent), g = A.target.hasFeatureAtPixel(i), r = A.target.getTarget();
      if (g) {
        const s = A.target.forEachFeatureAtPixel(
          A.pixel,
          (o) => {
    ...
    const e = (A) => {
      let i = A.frameState.viewState.center;
      const g = this.from;
      g.insideCheckSysCoord(i) || (i = g.modulateSysCoordInside(
        i
      ), A.target.getView().setCenter(i));
    };
  ...
  setBackMapBehavior() {
    const t = (e) => {
      ...
      const A = this.backMap.getSource();
      A && (this.__backMapMoving = !0, this.logger.debug("Backmap moving started"), this.convertParametersFromCurrent(A, (i) => {
        const g = this.backMap.getView();
        g.setCenter(i[0]), g.setZoom(i[1]), g.setRotation(this.noRotate ? 0 : i[2]), this.logger.debug("Backmap moving ended"), this.__backMapMoving = !1;
      }));
    };
  ...
  raiseChangeViewpoint() {
    this.mapObject.on("postrender", async (t) => {
      const e = this.mapObject.getView(), A = e.getCenter(), i = e.getDecimalZoom(), g = DA(e.getRotation() * 180 / Math.PI), r = await this.from.viewpoint2MercsAsync(), s = await this.mercSrc.mercs2ViewpointAsync(r);
      ...
      const o = Bt(s[0], "EPSG:3857", "EPSG:4326"), I = DA(s[2] * 180 / Math.PI);
      this.dispatchEvent(
  ...
  getRotation() {
    ...
    return t ? DA(t.getRotation() * 180 / Math.PI) : 0;
  }
  ...
  async getDirection() {
    ...
    return DA(e[2] * 180 / Math.PI);
  }
  currentMapInfo() {
    return ki(this.from);
  }
  mapInfo(t) {
    return ki(this.cacheHash[t]);
  }
  async clientPointToLngLat(t, e) {
    if (!this.from || !this.mapObject) return;
    const i = this.mapObject.getViewport().getBoundingClientRect(), g = [t - i.left, e - i.top], r = this.mapObject.getCoordinateFromPixel(g);
    if (!r) return;
    const s = await this.from.sysCoord2MercAsync(r), o = Bt(s, "EPSG:3857", "EPSG:4326");
    return {
      longitude: o[0],
      latitude: o[1]
    };
  ...
  async lngLatToClientPoint(t, e) {
    if (!this.from || !this.mapObject) return;
    const A = Bt([t, e], "EPSG:4326", "EPSG:3857"), i = await this.from.merc2SysCoordAsync(A), g = this.mapObject.getPixelFromCoordinate(i);
    if (!g) return;
  ...
  setMarker(t) {
    ...
    const e = t.lnglat || [
      t.lng || t.longitude,
      t.lat || t.latitude
    ], A = t.x, i = t.y, g = t.coordinates, r = this.from, s = t.icon ? this.__selectedMarker == t.namespaceID && t.selectedIcon ? t.selectedIcon : t.icon : this.__selectedMarker == t.namespaceID ? mr : ii;
    return (g ? (function() {
      ...
      const I = Bt(e, "EPSG:4326", "EPSG:3857");
      return r.merc2SysCoordAsync_ignoreBackground(
        I
      );
    })()).then((I) => {
  ...
  setVector(t) {
    this.logger.debug(t);
    let e;
    const A = (i, g = !1) => Promise.all(
      i.map((r) => Array.isArray(r[0]) ? A(r, g) : (g && (r = Bt(r, "EPSG:4326", "EPSG:3857")), this.from.merc2SysCoordAsync(r)))
    );
    t.coordinates ? e = A(t.coordinates) : e = A(t.lnglats, !0), e.then((i) => {
  ...
  redrawMarkers(t = void 0) {
    if (t || (t = this.from), this.__redrawMarkerBlock) {
      ...
      const A = this.__redrawMarkerThrottle;
        ...
        for (const s of Object.keys(this.pois)) {
          ...
          if (!o.hide)
            for (const I of o.pois) {
              const C = cg(I, o, this);
              lg(C, o, this), this.__selectedMarker == C.namespaceID ? g = C : i.push(this.setMarker(C));
            }
        }
        if (A.pois)
          for (const s of Object.keys(A.pois)) {
            const o = A.pois[s];
            if (!o.hide)
              for (const I of o.pois) {
                const C = cg(I, o, A, this);
                lg(C, o, A, this), this.__selectedMarker == C.namespaceID ? g = C : i.push(this.setMarker(C));
              }
          }
      }
      let r = Promise.all(i);
  ...
  selectMarker(t) {
    ...
    this.setViewpoint(A), this.redrawMarkers();
  }
  unselectMarker() {
  ...
  getMarker(t) {
    if (t.includes("#")) {
      ...
      for (const e of Object.keys(this.pois))
        for (const A of this.pois[e].pois)
          if (A.id === t)
            return A;
      return;
    }
    ...
    if (i) {
      if (e = _e(e || {}), A) {
        ...
        for (const g of Object.keys(e))
          g === "id" || g === "namespaceID" || (e[g] === "____delete____" ? delete i[g] : i[g] = e[g]);
      this.redrawMarkers();
    }
  }
  addMarker(t, e) {
    if (e || (e = "main"), e.includes("#")) {
      const A = e.split("#"), i = this.cacheHash[A[0]];
      if (i) {
        const g = i.addPoi(t, A[1]);
        return this.dispatchPoiNumber(), this.redrawMarkers(), g;
      }
    } else if (this.pois[e])
      return this.pois[e].pois.push(_e(t)), Nn(this.pois, e, {
        name: this.appName
      }), this.dispatchPoiNumber(), this.redrawMarkers(), t.namespaceID;
  }
  removeMarker(t) {
    if (t.includes("#")) {
      const e = t.split("#"), A = this.cacheHash[e[0]];
      A && (A.removePoi(e[1]), this.dispatchPoiNumber(), this.redrawMarkers());
    } else
      for (const e of Object.keys(this.pois))
        for (let A = 0; A < this.pois[e].pois.length; A++)
          this.pois[e].pois[A].id === t && (delete this.pois[e].pois[A], this.dispatchPoiNumber(), this.redrawMarkers());
  }
  clearMarker(t) {
    if (t || (t = "main"), t.includes("#")) {
      const e = t.split("#"), A = this.cacheHash[e[0]];
      A && (A.clearPoi(e[1]), this.dispatchPoiNumber(), this.redrawMarkers());
    } else {
      if (t === "all")
        for (const e of Object.keys(this.pois))
          this.pois[e].pois = [];
  ...
  addPoiLayer(t, e) {
    if (t !== "main" && !this.pois[t])
      if (!t.includes("#"))
        ...
        const A = t.split("#"), i = this.cacheHash[A[0]];
        i ? (i.addPoiLayer(A[1], e), this.redrawMarkers()) : ve(t, "addPoiLayer");
      }
  }
  removePoiLayer(t) {
    if (t !== "main")
      if (t.includes("#")) {
        ...
        if (!A.getPoiLayer(e[1])) {
          ve(t, "removePoiLayer");
          return;
        }
        A.removePoiLayer(e[1]), this.requestUpdateState({
  ...
  changeMap(t, e) {
    e === void 0 && (e = {});
    const A = this.mercSrc, i = this.cacheHash[t];
    return i ? (this.changeMapSeq || (this.changeMapSeq = Promise.resolve()), this.changeMapSeq = this.changeMapSeq.then(
      () => new Promise((g, r) => {
        this.convertParametersFromCurrent(i, (s) => {
          ...
          if (this.backMap && (o = this.backMap.getSource(), i.isWmts() ? this.backMap.exchangeSource() : (C ? (I = C, this.backMap.exchangeSource(I)) : o ? I = o : (I = A, this.from.isWmts() && (I = this.from instanceof QA ? (
          ...
          ) : this.from), I && this.backMap.exchangeSource(I)), I && this.requestUpdateState({ backgroundID: I.mapID }))), i instanceof QA) {
          ...
          i.isBasemap() && (a.backgroundID = "____delete____"), this.requestUpdateState(a), this.from = i, this.dispatchPoiNumber();
          const c = this.mapObject.getView();
          this.appData.zoomRestriction && (c.setMaxZoom(i.maxZoom), c.setMinZoom(i.minZoom || 0)), s && i.insideCheckSysCoord(s[0]) ? (c.setCenter(s[0]), c.setZoom(s[1]), c.setRotation(this.noRotate ? 0 : s[2])) : this.__init ? s || this.goHome(i) : (this.dispatchEvent(new yt("outOfMap", {})), this.goHome(i)), i.setGPSMarker(this.currentPosition, !0), e.hideLayer && (e.hideLayer.split(",").map((p) => {
            const y = this.getPoiLayer(p);
            y && (y.hide = !0);
          }), this.requestUpdateState({ hideLayer: e.hideLayer })), e.hideMarker ? this.hideAllMarkers() : this.redrawMarkers(), this.resetVector(), this.vectors.forEach((d) => {
            this.setVector(d);
          }), this.dispatchEvent(
            new yt("mapChanged", this.getMapMeta(i.mapID))
          ), this.mapObject.updateSize(), this.mapObject.render(), e.position && (this.__init = !1, i.setViewpoint(e.position)), e.transparency && this.setTransparency(e.transparency), this.__init ? (this.__init = !1, this.goHome(i)) : this.backMap && I && this.convertParametersFromCurrent(I, (d) => {
            const p = this.backMap.getView();
            p.setCenter(d[0]), p.setZoom(d[1]), p.setRotation(this.noRotate ? 0 : d[2]), this.backMap.updateSize(), this.backMap.render();
          }), g(void 0);
        });
      })
  ...
  requestUpdateState(t) {
    if (this.stateBuffer = Object.assign(this.stateBuffer, t), this.stateBuffer.backgroundID == "____delete____" && delete this.stateBuffer.backgroundID, this.restoreSession) {
      ...
      const A = function(i) {
        Object.keys(i).map((g) => {
          g == "position" ? A(i[g]) : g == "backgroundID" && i[g] == "____delete____" ? localStorage.removeItem(g) : localStorage.setItem(g, i[g]);
        });
      };
      A(t);
    }
  ...
  async fetchAllMapTileCacheAsync(t, e) {
    let A;
    if (t ? A = this.cacheHash[t] : A = this.from, !A) {
      e("stop", {});
      return;
    }
    await A.fetchAllTileCacheAsync(e);
  }
  ...
  convertParametersFromCurrent(t, e) {
    const A = this.mapObject.getView();
    if (!this.from) {
      e && e();
      return;
    }
    ...
    const g = Ln(
      [A.getCenter(), A.getZoom(), A.getRotation()],
      10
    );
    if (this.mercBuffer && this.mercBuffer.mercs && this.mercBuffer.buffer[this.from.mapID]) {
      ...
      r[0][0] == g[0][0] && r[0][1] == g[0][1] && r[1] == g[1] && r[2] == g[2] ? (this.logger.debug(r), this.logger.debug(g), this.logger.debug("From: Use buffer"), i = new Promise((s, o) => {
    ...
    this.logger.debug(
    ...
    ), this.logger.debug(`From: ${this.from.mapID}`), i.then((r) => {
      ...
      this.mercBuffer.buffer[o] && (this.logger.debug("To: Use buffer"), s = new Promise((I, C) => {
        ...
        ), this.logger.debug(`To: ${t.mapID}`), this.mercBuffer.buffer[t.mapID] = Ln(I, 10), e(I);
      }).catch((I) => {
        throw I;
      });
    }).catch((r) => {
...
if (typeof window < "u") {
  const n = {
    createObject: HA.createObject
  };
  window.Maplat = n, window.MaplatApp = HA, window.assets = EC;
}
export {
  yt as CustomEvent,
  PC as GPSErrorEvent,
  xC as GPSRequestEvent,
  Ve as GPSResultEvent,
  HA as MaplatApp,
  te as MaplatMap,
  EC as assets,
  We as createElement,
