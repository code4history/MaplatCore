...
var og = (i, t, e) => t in i ? sg(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : i[t] = e;
var M = (i, t, e) => og(i, typeof t != "symbol" ? t + "" : t, e);
import { transform as Xt, toLonLat as ci, Projection as gg, addProjection as qr, addCoordinateTransforms as Ir, getTransform as jr, identityTransform as kr } from "ol/proj";
...
var Og = (function(i) {
  ...
  return ie(e, [{
    ...
    value: function(r, A, s, o, g) {
      ...
      var C = Cr(this.data, I) || {};
      o ? bs(C, s, g) : C = Jn(Jn({}, C), s), AA(this.data, I, C), a.silent || this.emit("added", r, A, s);
    }
  }, {
    ...
    value: function(r, A) {
      return A || (A = this.options.defaultNS), this.options.compatibilityAPI === "v1" ? Jn(Jn({}, {}), this.getResource(r, A)) : this.getResource(r, A);
    }
  }, {
...
var aA = {}, IA = (function(i) {
  ...
  function e(n) {
    var r, A = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    return re(this, e), r = t.call(this), vr && me.call(pe(r)), bg(["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"], n, pe(r)), r.options = A, r.options.keySeparator === void 0 && (r.options.keySeparator = "."), r.logger = $t.create("translator"), r;
  }
  return ie(e, [{
    key: "changeLanguage",
    value: function(r) {
    ...
    value: function(r, A) {
      ...
      s === void 0 && (s = ":");
      var o = A.keySeparator !== void 0 ? A.keySeparator : this.options.keySeparator, g = A.ns || this.options.defaultNS || [], a = s && r.indexOf(s) > -1, I = !this.options.userDefinedKeySeparator && !A.keySeparator && !this.options.userDefinedNsSeparator && !A.nsSeparator && !Rg(r, s, o);
      if (a && !I) {
  ...
  return ie(e, [{
    ...
    value: function(r, A, s) {
      ...
      this.queue.forEach(function(C) {
        wg(C.loaded, [g], a), Hg(C, r), A && C.errors.push(A), C.pendingCount === 0 && !C.done && (Object.keys(C.loaded).forEach(function(c) {
          I[c] || (I[c] = {});
          var l = C.loaded[c];
...
var cr = (function(i) {
  ...
  function e() {
    ...
    if (re(this, e), n = t.call(this), vr && me.call(pe(n)), n.options = fA(r), n.services = {}, n.logger = $t, n.modules = {
      external: []
    }, Kg(pe(n)), A && !n.isInitialized && !r.isClone) {
      if (!n.options.initImmediate)
        return n.init(r, A), Ln(n, pe(n));
      setTimeout(function() {
        n.init(r, A);
      }, 0);
    }
  ...
  return ie(e, [{
    ...
    key: "loadResources",
    value: function(r) {
      var A = this, s = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : qn, o = s, g = typeof r == "string" ? r : this.language;
    ...
    value: function(r, A, s) {
      var o = In();
      return r || (r = this.languages), A || (A = this.options.ns), s || (s = qn), this.services.backendConnector.reload(r, A, function(g) {
        o.resolve(), s(g);
      }), o;
    }
  }, {
    ...
    key: "cloneInstance",
    value: function() {
      var r = this, A = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, s = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : qn, o = Jt(Jt(Jt({}, this.options), A), {
        isClone: !0
      }), g = new e(o);
...
function qg(i) {
  return Jg(i) ? i : Promise.resolve(i);
}
function pA(i, t) {
  var e = Object.keys(i);
  if (Object.getOwnPropertySymbols) {
...
function _g(i, t, e) {
  return (t = $g(t)) in i ? Object.defineProperty(i, t, { value: e, enumerable: !0, configurable: !0, writable: !0 }) : i[t] = e, i;
}
function $g(i) {
  var t = ta(i, "string");
...
if (!ye && !mn && !lr)
  try {
    Promise.resolve().then(() => Uc).then(function(i) {
      ye = i.default;
    }).catch(function() {
    });
  } catch {
...
var ni = function(t, e) {
  ...
  n && Le(n) === "object" && (n = ni("", n).slice(1)), t.queryStringParams && (e = ni(e, t.queryStringParams));
  try {
...
function sa(i, t, e) {
  return t && Aa(i.prototype, t), Object.defineProperty(i, "prototype", { writable: !1 }), i;
}
function Ps(i, t, e) {
...
var ga = function() {
  ...
  function i(t) {
    ...
    ia(this, i), this.services = t, this.options = e, this.allOptions = n, this.type = "backend", this.init(t, e, n);
  }
  return sa(i, [{
    key: "init",
    value: function(e) {
      var n = this, r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, A = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
      if (this.services = e, this.options = Xr(Xr(Xr({}, ga()), this.options || {}), r), this.allOptions = A, this.services && this.options.reloadInterval) {
    ...
    value: function(e, n, r, A, s) {
      ...
      typeof this.options.loadPath == "function" && (g = this.options.loadPath(e, r)), g = qg(g), g.then(function(a) {
        if (!a) return s(null, {});
...
function Oe(i, t, e) {
  if (Array.isArray(i))
    ...
    i.name && (n.name = i.name), n.pois = i.features.map((r) => yn(r)), i = n;
  }
  if (typeof i.id > "u")
    i.id = t;
...
const pa = (3 + 16 * Ie) * Ie, ma = (2 + 12 * Ie) * Ie, ya = (9 + 64 * Ie) * Ie * Ie, ze = jn(4), RA = jn(8), xA = jn(12), SA = jn(16), Ot = jn(4);
function va(i, t, e, n, r, A, s) {
  ...
  if (dt >= ut || -dt >= ut || (C = i - nt, o = i - (nt + C) + (C - r), C = e - at, a = e - (at + C) + (C - r), C = t - J, g = t - (J + C) + (C - A), C = n - rt, I = n - (rt + C) + (C - A), o === 0 && g === 0 && a === 0 && I === 0) || (ut = ya * s + fa * Math.abs(dt), dt += nt * I + rt * o - (J * a + at * g), dt >= ut || -dt >= ut)) return dt;
...
function ba(i, t, e, n, r, A) {
  const s = (t - A) * (e - r), o = (i - r) * (n - A), g = s - o, a = Math.abs(s + o);
  return Math.abs(g) >= pa * a ? g : -va(i, t, e, n, r, A, a);
}
function wa(i, t) {
...
function ar(i, t, e = {}) {
  ...
  const n = ua(i), r = ha(t), A = r.type, s = t.bbox;
  let o = r.coordinates;
  if (s && Ea(n, s) === !1)
    return !1;
  A === "Polygon" && (o = [o]);
  ...
  for (let r = 0; r < n.length; r++)
    for (let A = 0; A < n[r].length; A++) {
      ...
      for (let g = 0; g < n[r][A].length - 1; g++) {
        ...
        a.otherEvent = I, I.otherEvent = a, Ls(a, I) > 0 ? (I.isLeftEndpoint = !0, a.isLeftEndpoint = !1) : (a.isLeftEndpoint = !0, I.isLeftEndpoint = !1), t.push(a), t.push(I), s = o, tr = tr + 1;
      }
    }
  _n = _n + 1;
}
...
function Da(i, t) {
  const e = new Ts([], Ls);
  return Ra(i, e), Oa(e, t);
}
var Ba = Da;
function Ta(i, t, e = {}) {
  const { removeDuplicates: n = !0, ignoreSelfIntersections: r = !0 } = e;
  let A = [];
  i.type === "FeatureCollection" ? A = A.concat(i.features) : i.type === "Feature" ? A.push(i) : (i.type === "LineString" || i.type === "Polygon" || i.type === "MultiLineString" || i.type === "MultiPolygon") && A.push(vn(i)), t.type === "FeatureCollection" ? A = A.concat(t.features) : t.type === "Feature" ? A.push(t) : (t.type === "LineString" || t.type === "Polygon" || t.type === "MultiLineString" || t.type === "MultiPolygon") && A.push(vn(t));
  const s = Ba(
    MA(A),
    r
  );
  ...
  class t extends i {
    ...
    initialize(r) {
      ...
      if (r = te(r), this.mapID = r.mapID, this.homePosition = r.homePosition, this.mercZoom = r.mercZoom, this.label = r.label, this.maxZoom = r.maxZoom, this.minZoom = r.minZoom, this.poiTemplate = r.poiTemplate, this.poiStyle = r.poiStyle, this.iconTemplate = r.iconTemplate, this.icon = r.icon, this.selectedIcon = r.selectedIcon, this.mercatorXShift = r.mercatorXShift, this.mercatorYShift = r.mercatorYShift, this.weiwudi = r.weiwudi, r.envelopeLngLats) {
        ...
        a.push(a[0]), this.envelope = gr([a]), this.centroid = (o = La(this.envelope).geometry) == null ? void 0 : o.coordinates;
      }
    ...
    getPoi(r) {
      ...
      return Object.keys(this.pois).map((s) => {
        this.pois[s].pois.map((o, g) => {
          o.id === r && (A = this.pois[s].pois[g]);
        });
      }), A;
    }
    addPoi(r, A) {
      if (A || (A = "main"), this.pois[A])
        return r = yn(r), this.pois[A].pois.push(r), ui(this.pois, A, {
          name: this.officialTitle || this.title,
          namespace: this.mapID
        }), r.namespaceID;
    }
    removePoi(r) {
      Object.keys(this.pois).map((A) => {
        this.pois[A].pois.map((s, o) => {
          s.id === r && delete this.pois[A].pois[o];
        });
      });
    }
    clearPoi(r) {
...
function Ns(i) {
  class t extends ks(i) {
    ...
    modulateXyInside(n) {
      ...
      const r = la([n, this.centroid]), A = Ta(this.envelope, r);
...
function Fa(i) {
  ...
  return function() {
    ...
    return (!e || this !== n || !Xa(r, e)) && (n = this, e = r, t = i.apply(this, arguments)), t;
  };
}
function zs(i) {
  for (const t in i)
...
function Ys(i, t) {
  let e;
  return e = t(Va(i)), e || (e = t(Ya(i)), e) || (e = t(_a(i)), e) || (e = t(qa(i)), e) ? e : !1;
}
function Va(i) {
  return [i[0], i[1]];
}
...
let eI = 0;
function nI(i) {
  return i.ol_uid || (i.ol_uid = String(++eI));
}
const rI = {
  /**
...
function CI(i, t, e, n) {
  ...
  for (let A = 0; A < r; A += n) {
    t[A] = Ye * i[A] / 180;
    let s = kn * Math.log(Math.tan(Math.PI * (+i[A + 1] + 90) / 360));
...
function cI(i, t, e, n) {
  ...
  e = e > 1 ? e : 2, n = n ?? e, t === void 0 && (e > 2 ? t = i.slice() : t = new Array(r));
  for (let A = 0; A < r; A += n)
    t[A] = 180 * i[A] / Ye, t[A + 1] = 360 * Math.atan(Math.exp(i[A + 1] / kn)) / Math.PI - 90;
  return t;
}
...
function RI(i, t, e) {
  i = Ai(i, MI, PI), t < UA ? t = UA : t > zA && (t = zA);
  const n = qe(t), r = Math.sin(n), A = Math.cos(n), s = r / A, o = s * s, g = o * o, a = qe(i), I = to(e.number), C = qe(I), c = dr / Math.sqrt(1 - Ut * r ** 2), l = Be * A ** 2, h = A * Ai(a - C, -Math.PI, Math.PI), u = h * h, m = u * h, p = m * h, v = p * h, D = v * h, T = dr * ($s * n - dI * Math.sin(2 * n) + pI * Math.sin(4 * n) - mI * Math.sin(6 * n)), U = fr * c * (h + m / 6 * (1 - o + l) + v / 120 * (5 - 18 * o + g + 72 * l - 58 * Be)) + 5e5;
...
function SI(i) {
  return eo(i) ? new En({ code: i, units: "m" }) : null;
}
function OI(i) {
...
function he(i, t) {
  return oi && !hr(i, [0, 0]) && i[0] >= -180 && i[0] <= 180 && i[1] >= -90 && i[1] <= 90 && (oi = !1, AI(
...
class QI extends An {
   ...
   */
  transform(t, e) {
    const n = Pn(t), r = n.getUnits() == "tile-pixels" ? function(A, s, o) {
...
function JI(i, t, e, n, r, A, s, o, g, a, I) {
  I = I || [NaN, NaN];
...
function so(i, t, e, n, r, A, s) {
  ...
  for (; a.length > 0; ) {
    ...
    for (let v = c + n; v < C; v += n) {
      const D = i[v], T = i[v + 1], U = sI(D, T, h, u, m, p);
      U > l && (I = v, l = U);
    }
...
function qA(i, t, e, n, r) {
  ...
  for (let A = 0, s = e.length; A < s; ++A) {
    ...
    (A === 0 ? r && g || !r && !g : r && !g || !r && g) && oC(i, t, o, n), t = o;
  }
  return t;
}
class je extends Nn {
...
class ns extends An {
  ...
  applyOptions_(t) {
    ...
    const r = pC(t), A = n.constraint, s = yC(t);
    this.constraints_ = {
      center: r,
      resolution: A,
      rotation: s
  ...
  cancelAnimations() {
    ...
    for (let e = 0, n = this.animations_.length; e < n; ++e) {
      ...
      if (r[0].callback && rr(r[0].callback, !1), !t)
  ...
  calculateCenterRotate(t, e) {
    ...
    return r !== void 0 && (n = [r[0] - e[0], r[1] - e[1]], mi(n, t - this.getRotation()), oI(n, e)), n;
  }
  /**
  ...
  calculateExtentInternal(t) {
    ...
    return de(r !== void 0, "The view rotation is not defined"), Ka(e, n, r, t);
  }
  /**
  ...
  fit(t, e) {
    ...
    if (de(
      ...
      const r = nr(t, this.getProjection());
      n = _A(r);
...
function mC(i) {
  ...
  if (!a && !u && c.isGlobal() && (h = !1, u = l), i.resolutions !== void 0) {
    ...
    e = m[s], n = m[o] !== void 0 ? m[o] : m[m.length - 1], i.constrainResolution ? t = lC(
      m,
      I,
      !h && u,
      C
    ...
    ), n = e / Math.pow(g, o - s), i.constrainResolution ? t = uC(
      g,
      e,
      n,
      I,
...
class Io extends wC {
  ...
  isVisible(t) {
    ...
    return EC(r, e.viewState) && (!A || di(A, e.extent));
  }
  /**
...
class Dn extends ag {
  ...
  setFeature(e, n, r) {
    const A = this.getSource(r), s = new Ig(e);
  ...
  setMarker(e, n, r, A) {
    return A || (A = "marker"), n.geometry = new xn(e), r ? typeof r == "string" ? r = new _t({
      image: new tn({
        anchor: [0.5, 1],
        anchorXUnits: "fraction",
        anchorYUnits: "fraction",
  ...
  setVector(e, n = "Line", r, A) {
    ...
    const o = new _t(s), g = n === "Line" ? new pr(e) : new je(e);
  ...
  exchangeSource(e = void 0) {
    const n = this.getLayers(), r = n.item(0), A = Dn.spawnLayer(r, e, this.getTarget());
...
const ke = typeof navigator < "u" && typeof navigator.userAgent < "u" ? navigator.userAgent.toLowerCase() : "", LC = ke.includes("safari") && !ke.includes("chrom");
LC && (ke.includes("version/15.4") || /cpu (os|iphone os) 15_4 like mac os x/.test(ke));
const jC = ke.includes("webkit") && !ke.includes("edge"), uo = ke.includes("macintosh");
...
const kC = function(i) {
  ...
  return (e instanceof ShadowRoot ? e.host : t).hasAttribute("tabindex") ? GC(i) : !0;
}, XC = Za, fo = function(i) {
  const t = i.originalEvent;
  return "pointerId" in t && t.button == 0 && !(jC && uo && t.ctrlKey);
}, po = function(i) {
  const t = (
...
class UC extends Xs {
  ...
  createOrUpdateGeometry() {
    ...
    r[4] = r[0].slice(), this.geometry_ ? this.geometry_.setCoordinates([r]) : this.geometry_ = new je([r]);
  }
  /**
...
class HC extends sn {
  ...
  handleDragEvent(t) {
    ...
    const n = this.targetPointers, r = e.getEventPixel(Li(n));
...
class tc extends sn {
  ...
  handleDragEvent(t) {
    ...
    o.getConstraints().rotation !== Di && (this.anchor_ = s.getCoordinateFromPixelInternal(
      s.getEventPixel(Li(this.targetPointers))
...
class ec extends sn {
  ...
  handleDragEvent(t) {
    ...
    e != 1 && (this.lastScaleDelta_ = e), this.anchor_ = g.getCoordinateFromPixelInternal(
      g.getEventPixel(Li(this.targetPointers))
...
function As(i) {
  ...
  return (i.altShiftDragRotate !== void 0 ? i.altShiftDragRotate : !0) && t.push(new QC()), (i.doubleClickZoom !== void 0 ? i.doubleClickZoom : !0) && t.push(
    new TC({
      delta: i.zoomDelta,
  ...
  ), (i.pinchRotate !== void 0 ? i.pinchRotate : !0) && t.push(new tc()), (i.pinchZoom !== void 0 ? i.pinchZoom : !0) && t.push(
    new ec({
      duration: i.zoomDuration
    })
  ), (i.keyboard !== void 0 ? i.keyboard : !0) && (t.push(new KC()), t.push(
    new JC({
      delta: i.zoomDelta,
      duration: i.zoomDuration
    })
...
function ac(i, t, e, n, r) {
  return i.replace(Ac, t.toString()).replace(sc, e.toString()).replace(oc, n.toString()).replace(gc, function() {
    throw new Error(
...
function sr(i, t, e) {
  ...
  let A = jr(i, t);
  if (A == kr && n != r) {
    const s = jr(i, "EPSG:3857"), o = jr("EPSG:3857", t);
    if (s == kr && n != "EPSG:3857")
  ...
  return os || (os = 1, (function(i, t) {
    (function(e, n) {
      ...
      function p(d, y, P, R, G) {
        let O, k, Z, L, F = y[0], H = R[0], B = 0, N = 0;
        H > F == H > -F ? (O = F, F = y[++B]) : (O = H, H = R[++N]);
        let Q = 0;
        if (B < d && N < P) for (H > F == H > -F ? (k = F + O, Z = O - (k - F), F = y[++B]) : (k = H + O, Z = O - (k - H), H = R[++N]), O = k, Z !== 0 && (G[Q++] = Z); B < d && N < P; ) H > F == H > -F ? (k = O + F, L = k - O, Z = O - (k - L) + (F - L), F = y[++B]) : (k = O + H, L = k - O, Z = O - (k - L) + (H - L), H = R[++N]), O = k, Z !== 0 && (G[Q++] = Z);
        for (; B < d; ) k = O + F, L = k - O, Z = O - (k - L) + (F - L), F = y[++B], O = k, Z !== 0 && (G[Q++] = Z);
        for (; N < P; ) k = O + H, L = k - O, Z = O - (k - L) + (H - L), H = R[++N], O = k, Z !== 0 && (G[Q++] = Z);
      ...
      function rt(d, y, P, R, G, O, k) {
        let Z, L, F, H, B, N, Q, $, X, j, x, V, st, gt, ct, tt, Ct, mt;
        const Tt = d - G, Gt = P - G, Lt = y - O, bt = R - O;
        gt = Tt * bt, N = u * Tt, Q = N - (N - Tt), $ = Tt - Q, N = u * bt, X = N - (N - bt), j = bt - X, ct = $ * j - (gt - Q * X - $ * X - Q * j), tt = Lt * Gt, N = u * Lt, Q = N - (N - Lt), $ = Lt - Q, N = u * Gt, X = N - (N - Gt), j = Gt - X, Ct = $ * j - (tt - Q * X - $ * X - Q * j), x = ct - Ct, B = ct - x, q[0] = ct - (x + B) + (B - Ct), V = gt + x, B = V - gt, st = gt - (V - B) + (x - B), x = st - tt, B = st - x, q[1] = st - (x + B) + (B - tt), mt = V + x, B = mt - V, q[2] = V - (mt - B) + (x - B), q[3] = mt;
        let Yt = v(4, q), Pe = U * k;
        if (Yt >= Pe || -Yt >= Pe || (B = d - Tt, Z = d - (Tt + B) + (B - G), B = P - Gt, F = P - (Gt + B) + (B - G), B = y - Lt, L = y - (Lt + B) + (B - O), B = R - bt, H = R - (bt + B) + (B - O), Z === 0 && L === 0 && F === 0 && H === 0) || (Pe = W * k + m * Math.abs(Yt), Yt += Tt * H + bt * Z - (Lt * F + Gt * L), Yt >= Pe || -Yt >= Pe)) return Yt;
        gt = Z * bt, N = u * Z, Q = N - (N - Z), $ = Z - Q, N = u * bt, X = N - (N - bt), j = bt - X, ct = $ * j - (gt - Q * X - $ * X - Q * j), tt = L * Gt, N = u * L, Q = N - (N - L), $ = L - Q, N = u * Gt, X = N - (N - Gt), j = Gt - X, Ct = $ * j - (tt - Q * X - $ * X - Q * j), x = ct - Ct, B = ct - x, J[0] = ct - (x + B) + (B - Ct), V = gt + x, B = V - gt, st = gt - (V - B) + (x - B), x = st - tt, B = st - x, J[1] = st - (x + B) + (B - tt), mt = V + x, B = mt - V, J[2] = V - (mt - B) + (x - B), J[3] = mt;
        const Sr = p(4, q, 4, J, et);
        gt = Tt * H, N = u * Tt, Q = N - (N - Tt), $ = Tt - Q, N = u * H, X = N - (N - H), j = H - X, ct = $ * j - (gt - Q * X - $ * X - Q * j), tt = Lt * F, N = u * Lt, Q = N - (N - Lt), $ = Lt - Q, N = u * F, X = N - (N - F), j = F - X, Ct = $ * j - (tt - Q * X - $ * X - Q * j), x = ct - Ct, B = ct - x, J[0] = ct - (x + B) + (B - Ct), V = gt + x, B = V - gt, st = gt - (V - B) + (x - B), x = st - tt, B = st - x, J[1] = st - (x + B) + (B - tt), mt = V + x, B = mt - V, J[2] = V - (mt - B) + (x - B), J[3] = mt;
        const Or = p(Sr, et, 4, J, nt);
        gt = Z * H, N = u * Z, Q = N - (N - Z), $ = Z - Q, N = u * H, X = N - (N - H), j = H - X, ct = $ * j - (gt - Q * X - $ * X - Q * j), tt = L * F, N = u * L, Q = N - (N - L), $ = L - Q, N = u * F, X = N - (N - F), j = F - X, Ct = $ * j - (tt - Q * X - $ * X - Q * j), x = ct - Ct, B = ct - x, J[0] = ct - (x + B) + (B - Ct), V = gt + x, B = V - gt, st = gt - (V - B) + (x - B), x = st - tt, B = st - x, J[1] = st - (x + B) + (B - tt), mt = V + x, B = mt - V, J[2] = V - (mt - B) + (x - B), J[3] = mt;
        const Dr = p(Or, nt, 4, J, at);
        return at[Dr - 1];
      }
      function dt(d, y, P, R, G, O) {
        const k = (y - O) * (P - G), Z = (d - G) * (R - O), L = k - Z, F = Math.abs(k + Z);
        return Math.abs(L) >= T * F ? L : -rt(d, y, P, R, G, O, F);
      }
      function ut(d, y) {
        var P, R, G = 0, O, k, Z, L, F, H, B, N = d[0], Q = d[1], $ = y.length;
        for (P = 0; P < $; P++) {
          R = 0;
          var X = y[P], j = X.length - 1;
          if (H = X[0], H[0] !== X[j][0] && H[1] !== X[j][1]) throw new Error("First and last coordinates in a ring must be the same");
          for (k = H[0] - N, Z = H[1] - Q, R; R < j; R++) {
            if (B = X[R + 1], L = B[0] - N, F = B[1] - Q, Z === 0 && F === 0) {
              if (L <= 0 && k >= 0 || k <= 0 && L >= 0) return 0;
            } else if (F >= 0 && Z <= 0 || F <= 0 && Z >= 0) {
              if (O = dt(k, L, Z, F, 0, 0), O === 0) return 0;
      ...
      function _(d, y, P) {
        const R = y.geometry.coordinates[0][0], G = y.geometry.coordinates[0][1], O = y.geometry.coordinates[0][2], k = d.geometry.coordinates, Z = y.properties.a.geom, L = y.properties.b.geom, F = y.properties.c.geom, H = [G[0] - R[0], G[1] - R[1]], B = [O[0] - R[0], O[1] - R[1]], N = [k[0] - R[0], k[1] - R[1]], Q = [L[0] - Z[0], L[1] - Z[1]], $ = [F[0] - Z[0], F[1] - Z[1]];
        let X = (B[1] * N[0] - B[0] * N[1]) / (H[0] * B[1] - H[1] * B[0]), j = (H[0] * N[1] - H[1] * N[0]) / (H[0] * B[1] - H[1] * B[0]);
        if (P) {
          const x = P[y.properties.a.index], V = P[y.properties.b.index], st = P[y.properties.c.index];
          let gt;
          if (X < 0 || j < 0 || 1 - X - j < 0) {
            const ct = X / (X + j), tt = j / (X + j);
            gt = X / V / (ct / V + tt / st), j = j / st / (ct / V + tt / st);
          } else gt = X / V / (X / V + j / st + (1 - X - j) / x), j = j / st / (X / V + j / st + (1 - X - j) / x);
          X = gt;
        }
        return [X * Q[0] + j * $[0] + Z[0], X * Q[1] + j * $[1] + Z[1]];
      }
      function it(d, y, P, R) {
        ...
        const L = y[1][Z];
        return _(d, L.features[0], R);
      }
      function Y(d, y, P, R, G, O, k, Z) {
        let L;
        if (k && (L = z(d, a([k]))), !L) {
          if (P) {
            const F = d.geometry.coordinates, H = P.gridNum, B = P.xOrigin, N = P.yOrigin, Q = P.xUnit, $ = P.yUnit, X = P.gridCache, j = lt(F[0], B, Q, H), x = lt(F[1], N, $, H), V = X[j] ? X[j][x] ? X[j][x] : [] : [];
            y = a(V.map((st) => y.features[st]));
          }
          L = z(d, y);
        }
        return Z && Z(L), L ? _(d, L, O) : it(d, R, G, O);
      }
      function lt(d, y, P, R) {
      ...
      function we(d, y) {
        ...
        for (let O = 0; O < y.length; O++) {
          const k = (O + 1) % y.length, Z = pt(d - y[k]), L = Math.min(Math.abs(P), Math.abs(Z));
          P * Z <= 0 && L < R && (R = L, G = O), P = Z;
        }
        return G;
      }
      function pt(d, y = !1) {
      ...
      function se(d, y, P, R, G, O = !1, k) {
        const Z = d.map((L) => {
          (!k || k < 2.00703) && (L = Vt(L));
          const F = isFinite(L) ? y[L] : L === "c" ? R : L === "b0" ? G[0] : L === "b1" ? G[1] : L === "b2" ? G[2] : L === "b3" ? G[3] : (function() {
            const H = L.match(/e(\d+)/);
            if (H) {
      ...
      function zn(d) {
        ...
        for (let R = 0; R < P.length; R++) {
          const G = P[R];
          ["a", "b", "c"].map((O, k) => {
            const Z = G.geometry.coordinates[0][k], L = G.properties[O].geom, F = G.properties[O].index;
            typeof F == "number" && (y[F] = [Z, L]);
          });
        }
        return y;
      }
      const Hn = oe, Nt = class qt {
        ...
        addIndexedTin() {
          ...
          const Z = P.features.map((X) => {
            let j = [];
            return c(X)[0].map((x) => {
              O.length === 0 ? O = [Array.from(x), Array.from(x)] : (x[0] < O[0][0] && (O[0][0] = x[0]), x[0] > O[1][0] && (O[1][0] = x[0]), x[1] < O[0][1] && (O[0][1] = x[1]), x[1] > O[1][1] && (O[1][1] = x[1])), j.length === 0 ? j = [Array.from(x), Array.from(x)] : (x[0] < j[0][0] && (j[0][0] = x[0]), x[0] > j[1][0] && (j[1][0] = x[0]), x[1] < j[0][1] && (j[0][1] = x[1]), x[1] > j[1][1] && (j[1][1] = x[1]));
            }), j;
          }), L = (O[1][0] - O[0][0]) / G, F = (O[1][1] - O[0][1]) / G, H = Z.reduce((X, j, x) => {
            const V = lt(j[0][0], O[0][0], L, G), st = lt(j[1][0], O[0][0], L, G), gt = lt(j[0][1], O[0][1], F, G), ct = lt(j[1][1], O[0][1], F, G);
            ...
            let j = [];
            return c(X)[0].map((x) => {
              k.length === 0 ? k = [Array.from(x), Array.from(x)] : (x[0] < k[0][0] && (k[0][0] = x[0]), x[0] > k[1][0] && (k[1][0] = x[0]), x[1] < k[0][1] && (k[0][1] = x[1]), x[1] > k[1][1] && (k[1][1] = x[1])), j.length === 0 ? j = [Array.from(x), Array.from(x)] : (x[0] < j[0][0] && (j[0][0] = x[0]), x[0] > j[1][0] && (j[1][0] = x[0]), x[1] < j[0][1] && (j[0][1] = x[1]), x[1] > j[1][1] && (j[1][1] = x[1]));
            }), j;
          }), N = (k[1][0] - k[0][0]) / G, Q = (k[1][1] - k[0][1]) / G, $ = B.reduce((X, j, x) => {
            const V = lt(j[0][0], k[0][0], N, G), st = lt(j[1][0], k[0][0], N, G), gt = lt(j[0][1], k[0][1], Q, G), ct = lt(j[1][1], k[0][1], Q, G);
            for (let tt = V; tt <= st; tt++) {
              X[tt] || (X[tt] = []);
              for (let Ct = gt; Ct <= ct; Ct++) X[tt][Ct] || (X[tt][Ct] = []), X[tt][Ct].push(x);
            }
          ...
          this.indexedTins = { forw: { gridNum: G, xOrigin: O[0][0], yOrigin: O[0][1], xUnit: L, yUnit: F, gridCache: H }, bakw: { gridNum: G, xOrigin: k[0][0], yOrigin: k[0][1], xUnit: N, yUnit: Q, gridCache: $ } };
        }
        transform(y, P, R) {
          ...
          const O = P ? this.tins.bakw : this.tins.forw, k = P ? this.indexedTins.bakw : this.indexedTins.forw, Z = P ? this.vertices_params.bakw : this.vertices_params.forw, L = P ? this.centroid.bakw : this.centroid.forw, F = P ? this.pointsWeightBuffer.bakw : this.pointsWeightBuffer.forw;
          let H, B;
...
class mr extends vo {
  ...
  static async createAsync(e) {
    ...
    return qr(A), Ir(
      ...
      const g = o + 1, a = `Illst:${r.mapID}#${g}`, I = r.tins[g], C = new En({
        code: a,
...
if (Bt.arrayBuffer)
  var mc = [
    ...
    "[object Float32Array]",
    "[object Float64Array]"
  ], yc = ArrayBuffer.isView || function(i) {
    return i && mc.indexOf(Object.prototype.toString.call(i)) > -1;
  };
function on(i) {
  ...
  return new Promise(function(e, n) {
    ...
    if (A.open(r.method, o(r.url), !0), r.credentials === "include" ? A.withCredentials = !0 : r.credentials === "omit" && (A.withCredentials = !1), "responseType" in A && (Bt.blob ? A.responseType = "blob" : Bt.arrayBuffer && (A.responseType = "arraybuffer")), t && typeof t.headers == "object" && !(t.headers instanceof vt || Mt.Headers && t.headers instanceof Mt.Headers)) {
      ...
      Object.getOwnPropertyNames(t.headers).forEach(function(a) {
        g.push(on(a)), A.setRequestHeader(a, ji(t.headers[a]));
...
async function Oc(i, t) {
  if (typeof i == "string" && (i = Sc[i]), i = te(Object.assign(i, t)), i.label = i.label || i.year, Cs(i.maptype)) {
    const e = i.maptype === "base" ? rn : i.maptype === "overlay" ? Bn : i.maptype === "mapbox" ? Sn : i.maptype === "maplibre" ? On : ai;
      ...
      if (this.status === 200 || this.status === 0)
        try {
          ...
          if (typeof o != "object" && (o = JSON.parse(o)), i = te(Object.assign(o, i)), i.label = i.label || o.year, i.translator && (i.url = i.translator(i.url)), i.maptype || (i.maptype = "maplat"), Cs(i.maptype)) {
            const g = i.maptype === "base" ? rn : i.maptype === "overlay" ? Bn : i.maptype === "mapbox" ? Sn : i.maptype === "maplibre" ? On : ai;
...
function Bc() {
  return hs || (hs = 1, (function(i, t) {
    ...
    var Ee = {
      ...
      "\u2028": "u2028",
      "\u2029": "u2029"
    }, Me = typeof globalThis == "object" && globalThis && globalThis.Object === Object && globalThis, Xe = typeof self == "object" && self && self.Object === Object && self, gn = Me || Xe || Function("return this")(), Xn = t && !t.nodeType && t, le = Xn && !0 && i && !i.nodeType && i, Zn = le && le.exports === Xn, an = Zn && Me.process, Fn = (function() {
      try {
    ...
    var G = Function.prototype, O = Object.prototype, k = gn["__core-js_shared__"], Z = G.toString, L = O.hasOwnProperty, F = (function() {
      var f = /[^.]+$/.exec(k && k.keys && k.keys.IE_PROTO || "");
      return f ? "Symbol(src)_1." + f : "";
    })(), H = O.toString, B = Z.call(Object), N = RegExp(
      "^" + Z.call(L).replace(Ge, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
    ), Q = Zn ? gn.Buffer : void 0, $ = gn.Symbol, X = R(Object.getPrototypeOf, Object), j = O.propertyIsEnumerable, x = $ ? $.toStringTag : void 0, V = (function() {
      try {
    ...
    function Tt(f, E) {
      ...
      for (var Ft in f)
        (E || L.call(f, Ft)) && !(Zt && // Safari 9 has enumerable `arguments.length` in strict mode.
    ...
    function Gt(f, E, S) {
      var K = f[E];
      (!(L.call(f, E) && Br(K, S)) || S === void 0 && !(E in f)) && Lt(f, E, S);
    }
    function Lt(f, E, S) {
      E == "__proto__" && V ? V(f, E, {
        configurable: !0,
    ...
    function Or(f) {
      ...
      for (var S in Object(f))
        L.call(f, S) && S != "constructor" && E.push(S);
      return E;
    }
    function Dr(f) {
      if (!Qn(f))
      ...
      var E = Ui(f), S = [];
      for (var K in f)
        K == "constructor" && (E || !L.call(f, K)) || S.push(K);
      return S;
    }
    function Ni(f, E) {
    ...
    function Lo(f, E, S, K) {
      ...
      for (var yt = -1, Zt = E.length; ++yt < Zt; ) {
        ...
        Kt === void 0 && (Kt = f[ft]), ot ? Lt(S, ft, Kt) : Gt(S, ft, Kt);
      }
      return S;
    }
    function jo(f) {
    ...
    function Xi(f, E, S, K) {
      return f === void 0 || Br(f, O[S]) && !L.call(K, S) ? E : f;
    }
    function ko(f, E) {
      var S = P(f, E);
    ...
    var Qo = Yt(/* @__PURE__ */ (function() {
      ...
      return Ze(f) && L.call(f, "callee") && !j.call(f, "callee");
    }, zi = Array.isArray;
    function Tr(f) {
    ...
    function Vo(f) {
      ...
      if (E === null)
        return !0;
      var S = L.call(E, "constructor") && E.constructor;
    ...
    function $o(f, E, S) {
      ...
      var ot = Vi({}, E.imports, K.imports, Xi), yt = qo(ot), Zt = d(ot, yt), ft, Kt, Ft = 0, Ki = E.interpolate || Vt, jt = "__p += '", rg = RegExp(
        (E.escape || Vt).source + "|" + Ki.source + "|" + (Ki === e ? Ae : Vt).source + "|" + (E.evaluate || Vt).source + "|$",
        "g"
      ), ig = L.call(E, "sourceURL") ? "//# sourceURL=" + (E.sourceURL + "").replace(/[\r\n]/g, " ") + `
` : "";
      f.replace(rg, function(Ji, qi, Vn, Ag, _i, $i) {
        return Vn || (Vn = Ag), jt += f.slice(Ft, $i).replace(oe, y), qi && (ft = !0, jt += `' +
__e(` + qi + `) +
'`), _i && (Kt = !0, jt += `';
` + _i + `;
__p += '`), Vn && (jt += `' +
...
`;
      var Lr = L.call(E, "variable") && E.variable;
      Lr || (jt = `with (obj) {
` + jt + `
}
`), jt = (Kt ? jt.replace(we, "") : jt).replace(pt, "$1").replace(xt, "$1;"), jt = "function(" + (Lr || "obj") + `) {
` + (Lr ? "" : `obj || (obj = {});
...
`) + jt + `return __p
      ...
      var Wn = tg(function() {
        return Function(yt, ig + "return " + jt).apply(void 0, Zt);
      });
      if (Wn.source = jt, Hi(Wn))
        throw Wn;
      return Wn;
    }
...
var Tc = Bc();
const So = /* @__PURE__ */ js(Tc);
function fs(i, ...t) {
  const e = te(Object.assign({}, i));
  if (e.icon) return e;
...
function ds(i, ...t) {
  return i = te(i), i.html ? i : t.reduce((e, n) => {
    if (e) return e;
    const r = n.poiTemplate;
    if (r)
      return i.html = So(r)(i), i.poiStyle = i.poiStyle || n.poiStyle, i;
  }, void 0) || i;
}
const wt = {
  ACCURACY: "accuracy",
...
class Tn extends Hs {
      ...
      if (e)
        if (!this.alwaysGpsOn)
          ...
          if (r && A) {
            ...
            (async () => await a.setGPSMarkerAsync({ lnglat: r, acc: A }, !1) || (a.setGPSMarker(), this.dispatchEvent(new ln({ error: "gps_out" }))))();
          }
        }
  ...
  handleI18n(e, n) {
    ...
    return Os(this.appData.pois || [], this).then(
  ...
  setMarker(e) {
    ...
    const n = e.lnglat || [
      e.lng || e.longitude,
      e.lat || e.latitude
    ], r = e.x, A = e.y, s = e.coordinates, o = this.from, g = e.icon ? this.__selectedMarker == e.namespaceID && e.selectedIcon ? e.selectedIcon : e.icon : this.__selectedMarker == e.namespaceID ? Do : Bi;
    return (s ? (function() {
  ...
  updateMarker(e, n, r) {
    ...
    A && (n = yn(n || {}), r ? (Object.keys(A).map((s) => {
    ...
    return this.changeMapSeq || (this.changeMapSeq = Promise.resolve()), this.changeMapSeq = this.changeMapSeq.then(
      () => new Promise((s, o) => {
        this.convertParametersFromCurrent(A, (g) => {
          ...
          if (this.backMap && (a = this.backMap.getSource(), A.isWmts() ? this.backMap.exchangeSource() : (C ? (I = C, this.backMap.exchangeSource(I)) : a ? I = a : (I = r, this.from.isWmts() && (I = this.from instanceof Bn ? this.mapObject.getSource() : (
...
if (typeof window < "u") {
  ...
  window.Maplat = i, window.MaplatApp = Tn, window.assets = Nc;
}
var or = { exports: {} }, ps;
function Zc() {
...
var Bo = Zc();
const Fc = /* @__PURE__ */ js(Bo), Uc = /* @__PURE__ */ lg({
  __proto__: null,
  default: Fc
}, [Bo]);
export {
