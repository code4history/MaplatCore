...
class Fi extends Gs(Ug) {
  constructor(t = {}) {
    const e = Object.assign({}, t), { mapType: n, layerTypes: i } = Ja(t.maptype, t.layers);
...
class qr extends OA {
  ...
  applyOptions_(t) {
    ...
    const i = gI(t), r = n.constraint, s = aI(t);
    this.constraints_ = {
      center: i,
      resolution: r,
      rotation: s
  ...
  animateInternal(t) {
    ...
    for (; i < e; ++i) {
      ...
      II(c) ? c.complete = !0 : r += c.duration, a.push(c);
    }
...
function oI(A) {
  ...
  if (!a && !v && h.isGlobal() && (b = !1, v = m), A.resolutions !== void 0) {
    ...
    e = T[s], n = T[g] !== void 0 ? T[g] : T[T.length - 1], A.constrainResolution ? t = AI(
      T,
      I,
      !b && v,
      c
    ...
    )) / sI / Math.pow(2, mi), Z = O / Math.pow(2, 28 - mi);
    ...
    ), n = e / Math.pow(o, g - s), A.constrainResolution ? t = nI(
      o,
      e,
      n,
      I,
...
function aI(A) {
  if (A.enableRotation !== void 0 ? A.enableRotation : !0) {
    ...
    return e === void 0 || e === !0 ? rI() : e === !1 ? Jr : typeof e == "number" ? iI(e) : Jr;
  }
  return ar;
}
function II(A) {
...
class Ig extends cI {
  ...
  isVisible(t) {
    ...
    return lI(i, e.viewState) && (!r || Ki(r, e.extent));
  }
  /**
...
class Ge extends jg {
  ...
  static spawnLayer(t, e, n) {
    return e instanceof Vn || e instanceof _n || !(t instanceof hi) ? (e instanceof Vn ? t = new hI({
      style: e.style,
      accessToken: e.accessToken,
      container: n,
      source: e
    }) : e instanceof _n ? t = new uI({
      style: e.style,
      container: n,
      source: e
    }) : (t = new hi({
...
const AA = typeof navigator < "u" && typeof navigator.userAgent < "u" ? navigator.userAgent.toLowerCase() : "", MI = AA.includes("safari") && !AA.includes("chrom");
MI && (AA.includes("version/15.4") || /cpu (os|iphone os) 15_4 like mac os x/.test(AA));
const RI = AA.includes("webkit") && !AA.includes("edge"), hg = AA.includes("macintosh");
...
const TI = function(A) {
  ...
  const t = A.originalEvent;
  return "pointerId" in t && t.button == 0 && !(RI && hg && t.ctrlKey);
}, dg = function(A) {
  const t = (
...
class OI extends LA {
  ...
  constructor(t) {
    ...
    const e = t.condition ? t.condition : Ui(dg, BI);
...
class LI extends LA {
  ...
  constructor(t) {
    t = t || {}, super({
      stopDown: $n
    }), this.condition_ = t.condition ? t.condition : SI, this.lastAngle_ = void 0, this.duration_ = t.duration !== void 0 ? t.duration : 250;
  }
  /**
   * Handle pointer drag events.
   * @param {import("../MapBrowserEvent.js").default} mapBrowserEvent Event.
...
class NI extends LA {
   ...
   */
  constructor(t) {
    super(), this.on, this.once, this.un, t = t ?? {}, this.box_ = new kI(t.className || "ol-dragbox"), this.minArea_ = t.minArea ?? 64, t.onBoxEnd && (this.onBoxEnd = t.onBoxEnd), this.startPixel_ = null, this.condition_ = t.condition ?? fg, this.boxEndCondition_ = t.boxEndCondition ?? this.defaultBoxEndCondition;
  }
  /**
  ...
  handleEvent(t) {
    ...
    if (t.type == Ze.KEYDOWN) {
      ...
      if (this.condition_(t) && (i == _e.DOWN || i == _e.LEFT || i == _e.RIGHT || i == _e.UP)) {
        ...
        const I = [o, a];
        qi(I, s.getRotation()), wI(s, I, this.duration_), n.preventDefault(), e = !0;
      }
    }
    return !e;
  }
...
function es(A) {
  A = A || {};
  const t = new bI(), e = new EI(-5e-3, 0.05, 100);
  return (A.altShiftDragRotate === void 0 || A.altShiftDragRotate) && t.push(new LI()), (A.doubleClickZoom === void 0 || A.doubleClickZoom) && t.push(
    new vI({
      delta: A.zoomDelta,
  ...
  ), (A.pinchRotate === void 0 || A.pinchRotate) && t.push(new WI()), (A.pinchZoom === void 0 || A.pinchZoom) && t.push(
    new HI({
      duration: A.zoomDuration
    })
  ), (A.keyboard === void 0 || A.keyboard) && (t.push(new XI()), t.push(
    new jI({
      delta: A.zoomDelta,
      duration: A.zoomDuration
    })
...
const _I = /\{z\}/g, KI = /\{x\}/g, JI = /\{y\}/g, qI = /\{-y\}/g;
function $I(A, t, e, n, i) {
  return A.replace(_I, t.toString()).replace(KI, e.toString()).replace(JI, n.toString()).replace(qI, function() {
    throw new Error(
...
async function dC(A, t) {
  if (typeof A == "string" && (A = { ...fC[A] }), A = fe(Object.assign(A, t)), A.label = A.label || A.year, is(A.maptype)) {
...
const Dg = Object.entries, Cs = Object.setPrototypeOf, PC = Object.isFrozen, xC = Object.getPrototypeOf, DC = Object.getOwnPropertyDescriptor;
...
const yA = Mt(Array.prototype.forEach), BC = Mt(Array.prototype.lastIndexOf), cs = Mt(Array.prototype.pop), wA = Mt(Array.prototype.push), OC = Mt(Array.prototype.splice), Xe = Array.isArray, JA = Mt(String.prototype.toLowerCase), Ri = Mt(String.prototype.toString), ls = Mt(String.prototype.match), WA = Mt(String.prototype.replace), hs = Mt(String.prototype.indexOf), LC = Mt(String.prototype.trim), kC = Mt(Number.prototype.toString), NC = Mt(Boolean.prototype.toString), us = typeof BigInt > "u" ? null : Mt(BigInt.prototype.toString), fs = typeof Symbol > "u" ? null : Mt(Symbol.prototype.toString), xt = Mt(Object.prototype.hasOwnProperty), HA = Mt(Object.prototype.toString), Pt = Mt(RegExp.prototype.test), Ke = GC(TypeError);
function Mt(A) {
  return function(t) {
...
function jt(A) {
  ...
  for (const n of Dg(A)) {
    var e = TC(n, 2);
    const i = e[0], r = e[1];
    xt(A, i) && (Xe(r) ? t[i] = XC(r) : r && typeof r == "object" && r.constructor === Object ? t[i] = jt(r) : t[i] = r);
  }
  return t;
}
function jC(A) {
...
function Og() {
  let A = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : tc();
  const t = (X) => Og(X);
  ...
  const NA = zC, Fe = WC, rA = HC, sA = QC, Ue = YC, gA = VC, oA = _C, GA = JC;
  let aA = ws, gt = null;
  ...
  const IA = e.createElement("form"), CA = function(l) {
    ...
    Lt && Lt(l), Vt = l;
  }, ln = rt({}, [...Ti, ...Si, ...FC]), hn = rt({}, [...Pi, ...UC]), un = function(l, w, C) {
  ...
  const pn = function(l, w) {
    ...
    if ((U ? U(l) : l.nodeType) === te.element && !fn(l) || (C === "noscript" || C === "noembed" || C === "noframes") && Pt(qC, l.innerHTML))
      return re(l), !0;
  ...
  return t.sanitize = function(X) {
    ...
    if (J = !X, J && (X = "<!-->"), typeof X != "string" && !Ye(X) && (X = jC(X), typeof X != "string"))
    ...
    return qt && gt["!doctype"] && w.ownerDocument && w.ownerDocument.doctype && w.ownerDocument.doctype.name && Pt(KC, w.ownerDocument.doctype.name) && (q = "<!DOCTYPE " + w.ownerDocument.doctype.name + `>
` + q), Ft && (q = De(q)), tt && u ? wt(q) : q;
    ...
    if (xt(Ct, X)) {
      if (l !== void 0) {
        const w = BC(Ct[X], l);
        return w === -1 ? void 0 : OC(Ct[X], w, 1)[0];
      }
      return cs(Ct[X]);
    }
...
var Ac = Og();
const nc = ["b", "strong", "i", "em", "u", "s", "br", "p", "span", "div", "ul", "ol", "li", "a", "img", "small", "sub", "sup", "code", "pre", "table", "thead", "tbody", "tr", "th", "td"], ic = ["href", "src", "alt", "title", "class", "target", "rel", "width", "height"], rc = { values: ["target", "rel", "width", "height"] }, sc = ["script", "style", "iframe", "object", "embed", "form", "input", "textarea", "link", "meta", "base"], gc = ["srcdoc", "style", "formaction", "xlink:href"], oc = { valueAttributes: ["image-url", "image-type", "thumbnail-url", "caption", "material-url", "camera-position", "camera-target", "show-texture"], booleanAttributes: ["fit-to-container", "debug-mode"], urlAttributes: ["image-url", "thumbnail-url", "material-url"], textAttributes: { values: ["caption"] } }, Te = {
  tags: nc,
  attributes: ic,
  uriSafeAttributes: rc,
  forbidTags: sc,
  forbidAttributes: gc,
  slide: oc
}, ac = Te.tags, Ic = Te.attributes, Cc = /^(?:https?|mailto|tel|data):/i, cc = Te.uriSafeAttributes.values, lc = Te.forbidTags, hc = Te.forbidAttributes, uc = /^data:image\/(png|jpeg|gif|webp|avif);/i, Ms = (A) => !!A && /^\s*data:/i.test(A);
function fc(A) {
  if (A.tagName === "A" && A.getAttribute("target") === "_blank" && A.setAttribute("rel", "noopener noreferrer"), A.tagName === "IMG") {
    ...
    Ms(e) && !uc.test(e.trim()) && A.removeAttribute("src"), A.hasAttribute("srcset") && A.removeAttribute("srcset");
  } else
...
function Lg() {
  ...
  return QA = Ac(A), QA.addHook("afterSanitizeAttributes", fc), QA;
}
function kc(A) {
...
const pc = new Set(Te.slide.valueAttributes), yc = new Set(Te.slide.booleanAttributes), wc = new Set(Te.slide.textAttributes.values), bc = new Set(Te.slide.urlAttributes), Ec = (A) => /^(?:https?:)?\/\/|^\/|^[^:]*$/i.test(A.trim()), vc = /["'`<>\s]/;
function Nc(A) {
  const t = [];
  for (const [e, n] of Object.entries(A || {})) {
    ...
    if (!pc.has(i) || n == null) continue;
    let r = String(n);
    bc.has(i) && (!Ec(r) || vc.test(r)) || (wc.has(i) && (r = mc(r)), t.push(`${i}="${dc(r)}"`));
  }
  return t.join(" ");
}
const Mc = {
...
class qn extends Ws {
  ...
  async runLifecyclePhase(t, e) {
    ...
    const n = this.buildLifecycleContext(t, e), i = Rc[t], r = this.uiHooks?.[i];
    if (r)
      try {
        const s = await r(n);
  ...
  initGeolocation(t) {
    ...
    const e = this.geolocation = new EC({
      timerBase: t.fake,
    ...
    this.alwaysGpsOn ? (e.setTracking(!0), this.gpsEnabled_ = !0, this.initialGpsMove_ = !0) : (e.setTracking(!1), this.gpsEnabled_ = !1), e.on("change", () => {
      ...
      (s ? s.getSource() : g.getSource()).setGPSMarker(), this.dispatchEvent(new Tc(i === 1 ? "user_gps_deny" : i === 2 ? "gps_miss" : "gps_timeout")), this.dispatchEvent(new YA({ error: "gps_off" }));
  ...
  handleGPS(t, e = !1) {
    if (this.geolocation) {
      if (t)
        if (!this.alwaysGpsOn)
          this.firstGpsRequest_ = !0, this.geolocation.setTracking(!0), this.gpsEnabled_ = !0, this.dispatchEvent(new Sc());
        else {
...
if (typeof window < "u") {
  ...
  window.Maplat = A, window.MaplatApp = qn, window.assets = Mc;
}
export {
  zt as CustomEvent,
  Tc as GPSErrorEvent,
  Sc as GPSRequestEvent,
  YA as GPSResultEvent,
  qn as MaplatApp,
  Ge as MaplatMap,
  Mc as assets,
  Nc as buildSlideAttrs,
  UA as createElement,
  dc as escapeAttr,
