import { transform as Bt, toLonLat as kn, Projection as Zr, addProjection as vn, addCoordinateTransforms as kA, getTransform as on, identityTransform as In } from "ol/proj";
import { View as Ig, Map as Lr, Feature as jr } from "ol";
import { Vector as MA, Group as Nr, Tile as Cn } from "ol/layer";
import { XYZ as Cg, Google as zr, Vector as bA } from "ol/source";
import { Style as Lt, Icon as xe, Stroke as Mn, Fill as bn } from "ol/style";
class Vt {
  /**
...
var We = { exports: {} }, Wr = We.exports, mi;
function Vr() {
  return mi || (mi = 1, (function(n, t) {
    (function(e, A) {
      A(t);
    })(Wr, (function(e) {
      function A(h, l, u = {}) {
      ...
      function gt(h, l) {
        ...
        for (u = 0; u < U; u++) {
          ...
          if (Z = O[0], Z[0] !== O[G][0] && Z[1] !== O[G][1]) throw new Error("First and last coordinates in a ring must be the same");
          for (R = Z[0] - D, B = Z[1] - L, m; m < G; m++) {
      ...
      class ft {
        ...
        addIndexedTin() {
          ...
          const B = u.features.map((O) => {
            ...
            let G = [];
            return I(O)[0].map((x) => {
              R.length === 0 ? R = [Array.from(x), Array.from(x)] : (x[0] < R[0][0] && (R[0][0] = x[0]), x[0] > R[1][0] && (R[1][0] = x[0]), x[1] < R[0][1] && (R[0][1] = x[1]), x[1] > R[1][1] && (R[1][1] = x[1])), G.length === 0 ? G = [Array.from(x), Array.from(x)] : (x[0] < G[0][0] && (G[0][0] = x[0]), x[0] > G[1][0] && (G[1][0] = x[0]), x[1] < G[0][1] && (G[0][1] = x[1]), x[1] > G[1][1] && (G[1][1] = x[1]));
            }), G;
      ...
      class ee {
        ...
        merc2XyWithLayer(l) {
          return this._assertMapData(), this._getAllTinsWithIndex().map(({ index: u, tin: m, isMain: v }) => {
            ...
            return !u.length || !u[0] ? [[B, P, R]] : (u.push([B, P, R]), u.sort((k, Z) => {
              const E = k[2].importance ?? 0, D = Z[2].importance ?? 0;
              return E < D ? 1 : -1;
            }).filter((k, Z) => Z < 2));
          }, []).map((u) => {
            if (u) return [u[0], u[1]];
...
async function cg(n, t) {
  if (n = await pi(n), Array.isArray(n))
    n = await Promise.all(n.map(async (e) => await pi(e))), n.length > 0 && n[0].type === "FeatureCollection" ? n = n.reduce((e, A, i) => {
      let g = A.id || A.properties && A.properties.id;
      if (!g)
        if (i === 0) g = "main";
...
const $r = (3 + 16 * Wt) * Wt, ts = (2 + 12 * Wt) * Wt, es = (9 + 64 * Wt) * Wt * Wt, fe = rA(4), vi = rA(8), Mi = rA(12), bi = rA(16), wt = rA(4);
...
function gs(n, t, e = {}) {
  ...
  const A = Kr(n), i = Jr(t), g = i.type, r = t.bbox;
  let s = i.coordinates;
  if (r && rs(A, r) === !1)
    return !1;
  g === "Polygon" && (s = [s]);
  ...
  for (let i = 0; i < A.length; i++)
    for (let g = 0; g < A[i].length; g++) {
      ...
      for (let o = 0; o < A[i][g].length - 1; o++) {
        s = A[i][g][o + 1];
        const I = new Ei(r, EA, RA, xA), C = new Ei(s, EA, RA, xA + 1);
        I.otherEvent = C, C.otherEvent = I, dg(I, C) > 0 ? (C.isLeftEndpoint = !0, I.isLeftEndpoint = !1) : (I.isLeftEndpoint = !0, C.isLeftEndpoint = !1), t.push(I), t.push(C), r = s, xA = xA + 1;
      }
    }
  EA = EA + 1;
}
  ...
  class t extends n {
    ...
    addPoi(A, i) {
      if (i || (i = "main"), this.pois[i])
        return A = Je(A), this.pois[i].pois.push(A), On(this.pois, i, {
          name: this.officialTitle || this.title,
          namespace: this.mapID
        }), A.namespaceID;
    }
...
function pg(n) {
  class t extends mg(n) {
    ...
    static isWmts_ = !0;
    insideCheckXy(A) {
      return this.envelope ? gs(A, this.envelope) : !0;
    }
    ...
    modulateXyInside(A) {
      ...
      const i = Yr([A, this.centroid]), g = us(this.envelope, i);
...
function Ms(n) {
  ...
  return function() {
    ...
    return (!e || this !== A || !ws(i, e)) && (A = this, e = i, t = n.apply(this, arguments)), t;
  };
}
function Eg(n) {
  for (const t in n)
...
class Rg extends wg {
   ...
   */
  disposeInternal() {
    this.listeners_ && Eg(this.listeners_);
  }
  /**
  ...
  removeEventListener(t, e) {
    ...
    if (!A)
      return;
    const i = A.indexOf(e);
    i !== -1 && (this.pendingRemovals_ && t in this.pendingRemovals_ ? (A[i] = En, ++this.pendingRemovals_[t]) : (A.splice(i, 1), A.length === 0 && delete this.listeners_[t]));
  }
}
Ig.prototype.getDecimalZoom = function() {
...
function VA(n, t, e, A, i) {
  return i ? (i[0] = n, i[1] = t, i[2] = e, i[3] = A, i) : [n, t, e, A];
}
function Pg(n) {
  return VA(1 / 0, 1 / 0, -1 / 0, -1 / 0, n);
}
function Rs(n, t) {
  const e = n[0], A = n[1];
  return VA(e, A, e, A, t);
}
function xs(n, t, e, A, i) {
  const g = Pg(i);
  return Sg(g, n, t, e, A);
}
function Sg(n, t, e, A, i) {
  for (; e < A; e += i)
    Ps(n, t[e], t[e + 1]);
  return n;
}
...
function Dg(n, t) {
  let e;
  return e = t(Ss(n)), e || (e = t(Ds(n)), e) || (e = t(ks(n)), e) || (e = t(Gs(n)), e) ? e : !1;
}
function Ss(n) {
  return [n[0], n[1]];
}
...
function Bs(n, t, e, A, i) {
  const [g, r, s, o, I, C, a, c] = Ts(
    n,
    t,
    e,
    A
...
let Zs = 0;
function Ls(n) {
  return n.ol_uid || (n.ol_uid = String(++Zs));
}
const js = {
  /**
...
class De extends HA {
   ...
   */
  constructor(t) {
    super(), this.on, this.once, this.un, Ls(this), this.values_ = null, t !== void 0 && this.setProperties(t);
  }
  /**
   * Gets a value.
  ...
  notify(t, e) {
    let A;
    A = `change:${t}`, this.hasListener(A) && this.dispatchEvent(new Bi(A, t, e)), A = js.PROPERTYCHANGE, this.hasListener(A) && this.dispatchEvent(new Bi(A, t, e));
  }
  /**
   * @param {string} key Key name.
   * @param {import("./events.js").Listener} listener Listener.
...
const sA = 6378137, we = Math.PI * sA, Ws = [-we, -we, we, we], Vs = [-180, -85, 180, 85], PA = sA * Math.log(Math.tan(Math.PI / 2));
class de extends tA {
  /**
...
let Pn = {};
function qs(n) {
  return Pn[n] || Pn[n.replace(/urn:(x-)?ogc:def:crs:EPSG:(.*:)?(\w+)$/, "EPSG:$3")] || null;
}
function _s(n, t) {
  Pn[n] = t;
}
...
const ZA = 0.9996, kt = 669438e-8, YA = kt * kt, KA = YA * kt, se = kt / (1 - kt), Xi = Math.sqrt(1 - kt), Pe = (1 - Xi) / (1 + Xi), Gg = Pe * Pe, zn = Gg * Pe, Fn = zn * Pe, kg = Fn * Pe, Og = 1 - kt / 4 - 3 * YA / 64 - 5 * KA / 256, $s = 3 * kt / 8 + 3 * YA / 32 + 45 * KA / 1024, to = 15 * YA / 256 + 45 * KA / 1024, eo = 35 * KA / 3072, Ao = 3 / 2 * Pe - 27 / 32 * zn + 269 / 512 * kg, no = 21 / 16 * Gg - 55 / 32 * Fn, io = 151 / 96 * zn - 417 / 128 * kg, go = 1097 / 512 * Fn, LA = 6378137;
function ro(n, t, e) {
  const A = n - 5e5, r = (e.north ? t : t - 1e7) / ZA / (LA * Og), s = r + Ao * Math.sin(2 * r) + no * Math.sin(4 * r) + io * Math.sin(6 * r) + go * Math.sin(8 * r), o = Math.sin(s), I = o * o, C = Math.cos(s), a = o / C, c = a * a, d = c * c, p = 1 - kt * I, y = Math.sqrt(1 - kt * I), b = LA / y, T = (1 - kt) / p, X = se * C ** 2, z = X * X, j = A / (b * ZA), W = j * j, q = W * j, nt = q * j, H = nt * j, st = H * j, ot = s - a / T * (W / 2 - nt / 24 * (5 + 3 * c + 10 * X - 4 * z - 9 * se)) + st / 720 * (61 + 90 * c + 298 * X + 45 * d - 252 * se - 3 * z);
...
function Io(n, t, e) {
  n = xn(n, so, oo), t < Zi ? t = Zi : t > Li && (t = Li);
  const A = be(t), i = Math.sin(A), g = Math.cos(A), r = i / g, s = r * r, o = s * s, I = be(n), C = Xg(e.number), a = be(C), c = LA / Math.sqrt(1 - kt * i ** 2), d = se * g ** 2, p = g * xn(I - a, -Math.PI, Math.PI), y = p * p, b = y * p, T = b * p, X = T * p, z = X * p, j = LA * (Og * A - $s * Math.sin(2 * A) + to * Math.sin(4 * A) - eo * Math.sin(6 * A)), W = ZA * c * (p + b / 6 * (1 - s + d) + X / 120 * (5 - 18 * s + o + 72 * d - 58 * se)) + 5e5;
  let q = ZA * (j + c * r * (y / 2 + T / 24 * (5 - s + 9 * d + 4 * d ** 2) + z / 720 * (61 - 58 * s + o + 600 * d - 330 * se)));
...
function Jt(n, t) {
  return Sn && !XA(n, [0, 0]) && n[0] >= -180 && n[0] <= 180 && n[1] >= -90 && n[1] <= 90 && (Sn = !1, zs(
...
class Po extends De {
   ...
   */
  containsXY(t, e) {
    return this.closestPointXY(t, e, xo, Number.MIN_VALUE) === 0;
  }
  /**
  ...
  getExtent(t) {
    if (this.extentRevision_ != this.getRevision()) {
      ...
      (isNaN(e[0]) || isNaN(e[1])) && Pg(e), this.extentRevision_ = this.getRevision();
    }
    return Os(this.extent_, t);
  }
  /**
...
class oA extends Po {
   ...
   */
  scale(t, e, A) {
    e === void 0 && (e = t), A || (A = OA(this.getExtent()));
...
class Wn extends oA {
  ...
  intersectsExtent(t) {
    ...
    if (Ln(t, e)) {
      ...
      return t[0] <= A[0] && t[2] >= A[0] || t[1] <= A[1] && t[3] >= A[1] ? !0 : Dg(t, this.intersectsCoordinate.bind(this));
    }
    return !1;
  }
  /**
...
function Hn(n, t, e, A, i, g, r, s, o, I, C) {
  if (t == e)
    return I;
  let a, c;
  if (i === 0) {
...
function Go(n, t, e, A, i, g, r, s, o, I, C) {
  C = C || [NaN, NaN];
...
class nA extends oA {
   ...
   */
  closestPointXY(t, e, A, i) {
    return i < Xn(this.getExtent(), t, e) ? i : (this.maxDeltaRevision_ != this.getRevision() && (this.maxDelta_ = Math.sqrt(
      Vn(
        this.flatCoordinates,
        0,
        this.flatCoordinates.length,
    ...
    ), this.maxDeltaRevision_ = this.getRevision()), Hn(
      this.flatCoordinates,
      0,
      this.flatCoordinates.length,
      this.stride,
...
function Zo(n, t, e, A, i, g, r) {
  ...
  for (let C = 0; C < r; ++C)
    g[C] = s === void 0 ? NaN : o === void 0 ? n[s + C] : jn(n[s + C], n[s + A + C], o);
  return g;
}
function Lo(n, t, e, A, i, g) {
  if (e == t)
    return null;
  let r;
  if (i < n[t + A - 1])
...
function Kn(n, t, e, A, i, g) {
  return g = g ?? Sg(xg(), n, t, e, A), Ln(i, g) ? g[0] >= i[0] && g[2] <= i[2] || g[1] >= i[1] && g[3] <= i[3] ? !0 : Qg(
    n,
    t,
    e,
    A,
...
class jA extends oA {
  ...
  getCoordinateAtM(t, e) {
    return this.layout != "XYM" && this.layout != "XYZM" ? null : (e = e !== void 0 ? e : !1, Lo(
      this.flatCoordinates,
      0,
      this.flatCoordinates.length,
      this.stride,
...
class iA extends oA {
   ...
   */
  intersectsExtent(t) {
    return Es(t, this.flatCoordinates[0], this.flatCoordinates[1]);
  }
  /**
   * @param {!Array<*>} coordinates Coordinates.
   * @param {import("./Geometry.js").GeometryLayout} [layout] Layout.
...
class Ie extends oA {
  ...
  closestPointXY(t, e, A, i) {
    ...
    ), this.maxDeltaRevision_ = this.getRevision()), Go(
      this.flatCoordinates,
      0,
      this.ends_,
      this.stride,
  ...
  getCoordinates(t) {
    let e;
    return t !== void 0 ? (e = this.getOrientedFlatCoordinates().slice(), Vi(e, 0, this.ends_, this.stride, t)) : e = this.flatCoordinates, ko(e, 0, this.ends_, this.stride);
  }
  /**
...
function Jo(n, t, e, A) {
  ...
  (function(i, g, r, s) {
    if (i !== void 0) {
      const o = n[0], I = n[n.length - 1], C = e ? Jn(
        o,
        e,
        r,
        A
...
class qi extends De {
   ...
   */
  constructor(t) {
    super(), this.on, this.once, this.un, t = Object.assign({}, t), this.hints_ = [0, 0], this.animations_ = [], this.updateAnimationKey_, this.projection_ = Un(t.projection, "EPSG:3857"), this.viewportSize_ = [100, 100], this.targetCenter_ = null, this.targetResolution_, this.targetRotation_, this.nextCenter_ = null, this.nextResolution_, this.nextRotation_, this.cancelAnchor_ = void 0, t.projection && uo(), t.center && (t.center = Jt(t.center, this.projection_)), t.extent && (t.extent = SA(t.extent, this.projection_)), this.applyOptions_(t);
  }
  /**
  ...
  applyOptions_(t) {
    ...
    const i = eI(t), g = A.constraint, r = nI(t);
    this.constraints_ = {
      center: i,
      resolution: g,
      rotation: r
  ...
  animateInternal(t) {
    ...
    for (; i < e; ++i) {
      ...
      if (C.center && (a.sourceCenter = r, a.targetCenter = C.center.slice(), r = a.targetCenter), C.zoom !== void 0 ? (a.sourceResolution = s, a.targetResolution = this.getResolutionForZoom(C.zoom), s = a.targetResolution) : C.resolution && (a.sourceResolution = s, a.targetResolution = C.resolution, s = a.targetResolution), C.rotation !== void 0) {
        a.sourceRotation = o;
        const c = Rn(C.rotation - o + Math.PI, 2 * Math.PI) - Math.PI;
  ...
  cancelAnimations() {
    ...
    for (let e = 0, A = this.animations_.length; e < A; ++e) {
      ...
      if (i[0].callback && DA(i[0].callback, !1), !t)
    ...
    for (let A = this.animations_.length - 1; A >= 0; --A) {
      ...
      for (let r = 0, s = i.length; r < s; ++r) {
        ...
        if (o.sourceRotation !== void 0 && o.targetRotation !== void 0) {
          const c = a === 1 ? Rn(o.targetRotation + Math.PI, 2 * Math.PI) - Math.PI : o.sourceRotation + a * (o.targetRotation - o.sourceRotation);
          if (o.anchor) {
  ...
  calculateCenterRotate(t, e) {
    ...
    return i !== void 0 && (A = [i[0] - e[0], i[1] - e[1]], Nn(A, t - this.getRotation()), Us(A, e)), A;
  }
  /**
  ...
  getCenter() {
    ...
    return t && Fi(t, this.getProjection());
  }
  /**
  ...
  calculateExtentInternal(t) {
    ...
    _t(e, "The view center is not defined");
    const A = (
      /** @type {!number} */
      this.getResolution()
    );
    _t(A !== void 0, "The view resolution is not defined");
    const i = (
      /** @type {!number} */
      this.getRotation()
    );
    return _t(i !== void 0, "The view rotation is not defined"), Bs(e, A, i, t);
  }
  /**
  ...
  fit(t, e) {
    ...
    if (_t(
      ...
      const i = SA(t, this.getProjection());
      A = Hi(i);
      ...
      A = Hi(i), A.rotate(this.getRotation(), OA(i));
    } else
      A = t;
  ...
  fitInternal(t, e) {
    ...
    const d = c[0] * a - c[1] * C, p = c[1] * a + c[0] * C, y = this.getConstrainedCenter([d, p], o), b = e.callback ? e.callback : En;
    e.duration !== void 0 ? this.animateInternal(
      ...
      b
    ) : (this.targetResolution_ = o, this.targetCenter_ = y, this.applyTargetState_(!1, !0), DA(b, !0));
  }
  /**
  ...
  calculateCenterShift(t, e, A, i) {
    ...
    if (r && t) {
      const s = this.getViewportSizeMinusPadding_(-A), o = un(
        t,
        i,
        [s[0] / 2 + r[3], s[1] / 2 + r[0]],
        e,
   ...
   */
  adjustCenter(t) {
    const e = Fi(this.targetCenter_, this.getProjection());
    this.setCenter([
      e[0] + t[0],
      e[1] + t[1]
    ]);
  ...
  applyTargetState_(t, e) {
    ...
    this.get(Ot.ROTATION) !== i && this.set(Ot.ROTATION, i), this.get(Ot.RESOLUTION) !== r && (this.set(Ot.RESOLUTION, r), this.set("zoom", this.getZoom(), !0)), (!s || !this.get(Ot.CENTER) || !XA(this.get(Ot.CENTER), s)) && this.set(Ot.CENTER, s), this.getAnimating() && !t && this.cancelAnimations(), this.cancelAnchor_ = void 0;
  }
  /**
  ...
  resolveConstraints(t, e, A) {
    ...
    A = A || (t === 0 ? this.cancelAnchor_ : void 0), this.cancelAnchor_ = void 0, (this.getResolution() !== s || this.getRotation() !== g || !this.getCenterInternal() || !XA(this.getCenterInternal(), o)) && (this.getAnimating() && this.cancelAnimations(), this.animateInternal({
      rotation: g,
      center: o,
      resolution: s,
      duration: t,
...
function eI(n) {
  ...
  const t = Un(n.projection, "EPSG:3857");
...
function AI(n) {
  let t, e, A, r = n.minZoom !== void 0 ? n.minZoom : hn, s = n.maxZoom !== void 0 ? n.maxZoom : 28;
  const o = n.zoomFactor !== void 0 ? n.zoomFactor : 2, I = n.multiWorld !== void 0 ? n.multiWorld : !1, C = n.smoothResolutionConstraint !== void 0 ? n.smoothResolutionConstraint : !0, a = n.showFullExtent !== void 0 ? n.showFullExtent : !1, c = Un(n.projection, "EPSG:3857"), d = c.getExtent();
  ...
  if (!I && !y && c.isGlobal() && (p = !1, y = d), n.resolutions !== void 0) {
    ...
    const T = (d ? Math.max(Zn(d), $e(d)) : (
      // use an extent that can fit the whole world if need be
      360 * Tg.degrees / c.getMetersPerUnit()
    )) / tI / Math.pow(2, hn), X = T / Math.pow(2, 28 - hn);
    ...
    ), A = e / Math.pow(o, s - r), n.constrainResolution ? t = qo(
      o,
      e,
      A,
      C,
...
function nI(n) {
  if (n.enableRotation !== void 0 ? n.enableRotation : !0) {
    ...
    return e === void 0 || e === !0 ? $o() : e === !1 ? Ji : typeof e == "number" ? _o(e) : Ji;
  }
  return _n;
}
function iI(n) {
  return !(n.sourceCenter && n.targetCenter && !XA(n.sourceCenter, n.targetCenter) || n.sourceResolution !== n.targetResolution || n.sourceRotation !== n.targetRotation);
}
function un(n, t, e, A, i) {
  const g = Math.cos(-i);
...
class rI extends De {
  ...
  constructor(t) {
    ...
    const e = Object.assign({}, t);
    typeof t.properties == "object" && (delete e.properties, Object.assign(e, t.properties)), e[_.OPACITY] = t.opacity !== void 0 ? t.opacity : 1, _t(
   ...
   */
  setOpacity(t) {
    _t(typeof t == "number", "Layer opacity must be a number"), this.set(_.OPACITY, t);
  }
  /**
...
class Vg extends rI {
  ...
  isVisible(t) {
    ...
    !t && A && (t = A.getView()), t instanceof qi ? e = {
    ...
    return sI(i, e.viewState) && (!g || Ln(g, e.extent));
  }
  /**
  ...
  getAttributions(t) {
    ...
    if (!e)
      return [];
    const A = t instanceof qi ? t.getViewStateAndExtent() : t;
    let i = e(A);
...
class oI extends Vg {
  constructor(t) {
    const e = function(A) {
      ...
      r.style.opacity = I;
      const C = s.rotation * -180 / Math.PI, a = kn(s.center), c = s.zoom - 1, d = g.getBearing(), p = g.getCenter().toArray(), y = g.getZoom();
...
class II extends Vg {
  constructor(t) {
    const e = function(A) {
      ...
      const d = kn(s.center), p = s.zoom - 1;
...
class gA extends Lr {
  ...
  static spawnLayer(t, e, A) {
    return e instanceof NA || e instanceof zA || !(t instanceof Cn) ? (e instanceof NA ? t = new oI({
      style: e.style,
      accessToken: e.accessToken,
      container: A,
      source: e
    }) : e instanceof zA ? t = new II({
      style: e.style,
      container: A,
      source: e
    }) : t = new Cn({
  ...
  setFeature(t, e, A) {
    const i = this.getSource(A), g = new jr(t);
  ...
  setVector(t, e = "Line", A, i) {
    i || (i = "feature");
    const g = {};
    A.stroke != null && (g.stroke = new Mn(A.stroke)), A.fill != null && (g.fill = new bn(A.fill));
    const r = new Lt(g), s = e === "Line" ? new jA(t) : new Ie(t);
  ...
  setFillEnvelope(t, e, A, i) {
    ...
    if (e != null || A != null) {
      const r = {};
      e != null && (r.stroke = new Mn(e)), A != null && (r.fill = new bn(A)), g = new Lt(r);
    }
    return this.setFeature(
      {
        geometry: new Ie([t])
  ...
  setTransparency(t) {
    ...
    A instanceof Se || A instanceof Bn ? (this.getLayers().item(0).setOpacity(1), this.getLayers().item(1).setOpacity(e)) : this.getLayers().item(0).setOpacity(e);
  }
  setGPSMarker(t, e) {
...
class fI extends IA {
  ...
  handleEvent(t) {
    ...
    if (t.type == Ve.DBLCLICK) {
      ...
      ti(s, r, g, this.duration_), A.preventDefault(), e = !0;
    }
    return !e;
  }
}
...
const pI = function(n) {
  ...
  return (e instanceof ShadowRoot ? e.host : t).hasAttribute("tabindex") ? wI(n) : !0;
}, vI = vs, _g = function(n) {
  const t = n.originalEvent;
  return "pointerId" in t && t.button == 0 && !(mI && Jg && t.ctrlKey);
}, $g = function(n) {
  const t = (
...
class RI extends Be {
   ...
   */
  constructor(t) {
    super(), this.on, this.once, this.un, t = t ?? {}, this.box_ = new EI(t.className || "ol-dragbox"), this.minArea_ = t.minArea ?? 64, t.onBoxEnd && (this.onBoxEnd = t.onBoxEnd), this.startPixel_ = null, this.condition_ = t.condition ?? _g, this.boxEndCondition_ = t.boxEndCondition ?? this.defaultBoxEndCondition;
  }
  /**
...
class xI extends Be {
  ...
  constructor(t) {
    ...
    const e = t.condition ? t.condition : Tn($g, bI);
    this.condition_ = t.onFocusOnly ? Tn(qg, e) : e, this.noKinetic_ = !1;
  }
  /**
   * Handle pointer drag events.
   * @param {import("../MapBrowserEvent.js").default} mapBrowserEvent Event.
  ...
  handleDragEvent(t) {
    ...
    const A = this.targetPointers, i = e.getEventPixel(ei(A));
    if (A.length == this.lastPointersCount_) {
      if (this.kinetic_ && this.kinetic_.update(i[0], i[1]), this.lastCentroid) {
        ...
        Qs(g, s.getResolution()), Nn(g, s.getRotation()), s.adjustCenterInternal(g);
      }
...
class PI extends Be {
  ...
  constructor(t) {
    t = t || {}, super({
      stopDown: WA
    }), this.condition_ = t.condition ? t.condition : yI, this.lastAngle_ = void 0, this.duration_ = t.duration !== void 0 ? t.duration : 250;
  }
  /**
   * Handle pointer drag events.
   * @param {import("../MapBrowserEvent.js").default} mapBrowserEvent Event.
  ...
  handleDragEvent(t) {
    if (!Re(t))
      return;
    const e = t.map, A = e.getView();
    if (A.getConstraints().rotation === _n)
      return;
...
class SI extends Be {
  ...
  constructor(t) {
    t = t || {}, super(
      ...
      t
    ), this.condition_ = t.condition ? t.condition : tr, this.lastAngle_ = void 0, this.lastMagnitude_ = void 0, this.lastScaleDelta_ = 0, this.duration_ = t.duration !== void 0 ? t.duration : 400;
  }
  /**
   * Handle pointer drag events.
   * @param {import("../MapBrowserEvent.js").default} mapBrowserEvent Event.
...
class DI extends RI {
  ...
  constructor(t) {
    t = t || {};
    const e = t.condition ? t.condition : tr;
    super({
      condition: e,
...
class BI extends De {
   ...
   */
  updateLength_() {
    this.set($i.LENGTH, this.array_.length);
  }
  /**
   * @private
   * @param {T} elem Element.
  ...
  handleEvent(t) {
    ...
    if (t.type == $t.KEYDOWN) {
      ...
      if (this.condition_(t) && (i == ne.DOWN || i == ne.LEFT || i == ne.RIGHT || i == ne.UP)) {
        ...
        const C = [o, I];
        Nn(C, r.getRotation()), uI(r, C, this.duration_), A.preventDefault(), e = !0;
      }
    }
    return !e;
  }
  ...
  handleEvent(t) {
    ...
    if (t.type == $t.KEYDOWN || t.type == $t.KEYPRESS) {
      ...
      if (this.condition_(t) && (i === "+" || i === "-")) {
        ...
        ti(s, r, void 0, this.duration_), A.preventDefault(), e = !0;
      }
    }
    return !e;
  }
...
class XI extends IA {
  ...
  constructor(t) {
    ...
    const e = t.condition ? t.condition : vI;
    this.condition_ = t.onFocusOnly ? Tn(qg, e) : e, this.lastAnchor_ = null, this.startTime_ = void 0, this.timeoutId_, this.mode_ = void 0, this.trackpadEventGap_ = 400, this.trackpadTimeoutId_, this.deltaPerZoom_ = 300;
  }
  /**
   * @private
   */
  ...
  handleWheelZoom_(t) {
    ...
    (e.getConstrainResolution() || this.constrainResolution_) && (A = A ? A > 0 ? 1 : -1 : 0), ti(
      e,
      A,
      this.lastAnchor_ ? t.getCoordinateFromPixel(this.lastAnchor_) : null,
      this.duration_
...
class ZI extends Be {
  ...
  constructor(t) {
    ...
    e.stopDown || (e.stopDown = WA), super(e), this.anchor_ = null, this.lastAngle_ = void 0, this.rotating_ = !1, this.rotationDelta_ = 0, this.threshold_ = t.threshold !== void 0 ? t.threshold : 0.3, this.duration_ = t.duration !== void 0 ? t.duration : 250;
  }
  /**
   * Handle pointer drag events.
   * @param {import("../MapBrowserEvent.js").default} mapBrowserEvent Event.
  ...
  handleDragEvent(t) {
    ...
    s.getConstraints().rotation !== _n && (this.anchor_ = r.getCoordinateFromPixelInternal(
...
class LI extends Be {
  ...
  constructor(t) {
    ...
    e.stopDown || (e.stopDown = WA), super(e), this.anchor_ = null, this.duration_ = t.duration !== void 0 ? t.duration : 400, this.lastDistance_ = void 0, this.lastScaleDelta_ = 1;
  }
  /**
   * Handle pointer drag events.
   * @param {import("../MapBrowserEvent.js").default} mapBrowserEvent Event.
...
function tg(n) {
  n = n || {};
  const t = new BI(), e = new jI(-5e-3, 0.05, 100);
  return (n.altShiftDragRotate === void 0 || n.altShiftDragRotate) && t.push(new PI()), (n.doubleClickZoom === void 0 || n.doubleClickZoom) && t.push(
    new fI({
      delta: n.zoomDelta,
  ...
  ), (n.pinchRotate === void 0 || n.pinchRotate) && t.push(new ZI()), (n.pinchZoom === void 0 || n.pinchZoom) && t.push(
    new LI({
      duration: n.zoomDuration
    })
  ), (n.keyboard === void 0 || n.keyboard) && (t.push(new TI()), t.push(
    new GI({
      delta: n.zoomDelta,
      duration: n.zoomDuration
    })
...
class Qt extends KI {
  ...
  static async swCheck() {
    return ye !== void 0 ? ye : (fn === void 0 && (fn = new Promise((t, e) => {
...
function GA(n, t, e) {
  ...
  let g = on(n, t);
  if (g == In && A != i) {
    const r = on(n, "EPSG:3857"), s = on("EPSG:3857", t);
    if (r == In && A != "EPSG:3857")
...
class UA extends Ar {
  ...
  static async createAsync(t) {
    ...
    return vn(r), kA(
      ...
      (s) => g.transform(s, !1),
      (s) => g.transform(s, !0)
    ), GA("EPSG:4326", r), t.sub_maps && t.sub_maps.forEach((s, o) => {
  ...
  setupMapParameter(t) {
    ...
    this.mercZoom || (this.mercZoom = Math.log(300 * (2 * At.MERC_MAX) / 256 / p) / Math.log(2) - 3), this.homePosition || (this.homePosition = kn(g)), this.envelope = hg([
      [
        a[0],
        a[1],
        a[2],
...
function eC(n) {
  var t = new FileReader(), e = nr(t);
  return t.readAsArrayBuffer(n), e;
}
function AC(n) {
  var t = new FileReader(), e = nr(t), A = /charset=([A-Za-z0-9_-]+)/.exec(n.type), i = A ? A[1] : "utf-8";
...
function ir() {
  return this.bodyUsed = !1, this._initBody = function(n) {
    ...
    if (this._bodyArrayBuffer)
      return Promise.resolve(nC(this._bodyArrayBuffer));
    if (this._bodyFormData)
...
var iC = ["CONNECT", "DELETE", "GET", "HEAD", "OPTIONS", "PATCH", "POST", "PUT", "TRACE"];
function gC(n) {
  var t = n.toUpperCase();
...
function ae(n, t) {
  ...
  if (n instanceof ae) {
    ...
    this.url = String(n);
  if (this.credentials = t.credentials || this.credentials || "same-origin", (t.headers || !this.headers) && (this.headers = new at(t.headers)), this.method = gC(t.method || this.method || "GET"), this.mode = t.mode || this.mode || null, this.signal = t.signal || this.signal || (function() {
  ...
  return new Promise(function(e, A) {
    ...
    g.onload = function() {
      var I = {
        ...
        headers: sC(g.getAllResponseHeaders() || "")
      };
    ...
    if (g.open(i.method, s(i.url), !0), i.credentials === "include" ? g.withCredentials = !0 : i.credentials === "omit" && (g.withCredentials = !1), "responseType" in g && (Mt.blob ? g.responseType = "blob" : Mt.arrayBuffer && (g.responseType = "arraybuffer")), t && typeof t.headers == "object" && !(t.headers instanceof at || ut.Headers && t.headers instanceof ut.Headers)) {
      ...
      Object.getOwnPropertyNames(t.headers).forEach(function(I) {
        o.push(Te(I)), g.setRequestHeader(I, Ai(t.headers[I]));
...
async function CC(n, t) {
  if (typeof n == "string" && (n = IC[n]), n = jt(Object.assign(n, t)), n.label = n.label || n.year, ng(n.maptype)) {
    const r = n.maptype === "base" ? Se : n.maptype === "overlay" ? FA : n.maptype === "mapbox" ? NA : n.maptype === "maplibre" ? zA : Bn;
    r.isBasemap() ? (n.homePosition = n.homePos, n.mercZoom = n.defZoom) : (n.homePosition || (n.homePosition = n.homePos), n.mercZoom || (n.mercZoom = n.defZoom)), delete n.homePos, delete n.defZoom, n.zoomRestriction && (n.maxZoom = n.maxZoom || n.mercMaxZoom, n.minZoom = n.minZoom || n.mercMinZoom), n.zoomRestriction = n.mercMaxZoom = n.mercMinZoom = void 0, n.translator && (n.url = n.translator(n.url)), n.imageExtension || (n.imageExtension = "jpg"), n.mapID && !n.url && !n.urls && (n.url = n.tms ? `tiles/${n.mapID}/{z}/{x}/{-y}.${n.imageExtension}` : `tiles/${n.mapID}/{z}/{x}/{y}.${n.imageExtension}`), n.weiwudi = await mn(n), n.weiwudi && (n.url = n.weiwudi.url, delete n.urls);
    const s = await r.createAsync(n);
    return await s.initialWait, s;
  } else if (n.noload)
    return n.mercMaxZoom = n.mercMinZoom = void 0, new UA(n);
  ...
  if (n = jt(Object.assign(i, n)), n.label = n.label || i.year, n.translator && (n.url = n.translator(n.url)), n.maptype || (n.maptype = "maplat"), ng(n.maptype)) {
    const r = n.maptype === "base" ? Se : n.maptype === "overlay" ? FA : n.maptype === "mapbox" ? NA : n.maptype === "maplibre" ? zA : Bn;
    r.isBasemap() ? (n.homePosition = n.homePos, n.mercZoom = n.defZoom) : (n.homePosition || (n.homePosition = n.homePos), n.mercZoom || (n.mercZoom = n.defZoom)), delete n.homePos, delete n.defZoom, n.zoomRestriction && (n.maxZoom = n.maxZoom || n.mercMaxZoom, n.minZoom = n.minZoom || n.mercMinZoom), n.zoomRestriction = n.mercMaxZoom = n.mercMinZoom = void 0, n.imageExtension || (n.imageExtension = "jpg"), n.mapID && !n.url && !n.urls && (n.url = n.tms ? `tiles/${n.mapID}/{z}/{x}/{-y}.${n.imageExtension}` : `tiles/${n.mapID}/{z}/{x}/{y}.${n.imageExtension}`), n.weiwudi = await mn(n), n.weiwudi && (n.url = n.weiwudi.url, delete n.urls);
    const s = await r.createAsync(n);
    try {
      return await s.initialWait, s;
    } catch {
  ...
  n.width = n.width || n.compiled.wh[0], n.height = n.height || n.compiled.wh[1], n.weiwudi = await mn(n), n.weiwudi && (n.url = n.weiwudi.url, delete n.urls);
  const g = await UA.createAsync(n);
...
function Gn(n, t) {
  if (n instanceof Array)
    return n.map((A) => Gn(A, t));
  const e = Math.pow(10, t);
  return Math.round(n * e) / e;
}
var He = { exports: {} }, yn, ig;
function Ir() {
  if (ig) return yn;
  ig = 1;
  var n = /<%=([\s\S]+?)%>/g;
...
function aC() {
  if (gg) return wn;
  gg = 1;
  var n = Ir(), t = "[object Null]", e = "[object Symbol]", A = "[object Undefined]", i = /[&<>"']/g, g = RegExp(i.source), r = /<%-([\s\S]+?)%>/g, s = /<%([\s\S]+?)%>/g, o = {
    "&": "&amp;",
    "<": "&lt;",
    ">": "&gt;",
    '"': "&quot;",
...
function cC() {
  return rg || (rg = 1, (function(n, t) {
    ...
    function Y(f, w) {
      var S = si(f), V = !S && vr(f), J = !S && !V && Mr(f), Ct = !S && !V && !J && Rr(f), Tt = S || V || J || Ct, rt = Tt ? Le(f.length, String) : [], Zt = rt.length;
      for (var Gt in f)
        ...
        J && (Gt == "offset" || Gt == "parent") || // PhantomJS 2 has enumerable non-index properties on typed arrays.
        Ct && (Gt == "buffer" || Gt == "byteLength" || Gt == "byteOffset") || // Skip index properties.
        ii(Gt, Zt))) && rt.push(Gt);
      return rt;
    }
    function K(f, w, S) {
      var V = f[w];
      (!(u.call(f, w) && gn(V, S)) || S === void 0 && !(w in f)) && et(f, w, S);
    }
    function et(f, w, S) {
      w == "__proto__" && D ? D(f, w, {
        configurable: !0,
    ...
    function nn(f) {
      return Et(function(w, S) {
        ...
        for (Ct = f.length > 3 && typeof Ct == "function" ? (J--, Ct) : void 0, Tt && gi(S[0], S[1], Tt) && (Ct = J < 3 ? void 0 : Ct, J = 1), w = Object(w); ++V < J; ) {
          var rt = S[V];
          rt && f(w, rt, V, Ct);
        }
        return w;
    ...
    function pA(f, w, S, V) {
      return f === void 0 || gn(f, ee[S]) && !u.call(V, S) ? w : f;
    }
    function lr(f, w) {
      var S = le(f, w);
    ...
    function ii(f, w) {
      var S = typeof f;
      return w = w ?? r, !!w && (S == "number" || S != "symbol" && $A.test(f)) && f > -1 && f % 1 == 0 && f < w;
    }
    function gi(f, w, S) {
      if (!yA(S))
        return !1;
      var V = typeof w;
      return (V == "number" ? rn(S) && ii(w, S.length) : V == "string" && w in S) ? gn(S[w], f) : !1;
    }
    function ur(f) {
      return !!m && m in f;
    }
    ...
    function rn(f) {
      return f != null && Ci(f.length) && !Ii(f);
    }
    var Mr = L || Gr;
    function oi(f) {
      if (!ue(f))
    ...
    var ai = nn(function(f, w, S, V) {
      An(w, Sr(w), f, V);
    });
    function Pr(f) {
      return rn(f) ? Y(f) : St(f);
    }
    function Sr(f) {
      return rn(f) ? Y(f, !0) : Dt(f);
    }
    function Dr(f, w, S) {
      var V = A.imports._.templateSettings || A;
      S && gi(f, w, S) && (w = void 0), f = xr(f), w = ai({}, w, V, pA);
      var J = ai({}, w.imports, V.imports, pA), Ct = Pr(J), Tt = je(J, Ct), rt, Zt, Gt = 0, li = w.interpolate || ce, Rt = "__p += '", kr = RegExp(
        (w.escape || ce).source + "|" + li.source + "|" + (li === e ? cA : ce).source + "|" + (w.evaluate || ce).source + "|$",
        "g"
      ), Or = u.call(w, "sourceURL") ? "//# sourceURL=" + (w.sourceURL + "").replace(/[\r\n]/g, " ") + `
` : "";
      f.replace(kr, function(hi, ui, vA, Xr, fi, di) {
        return vA || (vA = Xr), Rt += f.slice(Gt, di).replace(tn, Ne), ui && (rt = !0, Rt += `' +
__e(` + ui + `) +
'`), fi && (Zt = !0, Rt += `';
` + fi + `;
__p += '`), vA && (Rt += `' +
...
`;
      var sn = u.call(w, "variable") && w.variable;
      sn || (Rt = `with (obj) {
` + Rt + `
}
`), Rt = (Zt ? Rt.replace(qA, "") : Rt).replace(_A, "$1").replace(Ge, "$1;"), Rt = "function(" + (sn || "obj") + `) {
` + (sn ? "" : `obj || (obj = {});
...
`) + Rt + `return __p
      ...
      var wA = Br(function() {
        return Function(Ct, Or + "return " + Rt).apply(void 0, Tt);
      });
      if (wA.source = Rt, oi(wA))
        throw wA;
      return wA;
    }
...
function og(n, ...t) {
  return n = jt(n), n.html ? n : t.reduce((e, A) => {
    ...
    if (i)
      return n.html = Cr(i)(n), n.poiStyle = n.poiStyle || A.poiStyle, n;
  }, void 0) || n;
}
const lt = {
  ACCURACY: "accuracy",
...
class fC extends De {
  ...
  timerPositionChange_() {
    const t = {
      longitude: pn(this.home_position_[0], 0.05),
      latitude: pn(this.home_position_[1], 0.05),
      accuracy: pn(15, 10)
    };
...
class QA extends Rg {
  ...
  async runLifecyclePhase(t, e) {
    ...
    const A = this.buildLifecycleContext(t, e), i = mC[t], g = this.uiHooks?.[i];
    if (g)
      try {
        const r = await g(A);
  ...
  async handleSetting(t, e) {
    ...
    const i = await cg(this.appData.pois || [], this);
  ...
  initGeolocation(t) {
    ...
    const e = this.geolocation = new fC({
      timerBase: t.fake,
    ...
    this.alwaysGpsOn ? (e.setTracking(!0), this.gpsEnabled_ = !0, this.initialGpsMove_ = !0) : (e.setTracking(!1), this.gpsEnabled_ = !1), e.on("change", () => {
      ...
      (r ? r.getSource() : s.getSource()).setGPSMarker(), this.dispatchEvent(new pC(i === 1 ? "user_gps_deny" : i === 2 ? "gps_miss" : "gps_timeout")), this.dispatchEvent(new Qe({ error: "gps_off" }));
  ...
  handleGPS(t, e = !1) {
    if (this.geolocation) {
      if (t)
        if (!this.alwaysGpsOn)
          this.firstGpsRequest_ = !0, this.geolocation.setTracking(!0), this.gpsEnabled_ = !0, this.dispatchEvent(new yC());
        else {
  ...
  async setInitialMap(t) {
    ...
    this.from = t.reduce(
      (A, i) => A ? !(A instanceof Ar) && i.mapID != e ? i : A : i.mapID != e ? i : A,
      void 0
  ...
  raiseChangeViewpoint() {
    this.mapObject.on("postrender", async (t) => {
      const e = this.mapObject.getView(), A = e.getCenter(), i = e.getDecimalZoom(), g = xi(e.getRotation() * 180 / Math.PI), r = await this.from.viewpoint2MercsAsync(), s = await this.mercSrc.mercs2ViewpointAsync(r);
      ...
      const o = Bt(s[0], "EPSG:3857", "EPSG:4326"), I = xi(s[2] * 180 / Math.PI);
      this.dispatchEvent(
  ...
  setMarker(t) {
    ...
    const e = t.lnglat || [
      t.lng || t.longitude,
      t.lat || t.latitude
    ], A = t.x, i = t.y, g = t.coordinates, r = this.from, s = t.icon ? this.__selectedMarker == t.namespaceID && t.selectedIcon ? t.selectedIcon : t.icon : this.__selectedMarker == t.namespaceID ? cr : $n;
    return (g ? (function() {
        ...
        for (const s of Object.keys(this.pois)) {
          ...
          if (!o.hide)
            for (const I of o.pois) {
              const C = sg(I, o, this);
              og(C, o, this), this.__selectedMarker == C.namespaceID ? g = C : i.push(this.setMarker(C));
            }
        }
        if (A.pois)
          for (const s of Object.keys(A.pois)) {
            ...
            if (!o.hide)
              for (const I of o.pois) {
                const C = sg(I, o, A, this);
                og(C, o, A, this), this.__selectedMarker == C.namespaceID ? g = C : i.push(this.setMarker(C));
              }
          }
      }
      let r = Promise.all(i);
  ...
  addMarker(t, e) {
    if (e || (e = "main"), e.includes("#")) {
      ...
      return this.pois[e].pois.push(Je(t)), On(this.pois, e, {
        name: this.appName
    ...
    return i ? (this.changeMapSeq || (this.changeMapSeq = Promise.resolve()), this.changeMapSeq = this.changeMapSeq.then(
      () => new Promise((g, r) => {
        this.convertParametersFromCurrent(i, (s) => {
          ...
          if (this.backMap && (o = this.backMap.getSource(), i.isWmts() ? this.backMap.exchangeSource() : (C ? (I = C, this.backMap.exchangeSource(I)) : o ? I = o : (I = A, this.from.isWmts() && (I = this.from instanceof FA ? this.mapObject.getSource() : (
            // If current foreground is TMS overlay, set current basemap as new background
            this.from
          )), this.backMap.exchangeSource(I)), this.requestUpdateState({ backgroundID: I.mapID }))), i instanceof FA) {
  ...
  convertParametersFromCurrent(t, e) {
    ...
    this.logger.debug(
      ...
      this.mercBuffer.buffer[o] && (this.logger.debug("To: Use buffer"), s = new Promise((I, C) => {
        ...
        ), this.logger.debug(`To: ${t.mapID}`), this.mercBuffer.buffer[t.mapID] = Gn(I, 10), e(I);
      }).catch((I) => {
        throw I;
      });
    }).catch((r) => {
