import { transform as bt, toLonLat as or, Projection as uo, addProjection as Ui, addCoordinateTransforms as Zn, getTransform as pi, identityTransform as yi } from "ol/proj";
import { View as _s, Map as fo, Feature as mo } from "ol";
import { Vector as Mn, Group as po, Tile as wi } from "ol/layer";
import { XYZ as Js, Google as yo, Vector as Rn } from "ol/source";
import { Style as Ft, Icon as CA, Stroke as zi, Fill as Wi } from "ol/style";
class Jt {
  /**
...
const Kt = 11102230246251565e-32, ct = 134217729, Mo = (3 + 8 * Kt) * Kt;
function Ei(A, t, e, n, i) {
  let r, s, g, o, a = t[0], I = n[0], C = 0, c = 0;
  I > a == I > -a ? (r = a, a = t[++C]) : (r = I, I = n[++c]);
  let h = 0;
  if (C < A && c < e)
    for (I > a == I > -a ? (s = a + r, g = r - (s - a), a = t[++C]) : (s = I + r, g = r - (s - I), I = n[++c]), r = s, g !== 0 && (i[h++] = g); C < A && c < e; )
      I > a == I > -a ? (s = r + a, o = s - r, g = r - (s - o) + (a - o), a = t[++C]) : (s = r + I, o = s - r, g = r - (s - o) + (I - o), I = n[++c]), r = s, g !== 0 && (i[h++] = g);
  for (; C < A; )
    s = r + a, o = s - r, g = r - (s - o) + (a - o), a = t[++C], r = s, g !== 0 && (i[h++] = g);
  for (; c < e; )
    s = r + I, o = s - r, g = r - (s - o) + (I - o), I = n[++c], r = s, g !== 0 && (i[h++] = g);
...
const To = (3 + 16 * Kt) * Kt, So = (2 + 12 * Kt) * Kt, Po = (9 + 64 * Kt) * Kt * Kt, Ve = $A(4), Xr = $A(8), Zr = $A(12), jr = $A(16), ut = $A(4);
function xo(A, t, e, n, i, r, s) {
  let g, o, a, I, C, c, h, p, f, d, m, E, T, M, P, S, O, L;
  const U = A - i, G = e - i, Z = t - r, j = n - r;
  M = U * j, c = ct * U, h = c - (c - U), p = U - h, c = ct * j, f = c - (c - j), d = j - f, P = p * d - (M - h * f - p * f - h * d), S = Z * G, c = ct * Z, h = c - (c - Z), p = Z - h, c = ct * G, f = c - (c - G), d = G - f, O = p * d - (S - h * f - p * f - h * d), m = P - O, C = P - m, Ve[0] = P - (m + C) + (C - O), E = M + m, C = E - M, T = M - (E - C) + (m - C), m = T - S, C = T - m, Ve[1] = T - (m + C) + (C - S), L = E + m, C = L - E, Ve[2] = E - (L - C) + (m - C), Ve[3] = L;
  let q = Ro(4, Ve), it = So * s;
  if (q >= it || -q >= it || (C = A - U, g = A - (U + C) + (C - i), C = e - G, a = e - (G + C) + (C - i), C = t - Z, o = t - (Z + C) + (C - r), C = n - j, I = n - (j + C) + (C - r), g === 0 && o === 0 && a === 0 && I === 0) || (it = Po * s + Mo * Math.abs(q), q += U * I + j * g - (Z * a + G * o), q >= it || -q >= it)) return q;
  M = g * j, c = ct * g, h = c - (c - g), p = g - h, c = ct * j, f = c - (c - j), d = j - f, P = p * d - (M - h * f - p * f - h * d), S = o * G, c = ct * o, h = c - (c - o), p = o - h, c = ct * G, f = c - (c - G), d = G - f, O = p * d - (S - h * f - p * f - h * d), m = P - O, C = P - m, ut[0] = P - (m + C) + (C - O), E = M + m, C = E - M, T = M - (E - C) + (m - C), m = T - S, C = T - m, ut[1] = T - (m + C) + (C - S), L = E + m, C = L - E, ut[2] = E - (L - C) + (m - C), ut[3] = L;
  const vt = Ei(4, Ve, 4, ut, Xr);
  M = U * I, c = ct * U, h = c - (c - U), p = U - h, c = ct * I, f = c - (c - I), d = I - f, P = p * d - (M - h * f - p * f - h * d), S = Z * a, c = ct * Z, h = c - (c - Z), p = Z - h, c = ct * a, f = c - (c - a), d = a - f, O = p * d - (S - h * f - p * f - h * d), m = P - O, C = P - m, ut[0] = P - (m + C) + (C - O), E = M + m, C = E - M, T = M - (E - C) + (m - C), m = T - S, C = T - m, ut[1] = T - (m + C) + (C - S), L = E + m, C = L - E, ut[2] = E - (L - C) + (m - C), ut[3] = L;
  const D = Ei(vt, Xr, 4, ut, Zr);
  M = g * I, c = ct * g, h = c - (c - g), p = g - h, c = ct * I, f = c - (c - I), d = I - f, P = p * d - (M - h * f - p * f - h * d), S = o * a, c = ct * o, h = c - (c - o), p = o - h, c = ct * a, f = c - (c - a), d = a - f, O = p * d - (S - h * f - p * f - h * d), m = P - O, C = P - m, ut[0] = P - (m + C) + (C - O), E = M + m, C = E - M, T = M - (E - C) + (m - C), m = T - S, C = T - m, ut[1] = T - (m + C) + (C - S), L = E + m, C = L - E, ut[2] = E - (L - C) + (m - C), ut[3] = L;
  const rt = Ei(D, Zr, 4, ut, jr);
  return jr[rt - 1];
}
function Do(A, t, e, n, i, r) {
  const s = (t - r) * (e - i), g = (A - i) * (n - r), o = s - g, a = Math.abs(s + g);
  return Math.abs(o) >= To * a ? o : -xo(A, t, e, n, i, r, a);
}
function Bo(A, t) {
  var e, n, i = 0, r, s, g, o, a, I, C, c = A[0], h = A[1], p = t.length;
  for (e = 0; e < p; e++) {
    n = 0;
    var f = t[e], d = f.length - 1;
    if (I = f[0], I[0] !== f[d][0] && I[1] !== f[d][1])
      throw new Error("First and last coordinates in a ring must be the same");
    for (s = I[0] - c, g = I[1] - h, n; n < d; n++) {
      if (C = f[n + 1], o = C[0] - c, a = C[1] - h, g === 0 && a === 0) {
        if (o <= 0 && s >= 0 || s <= 0 && o >= 0)
          return 0;
      } else if (a >= 0 && g <= 0 || a <= 0 && g >= 0) {
        if (r = Do(s, o, g, a, 0, 0), r === 0)
          return 0;
...
function rA(A, t, e = {}) {
  ...
  const n = bo(A), i = vo(t), r = i.type, s = t.bbox;
  let g = i.coordinates;
  if (s && Oo(n, s) === !1)
    return !1;
  r === "Polygon" && (g = [g]);
...
function $s(A, t, e) {
  const n = t.geometry.coordinates[0][0], i = t.geometry.coordinates[0][1], r = t.geometry.coordinates[0][2], s = A.geometry.coordinates, g = t.properties.a.geom, o = t.properties.b.geom, a = t.properties.c.geom, I = [i[0] - n[0], i[1] - n[1]], C = [r[0] - n[0], r[1] - n[1]], c = [s[0] - n[0], s[1] - n[1]], h = [o[0] - g[0], o[1] - g[1]], p = [a[0] - g[0], a[1] - g[1]];
  let f = (C[1] * c[0] - C[0] * c[1]) / (I[0] * C[1] - I[1] * C[0]), d = (I[0] * c[1] - I[1] * c[0]) / (I[0] * C[1] - I[1] * C[0]);
  if (e) {
    const m = e[t.properties.a.index], E = e[t.properties.b.index], T = e[t.properties.c.index];
    let M;
    if (f < 0 || d < 0 || 1 - f - d < 0) {
      const P = f / (f + d), S = d / (f + d);
      M = f / E / (P / E + S / T), d = d / T / (P / E + S / T);
    } else
      M = f / E / (f / E + d / T + (1 - f - d) / m), d = d / T / (f / E + d / T + (1 - f - d) / m);
    f = M;
  }
  return [
    f * h[0] + d * p[0] + g[0],
...
function Lo(A, t, e, n) {
  const i = A.geometry.coordinates, r = e.geometry.coordinates, s = Math.atan2(i[0] - r[0], i[1] - r[1]), g = No(s, t[0]);
  if (g === void 0)
    throw new Error("Unable to determine vertex index");
  const o = t[1][g];
  return $s(A, o.features[0], n);
}
function ko(A, t, e, n, i, r, s, g) {
  let o;
  if (s && (o = bi(A, cA([s]))), !o)
    if (e) {
      const a = A.geometry.coordinates, I = e.gridNum, C = e.xOrigin, c = e.yOrigin, h = e.xUnit, p = e.yUnit, f = e.gridCache, d = jt(a[0], C, h, I), m = jt(a[1], c, p, I), E = f[d] ? f[d][m] ? f[d][m] : [] : [], T = cA(E.map((M) => t.features[M]));
      o = bi(A, T);
    } else
      o = bi(A, t);
  return g && g(o), o ? $s(A, o, r) : Lo(A, n, i, r);
}
function jt(A, t, e, n) {
...
function No(A, t) {
  let e = Fr(A - t[0]), n = Math.PI * 2, i;
  for (let r = 0; r < t.length; r++) {
    const s = (r + 1) % t.length, g = Fr(A - t[s]), o = Math.min(Math.abs(e), Math.abs(g));
...
function Uo(A) {
  return !A.version || A.version < eg ? ["forw", "bakw"].reduce((t, e) => {
...
function Wo(A) {
  ...
  return t.forw[1] = Ur(A, !1), t.bakw[1] = Ur(A, !0), t;
}
function Ur(A, t) {
...
function Ho(A) {
  return {
    forw: fe(A.centroid_point[0], {
      target: {
        geom: A.centroid_point[1],
        index: "c"
      }
    }),
    bakw: fe(A.centroid_point[1], {
      target: {
...
class St {
  ...
  setCompiled(t) {
    if (Zo(t)) {
      this.applyModernState(jo(t));
      return;
    }
    this.applyLegacyState(Fo(t));
  }
  applyModernState(t) {
  ...
  addIndexedTin() {
    ...
    const g = e.features.map((f) => {
      ...
      (f, d, m) => {
        const E = jt(d[0][0], r[0][0], o, i), T = jt(d[1][0], r[0][0], o, i), M = jt(d[0][1], r[0][1], a, i), P = jt(d[1][1], r[0][1], a, i);
        for (let S = E; S <= T; S++) {
          f[S] || (f[S] = []);
          for (let O = M; O <= P; O++)
            f[S][O] || (f[S][O] = []), f[S][O].push(m);
        }
        return f;
      },
      []
    ...
    }), c = (s[1][0] - s[0][0]) / i, h = (s[1][1] - s[0][1]) / i, p = C.reduce(
      (f, d, m) => {
        const E = jt(d[0][0], s[0][0], c, i), T = jt(d[1][0], s[0][0], c, i), M = jt(d[0][1], s[0][1], h, i), P = jt(d[1][1], s[0][1], h, i);
        for (let S = E; S <= T; S++) {
          f[S] || (f[S] = []);
          for (let O = M; O <= P; O++)
            f[S][O] || (f[S][O] = []), f[S][O].push(m);
  ...
  transform(t, e, n) {
    ...
    let I, C;
    this.stateFull && (this.stateBackward == e ? I = this.stateTriangle : (this.stateBackward = e, this.stateTriangle = void 0), C = (h) => {
    ...
    if (this.bounds && e && !n) {
      const h = fe(c);
      if (!rA(h, this.boundsPolygon)) return !1;
    } else this.yaxisMode == St.YAXIS_FOLLOW && !e && (c = [c[0], -1 * c[1]]);
    return c;
  }
}
const W = 20037508342789244e-9, Ag = [
  [0, 0],
  [0, 1],
  [1, 0],
  [0, -1],
...
function Vi(A, t) {
  ...
  for (let c = 0; c < 4; c++) {
    ...
    r += f;
    const d = h[0] * p[1] - h[1] * p[0], m = Math.acos(
      (h[0] * p[0] + h[1] * p[1]) / f
    ), E = d > 0 ? -1 * m : m;
...
class ig {
  ...
  setMapData(t) {
    ...
    if (e.setCompiled(t.compiled), this.mainTin = e, t.maxZoom !== void 0)
      this._maxxy = Math.pow(2, t.maxZoom) * Mi;
    else if (t.compiled.wh) {
      const n = Math.max(t.compiled.wh[0], t.compiled.wh[1]), i = Math.ceil(Math.log2(n / Mi));
      this._maxxy = Math.pow(2, i) * Mi;
    }
  ...
  xy2MercWithLayer(t) {
    ...
    for (let n = 0; n < e.length; n++) {
      ...
      if (r || rA(fe(t), this.subTins[i - 1].xyBounds)) {
  ...
  merc2XyWithLayer(t) {
    return this._assertMapData(), this._getAllTinsWithIndex().map(({ index: e, tin: n, isMain: i }) => {
      ...
      return r === !1 ? [n, e] : i || rA(fe(r), this.subTins[e - 1].xyBounds) ? [n, e, r] : [n, e];
    }).sort((e, n) => {
      ...
      (e, n, i, r) => {
        ...
        for (let a = 0; a < i; a++) {
          const I = r[a][1], C = I === 0;
          if (r[a][2] && (C || rA(fe(o), this.subTins[I - 1].xyBounds)))
            if (e.length) {
  ...
  viewpoint2Mercs(t, e) {
    ...
    const n = Yi(t.center, t.zoom, t.rotation, e).map((g) => zr(g, this._maxxy)), i = this.xy2MercWithLayer(n[0]);
  ...
  xy2SysCoordInternal(t) {
    return vi(t, this._maxxy);
  }
}
const rg = "data:image/png;base64,", Se = 256, _o = `<canvas width="${Se}" height="${Se}" src="${rg}"></canvas>`;
async function Tn(A) {
  if (typeof A == "string") {
...
const sg = ["hide", "title", "icon", "selectedIcon"], Jo = [
  "lnglat",
  "lng",
  "lat",
  "longitude",
...
function _i(A) {
  if (!Ki(A) || A.type === "FeatureCollection") return !1;
  const t = A.layer, e = typeof t == "string", n = Ki(t) && t.type === "FeatureCollection";
  return !(!e && !n || Jo.some((i) => A[i] !== void 0));
}
function qo(A) {
  return _i(A) && sg.some((t) => A[t] !== void 0);
}
function Wr(A) {
  const t = {};
...
function Hr(A, t) {
  ...
  t.hide === !0 && (A.hide = !0);
  const e = t.title;
  (typeof e == "string" ? e !== "" : Ki(e) && Object.keys(e).length > 0) && (A.name = e);
...
async function gg(A, t) {
  if (A = await Tn(A), Array.isArray(A))
    if (A = await Promise.all(
      A.map(async (e) => await Tn(e))
    ), A.length > 0 && (A[0].type === "FeatureCollection" || _i(A[0]))) {
      const e = await Promise.all(
        A.map(async (n, i) => {
          let r, s;
          _i(n) ? (r = await Tn(n.layer), s = Wr(n)) : (r = n, s = null);
          let g = r.id || r.properties && r.properties.id;
          if (!g)
            if (i === 0) g = "main";
    ...
    const e = await Tn(A.layer), n = e.id || e.properties && e.properties.id || "main", i = ce(e, n, t);
    A = { [n]: Hr(i, Wr(A)) };
  } else
    Object.keys(A).map((e) => {
      A[e] = ce(A[e], e, t);
...
function ce(A, t, e) {
  if (Array.isArray(A))
    ...
    A.name && (n.name = A.name), n.pois = A.features.map((i) => WA(i)), A = n;
  }
  if (typeof A.id > "u")
    A.id = t;
...
function Ig(A, t, e) {
  if (A !== null)
    for (var n, i, r, s, g, o, a, I = 0, C = 0, c, h = A.type, p = h === "FeatureCollection", f = h === "Feature", d = p ? A.features.length : 1, m = 0; m < d; m++) {
      a = p ? (
      ...
      for (var E = 0; E < g; E++) {
        ...
        if (s = c ? a.geometries[E] : a, s !== null) {
          o = s.coordinates;
          var P = s.type;
          switch (I = P === "Polygon" || P === "MultiPolygon" ? 1 : 0, P) {
            case null:
              break;
            case "Point":
              if (
            ...
            case "MultiLineString":
              for (n = 0; n < o.length; n++) {
                ...
                P === "MultiLineString" && T++, P === "Polygon" && M++;
              }
              P === "Polygon" && T++;
              break;
            case "MultiPolygon":
              for (n = 0; n < o.length; n++) {
                for (M = 0, i = 0; i < o[n].length; i++) {
...
const _t = 11102230246251565e-32, lt = 134217729, Aa = (3 + 8 * _t) * _t;
function Ri(A, t, e, n, i) {
  let r, s, g, o, a = t[0], I = n[0], C = 0, c = 0;
  I > a == I > -a ? (r = a, a = t[++C]) : (r = I, I = n[++c]);
  let h = 0;
  if (C < A && c < e)
...
const ia = (3 + 16 * _t) * _t, ra = (2 + 12 * _t) * _t, sa = (9 + 64 * _t) * _t * _t, Ke = tn(4), Vr = tn(8), Kr = tn(12), _r = tn(16), ft = tn(4);
function ga(A, t, e, n, i, r, s) {
  let g, o, a, I, C, c, h, p, f, d, m, E, T, M, P, S, O, L;
  const U = A - i, G = e - i, Z = t - r, j = n - r;
  M = U * j, c = lt * U, h = c - (c - U), p = U - h, c = lt * j, f = c - (c - j), d = j - f, P = p * d - (M - h * f - p * f - h * d), S = Z * G, c = lt * Z, h = c - (c - Z), p = Z - h, c = lt * G, f = c - (c - G), d = G - f, O = p * d - (S - h * f - p * f - h * d), m = P - O, C = P - m, Ke[0] = P - (m + C) + (C - O), E = M + m, C = E - M, T = M - (E - C) + (m - C), m = T - S, C = T - m, Ke[1] = T - (m + C) + (C - S), L = E + m, C = L - E, Ke[2] = E - (L - C) + (m - C), Ke[3] = L;
  let q = na(4, Ke), it = ra * s;
  if (q >= it || -q >= it || (C = A - U, g = A - (U + C) + (C - i), C = e - G, a = e - (G + C) + (C - i), C = t - Z, o = t - (Z + C) + (C - r), C = n - j, I = n - (j + C) + (C - r), g === 0 && o === 0 && a === 0 && I === 0) || (it = sa * s + Aa * Math.abs(q), q += U * I + j * g - (Z * a + G * o), q >= it || -q >= it)) return q;
  M = g * j, c = lt * g, h = c - (c - g), p = g - h, c = lt * j, f = c - (c - j), d = j - f, P = p * d - (M - h * f - p * f - h * d), S = o * G, c = lt * o, h = c - (c - o), p = o - h, c = lt * G, f = c - (c - G), d = G - f, O = p * d - (S - h * f - p * f - h * d), m = P - O, C = P - m, ft[0] = P - (m + C) + (C - O), E = M + m, C = E - M, T = M - (E - C) + (m - C), m = T - S, C = T - m, ft[1] = T - (m + C) + (C - S), L = E + m, C = L - E, ft[2] = E - (L - C) + (m - C), ft[3] = L;
  const vt = Ri(4, Ke, 4, ft, Vr);
  M = U * I, c = lt * U, h = c - (c - U), p = U - h, c = lt * I, f = c - (c - I), d = I - f, P = p * d - (M - h * f - p * f - h * d), S = Z * a, c = lt * Z, h = c - (c - Z), p = Z - h, c = lt * a, f = c - (c - a), d = a - f, O = p * d - (S - h * f - p * f - h * d), m = P - O, C = P - m, ft[0] = P - (m + C) + (C - O), E = M + m, C = E - M, T = M - (E - C) + (m - C), m = T - S, C = T - m, ft[1] = T - (m + C) + (C - S), L = E + m, C = L - E, ft[2] = E - (L - C) + (m - C), ft[3] = L;
  const D = Ri(vt, Vr, 4, ft, Kr);
  M = g * I, c = lt * g, h = c - (c - g), p = g - h, c = lt * I, f = c - (c - I), d = I - f, P = p * d - (M - h * f - p * f - h * d), S = o * a, c = lt * o, h = c - (c - o), p = o - h, c = lt * a, f = c - (c - a), d = a - f, O = p * d - (S - h * f - p * f - h * d), m = P - O, C = P - m, ft[0] = P - (m + C) + (C - O), E = M + m, C = E - M, T = M - (E - C) + (m - C), m = T - S, C = T - m, ft[1] = T - (m + C) + (C - S), L = E + m, C = L - E, ft[2] = E - (L - C) + (m - C), ft[3] = L;
  const rt = Ri(D, Kr, 4, ft, _r);
  return _r[rt - 1];
}
function oa(A, t, e, n, i, r) {
  const s = (t - r) * (e - i), g = (A - i) * (n - r), o = s - g, a = Math.abs(s + g);
  return Math.abs(o) >= ia * a ? o : -ga(A, t, e, n, i, r, a);
}
function aa(A, t) {
  var e, n, i = 0, r, s, g, o, a, I, C, c = A[0], h = A[1], p = t.length;
  for (e = 0; e < p; e++) {
...
function Ia(A, t, e = {}) {
  ...
  if (!t)
    throw new Error("polygon is required");
  const n = ta(A), i = ea(t), r = i.type, s = t.bbox;
  let g = i.coordinates;
  if (s && Ca(n, s) === !1)
    return !1;
  r === "Polygon" && (g = [g]);
  ...
  for (let i = 0; i < n.length; i++)
    for (let r = 0; r < n[i].length; r++) {
      ...
      for (let o = 0; o < n[i][r].length - 1; o++) {
        g = n[i][r][o + 1];
        const a = new Jr(s, Sn, Pn, xn), I = new Jr(g, Sn, Pn, xn + 1);
        a.otherEvent = I, I.otherEvent = a, cg(a, I) > 0 ? (I.isLeftEndpoint = !0, a.isLeftEndpoint = !1) : (a.isLeftEndpoint = !0, I.isLeftEndpoint = !1), t.push(a), t.push(I), s = g, xn = xn + 1;
      }
    }
  Sn = Sn + 1;
}
...
function ma(A, t) {
  const e = new Cg([], cg);
  return ha(A, e), da(e, t);
}
var pa = ma;
function ya(A, t, e = {}) {
  const { removeDuplicates: n = !0, ignoreSelfIntersections: i = !0 } = e;
  let r = [];
  A.type === "FeatureCollection" ? r = r.concat(A.features) : A.type === "Feature" ? r.push(A) : (A.type === "LineString" || A.type === "Polygon" || A.type === "MultiLineString" || A.type === "MultiPolygon") && r.push(HA(A)), t.type === "FeatureCollection" ? r = r.concat(t.features) : t.type === "Feature" ? r.push(t) : (t.type === "LineString" || t.type === "Polygon" || t.type === "MultiLineString" || t.type === "MultiPolygon") && r.push(HA(t));
  const s = pa(
    Qr(r),
    i
  );
...
function lg(A) {
  class t extends A {
    ...
    initialize(n) {
      ...
      this.initialWait = Promise.all([r, i]), Ma(this);
    }
    static isBasemap() {
    ...
    setViewpointRadian(n) {
      ...
      n.latitude !== void 0 && n.longitude !== void 0 && (i = bt(
    ...
    mercsFromGPSValue(n, i) {
      const r = bt(n, "EPSG:4326", "EPSG:3857"), s = n[1] * Math.PI / 180, g = i / Math.cos(s);
      return Ag.map((o) => [
        o[0] * g + r[0],
        o[1] * g + r[1]
      ]);
    ...
    rotateMatrix(n, i) {
      return i === void 0 && (i = this.getMap().getView().getRotation()), ng(n, i);
    }
    async resolvePois(n) {
      this.pois = await gg(n || [], {
    ...
    addPoi(n, i) {
      if (i || (i = "main"), this.pois[i])
        return n = WA(n), this.pois[i].pois.push(n), Ir(this.pois, i, {
          name: this.officialTitle || this.title,
          namespace: this.mapID
        }), n.namespaceID;
    }
    ...
    zoom2Radius(n, i) {
      return i === void 0 && (i = this.getMap().getView().getDecimalZoom()), ar(n, i);
    }
...
function hg(A) {
  class t extends lg(A) {
    static isBasemap_ = !0;
    static isWmts_ = !0;
    insideCheckXy(n) {
      return this.envelope ? Ia(n, this.envelope) : !0;
    }
    ...
    modulateXyInside(n) {
      ...
      const i = $o([n, this.centroid]), r = ya(this.envelope, i);
...
function ug(A) {
  return A = Ut(A), A.imageExtension || (A.imageExtension = "jpg"), A.mapID && !A.url && !A.urls && (A.url = A.tms ? `tiles/${A.mapID}/{z}/{x}/{-y}.${A.imageExtension}` : `tiles/${A.mapID}/{z}/{x}/{y}.${A.imageExtension}`), A;
}
function Ma(A) {
  const t = A;
        ...
        return new Promise((C, c) => {
          const h = function(p, f = void 0) {
            ...
            d.crossOrigin = "Anonymous", d.onload = d.onerror = function() {
              if (d.width && d.height) {
                const m = s.getContext("2d"), E = g === 0 ? 256 - a : 0, T = o === 0 ? 256 - I : 0;
                a = g + a > d.width ? d.width - g : a, I = o + I > d.height ? d.height - o : I, m.drawImage(d, g, o, a, I, E, T, a, I), C(void 0);
              } else
                f ? h(f) : C("tileLoadError");
            }, d.src = p;
          };
          h(r);
        });
...
function Pa(A) {
  ...
  return function() {
    ...
    return (!e || this !== n || !Ta(i, e)) && (n = this, e = i, t = A.apply(this, arguments)), t;
  };
}
function yg(A) {
  for (const t in A)
...
class wg extends fg {
   ...
   */
  disposeInternal() {
    this.listeners_ && yg(this.listeners_);
  }
  /**
  ...
  removeEventListener(t, e) {
    ...
    if (!n)
      return;
    const i = n.indexOf(e);
    i !== -1 && (this.pendingRemovals_ && t in this.pendingRemovals_ ? (n[i] = Ji, ++this.pendingRemovals_[t]) : (n.splice(i, 1), n.length === 0 && delete this.listeners_[t]));
  }
}
_s.prototype.getDecimalZoom = function() {
...
function ts(A, t) {
  ...
  let o = ot.UNKNOWN;
  return s < e ? o = o | ot.LEFT : s > i && (o = o | ot.RIGHT), g < n ? o = o | ot.BELOW : g > r && (o = o | ot.ABOVE), o === ot.UNKNOWN && (o = ot.INTERSECTING), o;
}
function Eg() {
  return [1 / 0, 1 / 0, -1 / 0, -1 / 0];
}
function Jn(A, t, e, n, i) {
  return i ? (i[0] = A, i[1] = t, i[2] = e, i[3] = n, i) : [A, t, e, n];
}
function bg(A) {
  return Jn(1 / 0, 1 / 0, -1 / 0, -1 / 0, A);
}
function Ba(A, t) {
  const e = A[0], n = A[1];
  return Jn(e, n, e, n, t);
}
function Oa(A, t, e, n, i) {
  const r = bg(i);
  return vg(r, A, t, e, n);
}
function vg(A, t, e, n, i) {
  for (; e < n; e += i)
    La(A, t[e], t[e + 1]);
  return A;
}
...
function Mg(A, t) {
  let e;
  return e = t(ka(A)), e || (e = t(Na(A)), e) || (e = t(ja(A)), e) || (e = t(Za(A)), e) ? e : !1;
}
function ka(A) {
  return [A[0], A[1]];
}
...
function Xa(A, t, e, n) {
  const i = t * n[0] / 2, r = t * n[1] / 2, s = Math.cos(e), g = Math.sin(e), o = i * s, a = i * g, I = r * s, C = r * g, c = A[0], h = A[1];
  return [
    c - o + C,
    h - a - I,
    c - o - C,
...
function Ua(A, t, e) {
  let n = !1;
  const i = ts(A, t), r = ts(A, e);
  if (i === ot.INTERSECTING || r === ot.INTERSECTING)
    n = !0;
  else {
    const s = A[0], g = A[1], o = A[2], a = A[3], I = t[0], C = t[1], c = e[0], h = e[1], p = (h - C) / (c - I);
    let f, d;
    r & ot.ABOVE && !(i & ot.ABOVE) && (f = c - (h - a) / p, n = f >= s && f <= o), !n && r & ot.RIGHT && !(i & ot.RIGHT) && (d = h - (c - o) * p, n = d >= g && d <= a), !n && r & ot.BELOW && !(i & ot.BELOW) && (f = c - (h - g) / p, n = f >= s && f <= o), !n && r & ot.LEFT && !(i & ot.LEFT) && (d = h - (c - s) * p, n = d >= g && d <= a);
  }
  return n;
}
function mt() {
...
let za = 0;
function Wa(A) {
  return A.ol_uid || (A.ol_uid = String(++za));
}
const Ha = {
  /**
...
function sA(A) {
  A && A.target && (A.target.removeEventListener(A.type, A.listener), yg(A));
}
const me = {
  /**
...
class qn extends wg {
   ...
   */
  changed() {
    ++this.revision_, this.dispatchEvent(me.CHANGE);
  }
  /**
...
class uA extends qn {
   ...
   */
  constructor(t) {
    super(), this.on, this.once, this.un, Wa(this), this.values_ = null, t !== void 0 && this.setProperties(t);
  }
  /**
   * Gets a value.
  ...
  notify(t, e) {
    let n;
    n = `change:${t}`, this.hasListener(n) && this.dispatchEvent(new As(n, t, e)), n = Ha.PROPERTYCHANGE, this.hasListener(n) && this.dispatchEvent(new As(n, t, e));
  }
  /**
   * @param {string} key Key name.
   * @param {import("./events.js").Listener} listener Listener.
  ...
  unset(t, e) {
    if (this.values_ && t in this.values_) {
      ...
      delete this.values_[t], xa(this.values_) && (this.values_ = null), e || this.notify(t, n);
    }
  }
}
function Ya(...A) {
...
class VA {
   ...
   */
  getMetersPerUnit() {
    return this.metersPerUnit_ || Tg[this.units_];
  }
  /**
...
const en = 6378137, iA = Math.PI * en, Ja = [-iA, -iA, iA, iA], qa = [-180, -85, 180, 85], Bn = en * Math.log(Math.tan(Math.PI / 2));
class _e extends VA {
  /**
...
function $a(A, t, e, n) {
  ...
  for (let r = 0; r < i; r += n) {
    t[r] = iA * A[r] / 180;
    let s = en * Math.log(Math.tan(Math.PI * (+A[r + 1] + 90) / 360));
    s > Bn ? s = Bn : s < -Bn && (s = -Bn), t[r + 1] = s;
  }
  return t;
}
function tI(A, t, e, n) {
  ...
  e = e > 1 ? e : 2, n = n ?? e, t === void 0 && (e > 2 ? t = A.slice() : t = new Array(i));
  for (let r = 0; r < i; r += n)
    t[r] = 180 * A[r] / iA, t[r + 1] = 360 * Math.atan(Math.exp(A[r + 1] / en)) / Math.PI - 90;
  return t;
}
const eI = 6378137, rs = [-180, -90, 180, 90], AI = Math.PI * eI / 180;
class Me extends VA {
  /**
   * @param {string} code Code.
...
let tr = {};
function nI(A) {
  return tr[A] || tr[A.replace(/urn:(x-)?ogc:def:crs:EPSG:(.*:)?(\w+)$/, "EPSG:$3")] || null;
}
function iI(A, t) {
  tr[A] = t;
}
...
const Un = 0.9996, Pt = 669438e-8, $n = Pt * Pt, ti = $n * Pt, xe = Pt / (1 - Pt), gs = Math.sqrt(1 - Pt), lA = (1 - gs) / (1 + gs), Sg = lA * lA, fr = Sg * lA, dr = fr * lA, Pg = dr * lA, xg = 1 - Pt / 4 - 3 * $n / 64 - 5 * ti / 256, rI = 3 * Pt / 8 + 3 * $n / 32 + 45 * ti / 1024, sI = 15 * $n / 256 + 45 * ti / 1024, gI = 35 * ti / 3072, oI = 3 / 2 * lA - 27 / 32 * fr + 269 / 512 * Pg, aI = 21 / 16 * Sg - 55 / 32 * dr, II = 151 / 96 * fr - 417 / 128 * Pg, CI = 1097 / 512 * dr, zn = 6378137;
function cI(A, t, e) {
  const n = A - 5e5, s = (e.north ? t : t - 1e7) / Un / (zn * xg), g = s + oI * Math.sin(2 * s) + aI * Math.sin(4 * s) + II * Math.sin(6 * s) + CI * Math.sin(8 * s), o = Math.sin(g), a = o * o, I = Math.cos(g), C = o / I, c = C * C, h = c * c, p = 1 - Pt * a, f = Math.sqrt(1 - Pt * a), d = zn / f, m = (1 - Pt) / p, E = xe * I ** 2, T = E * E, M = n / (d * Un), P = M * M, S = P * M, O = S * M, L = O * M, U = L * M, G = g - C / m * (P / 2 - O / 24 * (5 + 3 * c + 10 * E - 4 * T - 9 * xe)) + U / 720 * (61 + 90 * c + 298 * E + 45 * h - 252 * xe - 3 * T);
  let Z = (M - S / 6 * (1 + 2 * c + E) + L / 120 * (5 - 2 * E + 28 * c - 3 * T + 8 * xe + 24 * h)) / I;
  return Z = $i(
    Z + oA(Dg(e.number)),
    -Math.PI,
    Math.PI
...
const os = -80, as = 84, lI = -180, hI = 180;
function uI(A, t, e) {
  A = $i(A, lI, hI), t < os ? t = os : t > as && (t = as);
  const n = oA(t), i = Math.sin(n), r = Math.cos(n), s = i / r, g = s * s, o = g * g, a = oA(A), I = Dg(e.number), C = oA(I), c = zn / Math.sqrt(1 - Pt * i ** 2), h = xe * r ** 2, p = r * $i(a - C, -Math.PI, Math.PI), f = p * p, d = f * p, m = d * p, E = m * p, T = E * p, M = zn * (xg * n - rI * Math.sin(2 * n) + sI * Math.sin(4 * n) - gI * Math.sin(6 * n)), P = Un * c * (p + d / 6 * (1 - g + h) + E / 120 * (5 - 18 * g + o + 72 * h - 58 * xe)) + 5e5;
  let S = Un * (M + c * s * (f / 2 + m / 24 * (5 - g + 9 * h + 4 * h ** 2) + T / 720 * (61 - 58 * g + o + 600 * h - 330 * xe)));
...
function dI(A) {
  return Bg(A) ? new VA({ code: A, units: "m" }) : null;
}
function mI(A) {
  const t = Bg(A.getCode());
  return t ? {
    forward: Is(uI, t),
    inverse: Is(cI, t)
  } : null;
...
function ae(A, t) {
  return er && !Fn(A, [0, 0]) && A[0] >= -180 && A[0] <= 180 && A[1] >= -90 && A[1] <= 90 && (er = !1, Ya(
...
function Lg(A, t, e, n, i, r, s) {
  s = s || [];
  const g = Math.cos(i), o = Math.sin(i), a = r[0], I = r[1];
  let C = 0;
  for (let c = t; c < e; c += n) {
    const h = A[c] - a, p = A[c + 1] - I;
    s[C++] = a + h * g - p * o, s[C++] = I + h * o + p * g;
...
const hs = SI(), OI = [NaN, NaN];
class LI extends uA {
  constructor() {
    super(), this.extent_ = Eg(), this.extentRevision_ = -1, this.simplifiedGeometryMaxMinSquaredTolerance = 0, this.simplifiedGeometryRevision = 0, this.simplifyTransformedInternal = Pa(
      (t, e, n) => {
        if (!n)
   ...
   */
  containsXY(t, e) {
    return this.closestPointXY(t, e, OI, Number.MIN_VALUE) === 0;
  }
  /**
  ...
  getExtent(t) {
    if (this.extentRevision_ != this.getRevision()) {
      ...
      (isNaN(e[0]) || isNaN(e[1])) && bg(e), this.extentRevision_ = this.getRevision();
    }
    return Fa(this.extent_, t);
  }
  /**
   ...
   */
  transform(t, e) {
    const n = _A(t), i = n.getUnits() == "tile-pixels" ? function(r, s, g) {
      const o = n.getExtent(), a = n.getWorldExtent(), I = YA(a) / YA(o);
      PI(
        hs,
        a[0],
        a[3],
...
class An extends LI {
  ...
  setFlatCoordinates(t, e) {
    this.stride = us(t), this.layout = t, this.flatCoordinates = e;
  }
  /**
   * @abstract
   ...
   */
  scale(t, e, n) {
    e === void 0 && (e = t), n || (n = jn(this.getExtent()));
...
class yr extends An {
  ...
  intersectsExtent(t) {
    ...
    if (lr(t, e)) {
      ...
      return t[0] <= n[0] && t[2] >= n[0] || t[1] <= n[1] && t[3] >= n[1] ? !0 : Mg(t, this.intersectsCoordinate.bind(this));
    }
    return !1;
  }
  /**
...
function ZI(A, t, e, n, i, r, s, g, o, a, I) {
  I = I || [NaN, NaN];
...
function Gg(A, t, e, n, i, r) {
  if (e.length === 0 || !De(A, t, e[0], n, i, r))
    return !1;
  for (let s = 1, g = e.length; s < g; ++s)
    if (De(A, e[s - 1], e[s], n, i, r))
      return !1;
  return !0;
}
...
function ei(A, t, e, n, i, r) {
  return r = r ?? vg(Eg(), A, t, e, n), lr(i, r) ? r[0] >= i[0] && r[2] <= i[2] || r[1] >= i[1] && r[3] <= i[3] ? !0 : Xg(
    A,
    t,
    e,
    n,
...
function Zg(A, t, e, n, i, r, s) {
  ...
  for (; a.length > 0; ) {
    ...
    for (let E = c + n; E < C; E += n) {
      const T = A[E], M = A[E + 1], P = Va(T, M, p, f, d, m);
      P > h && (I = E, h = P);
    }
    h > i && (o[(I - t) / n] = 1, c + n < I && a.push(c, I), I + n < C && a.push(I, C));
  }
  for (let C = 0; C < g; ++C)
...
function WI(A, t, e, n, i, r, s) {
  ...
  for (; t < e; ) {
    ...
    if (t += n, C == a && c == I)
      continue;
    const h = a - g, p = I - o, f = C - g, d = c - o;
    if (h * d == p * f && (h < 0 && f < h || h == f || h > 0 && f > h) && (p < 0 && d < p || p == d || p > 0 && d > p)) {
      a = C, I = c;
      continue;
    }
...
class JA extends An {
   ...
   */
  setCoordinates(t, e) {
    this.setLayout(e, t, 1), this.flatCoordinates || (this.flatCoordinates = []), this.flatCoordinates.length = pr(
      this.flatCoordinates,
      0,
      t,
      this.stride
...
function QI(A, t, e, n, i, r, s) {
  ...
  if (a === 1)
    ...
    for (let d = t + n; d < e; d += n) {
      const m = A[d], E = A[d + 1];
      c += Math.sqrt((m - I) * (m - I) + (E - C) * (E - C)), h.push(c), I = m, C = E;
    }
    const p = i * c, f = Ra(h, p);
    f < 0 ? (o = (p - h[-f - 2]) / (h[-f - 1] - h[-f - 2]), g = t + (-f - 2) * n) : g = t + f * n;
  }
  s = s > 1 ? s : 2, r = r || new Array(s);
  for (let I = 0; I < s; ++I)
    r[I] = g === void 0 ? NaN : o === void 0 ? A[g + I] : hr(A[g + I], A[g + n + I], o);
  return r;
}
function YI(A, t, e, n, i, r) {
  if (e == t)
    return null;
  let s;
  if (i < A[t + n - 1])
...
class Wn extends An {
  ...
  getCoordinateAtM(t, e) {
    return this.layout != "XYM" && this.layout != "XYZM" ? null : (e = e !== void 0 ? e : !1, YI(
      this.flatCoordinates,
      0,
      this.flatCoordinates.length,
      this.stride,
...
class qA extends An {
   ...
   */
  clone() {
    const t = new qA(this.flatCoordinates.slice(), this.layout);
    return t.applyProperties(this), t;
  }
  /**
   * @param {number} x X.
   ...
   */
  computeExtent(t) {
    return Ba(this.flatCoordinates, t);
  }
  /**
   * Get the type of this geometry.
   * @return {import("./Geometry.js").Type} Geometry type.
   ...
   */
  intersectsExtent(t) {
    return Da(t, this.flatCoordinates[0], this.flatCoordinates[1]);
  }
  /**
   * @param {!Array<*>} coordinates Coordinates.
   * @param {import("./Geometry.js").GeometryLayout} [layout] Layout.
...
function KI(A, t, e, n, i, r, s) {
  let g, o, a, I, C, c, h;
  const p = i[r + 1], f = [];
  for (let E = 0, T = e.length; E < T; ++E) {
    const M = e[E];
    for (I = A[M - n], c = A[M - n + 1], g = t; g < M; g += n)
      C = A[g], h = A[g + 1], (p <= c && h <= p || c <= p && p <= h) && (a = (p - c) / (h - c) * (C - I) + I, f.push(a)), I = C, c = h;
  }
  let d = NaN, m = -1 / 0;
  for (f.sort(dg), I = f[0], g = 1, o = f.length; g < o; ++g) {
    C = f[g];
    const E = Math.abs(C - I);
    E > m && (a = (I + C) / 2, Gg(A, t, e, n, a, p) && (d = a, m = E)), I = C;
  }
...
function ds(A, t, e, n, i) {
  ...
  for (let r = 0, s = e.length; r < s; ++r) {
    ...
    (r === 0 ? i && o || !i && !o : i && !o || !i && o) && _I(A, t, g, n), t = g;
  }
  return t;
}
class Be extends An {
  ...
  closestPointXY(t, e, n, i) {
    ...
    ), this.maxDeltaRevision_ = this.getRevision()), ZI(
      this.flatCoordinates,
      0,
      this.ends_,
      this.stride,
  ...
  getCoordinates(t) {
    let e;
    return t !== void 0 ? (e = this.getOrientedFlatCoordinates().slice(), ds(e, 0, this.ends_, this.stride, t)) : e = this.flatCoordinates, jI(e, 0, this.ends_, this.stride);
  }
  /**
   ...
   */
  getInteriorPoint() {
    return new qA(this.getFlatInteriorPoint(), "XYM");
  }
  /**
   ...
   */
  getLinearRing(t) {
    return t < 0 || this.ends_.length <= t ? null : new JA(
      this.flatCoordinates.slice(
  ...
  getOrientedFlatCoordinates() {
    if (this.orientedRevision_ != this.getRevision()) {
      ...
      JI(t, 0, this.ends_, this.stride) ? this.orientedFlatCoordinates_ = t : (this.orientedFlatCoordinates_ = t.slice(), this.orientedFlatCoordinates_.length = ds(
...
function ms(A) {
  ...
  return new Be(r, "XY", [r.length]);
}
class hA extends hg(Js) {
  constructor(t = {}) {
    const e = ug(t);
...
function ps(A, t, e) {
  return (
    ...
    (function(n, i, r, s, g) {
      ...
      let c = A[0] + o / 2 + I, h = A[2] - o / 2 + I, p = A[1] + a / 2 + C, f = A[3] - a / 2 + C;
      c > h && (c = (h + c) / 2, h = c), p > f && (p = (f + p) / 2, f = p);
      let d = kt(n[0], c, h), m = kt(n[1], p, f);
      if (s && e && i) {
        const E = 30 * i;
        d += -E * Math.log(1 + Math.max(0, c - n[0]) / E) + E * Math.log(1 + Math.max(0, n[0] - h) / E), m += -E * Math.log(1 + Math.max(0, p - n[1]) / E) + E * Math.log(1 + Math.max(0, n[1] - f) / E);
      }
      return [d, m];
    })
  );
...
function AC(A, t, e, n) {
  ...
  (function(i, r, s, g) {
    if (i !== void 0) {
      const o = A[0], a = A[A.length - 1], I = e ? vr(
        o,
        e,
        s,
        n
      ...
      const C = Math.min(I, i), c = Math.floor(mg(A, C, r));
      return A[c] > I && c < A.length - 1 ? A[c + 1] : A[c];
    }
  });
}
function nC(A, t, e, n, i, r) {
  ...
  (function(s, g, o, a) {
    if (s !== void 0) {
      ...
      ), h = -g * (0.5 - C) + 0.5, p = Math.min(I, s), f = Math.floor(
...
class Es extends uA {
   ...
   */
  constructor(t) {
    super(), this.on, this.once, this.un, t = Object.assign({}, t), this.hints_ = [0, 0], this.animations_ = [], this.updateAnimationKey_, this.projection_ = mr(t.projection, "EPSG:3857"), this.viewportSize_ = [100, 100], this.targetCenter_ = null, this.targetResolution_, this.targetRotation_, this.nextCenter_ = null, this.nextResolution_, this.nextRotation_, this.cancelAnchor_ = void 0, t.projection && wI(), t.center && (t.center = ae(t.center, this.projection_)), t.extent && (t.extent = On(t.extent, this.projection_)), this.applyOptions_(t);
  }
  /**
  ...
  applyOptions_(t) {
    ...
    const i = gC(t), r = n.constraint, s = aC(t);
    this.constraints_ = {
      center: i,
      resolution: r,
      rotation: s
  ...
  animate(t) {
    ...
    for (let n = 0; n < e.length; ++n) {
      let i = arguments[n];
      i.center && (i = Object.assign({}, i), i.center = ae(
        i.center,
        this.getProjection()
      )), i.anchor && (i = Object.assign({}, i), i.anchor = ae(
        i.anchor,
        this.getProjection()
      )), e[n] = i;
    }
  ...
  animateInternal(t) {
    ...
    for (; i < e; ++i) {
      ...
      if (I.center && (C.sourceCenter = s, C.targetCenter = I.center.slice(), s = C.targetCenter), I.zoom !== void 0 ? (C.sourceResolution = g, C.targetResolution = this.getResolutionForZoom(I.zoom), g = C.targetResolution) : I.resolution && (C.sourceResolution = g, C.targetResolution = I.resolution, g = C.targetResolution), I.rotation !== void 0) {
        C.sourceRotation = o;
        const c = qi(I.rotation - o + Math.PI, 2 * Math.PI) - Math.PI;
        C.targetRotation = o + c, o = C.targetRotation;
      }
      IC(C) ? C.complete = !0 : r += C.duration, a.push(C);
    }
    this.animations_.push(a), this.setHint(Ie.ANIMATING, 1), this.updateAnimations_();
  }
  /**
  ...
  cancelAnimations() {
    ...
    for (let e = 0, n = this.animations_.length; e < n; ++e) {
      ...
      if (i[0].callback && Ln(i[0].callback, !1), !t)
    ...
    for (let n = this.animations_.length - 1; n >= 0; --n) {
      ...
      for (let s = 0, g = i.length; s < g; ++s) {
        ...
        if (o.sourceRotation !== void 0 && o.targetRotation !== void 0) {
          const c = C === 1 ? qi(o.targetRotation + Math.PI, 2 * Math.PI) - Math.PI : o.sourceRotation + C * (o.targetRotation - o.sourceRotation);
          if (o.anchor) {
  ...
  calculateCenterRotate(t, e) {
    ...
    return i !== void 0 && (n = [i[0] - e[0], i[1] - e[1]], ur(n, t - this.getRotation()), Ka(n, e)), n;
  }
  /**
  ...
  getCenter() {
    ...
    return t && ls(t, this.getProjection());
  }
  /**
  ...
  calculateExtent(t) {
    ...
    return MI(e, this.getProjection());
  }
  /**
  ...
  calculateExtentInternal(t) {
    ...
    le(e, "The view center is not defined");
    const n = (
      /** @type {!number} */
      this.getResolution()
    );
    le(n !== void 0, "The view resolution is not defined");
    const i = (
      /** @type {!number} */
      this.getRotation()
    );
    return le(i !== void 0, "The view rotation is not defined"), Ga(e, n, i, t);
  }
  /**
  ...
  getZoomForResolution(t) {
    ...
    if (this.resolutions_) {
      const r = mg(this.resolutions_, t, 1);
  ...
  fit(t, e) {
    ...
    if (le(
      ...
      const i = On(t, this.getProjection());
      n = ms(i);
      ...
      n = ms(i), n.rotate(this.getRotation(), jn(i));
    } else
      n = t;
  ...
  rotatedExtentForGeometry(t) {
    ...
    for (let C = 0, c = r.length; C < c; C += s) {
      const h = r[C] * n - r[C + 1] * i, p = r[C] * i + r[C + 1] * n;
      g = Math.min(g, h), o = Math.min(o, p), a = Math.max(a, h), I = Math.max(I, p);
    }
    return [g, o, a, I];
  }
  /**
  ...
  fitInternal(t, e) {
    ...
    const a = this.getRotation(), I = Math.sin(a), C = Math.cos(a), c = jn(g);
    c[0] += (i[1] - i[3]) / 2 * o, c[1] += (i[0] - i[2]) / 2 * o;
    const h = c[0] * C - c[1] * I, p = c[1] * C + c[0] * I, f = this.getConstrainedCenter([h, p], o), d = e.callback ? e.callback : Ji;
    e.duration !== void 0 ? this.animateInternal(
      ...
      d
    ) : (this.targetResolution_ = o, this.targetCenter_ = f, this.applyTargetState_(!1, !0), Ln(d, !0));
  }
  /**
   ...
   */
  adjustCenter(t) {
    const e = ls(this.targetCenter_, this.getProjection());
    this.setCenter([
      e[0] + t[0],
      e[1] + t[1]
    ]);
  ...
  adjustResolution(t, e) {
    e = e && ae(e, this.getProjection()), this.adjustResolutionInternal(t, e);
  }
  /**
   * Multiply the view resolution by a ratio, optionally using an anchor. Any resolution
   * constraint will apply.
   ...
   */
  adjustRotation(t, e) {
    e && (e = ae(e, this.getProjection())), this.adjustRotationInternal(t, e);
  }
  /**
   * @param {number} delta Relative value to add to the zoom rotation, in radians.
   * @param {import("./coordinate.js").Coordinate} [anchor] The rotation center.
  ...
  applyTargetState_(t, e) {
    ...
    this.get(Lt.ROTATION) !== i && this.set(Lt.ROTATION, i), this.get(Lt.RESOLUTION) !== s && (this.set(Lt.RESOLUTION, s), this.set("zoom", this.getZoom(), !0)), (!g || !this.get(Lt.CENTER) || !Fn(this.get(Lt.CENTER), g)) && this.set(Lt.CENTER, g), this.getAnimating() && !t && this.cancelAnimations(), this.cancelAnchor_ = void 0;
  }
  /**
  ...
  resolveConstraints(t, e, n) {
    ...
    n = n || (t === 0 ? this.cancelAnchor_ : void 0), this.cancelAnchor_ = void 0, (this.getResolution() !== g || this.getRotation() !== r || !this.getCenterInternal() || !Fn(this.getCenterInternal(), o)) && (this.getAnimating() && this.cancelAnimations(), this.animateInternal({
      rotation: r,
      center: o,
      resolution: g,
      duration: t,
  ...
  endInteraction(t, e, n) {
    n = n && ae(n, this.getProjection()), this.endInteractionInternal(t, e, n);
  }
  /**
   * Notify the View that an interaction has ended. The view state will be resolved
   * to a stable one if needed (depending on its constraints).
...
function gC(A) {
  if (A.extent !== void 0) {
    ...
    return ps(A.extent, A.constrainOnlyCenter, e);
  }
  const t = mr(A.projection, "EPSG:3857");
  if (A.multiWorld !== !0 && t.isGlobal()) {
    const e = t.getExtent().slice();
    return e[0] = -1 / 0, e[2] = 1 / 0, ps(e, !1, !1);
  }
  return qI;
}
function oC(A) {
  let t, e, n, s = A.minZoom !== void 0 ? A.minZoom : Pi, g = A.maxZoom !== void 0 ? A.maxZoom : 28;
  const o = A.zoomFactor !== void 0 ? A.zoomFactor : 2, a = A.multiWorld !== void 0 ? A.multiWorld : !1, I = A.smoothResolutionConstraint !== void 0 ? A.smoothResolutionConstraint : !0, C = A.showFullExtent !== void 0 ? A.showFullExtent : !1, c = mr(A.projection, "EPSG:3857"), h = c.getExtent();
  let p = A.constrainOnlyCenter, f = A.extent;
  if (!a && !f && c.isGlobal() && (p = !1, f = h), A.resolutions !== void 0) {
    const d = A.resolutions;
    e = d[s], n = d[g] !== void 0 ? d[g] : d[d.length - 1], A.constrainResolution ? t = AC(
      d,
      I,
      !p && f,
      C
    ...
    const m = (h ? Math.max(cr(h), YA(h)) : (
      // use an extent that can fit the whole world if need be
      360 * Tg.degrees / c.getMetersPerUnit()
    )) / sC / Math.pow(2, Pi), E = m / Math.pow(2, 28 - Pi);
    ...
    ), n = e / Math.pow(o, g - s), A.constrainResolution ? t = nC(
      o,
      e,
      n,
      I,
...
function aC(A) {
  if (A.enableRotation !== void 0 ? A.enableRotation : !0) {
    ...
    return e === void 0 || e === !0 ? rC() : e === !1 ? ws : typeof e == "number" ? iC(e) : ws;
  }
  return Rr;
}
function IC(A) {
  return !(A.sourceCenter && A.targetCenter && !Fn(A.sourceCenter, A.targetCenter) || A.sourceResolution !== A.targetResolution || A.sourceRotation !== A.targetRotation);
}
function xi(A, t, e, n, i) {
  const r = Math.cos(-i);
...
class cC extends uA {
  ...
  constructor(t) {
    ...
    const e = Object.assign({}, t);
    typeof t.properties == "object" && (delete e.properties, Object.assign(e, t.properties)), e[z.OPACITY] = t.opacity !== void 0 ? t.opacity : 1, le(
   ...
   */
  setOpacity(t) {
    le(typeof t == "number", "Layer opacity must be a number"), this.set(z.OPACITY, t);
  }
  /**
...
class Fg extends cC {
  ...
  isVisible(t) {
    ...
    return lC(i, e.viewState) && (!r || lr(r, e.extent));
  }
  /**
   ...
   */
  setMap(t) {
    this.mapPrecomposeKey_ && (sA(this.mapPrecomposeKey_), this.mapPrecomposeKey_ = null), t || this.changed(), this.mapRenderKey_ && (sA(this.mapRenderKey_), this.mapRenderKey_ = null), t && (this.mapPrecomposeKey_ = de(
      t,
      CC.PRECOMPOSE,
      this.handlePrecompose_,
      this
    ), this.mapRenderKey_ = de(this, me.CHANGE, t.render, t), this.changed());
  }
  /**
...
class hC extends Fg {
  constructor(t) {
    const e = function(n) {
      ...
      s.style.opacity = a;
      const I = g.rotation * -180 / Math.PI, C = or(g.center), c = g.zoom - 1, h = r.getBearing(), p = r.getCenter().toArray(), f = r.getZoom();
      return I == h && C[0] == p[0] && C[1] == p[1] && c == f || (I != h && r.rotateTo(I, {
        animate: !1
...
class uC extends Fg {
  constructor(t) {
    const e = function(n) {
      ...
      const h = or(g.center), p = g.zoom - 1;
      if ((r.getCenter().toArray().toString() !== h.toString() || r.getZoom() !== p) && r.jumpTo({
        center: h,
        zoom: p,
        animate: !1
...
class he extends fo {
  ...
  static spawnLayer(t, e, n) {
    return e instanceof Hn || e instanceof Qn || !(t instanceof wi) ? (e instanceof Hn ? t = new hC({
      style: e.style,
      accessToken: e.accessToken,
      container: n,
      source: e
    }) : e instanceof Qn ? t = new uC({
      style: e.style,
      container: n,
      source: e
    }) : (t = new wi({
      source: e
    }), he.applyWmtsZoomGate(t, e)), t.set("name", "base")) : (t.setSource(e), he.applyWmtsZoomGate(t, e)), t;
  }
  getLayer(t = "base") {
    const e = (n) => {
  ...
  setFeature(t, e, n) {
    const i = this.getSource(n), r = new mo(t);
  ...
  setGPSPosition(t, e = void 0) {
    const n = e == "sub" ? mC : e == "hide" ? dC : fC;
    e != "sub" && this.resetFeature("gps"), t && (this.setFeature(
      {
        geometry: new qA(t.xy)
      },
      n,
      "gps"
    ), e || this.setFeature(
      {
        geometry: new yr(t.xy, t.rad)
      },
      pC,
      "gps"
    ));
  ...
  setMarker(t, e, n, i) {
    return i || (i = "marker"), e.geometry = new qA(t), n ? typeof n == "string" ? n = new Ft({
      image: new CA({
        anchor: [0.5, 1],
        anchorXUnits: "fraction",
        anchorYUnits: "fraction",
    ...
    }) : n instanceof Ft || (n = new Ft({
      image: new CA(n)
    })) : n = yC, this.setFeature(e, n, i);
  }
  resetMarker(t) {
  ...
  setVector(t, e = "Line", n, i) {
    i || (i = "feature");
    const r = {};
    n.stroke != null && (r.stroke = new zi(n.stroke)), n.fill != null && (r.fill = new Wi(n.fill));
    const s = new Ft(r), g = e === "Line" ? new Wn(t) : new Be(t);
  ...
  setFillEnvelope(t, e, n, i) {
    ...
    if (e != null || n != null) {
      const s = {};
      e != null && (s.stroke = new zi(e)), n != null && (s.fill = new Wi(n)), r = new Ft(s);
    }
    return this.setFeature(
      {
        geometry: new Be([t])
  ...
  exchangeSource(t = void 0) {
    const e = this.getLayers(), n = e.item(0), i = he.spawnLayer(n, t, this.getTarget());
  ...
  setLayer(t = void 0) {
    ...
    if (e.clear(), t) {
      ...
      he.applyWmtsZoomGate(n, t), e.push(n);
    }
  }
  setTransparency(t) {
    const e = (100 - t) / 100, n = this.getSource();
    n instanceof hA || n instanceof nr ? (this.getLayers().item(0).setOpacity(1), this.getLayers().item(1).setOpacity(e)) : this.getLayers().item(0).setOpacity(e);
  }
  setGPSMarker(t, e) {
...
class EC extends uA {
   ...
   */
  updateLength_() {
    this.set(vs.LENGTH, this.array_.length);
  }
  /**
   * @private
   * @param {T} elem Element.
...
class vC extends nn {
  ...
  handleEvent(t) {
    ...
    if (t.type == jA.DBLCLICK) {
      ...
      Sr(g, s, r, this.duration_), n.preventDefault(), e = !0;
    }
    return !e;
  }
}
const Oe = typeof navigator < "u" && typeof navigator.userAgent < "u" ? navigator.userAgent.toLowerCase() : "", MC = Oe.includes("safari") && !Oe.includes("chrom");
MC && (Oe.includes("version/15.4") || /cpu (os|iphone os) 15_4 like mac os x/.test(Oe));
const RC = Oe.includes("webkit") && !Oe.includes("edge"), Hg = Oe.includes("macintosh");
...
const TC = function(A) {
  ...
  return (e instanceof ShadowRoot ? e.host : t).hasAttribute("tabindex") ? PC(A) : !0;
}, xC = Sa, Yg = function(A) {
  const t = A.originalEvent;
  return "pointerId" in t && t.button == 0 && !(RC && Hg && t.ctrlKey);
}, Vg = function(A) {
  const t = (
...
class OC extends fA {
  ...
  constructor(t) {
    ...
    const e = t.condition ? t.condition : ir(Vg, BC);
    this.condition_ = t.onFocusOnly ? ir(Qg, e) : e, this.noKinetic_ = !1;
  }
  /**
   * Handle pointer drag events.
   * @param {import("../MapBrowserEvent.js").default} mapBrowserEvent Event.
  ...
  handleDragEvent(t) {
    ...
    const n = this.targetPointers, i = e.getEventPixel(Pr(n));
    if (n.length == this.lastPointersCount_) {
      if (this.kinetic_ && this.kinetic_.update(i[0], i[1]), this.lastCentroid) {
        ...
        _a(r, g.getResolution()), ur(r, g.getRotation()), g.adjustCenterInternal(r);
      }
...
class LC extends fA {
  ...
  constructor(t) {
    t = t || {}, super({
      stopDown: _n
    }), this.condition_ = t.condition ? t.condition : SC, this.lastAngle_ = void 0, this.duration_ = t.duration !== void 0 ? t.duration : 250;
  }
  /**
   * Handle pointer drag events.
   * @param {import("../MapBrowserEvent.js").default} mapBrowserEvent Event.
  ...
  handleDragEvent(t) {
    if (!IA(t))
      return;
    const e = t.map, n = e.getView();
    if (n.getConstraints().rotation === Rr)
      return;
   ...
   */
  handleDownEvent(t) {
    return IA(t) && Yg(t) && this.condition_(t) ? (t.map.getView().beginInteraction(), this.lastAngle_ = void 0, !0) : !1;
  }
}
class kC extends fg {
  /**
  ...
  createOrUpdateGeometry() {
    ...
    i[4] = i[0].slice(), this.geometry_ ? this.geometry_.setCoordinates([i]) : this.geometry_ = new Be([i]);
  }
  /**
...
class NC extends fA {
   ...
   */
  constructor(t) {
    super(), this.on, this.once, this.un, t = t ?? {}, this.box_ = new kC(t.className || "ol-dragbox"), this.minArea_ = t.minArea ?? 64, t.onBoxEnd && (this.onBoxEnd = t.onBoxEnd), this.startPixel_ = null, this.condition_ = t.condition ?? Yg, this.boxEndCondition_ = t.boxEndCondition ?? this.defaultBoxEndCondition;
  }
  /**
  ...
  setActive(t) {
    t || (this.box_.setMap(null), this.startPixel_ && (this.dispatchEvent(
      new kA(qe.BOXCANCEL, this.startPixel_, null)
...
class GC extends NC {
  ...
  constructor(t) {
    t = t || {};
    const e = t.condition ? t.condition : Kg;
    super({
      condition: e,
...
class XC extends nn {
  ...
  handleEvent(t) {
    let e = !1;
    if (t.type == me.KEYDOWN) {
      const n = (
        /** @type {KeyboardEvent} */
        t.originalEvent
      ), i = n.key;
      if (this.condition_(t) && (i == Re.DOWN || i == Re.LEFT || i == Re.RIGHT || i == Re.UP)) {
        const s = t.map.getView(), g = s.getResolution() * this.pixelDelta_;
        let o = 0, a = 0;
        i == Re.DOWN ? a = -g : i == Re.LEFT ? o = -g : i == Re.RIGHT ? o = g : a = g;
        const I = [o, a];
        ur(I, s.getRotation()), wC(s, I, this.duration_), n.preventDefault(), e = !0;
      }
    }
    return !e;
  }
...
class ZC extends nn {
  ...
  handleEvent(t) {
    let e = !1;
    if (t.type == me.KEYDOWN || t.type == me.KEYPRESS) {
      const n = (
        /** @type {KeyboardEvent} */
        t.originalEvent
      ), i = n.key;
      if (this.condition_(t) && (i === "+" || i === "-")) {
        ...
        Sr(g, s, void 0, this.duration_), n.preventDefault(), e = !0;
      }
    }
    return !e;
  }
}
const jC = 40, FC = 300, UC = 3;
class zC extends nn {
  /**
   * @param {Options} [options] Options.
   */
  constructor(t) {
    ...
    const e = t.condition ? t.condition : xC;
    this.condition_ = t.onFocusOnly ? ir(Qg, e) : e, this.lastAnchor_ = null, this.startTime_ = void 0, this.timeoutId_, this.mode_ = void 0, this.trackpadEventGap_ = 400, this.trackpadTimeoutId_, this.deltaPerZoom_ = 300, this.ctrlKeyPressed_ = !1, this.ctrlKeyListenerKeys_ = [];
  }
  /**
   * @param {import('../Map.js').default|null} map Map.
   * @override
   ...
   */
  handleEvent(t) {
    if (!this.condition_(t) || t.type !== me.WHEEL)
      return !0;
    const n = t.map, i = (
      /** @type {WheelEvent} */
      t.originalEvent
  ...
  handleWheelZoom_(t) {
    ...
    (e.getConstrainResolution() || this.constrainResolution_) && (n = n ? n > 0 ? 1 : -1 : 0), Sr(
      e,
      n,
      this.lastAnchor_ ? t.getCoordinateFromPixel(this.lastAnchor_) : null,
      this.duration_
...
class WC extends fA {
  ...
  constructor(t) {
    ...
    e.stopDown || (e.stopDown = _n), super(e), this.anchor_ = null, this.lastAngle_ = void 0, this.rotating_ = !1, this.rotationDelta_ = 0, this.threshold_ = t.threshold !== void 0 ? t.threshold : 0.3, this.duration_ = t.duration !== void 0 ? t.duration : 250;
  }
  /**
   * Handle pointer drag events.
   * @param {import("../MapBrowserEvent.js").default} mapBrowserEvent Event.
  ...
  handleDragEvent(t) {
    ...
    g.getConstraints().rotation !== Rr && (this.anchor_ = s.getCoordinateFromPixelInternal(
      s.getEventPixel(Pr(this.targetPointers))
...
class HC extends fA {
  ...
  constructor(t) {
    ...
    e.stopDown || (e.stopDown = _n), super(e), this.anchor_ = null, this.duration_ = t.duration !== void 0 ? t.duration : 400, this.lastDistance_ = void 0, this.lastScaleDelta_ = 1;
  }
  /**
   * Handle pointer drag events.
   * @param {import("../MapBrowserEvent.js").default} mapBrowserEvent Event.
  ...
  handleDragEvent(t) {
    ...
    e != 1 && (this.lastScaleDelta_ = e), this.anchor_ = o.getCoordinateFromPixelInternal(
      o.getEventPixel(Pr(this.targetPointers))
...
function Ms(A) {
  A = A || {};
  const t = new EC(), e = new bC(-5e-3, 0.05, 100);
  return (A.altShiftDragRotate === void 0 || A.altShiftDragRotate) && t.push(new LC()), (A.doubleClickZoom === void 0 || A.doubleClickZoom) && t.push(
    new vC({
      delta: A.zoomDelta,
  ...
  ), (A.pinchRotate === void 0 || A.pinchRotate) && t.push(new WC()), (A.pinchZoom === void 0 || A.pinchZoom) && t.push(
    new HC({
      duration: A.zoomDuration
    })
  ), (A.keyboard === void 0 || A.keyboard) && (t.push(new XC()), t.push(
    new ZC({
      delta: A.zoomDelta,
      duration: A.zoomDuration
    })
...
class QC extends fA {
  ...
  constructor(t) {
    t = t || {}, super(
      /** @type {import("./Pointer.js").Options} */
      t
    ), this.condition_ = t.condition ? t.condition : Kg, this.lastAngle_ = void 0, this.lastMagnitude_ = void 0, this.lastScaleDelta_ = 0, this.duration_ = t.duration !== void 0 ? t.duration : 400;
  }
  /**
   * Handle pointer drag events.
   * @param {import("../MapBrowserEvent.js").default} mapBrowserEvent Event.
...
const KC = /\{z\}/g, _C = /\{x\}/g, JC = /\{y\}/g, qC = /\{-y\}/g;
function $C(A, t, e, n, i) {
  return A.replace(KC, t.toString()).replace(_C, e.toString()).replace(JC, n.toString()).replace(qC, function() {
    throw new Error(
...
class Jg extends ba(Js) {
  constructor(t = {}) {
    ...
    t.maxZoom = Math.ceil(Math.max(e, n)), t.tileUrlFunction = t.tileUrlFunction || function(i) {
      ...
      return (
        // @ts-ignore
        s * Se * Math.pow(2, this.maxZoom - r) >= this.width || // @ts-ignore
        g * Se * Math.pow(2, this.maxZoom - r) >= this.height || s < 0 || g < 0 ? rg : this._tileUrlFunction(i)
      );
    }, super(t), t.mapID && (this.mapID = t.mapID), t.urls ? this._tileUrlFunction = Rs(t.urls) : t.url && (this._tileUrlFunction = Rs(Array.isArray(t.url) ? t.url : [t.url])), this.width = t.width, this.height = t.height, this.maxZoom = t.maxZoom, this._maxxy = Math.pow(2, this.maxZoom) * Se, this.initialize(t);
  }
}
class Yn extends hA {
  static isBasemap_ = !1;
...
const Yt = "https://weiwudi.example.com/api/";
let Di, $e;
class Ac {
  constructor() {
    this.listeners = {};
...
class Vt extends Ac {
  ...
  static async swCheck() {
    return $e !== void 0 ? $e : (Di === void 0 && (Di = new Promise((t, e) => {
      fetch(`${Yt}ping`).then((n) => {
        $e = !!n, t($e);
      }).catch((n) => {
        $e = !1, t($e);
      });
  ...
  static async registerMap(t, e) {
    if (!await Vt.swCheck()) throw "Weiwudi service worker is not implemented.";
    let n;
    ...
    i.append("mapID", t);
    const r = new URL(`${Yt}add`);
    if (r.search = i.toString(), n = await (await fetch(r.href)).text(), n.match(/^Error: /))
      throw n;
    return new Vt(t, JSON.parse(n));
  }
  static async retrieveMap(t) {
    if (!await Vt.swCheck()) throw "Weiwudi service worker is not implemented.";
    let e;
    if (e = await (await fetch(`${Yt}info?mapID=${t}`)).text(), e.match(/^Error: /))
      throw e;
    return console.log(e), new Vt(t, JSON.parse(e));
  }
  static async removeMap(t) {
    if (!await Vt.swCheck()) throw "Weiwudi service worker is not implemented.";
    let e;
    if (e = await (await fetch(`${Yt}delete?mapID=${t}`)).text(), e.match(/^Error: /))
      throw e;
  }
  constructor(t, e) {
    if (super(), !t) throw "MapID is necessary.";
    this.mapID = t, e && Object.assign(this, e), this.url = `${Yt}cache/${t}/{z}/{x}/{y}`, this.listener = (n) => {
  ...
  async stats() {
    let t;
    if (this.checkAspect(), t = await (await fetch(`${Yt}stats?mapID=${this.mapID}`)).text(), typeof t == "string" && t.match(/^Error: /))
      throw t;
    return JSON.parse(t);
  }
  async clean() {
    let t;
    if (this.checkAspect(), t = await (await fetch(`${Yt}clean?mapID=${this.mapID}`)).text(), t.match(/^Error: /))
      throw t;
  }
  async fetchAll() {
    let t;
    if (this.checkAspect(), t = await (await fetch(`${Yt}fetchAll?mapID=${this.mapID}`)).text(), t.match(/^Error: /))
      throw t;
  }
  async remove() {
    this.checkAspect(), this.mapID && await Vt.removeMap(this.mapID), this.release();
  }
  async cancel() {
    let t;
    if (this.checkAspect(), t = await (await fetch(`${Yt}cancel?mapID=${this.mapID}`)).text(), t.match(/^Error: /))
      throw t;
  }
}
function Gn(A, t, e) {
  ...
  let r = pi(A, t);
  if (r == yi && n != i) {
    const s = pi(A, "EPSG:3857"), g = pi("EPSG:3857", t);
    if (s == yi && n != "EPSG:3857")
      throw "Transform of Source projection is not defined.";
    if (g == yi && i != "EPSG:3857")
      throw "Transform of Distination projection is not defined.";
    r = function(a) {
      return bt(bt(a, A, "EPSG:3857"), "EPSG:3857", t);
    }, Zn(A, t, r, function(a) {
      return bt(bt(a, t, "EPSG:3857"), "EPSG:3857", A);
    });
  }
  if (e)
    return r(e);
...
class Vn extends Jg {
  mapTransform;
  constructor(t = {}) {
    super(t), this.mapTransform = new ig();
  }
  static async createAsync(t) {
    const [e, n] = await ic(t);
    t = e;
    const i = new Vn(t);
    i.mapTransform = n;
    const r = n.getLayerTransform(0), s = new VA({
      code: `Illst:${i.mapID}`,
    ...
    return Ui(s), Zn(
      ...
      (g) => r.transform(g, !1),
      (g) => r.transform(g, !0)
    ), Gn("EPSG:4326", s), t.sub_maps && t.sub_maps.forEach((g, o) => {
  ...
  setupMapParameter(t) {
    ...
    this.mercZoom || (this.mercZoom = Math.log(300 * (2 * W) / 256 / p) / Math.log(2) - 3), this.homePosition || (this.homePosition = or(r)), this.envelope = ag([
      [
        C[0],
        C[1],
        C[2],
...
var at = typeof globalThis < "u" && globalThis || typeof self < "u" && self || // eslint-disable-next-line no-undef
typeof globalThis < "u" && globalThis || {}, pt = {
  searchParams: "URLSearchParams" in at,
  iterable: "Symbol" in at && "iterator" in Symbol,
  blob: "FileReader" in at && "Blob" in at && (function() {
    try {
      return new Blob(), !0;
    } catch {
      return !1;
  ...
  formData: "FormData" in at,
  arrayBuffer: "ArrayBuffer" in at
};
function rc(A) {
...
if (pt.arrayBuffer)
  var sc = [
    ...
    "[object Float32Array]",
    "[object Float64Array]"
  ], gc = ArrayBuffer.isView || function(A) {
    return A && sc.indexOf(Object.prototype.toString.call(A)) > -1;
  };
function dA(A) {
...
function oc(A) {
  var t = new FileReader(), e = qg(t);
  return t.readAsArrayBuffer(A), e;
}
function ac(A) {
  var t = new FileReader(), e = qg(t), n = /charset=([A-Za-z0-9_-]+)/.exec(A.type), i = n ? n[1] : "utf-8";
...
function $g() {
  return this.bodyUsed = !1, this._initBody = function(A) {
    ...
    if (A)
      return A;
    if (this._bodyBlob)
      return ac(this._bodyBlob);
    if (this._bodyArrayBuffer)
      return Promise.resolve(Ic(this._bodyArrayBuffer));
    if (this._bodyFormData)
...
function Le(A, t) {
  ...
  if (A instanceof Le) {
    ...
    this.url = String(A);
  if (this.credentials = t.credentials || this.credentials || "same-origin", (t.headers || !this.headers) && (this.headers = new tt(t.headers)), this.method = cc(t.method || this.method || "GET"), this.mode = t.mode || this.mode || null, this.signal = t.signal || this.signal || (function() {
    if ("AbortController" in at) {
...
Le.prototype.clone = function() {
  return new Le(this, { body: this._bodyInit });
};
function lc(A) {
  var t = new FormData();
...
zt.error = function() {
  var A = new zt(null, { status: 200, statusText: "" });
  return A.ok = !1, A.status = 0, A.type = "error", A;
};
var uc = [301, 302, 303, 307, 308];
zt.redirect = function(A, t) {
  if (uc.indexOf(t) === -1)
    throw new RangeError("Invalid status code");
  return new zt(null, { status: t, headers: { location: A } });
};
var Pe = at.DOMException;
try {
  new Pe();
} catch {
  Pe = function(t, e) {
...
function to(A, t) {
  return new Promise(function(e, n) {
    ...
    if (i.signal && i.signal.aborted)
      return n(new Pe("Aborted", "AbortError"));
    ...
    r.onload = function() {
      var a = {
        ...
        headers: hc(r.getAllResponseHeaders() || "")
      };
      ...
      setTimeout(function() {
        n(new Pe("Aborted", "AbortError"));
      }, 0);
    };
    function g(a) {
      try {
        return a === "" && at.location.href ? at.location.href : a;
      } catch {
        return a;
      }
    }
    if (r.open(i.method, g(i.url), !0), i.credentials === "include" ? r.withCredentials = !0 : i.credentials === "omit" && (r.withCredentials = !1), "responseType" in r && (pt.blob ? r.responseType = "blob" : pt.arrayBuffer && (r.responseType = "arraybuffer")), t && typeof t.headers == "object" && !(t.headers instanceof tt || at.Headers && t.headers instanceof at.Headers)) {
      var o = [];
      Object.getOwnPropertyNames(t.headers).forEach(function(a) {
        o.push(dA(a)), r.setRequestHeader(a, xr(t.headers[a]));
...
}, Ss = (A) => (A || "").match(/^(?:base|overlay|google(?:_(?:roadmap|satellite|hybrid|terrain))?|mapbox|maplibre|osm)$/);
async function dc(A, t) {
  if (typeof A == "string" && (A = fc[A]), A = Ut(Object.assign(A, t)), A.label = A.label || A.year, Ss(A.maptype)) {
    const s = A.maptype === "base" ? hA : A.maptype === "overlay" ? Yn : A.maptype === "mapbox" ? Hn : A.maptype === "maplibre" ? Qn : nr;
    s.isBasemap() ? (A.homePosition = A.homePos, A.mercZoom = A.defZoom) : (A.homePosition || (A.homePosition = A.homePos), A.mercZoom || (A.mercZoom = A.defZoom)), delete A.homePos, delete A.defZoom, A.zoomRestriction && (A.maxZoom = A.maxZoom || A.mercMaxZoom, A.minZoom = A.minZoom || A.mercMinZoom), A.zoomRestriction = A.mercMaxZoom = A.mercMinZoom = void 0, A.translator && (A.url = A.translator(A.url)), A.imageExtension || (A.imageExtension = "jpg"), A.mapID && !A.url && !A.urls && (A.url = A.tms ? `tiles/${A.mapID}/{z}/{x}/{-y}.${A.imageExtension}` : `tiles/${A.mapID}/{z}/{x}/{y}.${A.imageExtension}`), A.weiwudi = await Oi(A), A.weiwudi && (A.url = A.weiwudi.url, delete A.urls);
    const g = await s.createAsync(A);
    return await g.initialWait, g;
  } else if (A.noload)
    return A.mercMaxZoom = A.mercMinZoom = void 0, new Vn(A);
  const e = A.settingFile || `maps/${A.mapID}.json`, n = await fetch(e);
  if (!n.ok)
    throw new Error("Fail to load map json");
  const i = await n.json();
  if (A = Ut(Object.assign(i, A)), A.label = A.label || i.year, A.translator && (A.url = A.translator(A.url)), A.maptype || (A.maptype = "maplat"), Ss(A.maptype)) {
    const s = A.maptype === "base" ? hA : A.maptype === "overlay" ? Yn : A.maptype === "mapbox" ? Hn : A.maptype === "maplibre" ? Qn : nr;
  ...
  A.width = A.width || A.compiled.wh[0], A.height = A.height || A.compiled.wh[1], A.weiwudi = await Oi(A), A.weiwudi && (A.url = A.weiwudi.url, delete A.urls);
  const r = await Vn.createAsync(A);
...
async function Oi(A) {
  ...
  let n;
  try {
    n = await Vt.registerMap(A.mapID, t);
  } catch {
  }
  return n;
}
...
function rr(A, t) {
  if (A instanceof Array)
    return A.map((n) => rr(n, t));
  const e = Math.pow(10, t);
  return Math.round(A * e) / e;
}
var FA = { exports: {} }, ki, Ps;
function io() {
  if (Ps) return ki;
  Ps = 1;
  var A = /<%=([\s\S]+?)%>/g;
...
function mc() {
  if (xs) return Ni;
  xs = 1;
  var A = io(), t = "[object Null]", e = "[object Symbol]", n = "[object Undefined]", i = /[&<>"']/g, r = RegExp(i.source), s = /<%-([\s\S]+?)%>/g, g = /<%([\s\S]+?)%>/g, o = {
    "&": "&amp;",
    "<": "&lt;",
    ">": "&gt;",
    '"': "&quot;",
  ...
  function c(D, rt) {
    for (var Nt = -1, qt = D == null ? 0 : D.length, $t = Array(qt); ++Nt < qt; )
      $t[Nt] = rt(D[Nt], Nt, D);
    return $t;
  }
  function h(D) {
  ...
  var p = h(o), f = Object.prototype, d = f.hasOwnProperty, m = f.toString, E = C.Symbol, T = E ? E.toStringTag : void 0, M = E ? E.prototype : void 0, P = M ? M.toString : void 0, S = {
    /**
  ...
  function O(D) {
    return D == null ? D === void 0 ? n : t : T && T in Object(D) ? U(D) : G(D);
  }
  function L(D) {
    if (typeof D == "string")
      return D;
    ...
    if (q(D))
      return P ? P.call(D) : "";
    var rt = D + "";
    return rt == "0" && 1 / D == -1 / 0 ? "-0" : rt;
  }
  function U(D) {
    var rt = d.call(D, T), Nt = D[T];
    try {
      D[T] = void 0;
      var qt = !0;
    } catch {
    ...
    var $t = m.call(D);
    return qt && (rt ? D[T] = Nt : delete D[T]), $t;
  }
  function G(D) {
    return m.call(D);
  }
  ...
  function q(D) {
    return typeof D == "symbol" || j(D) && O(D) == e;
  }
  function it(D) {
    return D == null ? "" : L(D);
  }
  function vt(D) {
    return D = it(D), D && r.test(D) ? D.replace(i, p) : D;
  }
  return Ni = S, Ni;
}
FA.exports;
var Ds;
function pc() {
  return Ds || (Ds = 1, (function(A, t) {
    var e = io(), n = mc(), i = "Invalid `variable` option passed into `_.template`", r = "Invalid `imports` option passed into `_.template`", s = 800, g = 16, o = 9007199254740991, a = "[object Arguments]", I = "[object Array]", C = "[object AsyncFunction]", c = "[object Boolean]", h = "[object Date]", p = "[object DOMException]", f = "[object Error]", d = "[object Function]", m = "[object GeneratorFunction]", E = "[object Map]", T = "[object Number]", M = "[object Null]", P = "[object Object]", S = "[object Proxy]", O = "[object RegExp]", L = "[object Set]", U = "[object String]", G = "[object Symbol]", Z = "[object Undefined]", j = "[object WeakMap]", q = "[object ArrayBuffer]", it = "[object DataView]", vt = "[object Float32Array]", D = "[object Float64Array]", rt = "[object Int8Array]", Nt = "[object Int16Array]", qt = "[object Int32Array]", $t = "[object Uint8Array]", Q = "[object Uint8ClampedArray]", ni = "[object Uint16Array]", ii = "[object Uint32Array]", ri = /\b__p \+= '';/g, si = /\b(__p \+=) '' \+/g, gi = /(__e\(.*?\)|\b__t\)) \+\n'';/g, oi = /[\\^$.*+?()[\]{}|]/g, mA = /[()=,{}\[\]\/\s]/, ai = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, rn = /^\[object .+?Constructor\]$/, V = /^(?:0|[1-9]\d*)$/, pe = /($^)/, K = /['\n\r\u2028\u2029\\]/g, H = {};
    H[vt] = H[D] = H[rt] = H[Nt] = H[qt] = H[$t] = H[Q] = H[ni] = H[ii] = !0, H[a] = H[I] = H[q] = H[c] = H[it] = H[h] = H[f] = H[d] = H[E] = H[T] = H[P] = H[O] = H[L] = H[U] = H[j] = !1;
    var _ = {
      "\\": "\\",
      "'": "'",
      "\n": "n",
      ...
      "\u2028": "u2028",
      "\u2029": "u2029"
    }, te = typeof globalThis == "object" && globalThis && globalThis.Object === Object && globalThis, sn = typeof self == "object" && self && self.Object === Object && self, Mt = te || sn || Function("return this")(), pA = t && !t.nodeType && t, Wt = pA && !0 && A && !A.nodeType && A, yA = Wt && Wt.exports === pA, ke = yA && te.process, xt = (function() {
      try {
        var u = Wt && Wt.require && Wt.require("util").types;
        return u || ke && ke.binding && ke.binding("util");
      } catch {
      }
    })(), Dt = xt && xt.isTypedArray;
    function Gt(u, y, b) {
      switch (b.length) {
        case 0:
          return u.call(y);
        case 1:
          return u.call(y, b[0]);
        case 2:
          return u.call(y, b[0], b[1]);
        case 3:
          return u.call(y, b[0], b[1], b[2]);
      }
      return u.apply(y, b);
    }
    function wA(u, y) {
      for (var b = -1, B = u == null ? 0 : u.length; ++b < B && y(u[b], b, u) !== !1; )
        ;
      return u;
    }
    function Ne(u, y) {
      for (var b = -1, B = u == null ? 0 : u.length, k = Array(B); ++b < B; )
        k[b] = y(u[b], b, u);
      return k;
    }
    function EA(u, y) {
      for (var b = -1, B = Array(u); ++b < u; )
        B[b] = y(b);
      return B;
    }
    function bA(u) {
    ...
    var gn = Function.prototype, Ae = Object.prototype, ye = Mt["__core-js_shared__"], ne = gn.toString, st = Ae.hasOwnProperty, wt = (function() {
      var u = /[^.]+$/.exec(ye && ye.keys && ye.keys.IE_PROTO || "");
      return u ? "Symbol(src)_1." + u : "";
    })(), Ze = Ae.toString, on = ne.call(Object), an = RegExp(
      "^" + ne.call(st).replace(oi, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
    ), je = yA ? Mt.Buffer : void 0, we = Mt.Symbol, Fe = vA(Object.getPrototypeOf, Object), Ue = Ae.propertyIsEnumerable, et = we ? we.toStringTag : void 0, Bt = (function() {
      try {
        var u = li(Object, "defineProperty");
        return u({}, "", {}), u;
      } catch {
      }
    })(), MA = je ? je.isBuffer : void 0, RA = vA(Object.keys, Object), In = Math.max, Cn = Date.now, ze = we ? we.prototype : void 0, TA = ze ? ze.toString : void 0;
    function SA(u, y) {
      var b = Qt(u), B = !b && He(u), k = !b && !B && Rt(u), X = !b && !B && !k && mi(u), J = b || B || k || X, N = J ? EA(u.length, String) : [], Xt = N.length;
      for (var Tt in u)
        st.call(u, Tt) && !(J && // Safari 9 has enumerable `arguments.length` in strict mode.
        (Tt == "length" || // Node.js 0.10 has enumerable non-index properties on buffers.
        k && (Tt == "offset" || Tt == "parent") || // PhantomJS 2 has enumerable non-index properties on typed arrays.
        X && (Tt == "buffer" || Tt == "byteLength" || Tt == "byteOffset") || // Skip index properties.
        Ot(Tt, Xt))) && N.push(Tt);
      return N;
    }
    function Ii(u, y, b) {
      var B = u[y];
      (!(st.call(u, y) && be(B, b)) || b === void 0 && !(y in u)) && ie(u, y, b);
    }
    function ie(u, y, b) {
      y == "__proto__" && Bt ? Bt(u, y, {
        configurable: !0,
        enumerable: !0,
        value: b,
        writable: !0
    ...
    function re(u) {
      return u == null ? u === void 0 ? Z : M : et && et in Object(u) ? hi(u) : BA(u);
    }
    function cn(u) {
      return oe(u) && re(u) == a;
    }
    ...
    function se(u) {
      return oe(u) && OA(u.length) && !!H[re(u)];
    }
    function Ci(u) {
      if (!ui(u))
        return RA(u);
      ...
      for (var b in Object(u))
        st.call(u, b) && b != "constructor" && y.push(b);
      return y;
    }
    function PA(u, y) {
      return un(fi(u, y, v), u + "");
    }
    var xA = Bt ? function(u, y) {
      return Bt(u, "toString", {
        configurable: !0,
        enumerable: !1,
        value: w(y),
        writable: !0
    ...
    function DA(u) {
      ...
      if (di(u))
        return TA ? TA.call(u) : "";
      var y = u + "";
      return y == "0" && 1 / u == -1 / 0 ? "-0" : y;
    }
    function ln(u, y, b, B) {
      var k = !b;
      b || (b = {});
      for (var X = -1, J = y.length; ++X < J; ) {
        var N = y[X], Xt = B ? B(b[N], u[N], N, b, u) : void 0;
        Xt === void 0 && (Xt = u[N]), k ? ie(b, N, Xt) : Ii(b, N, Xt);
      }
      return b;
    }
    function ci(u) {
      return PA(function(y, b) {
        var B = -1, k = b.length, X = k > 1 ? b[k - 1] : void 0, J = k > 2 ? b[2] : void 0;
        for (X = u.length > 3 && typeof X == "function" ? (k--, X) : void 0, J && Ee(b[0], b[1], J) && (X = k < 3 ? void 0 : X, k = 1), y = Object(y); ++B < k; ) {
          var N = b[B];
          N && u(y, N, B, X);
        }
        return y;
    ...
    function hn(u, y, b, B) {
      return u === void 0 || be(u, Ae[b]) && !st.call(B, b) ? y : u;
    }
    function li(u, y) {
      var b = Xe(u, y);
      return Y(b) ? b : void 0;
    ...
    function hi(u) {
      ...
      var k = Ze.call(u);
      return B && (y ? u[et] = b : delete u[et]), k;
    }
    function Ot(u, y) {
      var b = typeof u;
      return y = y ?? o, !!y && (b == "number" || b != "symbol" && V.test(u)) && u > -1 && u % 1 == 0 && u < y;
    }
    function Ee(u, y, b) {
      if (!Qe(b))
        return !1;
      var B = typeof y;
      return (B == "number" ? ge(b) && Ot(y, b.length) : B == "string" && y in b) ? be(b[y], u) : !1;
    }
    function Ht(u) {
      return !!wt && wt in u;
    }
    function ui(u) {
      var y = u && u.constructor, b = typeof y == "function" && y.prototype || Ae;
      return u === b;
    }
    function BA(u) {
      return Ze.call(u);
    ...
    function fi(u, y, b) {
      return y = In(y === void 0 ? u.length - 1 : y, 0), function() {
        for (var B = arguments, k = -1, X = In(B.length - y, 0), J = Array(X); ++k < X; )
          J[k] = B[y + k];
        k = -1;
        for (var N = Array(y + 1); ++k < y; )
          N[k] = B[k];
        return N[y] = b(J), Gt(u, this, N);
      };
    }
    var un = fn(xA);
    function fn(u) {
    ...
    var He = cn(/* @__PURE__ */ (function() {
      return arguments;
    })()) ? cn : function(u) {
      return oe(u) && st.call(u, "callee") && !Ue.call(u, "callee");
    }, Qt = Array.isArray;
    function ge(u) {
      return u != null && OA(u.length) && !mn(u);
    }
    var Rt = MA || x;
    function dn(u) {
      if (!oe(u))
        return !1;
      var y = re(u);
      return y == f || y == p || typeof u.message == "string" && typeof u.name == "string" && !pn(u);
    }
    function mn(u) {
      if (!Qe(u))
        return !1;
      var y = re(u);
      return y == d || y == m || y == C || y == S;
    }
    function OA(u) {
    ...
    function Qe(u) {
      var y = typeof u;
      return u != null && (y == "object" || y == "function");
    }
    function oe(u) {
    ...
    function pn(u) {
      ...
      if (y === null)
        return !0;
      var b = st.call(y, "constructor") && y.constructor;
      return typeof b == "function" && b instanceof b && ne.call(b) == on;
    }
    function di(u) {
      return typeof u == "symbol" || oe(u) && re(u) == G;
    }
    var mi = Dt ? bA(Dt) : se;
    function yn(u) {
      return u == null ? "" : DA(u);
    }
    var ve = ci(function(u, y, b, B) {
      ln(y, Ye(y), u, B);
    });
    function Ye(u) {
      return ge(u) ? SA(u) : Ci(u);
    }
    function R(u, y, b) {
      var B = n.imports._.templateSettings || n;
      b && Ee(u, y, b) && (y = void 0), u = yn(u), y = ve({}, y, B, hn);
      var k = ve({}, y.imports, B.imports, hn), X = Ye(k), J = ee(k, X);
      wA(X, function(bn) {
        if (mA.test(bn))
          throw new Error(r);
      });
      var N, Xt, Tt = 0, Br = y.interpolate || pe, yt = "__p += '", co = RegExp(
        (y.escape || pe).source + "|" + Br.source + "|" + (Br === e ? ai : pe).source + "|" + (y.evaluate || pe).source + "|$",
        "g"
      ), lo = st.call(y, "sourceURL") ? "//# sourceURL=" + (y.sourceURL + "").replace(/\s/g, " ") + `
` : "";
      u.replace(co, function(bn, Or, vn, ho, Lr, kr) {
        return vn || (vn = ho), yt += u.slice(Tt, kr).replace(K, Ge), Or && (N = !0, yt += `' +
__e(` + Or + `) +
'`), Lr && (Xt = !0, yt += `';
` + Lr + `;
__p += '`), vn && (yt += `' +
...
`;
      var wn = st.call(y, "variable") && y.variable;
      if (!wn)
        yt = `with (obj) {
` + yt + `
}
`;
        ...
        throw new Error(i);
      yt = (Xt ? yt.replace(ri, "") : yt).replace(si, "$1").replace(gi, "$1;"), yt = "function(" + (wn || "obj") + `) {
` + (wn ? "" : `obj || (obj = {});
`) + "var __t, __p = ''" + (N ? ", __e = _.escape" : "") + (Xt ? `, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
` : `;
`) + yt + `return __p
}`;
      var En = l(function() {
        return Function(X, lo + "return " + yt).apply(void 0, J);
      });
      if (En.source = yt, dn(En))
        throw En;
      return En;
    }
    var l = PA(function(u, y) {
      try {
        return Gt(u, void 0, y);
      } catch (b) {
        return dn(b) ? b : new Error(b);
      }
    });
    function w(u) {
      return function() {
...
var yc = pc();
const ro = /* @__PURE__ */ wa(yc);
function Bs(A, ...t) {
  const e = Ut(Object.assign({}, A));
  if (e.icon) return e;
  const n = t.reduce((i, r) => {
    if (i) return i;
    const s = r.iconTemplate;
    if (s)
      return JSON.parse(ro(s)(e));
    if (r.icon)
      return {
        icon: r.icon,
...
function Os(A, ...t) {
  return A = Ut(A), A.html ? A : t.reduce((e, n) => {
    if (e) return e;
    const i = n.poiTemplate;
    if (i)
      return A.html = ro(i)(A), A.poiStyle = A.poiStyle || n.poiStyle, A;
  }, void 0) || A;
}
const gt = {
  ACCURACY: "accuracy",
...
class Ec extends Jt {
  ...
  message;
  constructor(t) {
    super(wc.ERROR), this.code = t.code, this.message = t.message;
  }
}
class bc extends uA {
  task_id_;
  ...
  home_position_ = !1;
  constructor(t) {
    super(), t = t || {}, this.timer_base_ = t.timerBase !== void 0 ? t.timerBase : !1, this.task_id_ = void 0, this.home_position_ = t.homePosition !== void 0 ? t.homePosition : !1, this.addChangeListener(gt.TRACKING, this.handleTrackingChanged_), t.trackingOptions !== void 0 ? this.setTrackingOptions(t.trackingOptions) : this.setTrackingOptions({
  ...
  timerPositionChange_() {
    const t = {
      longitude: Li(this.home_position_[0], 0.05),
      latitude: Li(this.home_position_[1], 0.05),
      accuracy: Li(15, 10)
    };
  ...
  positionChange_(t) {
    const e = t.coords;
    this.set(gt.ACCURACY, e.accuracy), this.set(
      gt.ALTITUDE,
      e.altitude === null ? void 0 : e.altitude
    ), this.set(
      gt.ALTITUDE_ACCURACY,
      e.altitudeAccuracy === null ? void 0 : e.altitudeAccuracy
    ), this.set(
      gt.HEADING,
      e.heading === null ? void 0 : oA(e.heading)
    ), this.set(gt.POSITION, [e.longitude, e.latitude]), this.set(gt.SPEED, e.speed === null ? void 0 : e.speed), this.changed();
  }
  timerPositionError_() {
...
function Tc(A, t) {
  return vc(A) || Mc(A, t) || Sc(A, t) || Rc();
}
function Sc(A, t) {
  if (A) {
    if (typeof A == "string") return Ls(A, t);
    var e = {}.toString.call(A).slice(8, -1);
    return e === "Object" && A.constructor && (e = A.constructor.name), e === "Map" || e === "Set" ? Array.from(A) : e === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e) ? Ls(A, t) : void 0;
  }
}
const oo = Object.entries, ks = Object.setPrototypeOf, Pc = Object.isFrozen, xc = Object.getPrototypeOf, Dc = Object.getOwnPropertyDescriptor;
let It = Object.freeze, Ct = Object.seal, nA = Object.create, ao = typeof Reflect < "u" && Reflect, sr = ao.apply, gr = ao.construct;
It || (It = function(t) {
  return t;
});
Ct || (Ct = function(t) {
...
const tA = $(Array.prototype.forEach), Bc = $(Array.prototype.lastIndexOf), Ns = $(Array.prototype.pop), eA = $(Array.prototype.push), Oc = $(Array.prototype.splice), ue = Array.isArray, UA = $(String.prototype.toLowerCase), Gi = $(String.prototype.toString), Gs = $(String.prototype.match), NA = $(String.prototype.replace), Xs = $(String.prototype.indexOf), Lc = $(String.prototype.trim), kc = $(Number.prototype.toString), Nc = $(Boolean.prototype.toString), Zs = typeof BigInt > "u" ? null : $(BigInt.prototype.toString), js = typeof Symbol > "u" ? null : $(Symbol.prototype.toString), nt = $(Object.prototype.hasOwnProperty), GA = $(Object.prototype.toString), At = $(RegExp.prototype.test), Te = Gc(TypeError);
function $(A) {
  return function(t) {
...
function F(A, t) {
  let e = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : UA;
  if (ks && ks(A, null), !ue(t))
    return A;
  let n = t.length;
  for (; n--; ) {
    let i = t[n];
...
function dt(A) {
  ...
  for (const n of oo(A)) {
    var e = Tc(n, 2);
    const i = e[0], r = e[1];
    nt(A, i) && (ue(r) ? t[i] = Xc(r) : r && typeof r == "object" && r.constructor === Object ? t[i] = dt(r) : t[i] = r);
  }
  return t;
}
function Zc(A) {
  switch (typeof A) {
    ...
    case "object": {
      if (A === null)
        return GA(A);
      const t = A, e = Zt(t, "toString");
      if (typeof e == "function") {
        const n = e(t);
        return typeof n == "string" ? n : GA(n);
      }
      return GA(A);
    }
    default:
...
const Fs = It(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink", "blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "content", "data", "datalist", "dd", "decorator", "del", "details", "dfn", "dialog", "dir", "div", "dl", "dt", "element", "em", "fieldset", "figcaption", "figure", "font", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "map", "mark", "marquee", "menu", "menuitem", "meter", "nav", "nobr", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "search", "section", "select", "shadow", "slot", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"]), Xi = It(["svg", "a", "altglyph", "altglyphdef", "altglyphitem", "animatecolor", "animatemotion", "animatetransform", "circle", "clippath", "defs", "desc", "ellipse", "enterkeyhint", "exportparts", "filter", "font", "g", "glyph", "glyphref", "hkern", "image", "inputmode", "line", "lineargradient", "marker", "mask", "metadata", "mpath", "part", "path", "pattern", "polygon", "polyline", "radialgradient", "rect", "stop", "style", "switch", "symbol", "text", "textpath", "title", "tref", "tspan", "view", "vkern"]), Zi = It(["feBlend", "feColorMatrix", "feComponentTransfer", "feComposite", "feConvolveMatrix", "feDiffuseLighting", "feDisplacementMap", "feDistantLight", "feDropShadow", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feImage", "feMerge", "feMergeNode", "feMorphology", "feOffset", "fePointLight", "feSpecularLighting", "feSpotLight", "feTile", "feTurbulence"]), Fc = It(["animate", "color-profile", "cursor", "discard", "font-face", "font-face-format", "font-face-name", "font-face-src", "font-face-uri", "foreignobject", "hatch", "hatchpath", "mesh", "meshgradient", "meshpatch", "meshrow", "missing-glyph", "script", "set", "solidcolor", "unknown", "use"]), ji = It(["math", "menclose", "merror", "mfenced", "mfrac", "mglyph", "mi", "mlabeledtr", "mmultiscripts", "mn", "mo", "mover", "mpadded", "mphantom", "mroot", "mrow", "ms", "mspace", "msqrt", "mstyle", "msub", "msup", "msubsup", "mtable", "mtd", "mtext", "mtr", "munder", "munderover", "mprescripts"]), Uc = It(["maction", "maligngroup", "malignmark", "mlongdiv", "mscarries", "mscarry", "msgroup", "mstack", "msline", "msrow", "semantics", "annotation", "annotation-xml", "mprescripts", "none"]), Us = It(["#text"]), zs = It(["accept", "action", "align", "alt", "autocapitalize", "autocomplete", "autopictureinpicture", "autoplay", "background", "bgcolor", "border", "capture", "cellpadding", "cellspacing", "checked", "cite", "class", "clear", "color", "cols", "colspan", "command", "commandfor", "controls", "controlslist", "coords", "crossorigin", "datetime", "decoding", "default", "dir", "disabled", "disablepictureinpicture", "disableremoteplayback", "download", "draggable", "enctype", "enterkeyhint", "exportparts", "face", "for", "headers", "height", "hidden", "high", "href", "hreflang", "id", "inert", "inputmode", "integrity", "ismap", "kind", "label", "lang", "list", "loading", "loop", "low", "max", "maxlength", "media", "method", "min", "minlength", "multiple", "muted", "name", "nonce", "noshade", "novalidate", "nowrap", "open", "optimum", "part", "pattern", "placeholder", "playsinline", "popover", "popovertarget", "popovertargetaction", "poster", "preload", "pubdate", "radiogroup", "readonly", "rel", "required", "rev", "reversed", "role", "rows", "rowspan", "spellcheck", "scope", "selected", "shape", "size", "sizes", "slot", "span", "srclang", "start", "src", "srcset", "step", "style", "summary", "tabindex", "title", "translate", "type", "usemap", "valign", "value", "width", "wrap", "xmlns"]), Fi = It(["accent-height", "accumulate", "additive", "alignment-baseline", "amplitude", "ascent", "attributename", "attributetype", "azimuth", "basefrequency", "baseline-shift", "begin", "bias", "by", "class", "clip", "clippathunits", "clip-path", "clip-rule", "color", "color-interpolation", "color-interpolation-filters", "color-profile", "color-rendering", "cx", "cy", "d", "dx", "dy", "diffuseconstant", "direction", "display", "divisor", "dominant-baseline", "dur", "edgemode", "elevation", "end", "exponent", "fill", "fill-opacity", "fill-rule", "filter", "filterunits", "flood-color", "flood-opacity", "font-family", "font-size", "font-size-adjust", "font-stretch", "font-style", "font-variant", "font-weight", "fx", "fy", "g1", "g2", "glyph-name", "glyphref", "gradientunits", "gradienttransform", "height", "href", "id", "image-rendering", "in", "in2", "intercept", "k", "k1", "k2", "k3", "k4", "kerning", "keypoints", "keysplines", "keytimes", "lang", "lengthadjust", "letter-spacing", "kernelmatrix", "kernelunitlength", "lighting-color", "local", "marker-end", "marker-mid", "marker-start", "markerheight", "markerunits", "markerwidth", "maskcontentunits", "maskunits", "max", "mask", "mask-type", "media", "method", "mode", "min", "name", "numoctaves", "offset", "operator", "opacity", "order", "orient", "orientation", "origin", "overflow", "paint-order", "path", "pathlength", "patterncontentunits", "patterntransform", "patternunits", "points", "preservealpha", "preserveaspectratio", "primitiveunits", "r", "rx", "ry", "radius", "refx", "refy", "repeatcount", "repeatdur", "restart", "result", "rotate", "scale", "seed", "shape-rendering", "slope", "specularconstant", "specularexponent", "spreadmethod", "startoffset", "stddeviation", "stitchtiles", "stop-color", "stop-opacity", "stroke-dasharray", "stroke-dashoffset", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke", "stroke-width", "style", "surfacescale", "systemlanguage", "tabindex", "tablevalues", "targetx", "targety", "transform", "transform-origin", "text-anchor", "text-decoration", "text-orientation", "text-rendering", "textlength", "type", "u1", "u2", "unicode", "values", "viewbox", "visibility", "version", "vert-adv-y", "vert-origin-x", "vert-origin-y", "width", "word-spacing", "wrap", "writing-mode", "xchannelselector", "ychannelselector", "x", "x1", "x2", "xmlns", "y", "y1", "y2", "z", "zoomandpan"]), Ws = It(["accent", "accentunder", "align", "bevelled", "close", "columnalign", "columnlines", "columnspacing", "columnspan", "denomalign", "depth", "dir", "display", "displaystyle", "encoding", "fence", "frame", "height", "href", "id", "largeop", "length", "linethickness", "lquote", "lspace", "mathbackground", "mathcolor", "mathsize", "mathvariant", "maxsize", "minsize", "movablelimits", "notation", "numalign", "open", "rowalign", "rowlines", "rowspacing", "rowspan", "rspace", "rquote", "scriptlevel", "scriptminsize", "scriptsizemultiplier", "selection", "separator", "separators", "stretchy", "subscriptshift", "supscriptshift", "symmetric", "voffset", "width", "xmlns"]), Xn = It(["xlink:href", "xml:id", "xlink:title", "xml:space", "xmlns:xlink"]), zc = Ct(/{{[\w\W]*|^[\w\W]*}}/g), Wc = Ct(/<%[\w\W]*|^[\w\W]*%>/g), Hc = Ct(/\${[\w\W]*/g), Qc = Ct(/^data-[\-\w.\u00B7-\uFFFF]+$/), Yc = Ct(/^aria-[\-\w]+$/), Hs = Ct(
  /^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i
  // eslint-disable-line no-useless-escape
), Vc = Ct(/^(?:\w+script|data):/i), Kc = Ct(
  /[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g
  // eslint-disable-line no-control-regex
), _c = Ct(/^html$/i), Jc = Ct(/^[a-z][.\w]*(-[.\w]+)+$/i), Qs = Ct(/<[/\w!]/g), Ys = Ct(/<[/\w]/g), qc = Ct(/<\/no(script|embed|frames)/i), $c = Ct(/\/>/i), Et = {
  element: 1,
  attribute: 2,
  text: 3,
  cdataSection: 4,
  ...
  return nt(t, e) && ue(t[e]) ? F(i.base ? dt(i.base) : {}, t[e], i.transform) : n;
};
function Io() {
  let A = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : tl();
  const t = (R) => Io(R);
  if (t.version = "3.4.12", t.removed = [], !A || !A.document || A.document.nodeType !== Et.document || !A.Element)
  ...
  const I = A.DOMParser, C = A.trustedTypes, c = g.prototype, h = Zt(c, "cloneNode"), p = Zt(c, "remove"), f = Zt(c, "nextSibling"), d = Zt(c, "childNodes"), m = Zt(c, "parentNode"), E = Zt(c, "shadowRoot"), T = Zt(c, "attributes"), M = s && s.prototype ? Zt(s.prototype, "nodeType") : null, P = s && s.prototype ? Zt(s.prototype, "nodeName") : null;
  ...
  const Z = function() {
    if (G > 0)
      throw Te('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.');
  }, j = function(l) {
    Z(), G++;
    try {
      return S.createHTML(l);
    } finally {
      G--;
    }
  }, q = function(l) {
    Z(), G++;
    try {
      return S.createScriptURL(l);
    } finally {
      G--;
    }
  }, it = function() {
    return U || (L = el(C, i), U = !0), L;
  }, vt = e, D = vt.implementation, rt = vt.createNodeIterator, Nt = vt.createDocumentFragment, qt = vt.getElementsByTagName, $t = n.importNode;
  let Q = Vs();
  t.isSupported = typeof oo == "function" && typeof m == "function" && D && D.createHTMLDocument !== void 0;
  const ni = zc, ii = Wc, ri = Hc, si = Qc, gi = Yc, oi = Vc, mA = Kc, ai = Jc;
  let rn = Hs, V = null;
  const pe = F({}, [...Fs, ...Xi, ...Zi, ...ji, ...Us]);
  let K = null;
  const H = F({}, [...zs, ...Fi, ...Ws, ...Xn]);
  let _ = Object.seal(nA(null, {
    tagNameCheck: {
      writable: !0,
      configurable: !1,
      enumerable: !0,
  ...
  let pA = !0, Wt = !0, yA = !1, ke = !0, xt = !1, Dt = !0, Gt = !1, wA = !1, Ne = null, EA = null, bA = !1, ee = !1, Ge = !1, Xe = !1, vA = !0, gn = !1;
  const Ae = "user-content-";
  let ye = !0, ne = !1, st = {}, wt = null;
  const Ze = F({}, [
    "annotation-xml",
    "audio",
    "colgroup",
  ...
  let on = null;
  const an = F({}, ["audio", "video", "img", "source", "image", "track"]);
  let je = null;
  const we = F({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]), Fe = "http://www.w3.org/1998/Math/MathML", Ue = "http://www.w3.org/2000/svg", et = "http://www.w3.org/1999/xhtml";
  let Bt = et, MA = !1, RA = null;
  const In = F({}, [Fe, Ue, et], Gi), Cn = It(["mi", "mo", "mn", "ms", "mtext"]);
  let ze = F({}, Cn);
  const TA = It(["annotation-xml"]);
  let SA = F({}, TA);
  const Ii = F({}, ["title", "style", "font", "a", "script"]);
  let ie = null;
  const re = ["application/xhtml+xml", "text/html"], cn = "text/html";
  let Y = null, se = null;
  const Ci = e.createElement("form"), PA = function(l) {
    return l instanceof RegExp || l instanceof Function;
  }, xA = function() {
    let l = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    if (se && se === l)
      return;
    (!l || typeof l != "object") && (l = {}), l = dt(l), ie = // eslint-disable-next-line unicorn/prefer-includes
    re.indexOf(l.PARSER_MEDIA_TYPE) === -1 ? cn : l.PARSER_MEDIA_TYPE, Y = ie === "application/xhtml+xml" ? Gi : UA, V = Ce(l, "ALLOWED_TAGS", pe, {
      transform: Y
    }), K = Ce(l, "ALLOWED_ATTR", H, {
      transform: Y
    }), RA = Ce(l, "ALLOWED_NAMESPACES", In, {
      transform: Gi
    }), je = Ce(l, "ADD_URI_SAFE_ATTR", we, {
      transform: Y,
      base: we
    }), on = Ce(l, "ADD_DATA_URI_TAGS", an, {
      transform: Y,
      base: an
    }), wt = Ce(l, "FORBID_CONTENTS", Ze, {
      transform: Y
    }), te = Ce(l, "FORBID_TAGS", dt({}), {
      transform: Y
    }), sn = Ce(l, "FORBID_ATTR", dt({}), {
      transform: Y
    }), st = nt(l, "USE_PROFILES") ? l.USE_PROFILES && typeof l.USE_PROFILES == "object" ? dt(l.USE_PROFILES) : l.USE_PROFILES : !1, pA = l.ALLOW_ARIA_ATTR !== !1, Wt = l.ALLOW_DATA_ATTR !== !1, yA = l.ALLOW_UNKNOWN_PROTOCOLS || !1, ke = l.ALLOW_SELF_CLOSE_IN_ATTR !== !1, xt = l.SAFE_FOR_TEMPLATES || !1, Dt = l.SAFE_FOR_XML !== !1, Gt = l.WHOLE_DOCUMENT || !1, ee = l.RETURN_DOM || !1, Ge = l.RETURN_DOM_FRAGMENT || !1, Xe = l.RETURN_TRUSTED_TYPE || !1, bA = l.FORCE_BODY || !1, vA = l.SANITIZE_DOM !== !1, gn = l.SANITIZE_NAMED_PROPS || !1, ye = l.KEEP_CONTENT !== !1, ne = l.IN_PLACE || !1, rn = jc(l.ALLOWED_URI_REGEXP) ? l.ALLOWED_URI_REGEXP : Hs, Bt = typeof l.NAMESPACE == "string" ? l.NAMESPACE : et, ze = nt(l, "MATHML_TEXT_INTEGRATION_POINTS") && l.MATHML_TEXT_INTEGRATION_POINTS && typeof l.MATHML_TEXT_INTEGRATION_POINTS == "object" ? dt(l.MATHML_TEXT_INTEGRATION_POINTS) : F({}, Cn), SA = nt(l, "HTML_INTEGRATION_POINTS") && l.HTML_INTEGRATION_POINTS && typeof l.HTML_INTEGRATION_POINTS == "object" ? dt(l.HTML_INTEGRATION_POINTS) : F({}, TA);
    const w = nt(l, "CUSTOM_ELEMENT_HANDLING") && l.CUSTOM_ELEMENT_HANDLING && typeof l.CUSTOM_ELEMENT_HANDLING == "object" ? dt(l.CUSTOM_ELEMENT_HANDLING) : nA(null);
    if (_ = nA(null), nt(w, "tagNameCheck") && PA(w.tagNameCheck) && (_.tagNameCheck = w.tagNameCheck), nt(w, "attributeNameCheck") && PA(w.attributeNameCheck) && (_.attributeNameCheck = w.attributeNameCheck), nt(w, "allowCustomizedBuiltInElements") && typeof w.allowCustomizedBuiltInElements == "boolean" && (_.allowCustomizedBuiltInElements = w.allowCustomizedBuiltInElements), Ct(_), xt && (Wt = !1), Ge && (ee = !0), st && (V = F({}, Us), K = nA(null), st.html === !0 && (F(V, Fs), F(K, zs)), st.svg === !0 && (F(V, Xi), F(K, Fi), F(K, Xn)), st.svgFilters === !0 && (F(V, Zi), F(K, Fi), F(K, Xn)), st.mathMl === !0 && (F(V, ji), F(K, Ws), F(K, Xn))), Mt.tagCheck = null, Mt.attributeCheck = null, nt(l, "ADD_TAGS") && (typeof l.ADD_TAGS == "function" ? Mt.tagCheck = l.ADD_TAGS : ue(l.ADD_TAGS) && (V === pe && (V = dt(V)), F(V, l.ADD_TAGS, Y))), nt(l, "ADD_ATTR") && (typeof l.ADD_ATTR == "function" ? Mt.attributeCheck = l.ADD_ATTR : ue(l.ADD_ATTR) && (K === H && (K = dt(K)), F(K, l.ADD_ATTR, Y))), nt(l, "ADD_URI_SAFE_ATTR") && ue(l.ADD_URI_SAFE_ATTR) && F(je, l.ADD_URI_SAFE_ATTR, Y), nt(l, "FORBID_CONTENTS") && ue(l.FORBID_CONTENTS) && (wt === Ze && (wt = dt(wt)), F(wt, l.FORBID_CONTENTS, Y)), nt(l, "ADD_FORBID_CONTENTS") && ue(l.ADD_FORBID_CONTENTS) && (wt === Ze && (wt = dt(wt)), F(wt, l.ADD_FORBID_CONTENTS, Y)), ye && (V["#text"] = !0), Gt && F(V, ["html", "head", "body"]), V.table && (F(V, ["tbody"]), delete te.tbody), l.TRUSTED_TYPES_POLICY) {
      ...
      const v = S;
      S = l.TRUSTED_TYPES_POLICY;
      try {
        O = j("");
      } catch (x) {
        throw S = v, x;
      }
    } else l.TRUSTED_TYPES_POLICY === null ? (S = void 0, O = "") : (S === void 0 && (S = it()), S && typeof O == "string" && (O = j("")));
    It && It(l), se = l;
  }, DA = F({}, [...Xi, ...Zi, ...Fc]), ln = F({}, [...ji, ...Uc]), ci = function(l, w, v) {
    return w.namespaceURI === et ? l === "svg" : w.namespaceURI === Fe ? l === "svg" && (v === "annotation-xml" || ze[v]) : !!DA[l];
  }, hn = function(l, w, v) {
    return w.namespaceURI === et ? l === "math" : w.namespaceURI === Ue ? l === "math" && SA[v] : !!ln[l];
  }, li = function(l, w, v) {
    return w.namespaceURI === Ue && !SA[v] || w.namespaceURI === Fe && !ze[v] ? !1 : !ln[l] && (Ii[l] || !DA[l]);
  }, hi = function(l) {
    let w = m(l);
    (!w || !w.tagName) && (w = {
      namespaceURI: Bt,
    ...
    const v = UA(l.tagName), x = UA(w.tagName);
    return RA[l.namespaceURI] ? l.namespaceURI === Ue ? ci(v, w, x) : l.namespaceURI === Fe ? hn(v, w, x) : l.namespaceURI === et ? li(v, w, x) : !!(ie === "application/xhtml+xml" && RA[l.namespaceURI]) : !1;
  }, Ot = function(l) {
    eA(t.removed, {
      element: l
    });
    try {
      ...
      if (p(l), !m(l))
        throw Te("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place");
    }
  }, Ee = function(l) {
    BA(l);
    const w = d(l);
    ...
    if (w)
      for (let v = w.length - 1; v >= 0; --v) {
        const x = w[v], u = x && x.name;
        if (!(typeof u != "string" || K[Y(u)]))
          try {
            l.removeAttribute(u);
          } catch {
          }
    ...
    for (; w.length > 0; ) {
      const v = w.pop();
      (M ? M(v) : v.nodeType) === Et.element && ui(v);
      const u = d(v);
      if (u)
    ...
    const w = [l];
    for (; w.length > 0; ) {
      const v = w.pop(), x = M ? M(v) : v.nodeType;
      if (x === Et.processingInstruction || x === Et.comment && At(Ys, v.data)) {
        try {
          p(v);
        } catch {
        }
      ...
      if (x === Et.element) {
        const y = v, b = Y(P ? P(v) : v.nodeName);
        try {
          y.hasAttribute && y.hasAttribute("patchsrc") && y.removeAttribute("patchsrc"), y.hasAttribute && y.hasAttribute("for") && b !== "label" && b !== "output" && y.removeAttribute("for");
        } catch {
        }
      }
      const u = d(v);
    ...
    ie === "application/xhtml+xml" && Bt === et && (l = '<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>' + l + "</body></html>");
    const x = S ? j(l) : l;
    if (Bt === et)
      try {
        w = new I().parseFromString(x, ie);
      } catch {
      }
    if (!w || !w.documentElement) {
      w = D.createDocument(Bt, "template", null);
      try {
        w.documentElement.innerHTML = MA ? O : x;
      } catch {
      }
    }
    const u = w.body || w.documentElement;
    return l && v && u.insertBefore(e.createTextNode(v), u.childNodes[0] || null), Bt === et ? qt.call(w, Gt ? "html" : "body")[0] : Gt ? w.documentElement : u;
  }, fn = function(l) {
    return rt.call(
      l.ownerDocument || l,
      l,
    ...
    return l = NA(l, ni, " "), l = NA(l, ii, " "), l = NA(l, ri, " "), l;
  }, be = function(l) {
    var w;
    l.normalize();
    const v = rt.call(
    ...
    let x = v.nextNode();
    for (; x; )
      x.data = We(x.data), x = v.nextNode();
    const u = (w = l.querySelectorAll) === null || w === void 0 ? void 0 : w.call(l, "template");
    u && tA(u, (y) => {
      Qt(y.content) && be(y.content);
    });
  }, He = function(l) {
    const w = P ? P(l) : null;
    return typeof w != "string" || Y(w) !== "form" ? !1 : typeof l.nodeName != "string" || typeof l.textContent != "string" || typeof l.removeChild != "function" || // Realm-safe NamedNodeMap detection: equality against the cached
    // prototype getter. Clobbered .attributes (e.g. <input name="attributes">)
    // makes the direct read diverge from the cached read; a clean form
    // (same-realm OR foreign-realm) has both reads pointing at the same
    // canonical NamedNodeMap.
    l.attributes !== T(l) || typeof l.removeAttribute != "function" || typeof l.setAttribute != "function" || typeof l.namespaceURI != "string" || typeof l.insertBefore != "function" || typeof l.hasChildNodes != "function" || // NodeType clobbering probe. Cached Node.prototype.nodeType getter
    ...
    if (!M || typeof l != "object" || l === null)
      return !1;
    try {
      return M(l) === Et.documentFragment;
    } catch {
      return !1;
    }
  }, ge = function(l) {
  ...
  const dn = function(l, w) {
    return !!(Dt && l.hasChildNodes() && !ge(l.firstElementChild) && At(Qs, l.textContent) && At(Qs, l.innerHTML) || Dt && l.namespaceURI === et && w === "style" && ge(l.firstElementChild) || l.nodeType === Et.processingInstruction || Dt && l.nodeType === Et.comment && At(Ys, l.data));
  }, mn = function(l, w) {
    if (!te[w] && pn(w) && (_.tagNameCheck instanceof RegExp && At(_.tagNameCheck, w) || _.tagNameCheck instanceof Function && _.tagNameCheck(w)))
      return !1;
    if (ye && !wt[w]) {
      const v = m(l), x = d(l);
      if (x && v) {
        const u = x.length;
        for (let y = u - 1; y >= 0; --y) {
          const b = ne ? x[y] : h(x[y], !0);
          v.insertBefore(b, f(l));
        }
      }
    }
    return Ot(l), !0;
  }, OA = function(l, w) {
    if (Rt(Q.beforeSanitizeElements, l, null), l !== w && m(l) === null)
      return !0;
    if (He(l))
      return Ot(l), !0;
    const v = Y(P ? P(l) : l.nodeName);
    if (Rt(Q.uponSanitizeElement, l, {
      tagName: v,
      allowedTags: V
    }), l !== w && m(l) === null)
      return !0;
    if (dn(l, v))
      return Ot(l), !0;
    if (te[v] || !(Mt.tagCheck instanceof Function && Mt.tagCheck(v)) && !V[v]) {
      const u = mn(l, v);
      return u === !1 && Rt(Q.afterSanitizeElements, l, null), u;
    }
    if ((M ? M(l) : l.nodeType) === Et.element && !hi(l) || (v === "noscript" || v === "noembed" || v === "noframes") && At(qc, l.innerHTML))
      return Ot(l), !0;
    if (xt && l.nodeType === Et.text) {
      const u = We(l.textContent);
      l.textContent !== u && (eA(t.removed, {
        element: l.cloneNode()
      }), l.textContent = u);
    }
    return Rt(Q.afterSanitizeElements, l, null), !1;
  }, Qe = function(l, w, v) {
    if (sn[w] || Dt && w === "patchsrc" || Dt && w === "for" && l !== "label" && l !== "output" || vA && (w === "id" || w === "name") && (v in e || v in Ci))
      return !1;
    const x = K[w] || Mt.attributeCheck instanceof Function && Mt.attributeCheck(w, l);
    if (!(Wt && At(si, w))) {
      if (!(pA && At(gi, w))) {
        if (x) {
          if (!je[w]) {
            if (!At(rn, NA(v, mA, ""))) {
              if (!((w === "src" || w === "xlink:href" || w === "href") && l !== "script" && Xs(v, "data:") === 0 && on[l])) {
                if (!(yA && !At(oi, NA(v, mA, "")))) {
                  if (v)
                    return !1;
                }
          ...
          !(pn(l) && (_.tagNameCheck instanceof RegExp && At(_.tagNameCheck, l) || _.tagNameCheck instanceof Function && _.tagNameCheck(l)) && (_.attributeNameCheck instanceof RegExp && At(_.attributeNameCheck, w) || _.attributeNameCheck instanceof Function && _.attributeNameCheck(w, l)) || // Alternative, second condition checks if it's an `is`-attribute, AND
          // the value passes whatever the user has configured for CUSTOM_ELEMENT_HANDLING.tagNameCheck
          w === "is" && _.allowCustomizedBuiltInElements && (_.tagNameCheck instanceof RegExp && At(_.tagNameCheck, v) || _.tagNameCheck instanceof Function && _.tagNameCheck(v)))
        ) return !1;
      }
    }
    return !0;
  }, oe = F({}, ["annotation-xml", "color-profile", "font-face", "font-face-format", "font-face-name", "font-face-src", "font-face-uri", "missing-glyph"]), pn = function(l) {
    return !oe[UA(l)] && At(ai, l);
  }, di = function(l, w, v, x) {
    if (S && typeof C == "object" && typeof C.getAttributeType == "function" && !v)
    ...
    try {
      v ? l.setAttributeNS(v, w, x) : l.setAttribute(w, x), He(l) ? Ot(l) : Ns(t.removed);
    } catch {
      Ht(w, l);
    }
  }, yn = function(l) {
    Rt(Q.beforeSanitizeAttributes, l, null);
    ...
    let x = w.length;
    const u = Y(l.nodeName);
    for (; x--; ) {
      const y = w[x], b = y.name, B = y.namespaceURI, k = y.value, X = Y(b), J = k;
      let N = b === "value" ? J : Lc(J);
      if (v.attrName = X, v.attrValue = N, v.keepAttr = !0, v.forceKeepAttr = void 0, Rt(Q.uponSanitizeAttribute, l, v), N = v.attrValue, gn && (X === "id" || X === "name") && Xs(N, Ae) !== 0 && (Ht(b, l), N = Ae + N), Dt && At(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i, N)) {
        Ht(b, l);
        continue;
      }
      if (X === "attributename" && Gs(N, "href")) {
        Ht(b, l);
        continue;
      }
      if (!v.forceKeepAttr) {
        ...
        if (xt && (N = We(N)), !Qe(u, X, N)) {
          Ht(b, l);
          continue;
        }
        N = di(u, X, B, N), N !== J && mi(l, b, B, N);
      }
    }
    Rt(Q.afterSanitizeAttributes, l, null);
  }, ve = function(l) {
    let w = null;
    const v = fn(l);
    for (Rt(Q.beforeSanitizeShadowDOM, l, null); w = v.nextNode(); )
      if (Rt(Q.uponSanitizeShadowNode, w, null), OA(w, l), yn(w), Qt(w.content) && ve(w.content), (M ? M(w) : w.nodeType) === Et.element) {
        const u = E(w);
        Qt(u) && (Ye(u), ve(u));
      }
    Rt(Q.afterSanitizeShadowDOM, l, null);
  }, Ye = function(l) {
    const w = [{
      node: l,
      shadow: null
    ...
    for (; w.length > 0; ) {
      ...
      const x = v.node, y = (M ? M(x) : x.nodeType) === Et.element, b = d(x);
      if (b)
      ...
      if (y) {
        const B = P ? P(x) : null;
        if (typeof B == "string" && Y(B) === "template") {
          const k = x.content;
          Qt(k) && w.push({
            node: k,
            shadow: null
  ...
  return t.sanitize = function(R) {
    let l = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, w = null, v = null, x = null, u = null;
    if (MA = !R, MA && (R = "<!-->"), typeof R != "string" && !ge(R) && (R = Zc(R), typeof R != "string"))
      throw Te("dirty is not a string, aborting");
    if (!t.isSupported)
      return R;
    wA ? (V = Ne, K = EA) : xA(l), (Q.uponSanitizeElement.length > 0 || Q.uponSanitizeAttribute.length > 0) && (V = dt(V)), Q.uponSanitizeAttribute.length > 0 && (K = dt(K)), t.removed = [];
    const y = ne && typeof R != "string" && ge(R);
    if (y) {
      fi(R);
      const X = P ? P(R) : R.nodeName;
      if (typeof X == "string") {
        const J = Y(X);
        if (!V[J] || te[J])
          throw Ee(R), Te("root node is forbidden and cannot be sanitized in-place");
      }
      if (He(R))
        throw Ee(R), Te("root node is clobbered and cannot be sanitized in-place");
      try {
        Ye(R);
      } catch (J) {
        throw Ee(R), J;
      ...
      w = un("<!---->"), v = w.ownerDocument.importNode(R, !0), v.nodeType === Et.element && v.nodeName === "BODY" || v.nodeName === "HTML" ? w = v : w.appendChild(v), Ye(v);
    else {
      if (!ee && !xt && !Gt && // eslint-disable-next-line unicorn/prefer-includes
      R.indexOf("<") === -1)
        return S && Xe ? j(R) : R;
      if (w = un(R), !w)
        return ee ? null : Xe ? O : "";
    }
    w && bA && Ot(w.firstChild);
    const b = y ? R : w, B = fn(b);
    try {
      for (; x = B.nextNode(); )
        OA(x, b), yn(x), Qt(x.content) && ve(x.content);
    } catch (X) {
      throw y && (Ee(R), tA(t.removed, (J) => {
        J.element && BA(J.element);
      })), X;
    }
    if (y)
      return tA(t.removed, (X) => {
        X.element && BA(X.element);
      }), xt && be(R), R;
    if (ee) {
      if (xt && be(w), Ge)
        for (u = Nt.call(w.ownerDocument); w.firstChild; )
          u.appendChild(w.firstChild);
      else
        u = w;
      return (K.shadowroot || K.shadowrootmode) && (u = $t.call(n, u, !0)), u;
    }
    let k = Gt ? w.outerHTML : w.innerHTML;
    return Gt && V["!doctype"] && w.ownerDocument && w.ownerDocument.doctype && w.ownerDocument.doctype.name && At(_c, w.ownerDocument.doctype.name) && (k = "<!DOCTYPE " + w.ownerDocument.doctype.name + `>
` + k), xt && (k = We(k)), S && Xe ? j(k) : k;
  }, t.setConfig = function() {
    let R = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    xA(R), wA = !0, Ne = V, EA = K;
  }, t.clearConfig = function() {
    se = null, wA = !1, Ne = null, EA = null, S = L, O = "";
  }, t.isValidAttribute = function(R, l, w) {
    se || xA({});
    const v = Y(R), x = Y(l);
    return Qe(v, x, w);
  }, t.addHook = function(R, l) {
    typeof l == "function" && nt(Q, R) && eA(Q[R], l);
  }, t.removeHook = function(R, l) {
    if (nt(Q, R)) {
      if (l !== void 0) {
        const w = Bc(Q[R], l);
        return w === -1 ? void 0 : Oc(Q[R], w, 1)[0];
      }
      return Ns(Q[R]);
    }
...
const nl = [
  ...
  "width",
  "height"
], rl = /^(?:https?|mailto|tel|data):/i, sl = ["target", "rel", "width", "height"], gl = [
  "script",
  "style",
  "iframe",
  "object",
  ...
  "meta",
  "base"
], ol = ["srcdoc", "style", "formaction", "xlink:href"], al = /^data:image\/(png|jpeg|gif|webp|avif);/i, Ks = (A) => !!A && /^\s*data:/i.test(A);
function Il(A) {
  if (A.tagName === "A" && A.getAttribute("target") === "_blank" && A.setAttribute("rel", "noopener noreferrer"), A.tagName === "IMG") {
    ...
    Ks(e) && !al.test(e.trim()) && A.removeAttribute("src"), A.hasAttribute("srcset") && A.removeAttribute("srcset");
  } else
    for (const e of ["src", "href", "xlink:href"])
      Ks(A.getAttribute(e)) && A.removeAttribute(e);
}
let XA;
function Co() {
  if (XA) return XA;
  ...
  return XA = Al(A), XA.addHook("afterSanitizeAttributes", Il), XA;
}
function Sl(A) {
  return A == null ? "" : Co().sanitize(String(A), {
    ALLOWED_TAGS: nl,
    ALLOWED_ATTR: il,
    ALLOWED_URI_REGEXP: rl,
    ADD_URI_SAFE_ATTR: sl,
    FORBID_TAGS: gl,
    FORBID_ATTR: ol,
    ALLOW_DATA_ATTR: !1,
...
const ll = /* @__PURE__ */ new Set([
  ...
  "camera-target",
  "show-texture"
]), hl = /* @__PURE__ */ new Set(["fit-to-container", "debug-mode"]), ul = /* @__PURE__ */ new Set(["caption"]), fl = /* @__PURE__ */ new Set(["image-url", "thumbnail-url", "material-url"]), dl = (A) => /^(?:https?:)?\/\/|^\/|^[^:]*$/i.test(A.trim());
function Pl(A) {
  const t = [];
  for (const [e, n] of Object.entries(A || {})) {
    ...
    if (!ll.has(i) || n == null) continue;
    let r = String(n);
    fl.has(i) && (!dl(r) || /[<>]/.test(r)) || (ul.has(i) && (r = cl(r)), t.push(`${i}="${Cl(r)}"`));
  }
  return t.join(" ");
}
const ml = {
  ...
  gsi_ortho: no,
  redcircle: so,
  defaultpin_selected: go,
  defaultpin: Tr,
  bluedot: Ug,
  bluedot_transparent: zg,
  bluedot_small: Wg
}, pl = {
...
class Kn extends wg {
  ...
  // Maplat App Class
  constructor(t) {
    super(), t = Ut(t), this.appid = t.appid || "sample";
    ...
    [...LA(`<img id="center_circle" class="prevent-default" alt=""
            style="position:absolute;top:50%;left:50%;margin-top:-10px;
            margin-left:-10px;" src="${so}">`)].reverse().forEach((g) => {
  ...
  async runLifecyclePhase(t, e) {
    ...
    const n = this.buildLifecycleContext(t, e), i = pl[t], r = this.uiHooks?.[i];
    if (r)
      try {
        const s = await r(n);
  ...
  async handleSetting(t, e) {
    await this.runLifecyclePhase("setting-loaded", t), this.appData = Ut(t), await this.runLifecyclePhase("appdata-ready"), await this.runLifecyclePhase("ui-configure");
    const n = await this.prepareMap(e);
    await this.runLifecyclePhase("ui-dom-ready");
    const i = await gg(this.appData.pois || [], this);
  ...
  initGeolocation(t) {
    ...
    const e = this.geolocation = new bc({
      timerBase: t.fake,
    ...
    this.alwaysGpsOn ? (e.setTracking(!0), this.gpsEnabled_ = !0, this.initialGpsMove_ = !0) : (e.setTracking(!1), this.gpsEnabled_ = !1), e.on("change", () => {
      (async () => {
        ...
        this.dispatchEvent(new ZA(I ? { lnglat: g, acc: o } : { error: C }));
      })();
    }), e.on("error", (n) => {
      const i = n.code;
      if (i === 3) return;
      ...
      (s ? s.getSource() : g.getSource()).setGPSMarker(), this.dispatchEvent(new yl(i === 1 ? "user_gps_deny" : i === 2 ? "gps_miss" : "gps_timeout")), this.dispatchEvent(new ZA({ error: "gps_off" }));
      ...
      (async () => {
        if (e.getTracking()) {
          ...
          this.dispatchEvent(new ZA(a ? { lnglat: g, acc: o } : { error: I }));
        }
      })();
    });
  }
  ...
  handleGPS(t, e = !1) {
    if (this.geolocation) {
      if (t)
        if (!this.alwaysGpsOn)
          this.firstGpsRequest_ = !0, this.geolocation.setTracking(!0), this.gpsEnabled_ = !0, this.dispatchEvent(new wl());
        else {
  ...
  async prepareMap(t) {
    ...
    this.mapDivDocument.insertBefore(I, this.mapDivDocument.firstChild), this.fakeGps = g, this.fakeRadius = o, this.homePosition = e, this.mapObject = new he({
      div: a,
      controls: this.appData.controls || [],
      interactions: this.noRotate ? Ms({ altShiftDragRotate: !1, pinchRotate: !1 }) : Ms().extend([
        new QC({
          condition: TC
        })
      ]),
    ...
    let C = null;
    this.overlay && (C = `${this.mapDiv}_back`, I = LA(
  ...
  async handleSources(t) {
    ...
    }), this.dispatchEvent(new ht("sourceLoaded", t)), await this.setInitialMap(e), this.setMapClick(), this.setPointerEvents(), this.setMapOnOff(), this.setMouseCursor(), this.setBackMapBehavior(), this.raiseChangeViewpoint(), await this.runLifecyclePhase("core-ready"), await this.runLifecyclePhase("ui-ready");
  }
  ...
  async setInitialMap(t) {
    ...
    this.from = t.reduce(
      (n, i) => n ? !(n instanceof Jg) && i.mapID != e ? i : n : i.mapID != e ? i : n,
      void 0
    ...
    this.mapObject.on("click", (t) => {
      ...
      if (t.target.forEachFeatureAtPixel(t.pixel, (n) => {
        ...
        this.dispatchEvent(new ht("clickMapXy", n)), this.from.sysCoord2MercAsync(n).then((i) => {
          ...
          const r = bt(i, "EPSG:3857", "EPSG:4326");
          this.dispatchEvent(
            new ht("clickMap", {
              longitude: r[0],
              latitude: r[1]
  ...
  raiseChangeViewpoint() {
    this.mapObject.on("postrender", async (t) => {
      const e = this.mapObject.getView(), n = e.getCenter(), i = e.getDecimalZoom(), r = Dn(e.getRotation() * 180 / Math.PI), s = await this.from.viewpoint2MercsAsync(), g = await this.mercSrc.mercs2ViewpointAsync(s);
      ...
      const o = bt(g[0], "EPSG:3857", "EPSG:4326"), a = Dn(g[2] * 180 / Math.PI);
      this.dispatchEvent(
  ...
  getRotation() {
    ...
    return t ? Dn(t.getRotation() * 180 / Math.PI) : 0;
  }
  ...
  async getDirection() {
    ...
    return Dn(e[2] * 180 / Math.PI);
  }
  currentMapInfo() {
    return $r(this.from);
  }
  mapInfo(t) {
    return $r(this.cacheHash[t]);
  }
  async clientPointToLngLat(t, e) {
    ...
    if (!s) return;
    const g = await this.from.sysCoord2MercAsync(s), o = bt(g, "EPSG:3857", "EPSG:4326");
    return {
      longitude: o[0],
      latitude: o[1]
    };
  ...
  async lngLatToClientPoint(t, e) {
    if (!this.from || !this.mapObject) return;
    const n = bt([t, e], "EPSG:4326", "EPSG:3857"), i = await this.from.merc2SysCoordAsync(n), r = this.mapObject.getPixelFromCoordinate(i);
    if (!r) return;
  ...
  setMarker(t) {
    ...
    const e = t.lnglat || [
      t.lng || t.longitude,
      t.lat || t.latitude
    ], n = t.x, i = t.y, r = t.coordinates, s = this.from, g = t.icon ? this.__selectedMarker == t.namespaceID && t.selectedIcon ? t.selectedIcon : t.icon : this.__selectedMarker == t.namespaceID ? go : Tr;
    return (r ? (function() {
      ...
      const a = bt(e, "EPSG:4326", "EPSG:3857");
      return s.merc2SysCoordAsync_ignoreBackground(
        a
      );
    })()).then((a) => {
  ...
  setVector(t) {
    ...
    const n = (i, r = !1) => Promise.all(
      i.map((s) => Array.isArray(s[0]) ? n(s, r) : (r && (s = bt(s, "EPSG:4326", "EPSG:3857")), this.from.merc2SysCoordAsync(s)))
    );
        ...
        for (const g of Object.keys(this.pois)) {
          ...
          if (!o.hide)
            for (const a of o.pois) {
              const I = Bs(a, o, this);
              Os(I, o, this), this.__selectedMarker == I.namespaceID ? r = I : i.push(this.setMarker(I));
            }
        }
        if (n.pois)
          for (const g of Object.keys(n.pois)) {
            ...
            if (!o.hide)
              for (const a of o.pois) {
                const I = Bs(a, o, n, this);
                Os(I, o, n, this), this.__selectedMarker == I.namespaceID ? r = I : i.push(this.setMarker(I));
              }
          }
      }
      let s = Promise.all(i);
  ...
  addMarker(t, e) {
    if (e || (e = "main"), e.includes("#")) {
      ...
      return this.pois[e].pois.push(WA(t)), Ir(this.pois, e, {
        name: this.appName
    ...
    return i ? (this.changeMapSeq || (this.changeMapSeq = Promise.resolve()), this.changeMapSeq = this.changeMapSeq.then(
      () => new Promise((r, s) => {
        this.convertParametersFromCurrent(i, (g) => {
          ...
          if (this.backMap && (o = this.backMap.getSource(), i.isWmts() ? this.backMap.exchangeSource() : (I ? (a = I, this.backMap.exchangeSource(a)) : o ? a = o : (a = n, this.from.isWmts() && (a = this.from instanceof Yn ? (
          ...
          ) : this.from), a && this.backMap.exchangeSource(a)), a && this.requestUpdateState({ backgroundID: a.mapID }))), i instanceof Yn) {
  ...
  convertParametersFromCurrent(t, e) {
    ...
    this.logger.debug(
      ...
      this.mercBuffer.buffer[o] && (this.logger.debug("To: Use buffer"), g = new Promise((a, I) => {
        ...
        ), this.logger.debug(`To: ${t.mapID}`), this.mercBuffer.buffer[t.mapID] = rr(a, 10), e(a);
      }).catch((a) => {
        throw a;
      });
    }).catch((s) => {
...
if (typeof window < "u") {
  const A = {
    createObject: Kn.createObject
  };
  window.Maplat = A, window.MaplatApp = Kn, window.assets = ml;
}
export {
  ht as CustomEvent,
  yl as GPSErrorEvent,
  wl as GPSRequestEvent,
  ZA as GPSResultEvent,
  Kn as MaplatApp,
  he as MaplatMap,
  ml as assets,
  Pl as buildSlideAttrs,
  LA as createElement,
  Cl as escapeAttr,
  dc as mapSourceFactory,
  Sl as sanitizeHtml,
  cl as toPlainText
};
