import { transform as Et, toLonLat as Ir, Projection as mo, addProjection as Wi, addCoordinateTransforms as Un, getTransform as wi, identityTransform as bi } from "ol/proj";
import { View as qs, Map as po, Feature as yo } from "ol";
import { Vector as Pn, Group as wo, Tile as Ei } from "ol/layer";
import { XYZ as $s, Google as bo, Vector as xn } from "ol/source";
...
const Vt = 11102230246251565e-32, ot = 134217729, So = (3 + 8 * Vt) * Vt;
...
const xo = (3 + 16 * Vt) * Vt, Do = (2 + 12 * Vt) * Vt, Bo = (9 + 64 * Vt) * Vt * Vt, Ve = _A(4), Zr = _A(8), Fr = _A(12), Ur = _A(16), ht = _A(4);
function Oo(A, t, e, n, i, r, s) {
  ...
  let H = Po(4, Ve), At = Do * s;
  if (H >= At || -H >= At || (C = A - X, g = A - (X + C) + (C - i), C = e - Z, a = e - (Z + C) + (C - i), C = t - N, o = t - (N + C) + (C - r), C = n - F, I = n - (F + C) + (C - r), g === 0 && o === 0 && a === 0 && I === 0) || (At = Bo * s + So * Math.abs(H), H += X * I + F * g - (N * a + Z * o), H >= At || -H >= At)) return H;
  ...
  const $ = vi(B, Fr, 4, ht, Ur);
  return Ur[$ - 1];
}
function Lo(A, t, e, n, i, r) {
  const s = (t - r) * (e - i), g = (A - i) * (n - r), o = s - g, a = Math.abs(s + g);
  return Math.abs(o) >= xo * a ? o : -Oo(A, t, e, n, i, r, a);
}
function ko(A, t) {
...
function rA(A, t, e = {}) {
  ...
  const n = Ro(A), i = To(t), r = i.type, s = t.bbox;
  let g = i.coordinates;
  if (s && No(n, s) === !1)
    return !1;
  r === "Polygon" && (g = [g]);
...
function Go(A, t, e, n) {
  const i = A.geometry.coordinates, r = e.geometry.coordinates, s = Math.atan2(i[0] - r[0], i[1] - r[1]), g = Xo(s, t[0]);
  if (g === void 0)
    throw new Error("Unable to determine vertex index");
  const o = t[1][g];
  return eg(A, o.features[0], n);
}
function jo(A, t, e, n, i, r, s, g) {
  let o;
  if (s && (o = Mi(A, cA([s]))), !o)
    if (e) {
      ...
      o = Mi(A, t);
  return g && g(o), o ? eg(A, o, r) : Go(A, n, i, r);
}
function Nt(A, t, e, n) {
...
function Xo(A, t) {
  let e = zr(A - t[0]), n = Math.PI * 2, i;
  for (let r = 0; r < t.length; r++) {
    const s = (r + 1) % t.length, g = zr(A - t[s]), o = Math.min(Math.abs(e), Math.abs(g));
...
function Ho(A) {
  return !A.version || A.version < ng ? ["forw", "bakw"].reduce((t, e) => {
...
function Yo(A) {
  ...
  return t.forw[1] = Wr(A, !1), t.bakw[1] = Wr(A, !0), t;
}
function Wr(A, t) {
...
class Rt {
  ...
  setCompiled(t) {
    if (Uo(t)) {
      this.applyModernState(zo(t));
      return;
    }
    this.applyLegacyState(Wo(t));
  }
  applyModernState(t) {
...
const W = 20037508342789244e-9, ig = [
  [0, 0],
  [0, 1],
  [1, 0],
  [0, -1],
...
class sg {
  ...
  viewpoint2Mercs(t, e) {
    ...
    const n = Ki(t.center, t.zoom, t.rotation, e).map((g) => Hr(g, this._maxxy)), i = this.xy2MercWithLayer(n[0]);
...
const gg = "data:image/png;base64,", Re = 256, $o = `<canvas width="${Re}" height="${Re}" src="${gg}"></canvas>`;
async function xA(A) {
  if (typeof A == "string") {
...
const og = ["hide", "title", "icon", "selectedIcon"], ta = [
  "lnglat",
  "lng",
  "lat",
  "longitude",
...
function Ji(A) {
  ...
  return !(!e && !n || ta.some((i) => A[i] !== void 0));
}
function ea(A) {
  return Ji(A) && og.some((t) => A[t] !== void 0);
}
function Qr(A) {
  const t = {};
  ...
  if (A = await xA(A), Array.isArray(A)) {
    ...
    if (A.length > 0 && (typeof e == "string" || zn(e) && e.type === "FeatureCollection" || Ji(e))) {
      const i = await Promise.all(
        A.map(async (r, s) => {
          let g, o;
          Ji(r) ? (g = await xA(r.layer), o = Qr(r)) : (g = await xA(r), o = null);
...
const Kt = 11102230246251565e-32, at = 134217729, ra = (3 + 8 * Kt) * Kt;
...
const ga = (3 + 16 * Kt) * Kt, oa = (2 + 12 * Kt) * Kt, aa = (9 + 64 * Kt) * Kt * Kt, Ke = JA(4), _r = JA(8), Jr = JA(12), qr = JA(16), ut = JA(4);
function Ia(A, t, e, n, i, r, s) {
  let g, o, a, I, C, c, u, p, f, d, m, E, R, v, S, P, D, L;
  const X = A - i, Z = e - i, N = t - r, F = n - r;
  ...
  let H = sa(4, Ke), At = oa * s;
  if (H >= At || -H >= At || (C = A - X, g = A - (X + C) + (C - i), C = e - Z, a = e - (Z + C) + (C - i), C = t - N, o = t - (N + C) + (C - r), C = n - F, I = n - (F + C) + (C - r), g === 0 && o === 0 && a === 0 && I === 0) || (At = aa * s + ra * Math.abs(H), H += X * I + F * g - (N * a + Z * o), H >= At || -H >= At)) return H;
  ...
  const $ = Si(B, Jr, 4, ut, qr);
  return qr[$ - 1];
}
function Ca(A, t, e, n, i, r) {
  const s = (t - r) * (e - i), g = (A - i) * (n - r), o = s - g, a = Math.abs(s + g);
  return Math.abs(o) >= ga * a ? o : -Ia(A, t, e, n, i, r, a);
}
function ca(A, t) {
  var e, n, i = 0, r, s, g, o, a, I, C, c = A[0], u = A[1], p = t.length;
  for (e = 0; e < p; e++) {
...
function la(A, t, e = {}) {
  ...
  if (!t)
    throw new Error("polygon is required");
  const n = na(A), i = ia(t), r = i.type, s = t.bbox;
  let g = i.coordinates;
  if (s && ha(n, s) === !1)
    return !1;
  r === "Polygon" && (g = [g]);
  ...
  for (let i = 0; i < n.length; i++)
    for (let r = 0; r < n[i].length; r++) {
      ...
      for (let o = 0; o < n[i][r].length - 1; o++) {
        g = n[i][r][o + 1];
        const a = new $r(s, Dn, Bn, On), I = new $r(g, Dn, Bn, On + 1);
        a.otherEvent = I, I.otherEvent = a, hg(a, I) > 0 ? (I.isLeftEndpoint = !0, a.isLeftEndpoint = !1) : (a.isLeftEndpoint = !0, I.isLeftEndpoint = !1), t.push(a), t.push(I), s = g, On = On + 1;
      }
    }
  Dn = Dn + 1;
}
  ...
  class t extends A {
    ...
    initialize(n) {
      if (n = jt(n), this.mapID = n.mapID, this.homePosition = n.homePosition, this.mercZoom = n.mercZoom, this.label = n.label, this.maxZoom = n.maxZoom, this.minZoom = n.minZoom, this.poiTemplate = n.poiTemplate, this.poiStyle = n.poiStyle, this.iconTemplate = n.iconTemplate, this.icon = n.icon, this.selectedIcon = n.selectedIcon, this.mercatorXShift = n.mercatorXShift, this.mercatorYShift = n.mercatorYShift, this.weiwudi = n.weiwudi, n.envelopeLngLats) {
        ...
        g.push(g[0]), this.envelope = Cg([g]), this.centroid = Ma(this.envelope).geometry?.coordinates;
      }
      ...
      this.initialWait = Promise.all([r, i]), Sa(this);
    }
    static isBasemap() {
    ...
    rotateMatrix(n, i) {
      return i === void 0 && (i = this.getMap().getView().getRotation()), rg(n, i);
    }
    async resolvePois(n) {
      this.pois = await ag(n || [], {
    ...
    zoom2Radius(n, i) {
      return i === void 0 && (i = this.getMap().getView().getDecimalZoom()), Cr(n, i);
    }
...
function fg(A) {
  class t extends ug(A) {
    static isBasemap_ = !0;
    static isWmts_ = !0;
    insideCheckXy(n) {
      return this.envelope ? la(n, this.envelope) : !0;
    }
    ...
    modulateXyInside(n) {
      ...
      const i = Aa([n, this.centroid]), r = Ea(this.envelope, i);
...
const zA = [
  ...
  "reference",
  "description"
], qi = (A) => (A || "").match(/^(?:google(?:_(?:roadmap|satellite|hybrid|terrain))?|mapbox|maplibre)$/);
function dg(A) {
  return A = jt(A), A.imageExtension || (A.imageExtension = "jpg"), qi(A.maptype) ? (delete A.url, delete A.urls) : A.mapID && !A.url && !A.urls && (A.url = A.tms ? `tiles/${A.mapID}/{z}/{x}/{-y}.${A.imageExtension}` : `tiles/${A.mapID}/{z}/{x}/{y}.${A.imageExtension}`), A;
}
function Sa(A) {
  const t = A;
...
function Ba(A) {
  ...
  return function() {
    ...
    return (!e || this !== n || !xa(i, e)) && (n = this, e = i, t = A.apply(this, arguments)), t;
  };
}
function bg(A) {
  for (const t in A)
...
class Eg extends mg {
  ...
  removeEventListener(t, e) {
    ...
    if (!n)
      return;
    const i = n.indexOf(e);
    i !== -1 && (this.pendingRemovals_ && t in this.pendingRemovals_ ? (n[i] = $i, ++this.pendingRemovals_[t]) : (n.splice(i, 1), n.length === 0 && delete this.listeners_[t]));
  }
}
qs.prototype.getDecimalZoom = function() {
...
function Tg(A, t) {
  let e;
  return e = t(ja(A)), e || (e = t(Xa(A)), e) || (e = t(za(A)), e) || (e = t(Ua(A)), e) ? e : !1;
}
function ja(A) {
  return [A[0], A[1]];
}
...
let Qa = 0;
function Ya(A) {
  return A.ol_uid || (A.ol_uid = String(++Qa));
}
const Va = {
  /**
...
function sA(A) {
  A && A.target && (A.target.removeEventListener(A.type, A.listener), bg(A));
}
const de = {
  /**
...
class uA extends Ai {
   ...
   */
  constructor(t) {
    super(), this.on, this.once, this.un, Ya(this), this.values_ = null, t !== void 0 && this.setProperties(t);
  }
  /**
   * Gets a value.
  ...
  notify(t, e) {
    let n;
    n = `change:${t}`, this.hasListener(n) && this.dispatchEvent(new is(n, t, e)), n = Va.PROPERTYCHANGE, this.hasListener(n) && this.dispatchEvent(new is(n, t, e));
  }
  /**
   * @param {string} key Key name.
   * @param {import("./events.js").Listener} listener Listener.
  ...
  unset(t, e) {
    if (this.values_ && t in this.values_) {
      ...
      delete this.values_[t], Oa(this.values_) && (this.values_ = null), e || this.notify(t, n);
    }
  }
}
function _a(...A) {
...
const qA = 6378137, iA = Math.PI * qA, tI = [-iA, -iA, iA, iA], eI = [-180, -85, 180, 85], kn = qA * Math.log(Math.tan(Math.PI / 2));
class _e extends HA {
  /**
...
const iI = 6378137, gs = [-180, -90, 180, 90], rI = Math.PI * iI / 180;
class Ee extends HA {
  /**
   * @param {string} code Code.
...
let Ar = {};
function sI(A) {
  return Ar[A] || Ar[A.replace(/urn:(x-)?ogc:def:crs:EPSG:(.*:)?(\w+)$/, "EPSG:$3")] || null;
}
function gI(A, t) {
  Ar[A] = t;
}
...
const Qn = 0.9996, Tt = 669438e-8, ni = Tt * Tt, ii = ni * Tt, Se = Tt / (1 - Tt), as = Math.sqrt(1 - Tt), lA = (1 - as) / (1 + as), xg = lA * lA, mr = xg * lA, pr = mr * lA, Dg = pr * lA, Bg = 1 - Tt / 4 - 3 * ni / 64 - 5 * ii / 256, oI = 3 * Tt / 8 + 3 * ni / 32 + 45 * ii / 1024, aI = 15 * ni / 256 + 45 * ii / 1024, II = 35 * ii / 3072, CI = 3 / 2 * lA - 27 / 32 * mr + 269 / 512 * Dg, cI = 21 / 16 * xg - 55 / 32 * pr, lI = 151 / 96 * mr - 417 / 128 * Dg, hI = 1097 / 512 * pr, Yn = 6378137;
function uI(A, t, e) {
  const n = A - 5e5, s = (e.north ? t : t - 1e7) / Qn / (Yn * Bg), g = s + CI * Math.sin(2 * s) + cI * Math.sin(4 * s) + lI * Math.sin(6 * s) + hI * Math.sin(8 * s), o = Math.sin(g), a = o * o, I = Math.cos(g), C = o / I, c = C * C, u = c * c, p = 1 - Tt * a, f = Math.sqrt(1 - Tt * a), d = Yn / f, m = (1 - Tt) / p, E = Se * I ** 2, R = E * E, v = n / (d * Qn), S = v * v, P = S * v, D = P * v, L = D * v, X = L * v, Z = g - C / m * (S / 2 - D / 24 * (5 + 3 * c + 10 * E - 4 * R - 9 * Se)) + X / 720 * (61 + 90 * c + 298 * E + 45 * u - 252 * Se - 3 * R);
...
const Is = -80, Cs = 84, fI = -180, dI = 180;
function mI(A, t, e) {
  A = er(A, fI, dI), t < Is ? t = Is : t > Cs && (t = Cs);
  const n = oA(t), i = Math.sin(n), r = Math.cos(n), s = i / r, g = s * s, o = g * g, a = oA(A), I = Og(e.number), C = oA(I), c = Yn / Math.sqrt(1 - Tt * i ** 2), u = Se * r ** 2, p = r * er(a - C, -Math.PI, Math.PI), f = p * p, d = f * p, m = d * p, E = m * p, R = E * p, v = Yn * (Bg * n - oI * Math.sin(2 * n) + aI * Math.sin(4 * n) - II * Math.sin(6 * n)), S = Qn * c * (p + d / 6 * (1 - g + u) + E / 120 * (5 - 18 * g + o + 72 * u - 58 * Se)) + 5e5;
...
function yI(A) {
  return Lg(A) ? new HA({ code: A, units: "m" }) : null;
}
function wI(A) {
  const t = Lg(A.getCode());
  return t ? {
    forward: cs(mI, t),
    inverse: cs(uI, t)
  } : null;
...
function oe(A, t) {
  return nr && !Hn(A, [0, 0]) && A[0] >= -180 && A[0] <= 180 && A[1] >= -90 && A[1] <= 90 && (nr = !1, _a(
...
const fs = DI(), NI = [NaN, NaN];
class GI extends uA {
  constructor() {
    super(), this.extent_ = vg(), this.extentRevision_ = -1, this.simplifiedGeometryMaxMinSquaredTolerance = 0, this.simplifiedGeometryRevision = 0, this.simplifyTransformedInternal = Ba(
      (t, e, n) => {
        if (!n)
  ...
  getExtent(t) {
    if (this.extentRevision_ != this.getRevision()) {
      ...
      (isNaN(e[0]) || isNaN(e[1])) && Mg(e), this.extentRevision_ = this.getRevision();
    }
    return Wa(this.extent_, t);
  }
  /**
...
class br extends $A {
  ...
  intersectsExtent(t) {
    ...
    if (ur(t, e)) {
      ...
      return t[0] <= n[0] && t[2] >= n[0] || t[1] <= n[1] && t[3] >= n[1] ? !0 : Tg(t, this.intersectsCoordinate.bind(this));
    }
    return !1;
  }
  /**
...
function vr(A, t, e, n, i, r, s, g, o, a, I) {
  if (t == e)
    return a;
  let C, c;
  if (i === 0) {
...
function UI(A, t, e, n, i, r, s, g, o, a, I) {
  I = I || [NaN, NaN];
...
function ri(A, t, e, n, i, r) {
  return r = r ?? Rg(vg(), A, t, e, n), ur(i, r) ? r[0] >= i[0] && r[2] <= i[2] || r[1] >= i[1] && r[3] <= i[3] ? !0 : Zg(
    A,
    t,
    e,
    n,
...
function Fg(A, t, e, n, i, r, s) {
  ...
  for (; a.length > 0; ) {
    ...
    for (let E = c + n; E < C; E += n) {
      const R = A[E], v = A[E + 1], S = Ja(R, v, p, f, d, m);
      S > u && (I = E, u = S);
    }
...
class VA extends $A {
   ...
   */
  closestPointXY(t, e, n, i) {
    return i < lr(this.getExtent(), t, e) ? i : (this.maxDeltaRevision_ != this.getRevision() && (this.maxDelta_ = Math.sqrt(
      Er(
        this.flatCoordinates,
        0,
        this.flatCoordinates.length,
    ...
    ), this.maxDeltaRevision_ = this.getRevision()), vr(
      this.flatCoordinates,
      0,
      this.flatCoordinates.length,
      this.stride,
   ...
   */
  setCoordinates(t, e) {
    this.setLayout(e, t, 1), this.flatCoordinates || (this.flatCoordinates = []), this.flatCoordinates.length = wr(
      this.flatCoordinates,
      0,
      t,
      this.stride
...
function KI(A, t, e, n, i, r, s) {
  ...
  if (a === 1)
    ...
    const p = i * c, f = Pa(u, p);
    f < 0 ? (o = (p - u[-f - 2]) / (u[-f - 1] - u[-f - 2]), g = t + (-f - 2) * n) : g = t + f * n;
  }
  s = s > 1 ? s : 2, r = r || new Array(s);
  for (let I = 0; I < s; ++I)
    r[I] = g === void 0 ? NaN : o === void 0 ? A[g + I] : fr(A[g + I], A[g + n + I], o);
  return r;
}
function _I(A, t, e, n, i, r) {
  if (e == t)
    return null;
  let s;
  if (i < A[t + n - 1])
...
class Vn extends $A {
   ...
   */
  appendCoordinate(t) {
    wg(this.flatCoordinates, t), this.changed();
  }
  /**
   * Make a complete copy of the geometry.
  ...
  getCoordinateAtM(t, e) {
    return this.layout != "XYM" && this.layout != "XYZM" ? null : (e = e !== void 0 ? e : !1, _I(
      this.flatCoordinates,
      0,
      this.flatCoordinates.length,
      this.stride,
...
class KA extends $A {
   ...
   */
  computeExtent(t) {
    return ka(this.flatCoordinates, t);
  }
  /**
   * Get the type of this geometry.
   * @return {import("./Geometry.js").Type} Geometry type.
   ...
   */
  intersectsExtent(t) {
    return La(t, this.flatCoordinates[0], this.flatCoordinates[1]);
  }
  /**
   * @param {!Array<*>} coordinates Coordinates.
   * @param {import("./Geometry.js").GeometryLayout} [layout] Layout.
   ...
   */
  setCoordinates(t, e) {
    this.setLayout(e, t, 0), this.flatCoordinates || (this.flatCoordinates = []), this.flatCoordinates.length = Gg(
      this.flatCoordinates,
      0,
      t,
      this.stride
...
function qI(A, t, e, n, i, r, s) {
  ...
  let d = NaN, m = -1 / 0;
  for (f.sort(pg), I = f[0], g = 1, o = f.length; g < o; ++g) {
    C = f[g];
    const E = Math.abs(C - I);
    E > m && (a = (I + C) / 2, Xg(A, t, e, n, a, p) && (d = a, m = E)), I = C;
  }
...
function ps(A, t, e, n, i) {
  ...
  for (let r = 0, s = e.length; r < s; ++r) {
    ...
    (r === 0 ? i && o || !i && !o : i && !o || !i && o) && $I(A, t, g, n), t = g;
  }
  return t;
}
class xe extends $A {
   ...
   */
  appendLinearRing(t) {
    this.flatCoordinates ? wg(this.flatCoordinates, t.getFlatCoordinates()) : this.flatCoordinates = t.getFlatCoordinates().slice(), this.ends_.push(this.flatCoordinates.length), this.changed();
  }
  /**
   * Make a complete copy of the geometry.
  ...
  closestPointXY(t, e, n, i) {
    ...
    ), this.maxDeltaRevision_ = this.getRevision()), UI(
      this.flatCoordinates,
      0,
      this.ends_,
      this.stride,
  ...
  getCoordinates(t) {
    let e;
    return t !== void 0 ? (e = this.getOrientedFlatCoordinates().slice(), ps(e, 0, this.ends_, this.stride, t)) : e = this.flatCoordinates, zI(e, 0, this.ends_, this.stride);
  }
  /**
  ...
  getOrientedFlatCoordinates() {
    if (this.orientedRevision_ != this.getRevision()) {
      ...
      tC(t, 0, this.ends_, this.stride) ? this.orientedFlatCoordinates_ = t : (this.orientedFlatCoordinates_ = t.slice(), this.orientedFlatCoordinates_.length = ps(
...
class rr extends fg(bo) {
  constructor(t = {}) {
    const e = Object.assign({}, t), { mapType: n, layerTypes: i } = eC(t.maptype, t.layers);
...
function sC(A, t, e, n) {
  ...
  (function(i, r, s, g) {
    if (i !== void 0) {
      const o = A[0], a = A[A.length - 1], I = e ? Rr(
        o,
        e,
        s,
        n
      ...
      const C = Math.min(I, i), c = Math.floor(yg(A, C, r));
      return A[c] > I && c < A.length - 1 ? A[c + 1] : A[c];
    }
  });
}
function gC(A, t, e, n, i, r) {
...
class vs extends uA {
   ...
   */
  constructor(t) {
    super(), this.on, this.once, this.un, t = Object.assign({}, t), this.hints_ = [0, 0], this.animations_ = [], this.updateAnimationKey_, this.projection_ = yr(t.projection, "EPSG:3857"), this.viewportSize_ = [100, 100], this.targetCenter_ = null, this.targetResolution_, this.targetRotation_, this.nextCenter_ = null, this.nextResolution_, this.nextRotation_, this.cancelAnchor_ = void 0, t.projection && vI(), t.center && (t.center = oe(t.center, this.projection_)), t.extent && (t.extent = Nn(t.extent, this.projection_)), this.applyOptions_(t);
  }
  /**
  ...
  applyOptions_(t) {
    ...
    const i = CC(t), r = n.constraint, s = lC(t);
    this.constraints_ = {
      center: i,
      resolution: r,
      rotation: s
  ...
  animateInternal(t) {
    ...
    for (; i < e; ++i) {
      ...
      if (I.center && (C.sourceCenter = s, C.targetCenter = I.center.slice(), s = C.targetCenter), I.zoom !== void 0 ? (C.sourceResolution = g, C.targetResolution = this.getResolutionForZoom(I.zoom), g = C.targetResolution) : I.resolution && (C.sourceResolution = g, C.targetResolution = I.resolution, g = C.targetResolution), I.rotation !== void 0) {
        C.sourceRotation = o;
        const c = tr(I.rotation - o + Math.PI, 2 * Math.PI) - Math.PI;
        C.targetRotation = o + c, o = C.targetRotation;
      }
      hC(C) ? C.complete = !0 : r += C.duration, a.push(C);
    }
    ...
    for (let n = this.animations_.length - 1; n >= 0; --n) {
      ...
      for (let s = 0, g = i.length; s < g; ++s) {
        ...
        if (o.sourceRotation !== void 0 && o.targetRotation !== void 0) {
          const c = C === 1 ? tr(o.targetRotation + Math.PI, 2 * Math.PI) - Math.PI : o.sourceRotation + C * (o.targetRotation - o.sourceRotation);
          if (o.anchor) {
  ...
  calculateCenterRotate(t, e) {
    ...
    return i !== void 0 && (n = [i[0] - e[0], i[1] - e[1]], dr(n, t - this.getRotation()), qa(n, e)), n;
  }
  /**
  ...
  calculateExtent(t) {
    ...
    return SI(e, this.getProjection());
  }
  /**
  ...
  calculateExtentInternal(t) {
    ...
    return ce(i !== void 0, "The view rotation is not defined"), Za(e, n, i, t);
  }
  /**
  ...
  getZoomForResolution(t) {
    ...
    if (this.resolutions_) {
      const r = yg(this.resolutions_, t, 1);
  ...
  fit(t, e) {
    ...
    if (ce(
      ...
      n = ys(i), n.rotate(this.getRotation(), Wn(i));
    } else
      n = t;
  ...
  fitInternal(t, e) {
    ...
    const u = c[0] * C - c[1] * I, p = c[1] * C + c[0] * I, f = this.getConstrainedCenter([u, p], o), d = e.callback ? e.callback : $i;
...
function CC(A) {
  if (A.extent !== void 0) {
    ...
    return ws(A.extent, A.constrainOnlyCenter, e);
  }
  const t = yr(A.projection, "EPSG:3857");
  if (A.multiWorld !== !0 && t.isGlobal()) {
    const e = t.getExtent().slice();
    return e[0] = -1 / 0, e[2] = 1 / 0, ws(e, !1, !1);
  }
  return AC;
}
function cC(A) {
  let t, e, n, s = A.minZoom !== void 0 ? A.minZoom : Di, g = A.maxZoom !== void 0 ? A.maxZoom : 28;
  const o = A.zoomFactor !== void 0 ? A.zoomFactor : 2, a = A.multiWorld !== void 0 ? A.multiWorld : !1, I = A.smoothResolutionConstraint !== void 0 ? A.smoothResolutionConstraint : !0, C = A.showFullExtent !== void 0 ? A.showFullExtent : !1, c = yr(A.projection, "EPSG:3857"), u = c.getExtent();
  let p = A.constrainOnlyCenter, f = A.extent;
  if (!a && !f && c.isGlobal() && (p = !1, f = u), A.resolutions !== void 0) {
    const d = A.resolutions;
    e = d[s], n = d[g] !== void 0 ? d[g] : d[d.length - 1], A.constrainResolution ? t = sC(
      d,
      I,
      !p && f,
      C
    ...
    const m = (u ? Math.max(hr(u), WA(u)) : (
      // use an extent that can fit the whole world if need be
      360 * Pg.degrees / c.getMetersPerUnit()
    )) / IC / Math.pow(2, Di), E = m / Math.pow(2, 28 - Di);
    ...
    ), n = e / Math.pow(o, g - s), A.constrainResolution ? t = gC(
      o,
      e,
      n,
      I,
...
function lC(A) {
  if (A.enableRotation !== void 0 ? A.enableRotation : !0) {
    ...
    return e === void 0 || e === !0 ? aC() : e === !1 ? Es : typeof e == "number" ? oC(e) : Es;
  }
  return Sr;
}
function hC(A) {
...
class zg extends fC {
  ...
  isVisible(t) {
    ...
    !t && n && (t = n.getView()), t instanceof vs ? e = {
    ...
    return dC(i, e.viewState) && (!r || ur(r, e.extent));
  }
  /**
  ...
  getAttributions(t) {
    ...
    if (!e)
      return [];
    const n = t instanceof vs ? t.getViewStateAndExtent() : t;
    let i = e(n);
...
class mC extends zg {
  constructor(t) {
    ...
    const n = function(i) {
      ...
      g.style.opacity = I;
      const C = o.rotation * -180 / Math.PI, c = Ir(o.center), u = o.zoom - 1, p = s.getBearing(), f = s.getCenter().toArray(), d = s.getZoom();
      return C == p && c[0] == f[0] && c[1] == f[1] && u == d || (C != p && s.rotateTo(C, {
        animate: !1
      }), (c[0] != f[0] || c[1] != f[1] || u != d) && s.jumpTo({
        center: c,
        zoom: u,
        animate: !1
...
class pC extends zg {
  constructor(t) {
    ...
    const n = function(i) {
      ...
      const I = this.getOpacity();
      g.style.opacity = I;
      const c = -o.rotation * 180 / Math.PI, u = s.getBearing();
      Math.abs(c - u) > 0.01 && (s.stop(), s.setBearing(c));
      const p = Ir(o.center), f = o.zoom - 1;
...
class le extends po {
  ...
  static spawnLayer(t, e, n) {
    return e instanceof Kn || e instanceof _n || !(t instanceof Ei) ? (e instanceof Kn ? t = new mC({
      style: e.style,
      accessToken: e.accessToken,
      container: n,
      source: e
    }) : e instanceof _n ? t = new pC({
      style: e.style,
      container: n,
      source: e
    }) : (t = new Ei({
  ...
  setFeature(t, e, n) {
    const i = this.getSource(n), r = new yo(t);
  ...
  setTransparency(t) {
    ...
    n instanceof hA || n instanceof rr ? (this.getLayers().item(0).setOpacity(1), this.getLayers().item(1).setOpacity(e)) : this.getLayers().item(0).setOpacity(e);
  }
  setGPSMarker(t, e) {
...
class SC extends tn {
  ...
  handleEvent(t) {
    ...
    if (t.type == GA.DBLCLICK) {
      ...
      xr(g, s, r, this.duration_), n.preventDefault(), e = !0;
    }
    return !e;
  }
}
const De = typeof navigator < "u" && typeof navigator.userAgent < "u" ? navigator.userAgent.toLowerCase() : "", PC = De.includes("safari") && !De.includes("chrom");
PC && (De.includes("version/15.4") || /cpu (os|iphone os) 15_4 like mac os x/.test(De));
const xC = De.includes("webkit") && !De.includes("edge"), Yg = De.includes("macintosh");
...
const DC = function(A) {
  ...
  return (e instanceof ShadowRoot ? e.host : t).hasAttribute("tabindex") ? OC(A) : !0;
}, LC = Da, Kg = function(A) {
  const t = A.originalEvent;
  return "pointerId" in t && t.button == 0 && !(xC && Yg && t.ctrlKey);
}, _g = function(A) {
  const t = (
...
class GC extends fA {
  ...
  constructor(t) {
    ...
    const e = t.condition ? t.condition : sr(_g, NC);
    this.condition_ = t.onFocusOnly ? sr(Vg, e) : e, this.noKinetic_ = !1;
  }
  /**
   * Handle pointer drag events.
   * @param {import("../MapBrowserEvent.js").default} mapBrowserEvent Event.
  ...
  handleDragEvent(t) {
    ...
    const n = this.targetPointers, i = e.getEventPixel(Dr(n));
    if (n.length == this.lastPointersCount_) {
      if (this.kinetic_ && this.kinetic_.update(i[0], i[1]), this.lastCentroid) {
        ...
        $a(r, g.getResolution()), dr(r, g.getRotation()), g.adjustCenterInternal(r);
      }
...
class jC extends fA {
  ...
  constructor(t) {
    t = t || {}, super({
      stopDown: ti
    }), this.condition_ = t.condition ? t.condition : BC, this.lastAngle_ = void 0, this.duration_ = t.duration !== void 0 ? t.duration : 250;
  }
  /**
   * Handle pointer drag events.
   * @param {import("../MapBrowserEvent.js").default} mapBrowserEvent Event.
  ...
  handleDragEvent(t) {
    if (!IA(t))
      return;
    const e = t.map, n = e.getView();
    if (n.getConstraints().rotation === Sr)
      return;
   ...
   */
  handleDownEvent(t) {
    return IA(t) && Kg(t) && this.condition_(t) ? (t.map.getView().beginInteraction(), this.lastAngle_ = void 0, !0) : !1;
  }
}
class XC extends mg {
  /**
...
class ZC extends fA {
   ...
   */
  constructor(t) {
    super(), this.on, this.once, this.un, t = t ?? {}, this.box_ = new XC(t.className || "ol-dragbox"), this.minArea_ = t.minArea ?? 64, t.onBoxEnd && (this.onBoxEnd = t.onBoxEnd), this.startPixel_ = null, this.condition_ = t.condition ?? Kg, this.boxEndCondition_ = t.boxEndCondition ?? this.defaultBoxEndCondition;
  }
  /**
...
class FC extends ZC {
  ...
  constructor(t) {
    t = t || {};
    const e = t.condition ? t.condition : Jg;
    super({
      condition: e,
  ...
  handleEvent(t) {
    ...
    if (t.type == de.KEYDOWN) {
      ...
      if (this.condition_(t) && (i == ve.DOWN || i == ve.LEFT || i == ve.RIGHT || i == ve.UP)) {
        ...
        const I = [o, a];
        dr(I, s.getRotation()), MC(s, I, this.duration_), n.preventDefault(), e = !0;
      }
    }
    return !e;
  }
  ...
  handleEvent(t) {
    ...
    if (t.type == de.KEYDOWN || t.type == de.KEYPRESS) {
      ...
      if (this.condition_(t) && (i === "+" || i === "-")) {
        ...
        xr(g, s, void 0, this.duration_), n.preventDefault(), e = !0;
      }
    }
    return !e;
  }
}
const WC = 40, HC = 300, QC = 3;
class YC extends tn {
  /**
   * @param {Options} [options] Options.
   */
  constructor(t) {
    ...
    const e = t.condition ? t.condition : LC;
    this.condition_ = t.onFocusOnly ? sr(Vg, e) : e, this.lastAnchor_ = null, this.startTime_ = void 0, this.timeoutId_, this.mode_ = void 0, this.trackpadEventGap_ = 400, this.trackpadTimeoutId_, this.deltaPerZoom_ = 300, this.ctrlKeyPressed_ = !1, this.ctrlKeyListenerKeys_ = [];
  }
  /**
   * @param {import('../Map.js').default|null} map Map.
   * @override
  ...
  handleWheelZoom_(t) {
    ...
    (e.getConstrainResolution() || this.constrainResolution_) && (n = n ? n > 0 ? 1 : -1 : 0), xr(
      e,
      n,
      this.lastAnchor_ ? t.getCoordinateFromPixel(this.lastAnchor_) : null,
      this.duration_
...
class VC extends fA {
  ...
  handleDragEvent(t) {
    ...
    g.getConstraints().rotation !== Sr && (this.anchor_ = s.getCoordinateFromPixelInternal(
      s.getEventPixel(Dr(this.targetPointers))
...
class KC extends fA {
  ...
  handleDragEvent(t) {
    ...
    e != 1 && (this.lastScaleDelta_ = e), this.anchor_ = o.getCoordinateFromPixelInternal(
      o.getEventPixel(Dr(this.targetPointers))
...
function Ts(A) {
  A = A || {};
  const t = new RC(), e = new TC(-5e-3, 0.05, 100);
  return (A.altShiftDragRotate === void 0 || A.altShiftDragRotate) && t.push(new jC()), (A.doubleClickZoom === void 0 || A.doubleClickZoom) && t.push(
    new SC({
      delta: A.zoomDelta,
  ...
  ), (A.pinchRotate === void 0 || A.pinchRotate) && t.push(new VC()), (A.pinchZoom === void 0 || A.pinchZoom) && t.push(
    new KC({
      duration: A.zoomDuration
    })
  ), (A.keyboard === void 0 || A.keyboard) && (t.push(new UC()), t.push(
    new zC({
      delta: A.zoomDelta,
      duration: A.zoomDuration
    })
...
class _C extends fA {
  ...
  constructor(t) {
    t = t || {}, super(
      /** @type {import("./Pointer.js").Options} */
      t
    ), this.condition_ = t.condition ? t.condition : Jg, this.lastAngle_ = void 0, this.lastMagnitude_ = void 0, this.lastScaleDelta_ = 0, this.duration_ = t.duration !== void 0 ? t.duration : 400;
  }
  /**
   * Handle pointer drag events.
   * @param {import("../MapBrowserEvent.js").default} mapBrowserEvent Event.
...
const $C = /\{z\}/g, tc = /\{x\}/g, ec = /\{y\}/g, Ac = /\{-y\}/g;
function nc(A, t, e, n, i) {
  return A.replace($C, t.toString()).replace(tc, e.toString()).replace(ec, n.toString()).replace(Ac, function() {
    throw new Error(
  ...
  constructor(t = {}) {
    ...
    t.maxZoom = Math.ceil(Math.max(e, n)), t.tileUrlFunction = t.tileUrlFunction || function(i) {
      ...
      return (
        ...
        g * Re * Math.pow(2, this.maxZoom - r) >= this.height || s < 0 || g < 0 ? gg : this._tileUrlFunction(i)
      );
    }, super(t), t.mapID && (this.mapID = t.mapID), t.urls ? this._tileUrlFunction = Ss(t.urls) : t.url && (this._tileUrlFunction = Ss(Array.isArray(t.url) ? t.url : [t.url])), this.width = t.width, this.height = t.height, this.maxZoom = t.maxZoom, this._maxxy = Math.pow(2, this.maxZoom) * Re, this.initialize(t);
  }
}
class Jn extends hA {
  static isBasemap_ = !1;
...
class qn extends $g {
  mapTransform;
  constructor(t = {}) {
    super(t), this.mapTransform = new sg();
  }
  static async createAsync(t) {
    const [e, n] = await oc(t);
    t = e;
    const i = new qn(t);
    i.mapTransform = n;
  ...
  setupMapParameter(t) {
    ...
    this.mercZoom || (this.mercZoom = Math.log(300 * (2 * W) / 256 / p) / Math.log(2) - 3), this.homePosition || (this.homePosition = Ir(r)), this.envelope = Cg([
      [
        C[0],
        C[1],
        C[2],
...
if (dt.arrayBuffer)
  var Ic = [
    ...
    "[object Float32Array]",
    "[object Float64Array]"
  ], Cc = ArrayBuffer.isView || function(A) {
...
function cc(A) {
  var t = new FileReader(), e = to(t);
  return t.readAsArrayBuffer(A), e;
}
function lc(A) {
  var t = new FileReader(), e = to(t), n = /charset=([A-Za-z0-9_-]+)/.exec(A.type), i = n ? n[1] : "utf-8";
...
function eo() {
  return this.bodyUsed = !1, this._initBody = function(A) {
    ...
    if (A)
      return A;
    if (this._bodyBlob)
      return lc(this._bodyBlob);
    if (this._bodyArrayBuffer)
      return Promise.resolve(hc(this._bodyArrayBuffer));
    if (this._bodyFormData)
      throw new Error("could not read FormData body as text");
    return Promise.resolve(this._bodyText);
  }, dt.formData && (this.formData = function() {
    return this.text().then(dc);
  }), this.json = function() {
    return this.text().then(JSON.parse);
  }, this;
}
var uc = ["CONNECT", "DELETE", "GET", "HEAD", "OPTIONS", "PATCH", "POST", "PUT", "TRACE"];
function fc(A) {
  var t = A.toUpperCase();
  return uc.indexOf(t) > -1 ? t : A;
}
function Be(A, t) {
  ...
  if (A instanceof Be) {
    ...
    this.url = String(A);
  if (this.credentials = t.credentials || this.credentials || "same-origin", (t.headers || !this.headers) && (this.headers = new q(t.headers)), this.method = fc(t.method || this.method || "GET"), this.mode = t.mode || this.mode || null, this.signal = t.signal || this.signal || (function() {
  ...
  return new Promise(function(e, n) {
    ...
    r.onload = function() {
      var a = {
        ...
        headers: mc(r.getAllResponseHeaders() || "")
      };
    ...
    if (r.open(i.method, g(i.url), !0), i.credentials === "include" ? r.withCredentials = !0 : i.credentials === "omit" && (r.withCredentials = !1), "responseType" in r && (dt.blob ? r.responseType = "blob" : dt.arrayBuffer && (r.responseType = "arraybuffer")), t && typeof t.headers == "object" && !(t.headers instanceof q || rt.Headers && t.headers instanceof rt.Headers)) {
      ...
      Object.getOwnPropertyNames(t.headers).forEach(function(a) {
        o.push(dA(a)), r.setRequestHeader(a, Br(t.headers[a]));
...
async function wc(A, t) {
  ...
  if (A = jt(Object.assign(r, A)), A.label = A.label || r.year, A.maptype || (A.maptype = "maplat"), xs(A.maptype)) {
    const g = A.maptype === "base" ? hA : A.maptype === "overlay" ? Jn : A.maptype === "mapbox" ? Kn : A.maptype === "maplibre" ? _n : rr;
    g.isBasemap() ? (A.homePosition = A.homePos, A.mercZoom = A.defZoom) : (A.homePosition || (A.homePosition = A.homePos), A.mercZoom || (A.mercZoom = A.defZoom)), delete A.homePos, delete A.defZoom, A.zoomRestriction && (A.maxZoom = A.maxZoom || A.mercMaxZoom, A.minZoom = A.minZoom || A.mercMinZoom), A.zoomRestriction = A.mercMaxZoom = A.mercMinZoom = void 0, A.imageExtension || (A.imageExtension = "jpg"), qi(A.maptype) ? (delete A.url, delete A.urls) : A.mapID && !A.url && !A.urls && (A.url = A.tms ? `tiles/${A.mapID}/{z}/{x}/{-y}.${A.imageExtension}` : `tiles/${A.mapID}/{z}/{x}/{y}.${A.imageExtension}`), A.weiwudi = await ki(A), A.weiwudi && (A.url = A.weiwudi.url, delete A.urls);
    const o = await g.createAsync(A);
    try {
  ...
  const s = await qn.createAsync(A);
...
function gr(A, t) {
  if (A instanceof Array)
    return A.map((n) => gr(n, t));
  const e = Math.pow(10, t);
  return Math.round(A * e) / e;
}
var jA = { exports: {} }, Gi, Ds;
function so() {
  if (Ds) return Gi;
  Ds = 1;
  var A = /<%=([\s\S]+?)%>/g;
...
function bc() {
  if (Bs) return ji;
  Bs = 1;
  var A = so(), t = "[object Null]", e = "[object Symbol]", n = "[object Undefined]", i = /[&<>"']/g, r = RegExp(i.source), s = /<%-([\s\S]+?)%>/g, g = /<%([\s\S]+?)%>/g, o = {
    "&": "&amp;",
    "<": "&lt;",
    ">": "&gt;",
    '"': "&quot;",
...
function Ec() {
  return Os || (Os = 1, (function(A, t) {
    ...
    function Ye(l, y, b) {
      ...
      var G, mt, Q = 0, Lr = y.interpolate || U, pt = "__p += '", ho = RegExp(
        (y.escape || U).source + "|" + Lr.source + "|" + (Lr === e ? nn : U).source + "|" + (y.evaluate || U).source + "|$",
        "g"
      ), uo = Ct.call(y, "sourceURL") ? "//# sourceURL=" + (y.sourceURL + "").replace(/\s/g, " ") + `
` : "";
      l.replace(ho, function(Tn, kr, Sn, fo, Nr, Gr) {
        return Sn || (Sn = fo), pt += l.slice(Q, Gr).replace(mA, ee), kr && (G = !0, pt += `' +
__e(` + kr + `) +
'`), Nr && (mt = !0, pt += `';
` + Nr + `;
__p += '`), Sn && (pt += `' +
...
`) + pt + `return __p
      ...
      var Rn = PA(function() {
        return Function(k, uo + "return " + pt).apply(void 0, Y);
      });
...
function ks(A, ...t) {
  return A = jt(A), A.html ? A : t.reduce((e, n) => {
    ...
    if (i)
      return A.html = go(i)(A), A.poiStyle = A.poiStyle || n.poiStyle, A;
  }, void 0) || A;
}
const nt = {
  ACCURACY: "accuracy",
...
class Rc extends _t {
  ...
  message;
  constructor(t) {
    super(Mc.ERROR), this.code = t.code, this.message = t.message;
  }
}
class Tc extends uA {
  task_id_;
...
function Dc(A, t) {
  return Sc(A) || Pc(A, t) || Bc(A, t) || xc();
}
function Bc(A, t) {
  if (A) {
    if (typeof A == "string") return Ns(A, t);
    var e = {}.toString.call(A).slice(8, -1);
    return e === "Object" && A.constructor && (e = A.constructor.name), e === "Map" || e === "Set" ? Array.from(A) : e === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e) ? Ns(A, t) : void 0;
  }
}
const Io = Object.entries, Gs = Object.setPrototypeOf, Oc = Object.isFrozen, Lc = Object.getPrototypeOf, kc = Object.getOwnPropertyDescriptor;
let st = Object.freeze, gt = Object.seal, nA = Object.create, Co = typeof Reflect < "u" && Reflect, or = Co.apply, ar = Co.construct;
st || (st = function(t) {
  return t;
});
gt || (gt = function(t) {
...
const tA = J(Array.prototype.forEach), Nc = J(Array.prototype.lastIndexOf), js = J(Array.prototype.pop), eA = J(Array.prototype.push), Gc = J(Array.prototype.splice), he = Array.isArray, XA = J(String.prototype.toLowerCase), Xi = J(String.prototype.toString), Xs = J(String.prototype.match), OA = J(String.prototype.replace), Zs = J(String.prototype.indexOf), jc = J(String.prototype.trim), Xc = J(Number.prototype.toString), Zc = J(Boolean.prototype.toString), Fs = typeof BigInt > "u" ? null : J(BigInt.prototype.toString), Us = typeof Symbol > "u" ? null : J(Symbol.prototype.toString), et = J(Object.prototype.hasOwnProperty), LA = J(Object.prototype.toString), tt = J(RegExp.prototype.test), Me = Fc(TypeError);
function J(A) {
  return function(t) {
...
function It(A) {
  ...
  for (const n of Io(A)) {
    var e = Dc(n, 2);
    const i = e[0], r = e[1];
    et(A, i) && (he(r) ? t[i] = Uc(r) : r && typeof r == "object" && r.constructor === Object ? t[i] = It(r) : t[i] = r);
  }
  return t;
}
function zc(A) {
...
function co() {
  let A = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : il();
  const t = (M) => co(M);
  ...
  const F = function() {
    ...
    return Z || (X = rl(C, i), Z = !0), X;
  }, B = e, $ = B.implementation, St = B.createNodeIterator, qt = B.createDocumentFragment, $t = B.getElementsByTagName, en = n.importNode;
  let V = _s();
  t.isSupported = typeof Io == "function" && typeof m == "function" && $ && $.createHTMLDocument !== void 0;
  const gi = Yc, oi = Vc, ai = Kc, Ii = _c, Ci = Jc, An = qc, nn = $c, ci = el;
  let rn = Ys, U = null;
  const mA = j({}, [...zs, ...Zi, ...Fi, ...Ui, ...Ws]);
  let O = null;
  const pA = j({}, [...Hs, ...zi, ...Qs, ...Fn]);
  ...
  const cn = e.createElement("form"), ln = function(h) {
    ...
    st && st(h), se = h;
  }, hn = j({}, [...Zi, ...Fi, ...Hc]), un = j({}, [...Ui, ...Qc]), fn = function(h, w, l) {
    ...
    for (; w.length > 0; ) {
      ...
      if (y === bt.processingInstruction || y === bt.comment && tt(Ks, l.data)) {
        try {
          p(l);
        } catch {
        }
  ...
  const yn = function(h, w) {
    return !!(Dt && h.hasChildNodes() && !be(h.firstElementChild) && tt(Vs, h.textContent) && tt(Vs, h.innerHTML) || Dt && h.namespaceURI === ct && w === "style" && be(h.firstElementChild) || h.nodeType === bt.processingInstruction || Dt && h.nodeType === bt.comment && tt(Ks, h.data));
  }, wn = function(h, w, l) {
    ...
    if ((v ? v(h) : h.nodeType) === bt.element && !dn(h) || (l === "noscript" || l === "noembed" || l === "noframes") && tt(Al, h.innerHTML))
      return Bt(h), !0;
    ...
    if (!(Le && tt(Ii, w))) {
      if (!(te && tt(Ci, w))) {
        if (y) {
          if (!ie[w]) {
            if (!tt(rn, OA(l, nn, ""))) {
              if (!((w === "src" || w === "xlink:href" || w === "href") && h !== "script" && Zs(l, "data:") === 0 && gn[h])) {
                if (!(ke && !tt(An, OA(l, nn, "")))) {
                  if (l)
                    return !1;
                }
    ...
    try {
      l ? h.setAttributeNS(l, w, y) : h.setAttribute(w, y), we(h) ? Bt(h) : js(t.removed);
    } catch {
      zt(w, h);
    }
  }, SA = function(h) {
    ...
    for (; y--; ) {
      ...
      let Q = x === "value" ? mt : jc(mt);
      if (l.attrName = G, l.attrValue = Q, l.keepAttr = !0, l.forceKeepAttr = void 0, wt(V.uponSanitizeAttribute, h, l), Q = l.attrValue, Ae && (G === "id" || G === "name") && Zs(Q, Ze) !== 0 && (zt(x, h), Q = Ze + Q), Dt && tt(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i, Q)) {
        zt(x, h);
        continue;
      }
      if (G === "attributename" && Xs(Q, "href")) {
        zt(x, h);
        continue;
      }
      if (!l.forceKeepAttr) {
  ...
  return t.sanitize = function(M) {
    ...
    if (vA = !M, vA && (M = "<!-->"), typeof M != "string" && !be(M) && (M = zc(M), typeof M != "string"))
    ...
    return Ft && U["!doctype"] && w.ownerDocument && w.ownerDocument.doctype && w.ownerDocument.doctype.name && tt(tl, w.ownerDocument.doctype.name) && (k = "<!DOCTYPE " + w.ownerDocument.doctype.name + `>
` + k), xt && (k = ge(k)), D && pe ? H(k) : k;
    ...
    if (et(V, M)) {
      if (h !== void 0) {
        const w = Nc(V[M], h);
        return w === -1 ? void 0 : Gc(V[M], w, 1)[0];
      }
      return js(V[M]);
    }
...
var sl = co();
const gl = ["b", "strong", "i", "em", "u", "s", "br", "p", "span", "div", "ul", "ol", "li", "a", "img", "small", "sub", "sup", "code", "pre", "table", "thead", "tbody", "tr", "th", "td"], ol = ["href", "src", "alt", "title", "class", "target", "rel", "width", "height"], al = { values: ["target", "rel", "width", "height"] }, Il = ["script", "style", "iframe", "object", "embed", "form", "input", "textarea", "link", "meta", "base"], Cl = ["srcdoc", "style", "formaction", "xlink:href"], cl = { valueAttributes: ["image-url", "image-type", "thumbnail-url", "caption", "material-url", "camera-position", "camera-target", "show-texture"], booleanAttributes: ["fit-to-container", "debug-mode"], urlAttributes: ["image-url", "thumbnail-url", "material-url"], textAttributes: { values: ["caption"] } }, Jt = {
  tags: gl,
  attributes: ol,
  uriSafeAttributes: al,
  forbidTags: Il,
  forbidAttributes: Cl,
  slide: cl
}, ll = Jt.tags, hl = Jt.attributes, ul = /^(?:https?|mailto|tel|data):/i, fl = Jt.uriSafeAttributes.values, dl = Jt.forbidTags, ml = Jt.forbidAttributes, pl = /^data:image\/(png|jpeg|gif|webp|avif);/i, Js = (A) => !!A && /^\s*data:/i.test(A);
function yl(A) {
  if (A.tagName === "A" && A.getAttribute("target") === "_blank" && A.setAttribute("rel", "noopener noreferrer"), A.tagName === "IMG") {
    ...
    Js(e) && !pl.test(e.trim()) && A.removeAttribute("src"), A.hasAttribute("srcset") && A.removeAttribute("srcset");
  } else
    for (const e of ["src", "href", "xlink:href"])
      Js(A.getAttribute(e)) && A.removeAttribute(e);
}
let kA;
function lo() {
  if (kA) return kA;
  ...
  return kA = sl(A), kA.addHook("afterSanitizeAttributes", yl), kA;
}
function Xl(A) {
  return A == null ? "" : lo().sanitize(String(A), {
    ALLOWED_TAGS: ll,
    ALLOWED_ATTR: hl,
    ALLOWED_URI_REGEXP: ul,
    ADD_URI_SAFE_ATTR: fl,
    FORBID_TAGS: dl,
    FORBID_ATTR: ml,
    ALLOW_DATA_ATTR: !1,
...
const El = new Set(Jt.slide.valueAttributes), vl = new Set(Jt.slide.booleanAttributes), Ml = new Set(Jt.slide.textAttributes.values), Rl = new Set(Jt.slide.urlAttributes), Tl = (A) => /^(?:https?:)?\/\/|^\/|^[^:]*$/i.test(A.trim()), Sl = /["'`<>\s]/;
function Zl(A) {
  const t = [];
  for (const [e, n] of Object.entries(A || {})) {
    ...
    if (!El.has(i) || n == null) continue;
    let r = String(n);
    Rl.has(i) && (!Tl(r) || Sl.test(r)) || (Ml.has(i) && (r = bl(r)), t.push(`${i}="${wl(r)}"`));
  }
  return t.join(" ");
}
const Pl = {
  ...
  gsi_ortho: ro,
  redcircle: oo,
  defaultpin_selected: ao,
  defaultpin: Pr,
  bluedot: Wg,
  bluedot_transparent: Hg,
  bluedot_small: Qg
}, xl = {
...
class $n extends Eg {
  ...
  constructor(t) {
    ...
    e && t.mapboxToken && (e.accessToken = t.mapboxToken), t.googleApiKey && (this.googleApiKey = t.googleApiKey), this.mapDiv = t.div || "map_div", this.mapDivDocument = document.querySelector(`#${this.mapDiv}`), this.mapDivDocument.classList.add("maplat"), this.logger = new vo(
    ...
    [...DA(`<img id="center_circle" class="prevent-default" alt=""
            ...
            margin-left:-10px;" src="${oo}">`)].reverse().forEach((g) => {
  ...
  async runLifecyclePhase(t, e) {
    ...
    const n = this.buildLifecycleContext(t, e), i = xl[t], r = this.uiHooks?.[i];
    if (r)
      try {
        const s = await r(n);
  ...
  async handleSetting(t, e) {
    ...
    const i = await ag(this.appData.pois || [], this);
  ...
  initGeolocation(t) {
    ...
    const e = this.geolocation = new Tc({
      timerBase: t.fake,
    ...
    this.alwaysGpsOn ? (e.setTracking(!0), this.gpsEnabled_ = !0, this.initialGpsMove_ = !0) : (e.setTracking(!1), this.gpsEnabled_ = !1), e.on("change", () => {
      ...
      (s ? s.getSource() : g.getSource()).setGPSMarker(), this.dispatchEvent(new Dl(i === 1 ? "user_gps_deny" : i === 2 ? "gps_miss" : "gps_timeout")), this.dispatchEvent(new NA({ error: "gps_off" }));
  ...
  handleGPS(t, e = !1) {
    if (this.geolocation) {
      if (t)
        if (!this.alwaysGpsOn)
          this.firstGpsRequest_ = !0, this.geolocation.setTracking(!0), this.gpsEnabled_ = !0, this.dispatchEvent(new Bl());
        else {
  ...
  async prepareMap(t) {
    ...
    this.mapDivDocument.insertBefore(I, this.mapDivDocument.firstChild), this.fakeGps = g, this.fakeRadius = o, this.homePosition = e, this.mapObject = new le({
      ...
      interactions: this.noRotate ? Ts({ altShiftDragRotate: !1, pinchRotate: !1 }) : Ts().extend([
        new _C({
          condition: DC
        })
      ]),
  ...
  async handleSources(t) {
    ...
    }, null), this.dispatchEvent(new lt("sourceLoaded", t)), e.length === 0) {
  ...
  async setInitialMap(t) {
    ...
    this.from = t.reduce(
      (n, i) => n ? !(n instanceof $g) && i.mapID != e ? i : n : i.mapID != e ? i : n,
      void 0
  ...
  setMarker(t) {
    ...
    const e = t.lnglat || [
      t.lng || t.longitude,
      t.lat || t.latitude
    ], n = t.x, i = t.y, r = t.coordinates, s = this.from, g = t.icon ? this.__selectedMarker == t.namespaceID && t.selectedIcon ? t.selectedIcon : t.icon : this.__selectedMarker == t.namespaceID ? ao : Pr;
    return (r ? (function() {
        ...
        for (const g of Object.keys(this.pois)) {
          ...
          if (!o.hide)
            for (const a of o.pois) {
              const I = Ls(a, o, this);
              ks(I, o, this), this.__selectedMarker == I.namespaceID ? r = I : i.push(this.setMarker(I));
            }
        }
        if (n.pois)
          for (const g of Object.keys(n.pois)) {
            ...
            if (!o.hide)
              for (const a of o.pois) {
                const I = Ls(a, o, n, this);
                ks(I, o, n, this), this.__selectedMarker == I.namespaceID ? r = I : i.push(this.setMarker(I));
              }
          }
      }
      let s = Promise.all(i);
  ...
  convertParametersFromCurrent(t, e) {
    ...
    this.logger.debug(
      ...
      this.mercBuffer.buffer[o] && (this.logger.debug("To: Use buffer"), g = new Promise((a, I) => {
        ...
        ), this.logger.debug(`To: ${t.mapID}`), this.mercBuffer.buffer[t.mapID] = gr(a, 10), e(a);
      }).catch((a) => {
        throw a;
      });
    }).catch((s) => {
...
if (typeof window < "u") {
  ...
  window.Maplat = A, window.MaplatApp = $n, window.assets = Pl;
}
export {
  lt as CustomEvent,
  Dl as GPSErrorEvent,
  Bl as GPSRequestEvent,
  NA as GPSResultEvent,
  $n as MaplatApp,
  le as MaplatMap,
  Pl as assets,
  Zl as buildSlideAttrs,
  DA as createElement,
  wl as escapeAttr,
  wc as mapSourceFactory,
  Xl as sanitizeHtml,
  bl as toPlainText
};
