...
var VA = { exports: {} }, Yg = VA.exports, pr;
function Vg() {
...
const Ps = ["hide", "title", "icon", "selectedIcon"], Kg = [
  "lnglat",
  "lng",
  "lat",
  "longitude",
...
function Li(A) {
  ...
  return !(!e && !n || Kg.some((i) => A[i] !== void 0));
}
function Jg(A) {
...
const Me = 11102230246251565e-32, Xt = 134217729, eo = (3 + 8 * Me) * Me;
...
const no = (3 + 16 * Me) * Me, io = (2 + 12 * Me) * Me, ro = (9 + 64 * Me) * Me * Me, uA = an(4), vr = an(8), Mr = an(12), Rr = an(16), Wt = an(4);
function so(A, t, e, n, i, r, s) {
  ...
  let wt = Ao(4, uA), Zt = io * s;
  if (wt >= Zt || -wt >= Zt || (c = A - pt, g = A - (pt + c) + (c - i), c = e - yt, a = e - (yt + c) + (c - i), c = t - lt, o = t - (lt + c) + (c - r), c = n - dt, I = n - (dt + c) + (c - r), g === 0 && o === 0 && a === 0 && I === 0) || (Zt = ro * s + eo * Math.abs(wt), wt += pt * I + dt * g - (lt * a + yt * o), wt >= Zt || -wt >= Zt)) return wt;
...
function go(A, t, e, n, i, r) {
  const s = (t - r) * (e - i), g = (A - i) * (n - r), o = s - g, a = Math.abs(s + g);
  return Math.abs(o) >= no * a ? o : -so(A, t, e, n, i, r, a);
}
function oo(A, t) {
...
function ao(A, t, e = {}) {
  ...
  const n = $g(A), i = to(t), r = i.type, s = t.bbox;
  let g = i.coordinates;
  if (s && Io(n, s) === !1)
    return !1;
  r === "Polygon" && (g = [g]);
  ...
  class t extends A {
    ...
    initialize(n) {
      if (n = fe(n), this.mapID = n.mapID, this.homePosition = n.homePosition, this.mercZoom = n.mercZoom, this.label = n.label, this.maxZoom = n.maxZoom, this.minZoom = n.minZoom, this.poiTemplate = n.poiTemplate, this.poiStyle = n.poiStyle, this.iconTemplate = n.iconTemplate, this.icon = n.icon, this.selectedIcon = n.selectedIcon, this.mercatorXShift = n.mercatorXShift, this.mercatorYShift = n.mercatorYShift, this.weiwudi = n.weiwudi, n.envelopeLngLats) {
        ...
        g.push(g[0]), this.envelope = Bs([g]), this.centroid = wo(this.envelope).geometry?.coordinates;
      }
      ...
      this.initialWait = Promise.all([r, i]), vo(this);
    }
    static isBasemap() {
...
function Gs(A) {
  class t extends Ns(A) {
    ...
    static isWmts_ = !0;
    insideCheckXy(n) {
      return this.envelope ? ao(n, this.envelope) : !0;
    }
    ...
    modulateXyInside(n) {
      ...
      const i = qg([n, this.centroid]), r = yo(this.envelope, i);
...
function So(A) {
  ...
  return function() {
    ...
    return (!e || this !== n || !Ro(i, e)) && (n = this, e = i, t = A.apply(this, arguments)), t;
  };
}
function zs(A) {
  for (const t in A)
...
function Vs(A, t) {
  let e;
  return e = t(Lo(A)), e || (e = t(ko(A)), e) || (e = t(jo(A)), e) || (e = t(Xo(A)), e) ? e : !1;
}
function Lo(A) {
  return [A[0], A[1]];
}
...
let Uo = 0;
function zo(A) {
  return A.ol_uid || (A.ol_uid = String(++Uo));
}
const Wo = {
  /**
...
class OA extends ei {
   ...
   */
  constructor(t) {
    super(), this.on, this.once, this.un, zo(this), this.values_ = null, t !== void 0 && this.setProperties(t);
  }
  /**
   * Gets a value.
  ...
  notify(t, e) {
    let n;
    n = `change:${t}`, this.hasListener(n) && this.dispatchEvent(new Br(n, t, e)), n = Wo.PROPERTYCHANGE, this.hasListener(n) && this.dispatchEvent(new Br(n, t, e));
  }
  /**
   * @param {string} key Key name.
   * @param {import("./events.js").Listener} listener Listener.
  ...
  unset(t, e) {
    if (this.values_ && t in this.values_) {
      ...
      delete this.values_[t], Po(this.values_) && (this.values_ = null), e || this.notify(t, n);
    }
  }
}
function Qo(...A) {
...
const In = 6378137, vA = Math.PI * In, Ko = [-vA, -vA, vA, vA], Jo = [-180, -85, 180, 85], Ln = In * Math.log(Math.tan(Math.PI / 2));
class fA extends nn {
  /**
...
const ta = 6378137, kr = [-180, -90, 180, 90], ea = Math.PI * ta / 180;
class Ve extends nn {
  /**
   * @param {string} code Code.
...
const Hn = 0.9996, Ae = 669438e-8, Ai = Ae * Ae, ni = Ai * Ae, $e = Ae / (1 - Ae), Gr = Math.sqrt(1 - Ae), DA = (1 - Gr) / (1 + Gr), Js = DA * DA, $i = Js * DA, tr = $i * DA, qs = tr * DA, $s = 1 - Ae / 4 - 3 * Ai / 64 - 5 * ni / 256, ia = 3 * Ae / 8 + 3 * Ai / 32 + 45 * ni / 1024, ra = 15 * Ai / 256 + 45 * ni / 1024, sa = 35 * ni / 3072, ga = 3 / 2 * DA - 27 / 32 * $i + 269 / 512 * qs, oa = 21 / 16 * Js - 55 / 32 * tr, aa = 151 / 96 * $i - 417 / 128 * qs, Ia = 1097 / 512 * tr, Qn = 6378137;
function Ca(A, t, e) {
  const n = A - 5e5, s = (e.north ? t : t - 1e7) / Hn / (Qn * $s), g = s + ga * Math.sin(2 * s) + oa * Math.sin(4 * s) + aa * Math.sin(6 * s) + Ia * Math.sin(8 * s), o = Math.sin(g), a = o * o, I = Math.cos(g), c = o / I, h = c * c, m = h * h, b = 1 - Ae * a, v = Math.sqrt(1 - Ae * a), T = Qn / v, O = (1 - Ae) / b, Z = $e * I ** 2, Q = Z * Z, U = n / (T * Hn), Y = U * U, nt = Y * U, tt = nt * U, _ = tt * U, pt = _ * U, yt = g - c / O * (Y / 2 - tt / 24 * (5 + 3 * h + 10 * Z - 4 * Q - 9 * $e)) + pt / 720 * (61 + 90 * h + 298 * Z + 45 * m - 252 * $e - 3 * Q);
...
const Xr = -80, jr = 84, ca = -180, la = 180;
function ha(A, t, e) {
  A = Gi(A, ca, la), t < Xr ? t = Xr : t > jr && (t = jr);
  const n = TA(t), i = Math.sin(n), r = Math.cos(n), s = i / r, g = s * s, o = g * g, a = TA(A), I = tg(e.number), c = TA(I), h = Qn / Math.sqrt(1 - Ae * i ** 2), m = $e * r ** 2, b = r * Gi(a - c, -Math.PI, Math.PI), v = b * b, T = v * b, O = T * b, Z = O * b, Q = Z * b, U = Qn * ($s * n - ia * Math.sin(2 * n) + ra * Math.sin(4 * n) - sa * Math.sin(6 * n)), Y = Hn * h * (b + T / 6 * (1 - g + m) + Z / 120 * (5 - 18 * g + o + 72 * m - 58 * $e)) + 5e5;
...
function Be(A, t) {
  return ji && !Wn(A, [0, 0]) && A[0] >= -180 && A[0] <= 180 && A[1] >= -90 && A[1] <= 90 && (ji = !1, Qo(
...
const Ra = [1, 0, 0, 1, 0, 0];
new Array(6);
function Ta() {
  return Ra.slice(0);
}
function Sa(A, t, e, n, i, r, s, g) {
...
const Wr = Ta(), Ba = [NaN, NaN];
class Oa extends OA {
  constructor() {
    super(), this.extent_ = Hs(), this.extentRevision_ = -1, this.simplifiedGeometryMaxMinSquaredTolerance = 0, this.simplifiedGeometryRevision = 0, this.simplifyTransformedInternal = So(
      (t, e, n) => {
        if (!n)
   ...
   */
  containsXY(t, e) {
    return this.closestPointXY(t, e, Ba, Number.MIN_VALUE) === 0;
  }
  /**
...
function Xa(A, t, e, n, i, r, s, g, o, a, I) {
  I = I || [NaN, NaN];
...
function og(A, t, e, n, i, r, s) {
  ...
  for (; a.length > 0; ) {
    ...
    for (let Z = h + n; Z < c; Z += n) {
      const Q = A[Z], U = A[Z + 1], Y = Yo(Q, U, b, v, T, O);
      Y > m && (I = Z, m = Y);
    }
...
class Yn extends Cn {
  ...
  getCoordinateAtM(t, e) {
    return this.layout != "XYM" && this.layout != "XYZM" ? null : (e = e !== void 0 ? e : !1, Qa(
      this.flatCoordinates,
      0,
      this.flatCoordinates.length,
      this.stride,
...
class on extends Cn {
   ...
   */
  computeExtent(t) {
    return Do(this.flatCoordinates, t);
  }
  /**
   * Get the type of this geometry.
   * @return {import("./Geometry.js").Type} Geometry type.
...
function Yr(A, t, e, n, i) {
  ...
  for (let r = 0, s = e.length; r < s; ++r) {
    ...
    (r === 0 ? i && o || !i && !o : i && !o || !i && o) && _a(A, t, g, n), t = g;
  }
  return t;
}
class eA extends Cn {
  ...
  closestPointXY(t, e, n, i) {
    ...
    ), this.maxDeltaRevision_ = this.getRevision()), Xa(
      this.flatCoordinates,
      0,
      this.ends_,
      this.stride,
  ...
  getCoordinates(t) {
    let e;
    return t !== void 0 ? (e = this.getOrientedFlatCoordinates().slice(), Yr(e, 0, this.ends_, this.stride, t)) : e = this.flatCoordinates, ja(e, 0, this.ends_, this.stride);
  }
  /**
  ...
  getOrientedFlatCoordinates() {
    if (this.orientedRevision_ != this.getRevision()) {
      ...
      Ka(t, 0, this.ends_, this.stride) ? this.orientedFlatCoordinates_ = t : (this.orientedFlatCoordinates_ = t.slice(), this.orientedFlatCoordinates_.length = Yr(
...
class qr extends OA {
   ...
   */
  constructor(t) {
    super(), this.on, this.once, this.un, t = Object.assign({}, t), this.hints_ = [0, 0], this.animations_ = [], this.updateAnimationKey_, this.projection_ = er(t.projection, "EPSG:3857"), this.viewportSize_ = [100, 100], this.targetCenter_ = null, this.targetResolution_, this.targetRotation_, this.nextCenter_ = null, this.nextResolution_, this.nextRotation_, this.cancelAnchor_ = void 0, t.projection && ya(), t.center && (t.center = Be(t.center, this.projection_)), t.extent && (t.extent = kn(t.extent, this.projection_)), this.applyOptions_(t);
  }
  /**
  ...
  applyOptions_(t) {
    ...
    const i = sI(t), r = n.constraint, s = oI(t);
    this.constraints_ = {
      center: i,
      resolution: r,
      rotation: s
  ...
  animateInternal(t) {
    ...
    for (; i < e; ++i) {
      ...
      aI(c) ? c.complete = !0 : r += c.duration, a.push(c);
    }
  ...
  calculateCenterRotate(t, e) {
    ...
    return i !== void 0 && (n = [i[0] - e[0], i[1] - e[1]], qi(n, t - this.getRotation()), Vo(n, e)), n;
  }
  /**
  ...
  calculateExtent(t) {
    ...
    return va(e, this.getProjection());
  }
  /**
  ...
  calculateExtentInternal(t) {
    ...
    return Ne(i !== void 0, "The view rotation is not defined"), No(e, n, i, t);
  }
  /**
...
function gI(A) {
  ...
  if (!a && !v && h.isGlobal() && (b = !1, v = m), A.resolutions !== void 0) {
    ...
    e = T[s], n = T[g] !== void 0 ? T[g] : T[T.length - 1], A.constrainResolution ? t = eI(
      T,
      I,
      !b && v,
      c
    ...
    )) / rI / Math.pow(2, mi), Z = O / Math.pow(2, 28 - mi);
    ...
    ), n = e / Math.pow(o, g - s), A.constrainResolution ? t = AI(
      o,
      e,
      n,
      I,
...
function oI(A) {
  if (A.enableRotation !== void 0 ? A.enableRotation : !0) {
    ...
    return e === void 0 || e === !0 ? iI() : e === !1 ? Jr : typeof e == "number" ? nI(e) : Jr;
  }
  return ar;
}
function aI(A) {
...
class Ge extends jg {
  ...
  static spawnLayer(t, e, n) {
    return e instanceof Vn || e instanceof _n || !(t instanceof hi) ? (e instanceof Vn ? t = new lI({
      style: e.style,
      accessToken: e.accessToken,
      container: n,
      source: e
    }) : e instanceof _n ? t = new hI({
      style: e.style,
      container: n,
      source: e
    }) : (t = new hi({
...
const AA = typeof navigator < "u" && typeof navigator.userAgent < "u" ? navigator.userAgent.toLowerCase() : "", vI = AA.includes("safari") && !AA.includes("chrom");
vI && (AA.includes("version/15.4") || /cpu (os|iphone os) 15_4 like mac os x/.test(AA));
const MI = AA.includes("webkit") && !AA.includes("edge"), hg = AA.includes("macintosh");
...
const RI = function(A) {
  ...
  return (e instanceof ShadowRoot ? e.host : t).hasAttribute("tabindex") ? SI(A) : !0;
}, PI = To, fg = function(A) {
  const t = A.originalEvent;
  return "pointerId" in t && t.button == 0 && !(MI && hg && t.ctrlKey);
}, dg = function(A) {
  const t = (
...
class BI extends LA {
  ...
  constructor(t) {
    ...
    const e = t.condition ? t.condition : Ui(dg, DI);
  ...
  handleDragEvent(t) {
    ...
    if (n.length == this.lastPointersCount_) {
      if (this.kinetic_ && this.kinetic_.update(i[0], i[1]), this.lastCentroid) {
        ...
        _o(r, g.getResolution()), qi(r, g.getRotation()), g.adjustCenterInternal(r);
      }
...
class OI extends LA {
  ...
  constructor(t) {
    t = t || {}, super({
      stopDown: $n
    }), this.condition_ = t.condition ? t.condition : TI, this.lastAngle_ = void 0, this.duration_ = t.duration !== void 0 ? t.duration : 250;
  }
  /**
   * Handle pointer drag events.
   * @param {import("../MapBrowserEvent.js").default} mapBrowserEvent Event.
...
class kI extends LA {
   ...
   */
  constructor(t) {
    super(), this.on, this.once, this.un, t = t ?? {}, this.box_ = new LI(t.className || "ol-dragbox"), this.minArea_ = t.minArea ?? 64, t.onBoxEnd && (this.onBoxEnd = t.onBoxEnd), this.startPixel_ = null, this.condition_ = t.condition ?? fg, this.boxEndCondition_ = t.boxEndCondition ?? this.defaultBoxEndCondition;
  }
  /**
  ...
  handleEvent(t) {
    ...
    if (t.type == Ze.KEYDOWN) {
      ...
      if (this.condition_(t) && (i == _e.DOWN || i == _e.LEFT || i == _e.RIGHT || i == _e.UP)) {
        ...
        const I = [o, a];
        qi(I, s.getRotation()), yI(s, I, this.duration_), n.preventDefault(), e = !0;
      }
    }
    return !e;
  }
...
function es(A) {
  A = A || {};
  const t = new wI(), e = new bI(-5e-3, 0.05, 100);
  return (A.altShiftDragRotate === void 0 || A.altShiftDragRotate) && t.push(new OI()), (A.doubleClickZoom === void 0 || A.doubleClickZoom) && t.push(
    new EI({
      delta: A.zoomDelta,
  ...
  ), (A.pinchRotate === void 0 || A.pinchRotate) && t.push(new zI()), (A.pinchZoom === void 0 || A.pinchZoom) && t.push(
    new WI({
      duration: A.zoomDuration
    })
  ), (A.keyboard === void 0 || A.keyboard) && (t.push(new GI()), t.push(
    new XI({
      delta: A.zoomDelta,
      duration: A.zoomDuration
    })
...
const VI = /\{z\}/g, _I = /\{x\}/g, KI = /\{y\}/g, JI = /\{-y\}/g;
function qI(A, t, e, n, i) {
  return A.replace(VI, t.toString()).replace(_I, e.toString()).replace(KI, n.toString()).replace(JI, function() {
    throw new Error(
...
if (Qt.arrayBuffer)
  var rC = [
    ...
    "[object Float32Array]",
    "[object Float64Array]"
  ], sC = ArrayBuffer.isView || function(A) {
    return A && rC.indexOf(Object.prototype.toString.call(A)) > -1;
  };
function kA(A) {
  ...
  return new Promise(function(e, n) {
    ...
    r.onload = function() {
      var a = {
        ...
        headers: lC(r.getAllResponseHeaders() || "")
      };
...
async function fC(A, t) {
  if (typeof A == "string" && (A = { ...uC[A] }), A = fe(Object.assign(A, t)), A.label = A.label || A.year, is(A.maptype)) {
...
class wC extends Re {
  ...
  message;
  constructor(t) {
    super(yC.ERROR), this.code = t.code, this.message = t.message;
  }
}
class bC extends OA {
  task_id_;
...
const Dg = Object.entries, Cs = Object.setPrototypeOf, SC = Object.isFrozen, PC = Object.getPrototypeOf, xC = Object.getOwnPropertyDescriptor;
...
const yA = Mt(Array.prototype.forEach), DC = Mt(Array.prototype.lastIndexOf), cs = Mt(Array.prototype.pop), wA = Mt(Array.prototype.push), BC = Mt(Array.prototype.splice), Xe = Array.isArray, JA = Mt(String.prototype.toLowerCase), Ri = Mt(String.prototype.toString), ls = Mt(String.prototype.match), WA = Mt(String.prototype.replace), hs = Mt(String.prototype.indexOf), OC = Mt(String.prototype.trim), LC = Mt(Number.prototype.toString), kC = Mt(Boolean.prototype.toString), us = typeof BigInt > "u" ? null : Mt(BigInt.prototype.toString), fs = typeof Symbol > "u" ? null : Mt(Symbol.prototype.toString), xt = Mt(Object.prototype.hasOwnProperty), HA = Mt(Object.prototype.toString), Pt = Mt(RegExp.prototype.test), Ke = NC(TypeError);
function Mt(A) {
  return function(t) {
...
function jt(A) {
  ...
  for (const n of Dg(A)) {
    var e = RC(n, 2);
    const i = e[0], r = e[1];
    xt(A, i) && (Xe(r) ? t[i] = GC(r) : r && typeof r == "object" && r.constructor === Object ? t[i] = jt(r) : t[i] = r);
  }
  return t;
}
function XC(A) {
...
function Og() {
  let A = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : $C();
  const t = (X) => Og(X);
  ...
  const NA = UC, Fe = zC, rA = WC, sA = HC, Ue = QC, gA = YC, oA = VC, GA = KC;
  let aA = ws, gt = null;
  ...
  const IA = e.createElement("form"), CA = function(l) {
    ...
    Lt && Lt(l), Vt = l;
  }, ln = rt({}, [...Ti, ...Si, ...ZC]), hn = rt({}, [...Pi, ...FC]), un = function(l, w, C) {
  ...
  const pn = function(l, w) {
    ...
    if ((U ? U(l) : l.nodeType) === te.element && !fn(l) || (C === "noscript" || C === "noembed" || C === "noframes") && Pt(JC, l.innerHTML))
      return re(l), !0;
  ...
  return t.sanitize = function(X) {
    ...
    if (J = !X, J && (X = "<!-->"), typeof X != "string" && !Ye(X) && (X = XC(X), typeof X != "string"))
    ...
    return qt && gt["!doctype"] && w.ownerDocument && w.ownerDocument.doctype && w.ownerDocument.doctype.name && Pt(_C, w.ownerDocument.doctype.name) && (q = "<!DOCTYPE " + w.ownerDocument.doctype.name + `>
` + q), Ft && (q = De(q)), tt && u ? wt(q) : q;
    ...
    if (xt(Ct, X)) {
      if (l !== void 0) {
        const w = DC(Ct[X], l);
        return w === -1 ? void 0 : BC(Ct[X], w, 1)[0];
      }
      return cs(Ct[X]);
    }
...
var ec = Og();
const Ac = ["b", "strong", "i", "em", "u", "s", "br", "p", "span", "div", "ul", "ol", "li", "a", "img", "small", "sub", "sup", "code", "pre", "table", "thead", "tbody", "tr", "th", "td"], nc = ["href", "src", "alt", "title", "class", "target", "rel", "width", "height"], ic = { values: ["target", "rel", "width", "height"] }, rc = ["script", "style", "iframe", "object", "embed", "form", "input", "textarea", "link", "meta", "base"], sc = ["srcdoc", "style", "formaction", "xlink:href"], gc = { valueAttributes: ["image-url", "image-type", "thumbnail-url", "caption", "material-url", "camera-position", "camera-target", "show-texture"], booleanAttributes: ["fit-to-container", "debug-mode"], urlAttributes: ["image-url", "thumbnail-url", "material-url"], textAttributes: { values: ["caption"] } }, Te = {
  tags: Ac,
  attributes: nc,
  uriSafeAttributes: ic,
  forbidTags: rc,
  forbidAttributes: sc,
  slide: gc
}, oc = Te.tags, ac = Te.attributes, Ic = /^(?:https?|mailto|tel|data):/i, Cc = Te.uriSafeAttributes.values, cc = Te.forbidTags, lc = Te.forbidAttributes, hc = /^data:image\/(png|jpeg|gif|webp|avif);/i, Ms = (A) => !!A && /^\s*data:/i.test(A);
function uc(A) {
  if (A.tagName === "A" && A.getAttribute("target") === "_blank" && A.setAttribute("rel", "noopener noreferrer"), A.tagName === "IMG") {
    ...
    Ms(e) && !hc.test(e.trim()) && A.removeAttribute("src"), A.hasAttribute("srcset") && A.removeAttribute("srcset");
  } else
...
function Lg() {
  ...
  return QA = ec(A), QA.addHook("afterSanitizeAttributes", uc), QA;
}
function Lc(A) {
  return A == null ? "" : Lg().sanitize(String(A), {
    ALLOWED_TAGS: oc,
    ALLOWED_ATTR: ac,
    ALLOWED_URI_REGEXP: Ic,
    ADD_URI_SAFE_ATTR: Cc,
    FORBID_TAGS: cc,
    FORBID_ATTR: lc,
    ALLOW_DATA_ATTR: !1,
...
const mc = new Set(Te.slide.valueAttributes), pc = new Set(Te.slide.booleanAttributes), yc = new Set(Te.slide.textAttributes.values), wc = new Set(Te.slide.urlAttributes), bc = (A) => /^(?:https?:)?\/\/|^\/|^[^:]*$/i.test(A.trim()), Ec = /["'`<>\s]/;
function kc(A) {
  const t = [];
  for (const [e, n] of Object.entries(A || {})) {
    ...
    if (!mc.has(i) || n == null) continue;
    let r = String(n);
    wc.has(i) && (!bc(r) || Ec.test(r)) || (yc.has(i) && (r = dc(r)), t.push(`${i}="${fc(r)}"`));
  }
  return t.join(" ");
}
const vc = {
...
class qn extends Ws {
  ...
  async runLifecyclePhase(t, e) {
    ...
    const n = this.buildLifecycleContext(t, e), i = Mc[t], r = this.uiHooks?.[i];
    if (r)
      try {
        const s = await r(n);
  ...
  initGeolocation(t) {
    ...
    this.alwaysGpsOn ? (e.setTracking(!0), this.gpsEnabled_ = !0, this.initialGpsMove_ = !0) : (e.setTracking(!1), this.gpsEnabled_ = !1), e.on("change", () => {
      ...
      (s ? s.getSource() : g.getSource()).setGPSMarker(), this.dispatchEvent(new Rc(i === 1 ? "user_gps_deny" : i === 2 ? "gps_miss" : "gps_timeout")), this.dispatchEvent(new YA({ error: "gps_off" }));
  ...
  handleGPS(t, e = !1) {
    if (this.geolocation) {
      if (t)
        if (!this.alwaysGpsOn)
          this.firstGpsRequest_ = !0, this.geolocation.setTracking(!0), this.gpsEnabled_ = !0, this.dispatchEvent(new Tc());
        else {
...
if (typeof window < "u") {
  ...
  window.Maplat = A, window.MaplatApp = qn, window.assets = vc;
}
export {
  zt as CustomEvent,
  Rc as GPSErrorEvent,
  Tc as GPSRequestEvent,
  YA as GPSResultEvent,
  qn as MaplatApp,
  Ge as MaplatMap,
  vc as assets,
  kc as buildSlideAttrs,
  UA as createElement,
  fc as escapeAttr,
  fC as mapSourceFactory,
  Lc as sanitizeHtml,
  dc as toPlainText
};
