...
var w = (A, t, e) => Qr(A, typeof t != "symbol" ? t + "" : t, e);
...
function nC() {
  return ng || (ng = 1, (function(A, t) {
    (function(e, n) {
      ...
      var n = Object.defineProperty, i = (h, d, y) => d in h ? n(h, d, { enumerable: !0, configurable: !0, writable: !0, value: y }) : h[d] = y, g = (h, d, y) => i(h, typeof d != "symbol" ? d + "" : d, y);
      function r(h, d, y = {}) {
        const b = { type: "Feature" };
        return (y.id === 0 || y.id) && (b.id = y.id), y.bbox && (b.bbox = y.bbox), b.properties = d || {}, b.geometry = h, b;
      }
      function s(h, d, y = {}) {
        ...
        return r({ type: "Point", coordinates: h }, d, y);
      }
      function o(h, d, y = {}) {
        for (const b of h) {
        ...
        return r({ type: "Polygon", coordinates: h }, d, y);
      }
      function I(h, d = {}) {
        const y = { type: "FeatureCollection" };
        return d.id && (y.id = d.id), d.bbox && (y.bbox = d.bbox), y.features = h, y;
      }
      function C(h) {
      ...
      function E(h, d, y, b, O) {
        let P, T, X, D, Z = d[0], j = b[0], x = 0, G = 0;
        j > Z == j > -Z ? (P = Z, Z = d[++x]) : (P = j, j = b[++G]);
        let N = 0;
        if (x < h && G < y) for (j > Z == j > -Z ? (T = Z + P, X = P - (T - Z), Z = d[++x]) : (T = j + P, X = P - (T - j), j = b[++G]), P = T, X !== 0 && (O[N++] = X); x < h && G < y; ) j > Z == j > -Z ? (T = P + Z, D = T - P, X = P - (T - D) + (Z - D), Z = d[++x]) : (T = P + j, D = T - P, X = P - (T - D) + (j - D), j = b[++G]), P = T, X !== 0 && (O[N++] = X);
        for (; x < h; ) T = P + Z, D = T - P, X = P - (T - D) + (Z - D), Z = d[++x], P = T, X !== 0 && (O[N++] = X);
        for (; G < y; ) T = P + j, D = T - P, X = P - (T - D) + (j - D), j = b[++G], P = T, X !== 0 && (O[N++] = X);
        return (P !== 0 || N === 0) && (O[N++] = P), N;
      }
      function S(h, d) {
        let y = d[0];
        for (let b = 1; b < h; b++) y += d[b];
        return y;
      }
      function L(h) {
      ...
      function lt(h, d, y, b, O, P, T) {
        let X, D, Z, j, x, G, N, Y, k, B, M, Q, J, _, it, V, nt, It;
        const bt = h - O, St = y - O, Mt = d - P, ct = b - P;
        ...
        let Lt = S(4, $), ne = U * T;
        if (Lt >= ne || -Lt >= ne || (x = h - bt, X = h - (bt + x) + (x - O), x = y - St, Z = y - (St + x) + (x - O), x = d - Mt, D = d - (Mt + x) + (x - P), x = b - ct, j = b - (ct + x) + (x - P), X === 0 && D === 0 && Z === 0 && j === 0) || (ne = K * T + v * Math.abs(Lt), Lt += bt * j + ct * X - (Mt * Z + St * D), Lt >= ne || -Lt >= ne)) return Lt;
      ...
      function mt(h, d, y, b, O, P) {
        const T = (d - P) * (y - O), X = (h - O) * (b - P), D = T - X, Z = Math.abs(T + X);
        return Math.abs(D) >= z * Z ? D : -lt(h, d, y, b, O, P, Z);
      }
      function Ot(h, d) {
        var y, b, O = 0, P, T, X, D, Z, j, x, G = h[0], N = h[1], Y = d.length;
        for (y = 0; y < Y; y++) {
          b = 0;
          var k = d[y], B = k.length - 1;
      ...
      function Qt(h, d, y = {}) {
        ...
        for (var Z = 0; Z < X.length; ++Z) {
          const j = Ot(b, X[Z]);
          if (j === 0) return !y.ignoreBoundary;
          j && (D = !0);
        }
        return D;
      }
      ...
      function pt(h, d) {
        for (let y = 0; y < d.features.length; y++) if (Qt(h, d.features[y])) return d.features[y];
      }
      function kt(h, d, y) {
        ...
        if (y) {
          const M = y[d.properties.a.index], Q = y[d.properties.b.index], J = y[d.properties.c.index];
          let _;
          if (k < 0 || B < 0 || 1 - k - B < 0) {
      ...
      function Jt(h, d, y, b) {
        const O = h.geometry.coordinates, P = y.geometry.coordinates, T = Math.atan2(O[0] - P[0], O[1] - P[1]), X = YA(T, d[0]);
        if (X === void 0) throw new Error("Unable to determine vertex index");
        const D = d[1][X];
        return kt(h, D.features[0], b);
      }
      function Wt(h, d, y, b, O, P, T, X) {
        let D;
        if (T && (D = pt(h, I([T]))), !D) {
          if (y) {
            const Z = h.geometry.coordinates, j = y.gridNum, x = y.xOrigin, G = y.yOrigin, N = y.xUnit, Y = y.yUnit, k = y.gridCache, B = Pt(Z[0], x, N, j), M = Pt(Z[1], G, Y, j), Q = k[B] ? k[B][M] ? k[B][M] : [] : [];
      ...
      function Pt(h, d, y, b) {
        let O = Math.floor((h - d) / y);
        return O >= b && (O = b - 1), O;
      }
      function YA(h, d) {
        let y = oA(h - d[0]), b = Math.PI * 2, O;
        for (let P = 0; P < d.length; P++) {
          const T = (P + 1) % d.length, X = oA(h - d[T]), D = Math.min(Math.abs(y), Math.abs(X));
          y * X <= 0 && D < b && (b = D, O = P), y = X;
        }
        return O;
      }
      function oA(h, d = !1) {
        const y = d ? function(b) {
          return !(b >= 0 && b < Math.PI * 2);
        } : function(b) {
          return !(b > -1 * Math.PI && b <= Math.PI);
        };
        for (; y(h); ) h = h + 2 * Math.PI * (h > 0 ? -1 : 1);
        return h;
      }
      function IA(h, d) {
        return d && d >= 2.00703 || Array.isArray(h[0]) ? h : h.map((y) => [y.illstNodes, y.mercNodes, y.startEnd]);
      }
      function VA(h) {
        const d = h.features;
        for (let y = 0; y < d.length; y++) {
          const b = d[y];
          `${b.properties.a.index}`.substring(0, 1) === "b" && `${b.properties.b.index}`.substring(0, 1) === "b" ? d[y] = { geometry: { type: "Polygon", coordinates: [[b.geometry.coordinates[0][2], b.geometry.coordinates[0][0], b.geometry.coordinates[0][1], b.geometry.coordinates[0][2]]] }, properties: { a: { geom: b.properties.c.geom, index: b.properties.c.index }, b: { geom: b.properties.a.geom, index: b.properties.a.index }, c: { geom: b.properties.b.geom, index: b.properties.b.index } }, type: "Feature" } : `${b.properties.c.index}`.substring(0, 1) === "b" && `${b.properties.a.index}`.substring(0, 1) === "b" && (d[y] = { geometry: { type: "Polygon", coordinates: [[b.geometry.coordinates[0][1], b.geometry.coordinates[0][2], b.geometry.coordinates[0][0], b.geometry.coordinates[0][1]]] }, properties: { a: { geom: b.properties.b.geom, index: b.properties.b.index }, b: { geom: b.properties.c.geom, index: b.properties.c.index }, c: { geom: b.properties.a.geom, index: b.properties.a.index } }, type: "Feature" });
        }
        return h;
      }
      function HA(h) {
        const d = ["a", "b", "c", "a"].map((P) => h.properties[P].geom), y = h.geometry.coordinates[0], b = h.properties, O = { a: { geom: y[0], index: b.a.index }, b: { geom: y[1], index: b.b.index }, c: { geom: y[2], index: b.c.index } };
        return o([d], O);
      }
      function KA(h) {
        const d = [0, 1, 2, 0].map((b) => h[b][0][0]), y = { a: { geom: h[0][0][1], index: h[0][1] }, b: { geom: h[1][0][1], index: h[1][1] }, c: { geom: h[2][0][1], index: h[2][1] } };
        return o([d], y);
      }
      function Te(h, d, y, b, O, P = !1, T) {
        const X = h.map((D) => {
          (!T || T < 2.00703) && (D = Ae(D));
      ...
      function CA(h) {
        const d = hA(h), y = d.tins;
        return { compiled: d, tins: y, points: uA(y), strictStatus: d.strict_status, pointsWeightBuffer: d.weight_buffer, verticesParams: d.vertices_params, centroid: d.centroid, kinks: d.kinks };
      }
      function qA(h) {
        return !h.version || h.version < Ge ? ["forw", "bakw"].reduce((d, y) => {
          const b = h.weight_buffer[y];
          return b && (d[y] = Object.keys(b).reduce((O, P) => {
            const T = Ae(P);
            return O[T] = b[P], O;
          }, {})), d;
        }, {}) : h.weight_buffer;
      ...
      function qt(h, d) {
        return [0, 1, 2, 3].map((y) => {
          const b = (y + 1) % 4, O = Te(["c", `b${y}`, `b${b}`], h.points, h.edgeNodes || [], h.centroid_point, h.vertices_points, d, Ge);
          return I([O]);
        });
      }
      function cA(h) {
      ...
      function ke(h) {
        ...
        return { forw: I(h.tins_points[0].map((y) => Te(y, h.points, h.edgeNodes || [], h.centroid_point, h.vertices_points, !1, h.version))), bakw: I(h.tins_points[d].map((y) => Te(y, h.points, h.edgeNodes || [], h.centroid_point, h.vertices_points, !0, h.version))) };
      }
      function lA(h) {
      ...
      const fA = Ge, xt = class Nt {
        ...
        addIndexedTin() {
          const d = this.tins, y = d.forw, b = d.bakw, O = Math.ceil(Math.sqrt(y.features.length));
          if (O < 3) {
            this.indexedTins = void 0;
            return;
          }
          let P = [], T = [];
          const X = y.features.map((k) => {
            let B = [];
            return c(k)[0].map((M) => {
        ...
        transform(d, y, b) {
          if (y && this.strict_status == Nt.STATUS_ERROR) throw 'Backward transform is not allowed if strict_status == "strict_error"';
          this.yaxisMode == Nt.YAXIS_FOLLOW && y && (d = [d[0], -1 * d[1]]);
          const O = s(d);
          if (this.bounds && !y && !b && !Qt(O, this.boundsPolygon)) return !1;
          const P = y ? this.tins.bakw : this.tins.forw, T = y ? this.indexedTins.bakw : this.indexedTins.forw, X = y ? this.vertices_params.bakw : this.vertices_params.forw, D = y ? this.centroid.bakw : this.centroid.forw, Z = y ? this.pointsWeightBuffer.bakw : this.pointsWeightBuffer.forw;
          let j, x;
          this.stateFull && (this.stateBackward == y ? j = this.stateTriangle : (this.stateBackward = y, this.stateTriangle = void 0), x = (N) => {
          ...
          } else this.yaxisMode == Nt.YAXIS_FOLLOW && !y && (G = [G[0], -1 * G[1]]);
          return G;
        }
      };
...
class nA extends Sg {
  ...
  async handleSetting(e, n) {
    this.appData = Ft(e), !this.lang && this.appData.lang && (this.lang = this.appData.lang);
    const i = this.prepareMap(n), g = await fg(this.appData.pois || [], this);
