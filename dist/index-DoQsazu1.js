...
if (!me && !pn && !cr)
  try {
    import("./browser-ponyfill-B_w46y2C.js").then((i) => i.b).then(function(i) {
      me = i.default;
    }).catch(function() {
    });
  } catch {
...
function or(i, t, e = {}) {
  ...
  const n = aa(i), r = Ia(t), A = r.type, s = t.bbox;
  let g = r.coordinates;
  if (s && ma(n, s) === !1)
    return !1;
  A === "Polygon" && (g = [g]);
  ...
  class t extends i {
    ...
    initialize(r) {
      ...
      if (r = $t(r), this.mapID = r.mapID, this.homePosition = r.homePosition, this.mercZoom = r.mercZoom, this.label = r.label, this.maxZoom = r.maxZoom, this.minZoom = r.minZoom, this.poiTemplate = r.poiTemplate, this.poiStyle = r.poiStyle, this.iconTemplate = r.iconTemplate, this.icon = r.icon, this.selectedIcon = r.selectedIcon, this.mercatorXShift = r.mercatorXShift, this.mercatorYShift = r.mercatorYShift, this.weiwudi = r.weiwudi, r.envelopeLngLats) {
        ...
        a.push(a[0]), this.envelope = gr([a]), this.centroid = (g = Oa(this.envelope).geometry) == null ? void 0 : g.coordinates;
      }
      ...
      this.initialWait = Promise.all([s, A]), Ta(this);
    }
    static isBasemap() {
...
function Ls(i) {
  class t extends Ts(i) {
    ...
    modulateXyInside(n) {
      ...
      const r = oa([n, this.centroid]), A = xa(this.envelope, r);
...
function Na(i) {
  ...
  return function() {
    ...
    return (!e || this !== n || !ja(r, e)) && (n = this, e = r, t = i.apply(this, arguments)), t;
  };
}
function Zs(i) {
  for (const t in i)
...
function Ws(i, t) {
  let e;
  return e = t(za(i)), e || (e = t(Qa(i)), e) || (e = t(Ya(i)), e) || (e = t(Va(i)), e) ? e : !1;
}
function za(i) {
  return [i[0], i[1]];
}
...
let qa = 0;
function _a(i) {
  return i.ol_uid || (i.ol_uid = String(++qa));
}
const $a = {
  /**
...
class rn extends wr {
   ...
   */
  constructor(t) {
    super(), this.on, this.once, this.un, _a(this), this.values_ = null, t !== void 0 && this.setProperties(t);
  }
  /**
   * Gets a value.
  ...
  notify(t, e) {
    let n;
    n = `change:${t}`, this.hasListener(n) && this.dispatchEvent(new jA(n, t, e)), n = $a.PROPERTYCHANGE, this.hasListener(n) && this.dispatchEvent(new jA(n, t, e));
  }
  /**
   * @param {string} key Key name.
   * @param {import("./events.js").Listener} listener Listener.
  ...
  unset(t, e) {
    if (this.values_ && t in this.values_) {
      ...
      delete this.values_[t], Ga(this.values_) && (this.values_ = null), e || this.notify(t, n);
    }
  }
}
function eI(...i) {
...
const jn = 6378137, Ve = Math.PI * jn, AI = [-Ve, -Ve, Ve, Ve], sI = [-180, -85, 180, 85], tr = jn * Math.log(Math.tan(Math.PI / 2));
class ze extends wn {
  /**
...
const aI = 6378137, GA = [-180, -90, 180, 90], II = Math.PI * aI / 180;
class Me extends wn {
  /**
   * @param {string} code Code.
...
const FA = -80, UA = 84, vI = -180, bI = 180;
function wI(i, t, e) {
  i = ii(i, vI, bI), t < FA ? t = FA : t > UA && (t = UA);
  const n = Je(t), r = Math.sin(n), A = Math.cos(n), s = r / A, g = s * s, o = g * g, a = Je(i), I = qs(e.number), C = Je(I), c = fr / Math.sqrt(1 - Xt * r ** 2), l = Oe * A ** 2, u = A * ii(a - C, -Math.PI, Math.PI), f = u * u, m = f * u, p = m * u, v = p * u, O = v * u, D = fr * (Js * n - lI * Math.sin(2 * n) + uI * Math.sin(4 * n) - hI * Math.sin(6 * n)), z = hr * c * (u + m / 6 * (1 - g + l) + v / 120 * (5 - 18 * g + o + 72 * l - 58 * Oe)) + 5e5;
...
function ue(i, t) {
  return si && !ur(i, [0, 0]) && i[0] >= -180 && i[0] <= 180 && i[1] >= -90 && i[1] <= 90 && (si = !1, eI(
...
const VA = jI(), ZI = [NaN, NaN];
class FI extends rn {
  constructor() {
    super(), this.extent_ = Us(), this.extentRevision_ = -1, this.simplifiedGeometryMaxMinSquaredTolerance = 0, this.simplifiedGeometryRevision = 0, this.simplifyTransformedInternal = Na(
      (t, e, n) => {
        if (!n)
   ...
   */
  containsXY(t, e) {
    return this.closestPointXY(t, e, ZI, Number.MIN_VALUE) === 0;
  }
  /**
...
function HI(i, t, e, n, r, A, s, g, o, a, I) {
  I = I || [NaN, NaN];
...
function rg(i, t, e, n, r, A, s) {
  ...
  for (; a.length > 0; ) {
    ...
    for (let v = c + n; v < C; v += n) {
      const O = i[v], D = i[v + 1], z = nI(O, D, u, f, m, p);
      z > l && (I = v, l = z);
    }
...
class dr extends kn {
  ...
  getCoordinateAtM(t, e) {
    return this.layout != "XYM" && this.layout != "XYZM" ? null : (e = e !== void 0 ? e : !1, qI(
      this.flatCoordinates,
      0,
      this.flatCoordinates.length,
      this.stride,
...
class Rn extends kn {
   ...
   */
  computeExtent(t) {
    return Za(this.flatCoordinates, t);
  }
  /**
   * Get the type of this geometry.
   * @return {import("./Geometry.js").Type} Geometry type.
...
function JA(i, t, e, n, r) {
  ...
  for (let A = 0, s = e.length; A < s; ++A) {
    ...
    (A === 0 ? r && o || !r && !o : r && !o || !r && o) && rC(i, t, g, n), t = g;
  }
  return t;
}
class Te extends kn {
  ...
  closestPointXY(t, e, n, r) {
    ...
    ), this.maxDeltaRevision_ = this.getRevision()), HI(
      this.flatCoordinates,
      0,
      this.ends_,
      this.stride,
  ...
  getCoordinates(t) {
    let e;
    return t !== void 0 ? (e = this.getOrientedFlatCoordinates().slice(), JA(e, 0, this.ends_, this.stride, t)) : e = this.flatCoordinates, VI(e, 0, this.ends_, this.stride);
  }
  /**
  ...
  getOrientedFlatCoordinates() {
    if (this.orientedRevision_ != this.getRevision()) {
      ...
      iC(t, 0, this.ends_, this.stride) ? this.orientedFlatCoordinates_ = t : (this.orientedFlatCoordinates_ = t.slice(), this.orientedFlatCoordinates_.length = JA(
...
class es extends rn {
   ...
   */
  constructor(t) {
    super(), this.on, this.once, this.un, t = Object.assign({}, t), this.hints_ = [0, 0], this.animations_ = [], this.updateAnimationKey_, this.projection_ = vi(t.projection, "EPSG:3857"), this.viewportSize_ = [100, 100], this.targetCenter_ = null, this.targetResolution_, this.targetRotation_, this.nextCenter_ = null, this.nextResolution_, this.nextRotation_, this.cancelAnchor_ = void 0, t.projection && SI(), t.center && (t.center = ue(t.center, this.projection_)), t.extent && (t.extent = er(t.extent, this.projection_)), this.applyOptions_(t);
  }
  /**
  ...
  applyOptions_(t) {
    ...
    const r = uC(t), A = n.constraint, s = fC(t);
    this.constraints_ = {
      center: r,
      resolution: A,
      rotation: s
  ...
  animateInternal(t) {
    ...
    for (; r < e; ++r) {
      ...
      dC(C) ? C.complete = !0 : A += C.duration, a.push(C);
    }
  ...
  calculateCenterRotate(t, e) {
    ...
    return r !== void 0 && (n = [r[0] - e[0], r[1] - e[1]], pi(n, t - this.getRotation()), rI(n, e)), n;
  }
  /**
  ...
  calculateExtentInternal(t) {
    ...
    return fe(r !== void 0, "The view rotation is not defined"), Wa(e, n, r, t);
  }
  /**
...
function hC(i) {
  ...
  if (!a && !f && c.isGlobal() && (u = !1, f = l), i.resolutions !== void 0) {
    ...
    e = m[s], n = m[g] !== void 0 ? m[g] : m[m.length - 1], i.constrainResolution ? t = aC(
      m,
      I,
      !u && f,
      C
    ...
    )) / lC / Math.pow(2, Ur), v = p / Math.pow(2, 28 - Ur);
    ...
    ), n = e / Math.pow(o, g - s), i.constrainResolution ? t = IC(
      o,
      e,
      n,
      I,
...
function fC(i) {
  if (i.enableRotation !== void 0 ? i.enableRotation : !0) {
    ...
    return e === void 0 || e === !0 ? cC() : e === !1 ? ts : typeof e == "number" ? CC(e) : ts;
  }
  return Oi;
}
function dC(i) {
...
class gg extends mC {
  ...
  isVisible(t) {
    ...
    return yC(r, e.viewState) && (!A || fi(A, e.extent));
  }
  /**
...
class On extends io {
  ...
  static spawnLayer(e, n, r) {
    return n instanceof xn || n instanceof Sn || !(e instanceof kr) ? (n instanceof xn ? e = new vC({
      style: n.style,
      accessToken: n.accessToken,
      container: r,
      source: n
    }) : n instanceof Sn ? e = new bC({
      style: n.style,
      container: r,
      source: n
    }) : e = new kr({
...
const Le = typeof navigator < "u" && typeof navigator.userAgent < "u" ? navigator.userAgent.toLowerCase() : "", OC = Le.includes("safari") && !Le.includes("chrom");
OC && (Le.includes("version/15.4") || /cpu (os|iphone os) 15_4 like mac os x/.test(Le));
const DC = Le.includes("webkit") && !Le.includes("edge"), Cg = Le.includes("macintosh");
...
const BC = function(i) {
  ...
  return (e instanceof ShadowRoot ? e.host : t).hasAttribute("tabindex") ? LC(i) : !0;
}, jC = ka, lg = function(i) {
  const t = i.originalEvent;
  return "pointerId" in t && t.button == 0 && !(DC && Cg && t.ctrlKey);
}, ug = function(i) {
  const t = (
...
class XC extends An {
   ...
   */
  constructor(t) {
    super(), this.on, this.once, this.un, t = t ?? {}, this.box_ = new GC(t.className || "ol-dragbox"), this.minArea_ = t.minArea ?? 64, t.onBoxEnd && (this.onBoxEnd = t.onBoxEnd), this.startPixel_ = null, this.condition_ = t.condition ?? lg, this.boxEndCondition_ = t.boxEndCondition ?? this.defaultBoxEndCondition;
  }
  /**
...
class ZC extends An {
  ...
  constructor(t) {
    ...
    const e = t.condition ? t.condition : ai(ug, NC);
  ...
  handleDragEvent(t) {
    ...
    if (n.length == this.lastPointersCount_) {
      if (this.kinetic_ && this.kinetic_.update(r[0], r[1]), this.lastCentroid) {
        ...
        iI(A, g.getResolution()), pi(A, g.getRotation()), g.adjustCenterInternal(A);
      }
  ...
  handleEvent(t) {
    ...
    if (t.type == ye.KEYDOWN) {
      ...
      if (this.condition_(t) && (r == Pe.DOWN || r == Pe.LEFT || r == Pe.RIGHT || r == Pe.UP)) {
        ...
        const I = [o, a];
        pi(I, s.getRotation()), xC(s, I, this.duration_), n.preventDefault(), e = !0;
      }
    }
    return !e;
  }
...
class KC extends Nn {
  ...
  constructor(t) {
    ...
    const e = t.condition ? t.condition : jC;
...
function is(i) {
  i = i || {};
  const t = new QC(), e = new _C(-5e-3, 0.05, 100);
  return (i.altShiftDragRotate !== void 0 ? i.altShiftDragRotate : !0) && t.push(new FC()), (i.doubleClickZoom !== void 0 ? i.doubleClickZoom : !0) && t.push(
    new SC({
      delta: i.zoomDelta,
  ...
  ), (i.pinchRotate !== void 0 ? i.pinchRotate : !0) && t.push(new JC()), (i.pinchZoom !== void 0 ? i.pinchZoom : !0) && t.push(
    new qC({
      duration: i.zoomDuration
    })
  ), (i.keyboard !== void 0 ? i.keyboard : !0) && (t.push(new WC()), t.push(
    new HC({
      delta: i.zoomDelta,
      duration: i.zoomDuration
    })
...
function $C(i) {
  return tc(i[0], i[1], i[2]);
}
function tc(i, t, e) {
  return (t << i) + e;
}
const ec = /\{z\}/g, nc = /\{x\}/g, rc = /\{y\}/g, ic = /\{-y\}/g;
function Ac(i, t, e, n, r) {
  return i.replace(ec, t.toString()).replace(nc, e.toString()).replace(rc, n.toString()).replace(ic, function() {
    throw new Error(
...
class oe extends oc {
  ...
  static async registerMap(t, e) {
    ...
    let n;
    const r = ["type", "url", "width", "height", "tileSize", "minZoom", "maxZoom", "maxLng", "maxLat", "minLng", "minLat"].reduce((s, g) => (typeof e[g] < "u" && (e[g] instanceof Array ? e[g].map((o) => {
      s.append(g, o);
  ...
  static async retrieveMap(t) {
    ...
    if (e = await (await fetch(`${ge}info?mapID=${t}`)).text(), e.match(/^Error: /))
      throw e;
    return console.log(e), new oe(t, JSON.parse(e));
  }
  ...
  async remove() {
    this.checkAspect(), this.mapID && await oe.removeMap(this.mapID), this.release();
  }
  async cancel() {
    let t;
...
var un = { exports: {} }, ac = un.exports, ss;
function Ic() {
...
if (Pt.arrayBuffer)
  var hc = [
    ...
    "[object Float32Array]",
    "[object Float64Array]"
  ], fc = ArrayBuffer.isView || function(i) {
    return i && hc.indexOf(Object.prototype.toString.call(i)) > -1;
  };
function sn(i) {
...
var yc = ["CONNECT", "DELETE", "GET", "HEAD", "OPTIONS", "PATCH", "POST", "PUT", "TRACE"];
function vc(i) {
  var t = i.toUpperCase();
  return yc.indexOf(t) > -1 ? t : i;
}
function je(i, t) {
  ...
  if (i instanceof je) {
    ...
    this.url = String(i);
  if (this.credentials = t.credentials || this.credentials || "same-origin", (t.headers || !this.headers) && (this.headers = new ut(t.headers)), this.method = vc(t.method || this.method || "GET"), this.mode = t.mode || this.mode || null, this.signal = t.signal || this.signal || (function() {
  ...
  return new Promise(function(e, n) {
    ...
    A.onload = function() {
      var a = {
        ...
        headers: wc(A.getAllResponseHeaders() || "")
      };
...
async function Pc(i, t) {
  if (typeof i == "string" && (i = Mc[i]), i = $t(Object.assign(i, t)), i.label = i.label || i.year, Is(i.maptype)) {
...
class Bn extends Fs {
  ...
  initGeolocation(e) {
    ...
    const n = this.geolocation = new Bc({
      timerBase: e.fake,
    ...
    this.alwaysGpsOn ? (n.setTracking(!0), this.gpsEnabled_ = !0) : (n.setTracking(!1), this.gpsEnabled_ = !1), n.on("change", () => {
      ...
      (g ? g.getSource() : o.getSource()).setGPSMarker(), this.dispatchEvent(new Lc(A === 1 ? "user_gps_deny" : A === 2 ? "gps_miss" : "gps_timeout")), this.dispatchEvent(new sr({ error: "gps_off" }));
  ...
  handleGPS(e, n = !1) {
    if (this.geolocation) {
      if (e)
        if (!this.alwaysGpsOn)
          this.firstGpsRequest_ = !0, this.geolocation.setTracking(!0), this.gpsEnabled_ = !0, this.dispatchEvent(new jc());
        else {
          this.moveTo_ = !0;
...
if (typeof window < "u") {
  ...
  window.Maplat = i, window.MaplatApp = Bn, window.assets = Tc;
}
export {
  Dt as C,
  Lc as G,
...
//# sourceMappingURL=index-DoQsazu1.js.map
